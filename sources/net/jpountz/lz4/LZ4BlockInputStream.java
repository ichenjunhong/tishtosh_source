...
public final class LZ4BlockInputStream extends FilterInputStream {
    ...
    public final int available() throws IOException {
        return this.originalLen - this.f132149o;
    }
    ...
    public final int read() throws IOException {
        ...
        if (this.f132149o == this.originalLen) {
            refill();
        }
        if (this.finished) {
            return -1;
    ...
    public final long skip(long j) throws IOException {
        ...
        int min = (int) Math.min(j, (long) (this.originalLen - this.f132149o));
        this.f132149o += min;
        return (long) min;
    }
    ...
    public final int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        int min = Math.min(i2, this.originalLen - this.f132149o);
        System.arraycopy(this.buffer, this.f132149o, bArr, i, min);
        this.f132149o += min;
        return min;
    }
