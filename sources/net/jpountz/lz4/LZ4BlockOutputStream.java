...
public final class LZ4BlockOutputStream extends FilterOutputStream {
    ...
    private void flushBufferedData() throws IOException {
        ...
        if (this.f132150o != 0) {
            this.checksum.reset();
            this.checksum.update(this.buffer, 0, this.f132150o);
            int value = (int) this.checksum.getValue();
            int compress = this.compressor.compress(this.buffer, 0, this.f132150o, this.compressedBuffer, HEADER_LENGTH);
            if (compress >= this.f132150o) {
                i2 = 16;
                i = this.f132150o;
                System.arraycopy(this.buffer, 0, this.compressedBuffer, HEADER_LENGTH, this.f132150o);
            } else {
                i = compress;
                i2 = 32;
            }
            ...
            writeIntLE(this.f132150o, this.compressedBuffer, MAGIC_LENGTH + 5);
    ...
    public final void write(int i) throws IOException {
        ensureNotFinished();
        if (this.f132150o == this.blockSize) {
            flushBufferedData();
        }
        byte[] bArr = this.buffer;
        int i2 = this.f132150o;
        this.f132150o = i2 + 1;
        bArr[i2] = (byte) i;
    }
    ...
    public final void write(byte[] bArr, int i, int i2) throws IOException {
        ...
        ensureNotFinished();
        while (this.f132150o + i2 > this.blockSize) {
            int i3 = this.blockSize - this.f132150o;
            System.arraycopy(bArr, i, this.buffer, this.f132150o, this.blockSize - this.f132150o);
            this.f132150o = this.blockSize;
            flushBufferedData();
            i += i3;
            i2 -= i3;
        }
        System.arraycopy(bArr, i, this.buffer, this.f132150o, i2);
        this.f132150o += i2;
    }
