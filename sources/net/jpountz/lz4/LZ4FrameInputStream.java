...
import net.jpountz.lz4.LZ4FrameOutputStream.C53438BD;
...
public class LZ4FrameInputStream extends FilterInputStream {
    ...
    private void readBlock() throws IOException {
        ...
        if (i != 0) {
            ...
            throw new IOException(C2240a.m6773a(Locale.ROOT, "Block size %s exceeded max: %s", new Object[]{Integer.valueOf(i), Integer.valueOf(this.maxBlockSize)}));
    ...
    private void readHeader() throws IOException {
        ...
        if (read >= 0) {
            ...
            if (read2 >= 0) {
                ...
                C53438BD fromByte2 = C53438BD.fromByte(b2);
