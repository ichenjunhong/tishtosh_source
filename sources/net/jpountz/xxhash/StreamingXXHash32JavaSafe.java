...
final class StreamingXXHash32JavaSafe extends AbstractStreamingXXHash32Java {
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f132152v1 += SafeUtils.readIntLE(this.memory, 0) * -2048144777;
            this.f132152v1 = Integer.rotateLeft(this.f132152v1, 13);
            this.f132152v1 *= -1640531535;
            this.f132153v2 += SafeUtils.readIntLE(this.memory, 4) * -2048144777;
            this.f132153v2 = Integer.rotateLeft(this.f132153v2, 13);
            this.f132153v2 *= -1640531535;
            this.f132154v3 += SafeUtils.readIntLE(this.memory, 8) * -2048144777;
            this.f132154v3 = Integer.rotateLeft(this.f132154v3, 13);
            this.f132154v3 *= -1640531535;
            this.f132155v4 += SafeUtils.readIntLE(this.memory, 12) * -2048144777;
