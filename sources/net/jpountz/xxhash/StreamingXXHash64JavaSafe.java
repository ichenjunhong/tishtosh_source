...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f132156v1 += SafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
            this.f132156v1 = Long.rotateLeft(this.f132156v1, 31);
            this.f132156v1 *= -7046029288634856825L;
            this.f132157v2 += SafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
            this.f132157v2 = Long.rotateLeft(this.f132157v2, 31);
            this.f132157v2 *= -7046029288634856825L;
            this.f132158v3 += SafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
            this.f132158v3 = Long.rotateLeft(this.f132158v3, 31);
            this.f132158v3 *= -7046029288634856825L;
            this.f132159v4 += SafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
