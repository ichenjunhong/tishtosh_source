...
final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public final long getValue() {
        long j;
        if (this.totalLen >= 32) {
            long j2 = this.f132156v1;
            long j3 = this.f132157v2;
            long j4 = this.f132158v3;
            long j5 = this.f132159v4;
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f132156v1 += UnsafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
            this.f132156v1 = Long.rotateLeft(this.f132156v1, 31);
            this.f132156v1 *= -7046029288634856825L;
            this.f132157v2 += UnsafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
            this.f132157v2 = Long.rotateLeft(this.f132157v2, 31);
            this.f132157v2 *= -7046029288634856825L;
            this.f132158v3 += UnsafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
            this.f132158v3 = Long.rotateLeft(this.f132158v3, 31);
            this.f132158v3 *= -7046029288634856825L;
            this.f132159v4 += UnsafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
            this.f132159v4 = Long.rotateLeft(this.f132159v4, 31);
            this.f132159v4 *= -7046029288634856825L;
            i3 += 32 - this.memSize;
            this.memSize = 0;
        }
        int i6 = i5 - 32;
        long j = this.f132156v1;
        long j2 = this.f132157v2;
        long j3 = this.f132158v3;
        long j4 = this.f132159v4;
        while (i3 <= i6) {
