...
public enum Native {
    ...
    enum C53439OS {
        private static final /* synthetic */ C53439OS[] $VALUES = null;
        public static final C53439OS LINUX = null;
        public static final C53439OS MAC = null;
        public static final C53439OS SOLARIS = null;
        public static final C53439OS WINDOWS = null;
        public final String libExtension;
        public final String name;

        public static C53439OS[] values() {
            return (C53439OS[]) $VALUES.clone();
        }

        static {
            WINDOWS = new C53439OS("WINDOWS", 0, "win32", "so");
            LINUX = new C53439OS("LINUX", 1, "linux", "so");
            MAC = new C53439OS("MAC", 2, "darwin", "dylib");
            SOLARIS = new C53439OS("SOLARIS", 3, "solaris", "so");
            $VALUES = new C53439OS[]{WINDOWS, LINUX, MAC, SOLARIS};
        }

        public static C53439OS valueOf(String str) {
            return (C53439OS) Enum.valueOf(C53439OS.class, str);
        }

        private C53439OS(String str, int i, String str2, String str3) {
            this.name = str2;
    ...
    /* renamed from: os */
    private static C53439OS m113489os() {
        String property = System.getProperty("os.name");
        if (property.contains("Linux")) {
            return C53439OS.LINUX;
        }
        if (property.contains("Mac")) {
            return C53439OS.MAC;
        }
        if (property.contains("Windows")) {
            return C53439OS.WINDOWS;
        }
        if (property.contains("Solaris") || property.contains("SunOS")) {
            return C53439OS.SOLARIS;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        ...
        r4.append(m113489os().libExtension);
    ...
    public static synchronized void load() {
        ...
        L_0x0013:
            ...
            net.jpountz.util.Native$OS r5 = m113489os()     // Catch:{ IOException -> 0x0092 }
