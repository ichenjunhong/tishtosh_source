...
class C0808d extends C0824h {
    C0808d() {
    }

    /* renamed from: a */
    private static File m2315a(ParcelFileDescriptor parcelFileDescriptor) {
        try {
    ...
    public android.graphics.Typeface mo2604a(android.content.Context r4, android.os.CancellationSignal r5, android.support.p030v4.p036d.C0747b.C0753b[] r6, int r7) {
        /*
            r3 = this;
            int r0 = r6.length
            r1 = 0
            ...
            return r1
        L_0x0005:
            android.support.v4.d.b$b r6 = r3.mo2667a(r6, r7)
            android.content.ContentResolver r7 = r4.getContentResolver()
            android.net.Uri r6 = r6.f2591a     // Catch:{ IOException -> 0x0074 }
            java.lang.String r0 = "r"
            android.os.ParcelFileDescriptor r5 = r7.openFileDescriptor(r6, r0, r5)     // Catch:{ IOException -> 0x0074 }
            java.io.File r6 = m2315a(r5)     // Catch:{ Throwable -> 0x005d, all -> 0x005a }
        ...
        L_0x002c:
            ...
            android.graphics.Typeface r4 = android.support.p030v4.graphics.C0824h.m2374a(r4, r6)     // Catch:{ Throwable -> 0x0045, all -> 0x0042 }
        ...
        L_0x0051:
            r6 = move-exception
            com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r7, r6)     // Catch:{ Throwable -> 0x005d, all -> 0x005a }
            goto L_0x0059
        L_0x0056:
            r6.close()     // Catch:{ Throwable -> 0x005d, all -> 0x005a }
        L_0x0059:
        ...
        L_0x006b:
            r5 = move-exception
            com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r6, r5)     // Catch:{ IOException -> 0x0074 }
            goto L_0x0073
        L_0x0070:
            r5.close()     // Catch:{ IOException -> 0x0074 }
        L_0x0073:
        ...
        L_0x0074:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.graphics.C0808d.mo2604a(android.content.Context, android.os.CancellationSignal, android.support.v4.d.b$b[], int):android.graphics.Typeface");
    }
}
