...
public final class C0828i {
    /* renamed from: a */
    public static void m2390a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
    ...
    /* renamed from: a */
    private static ByteBuffer m2389a(File file) {
        Throwable th;
        Throwable th2;
        try {
    ...
    /* renamed from: a */
    public static File m2386a(Context context) {
    ...
    /* renamed from: a */
    public static boolean m2392a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m2390a((Closeable) fileOutputStream);
                ...
                m2390a((Closeable) fileOutputStream2);
                StrictMode.setThreadPolicy(allowThreadDiskWrites);
                return false;
            } catch (Throwable th) {
                th = th;
    ...
    /* renamed from: a */
    public static ByteBuffer m2387a(Context context, Resources resources, int i) {
        File a = m2386a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m2391a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m2389a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    public static java.nio.ByteBuffer m2388a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        /*
        ...
        L_0x0044:
            r9 = move-exception
            com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r1, r9)     // Catch:{ Throwable -> 0x0050, all -> 0x004d }
            goto L_0x004c
        L_0x0049:
            r9.close()     // Catch:{ Throwable -> 0x0050, all -> 0x004d }
        L_0x004c:
        ...
        L_0x005e:
            r8 = move-exception
            com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r10, r8)     // Catch:{ IOException -> 0x0067 }
            goto L_0x0066
        L_0x0063:
            r8.close()     // Catch:{ IOException -> 0x0067 }
        L_0x0066:
        ...
        L_0x0067:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.graphics.C0828i.m2388a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static boolean m2391a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m2392a(file, inputStream);
                m2390a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m2390a((Closeable) inputStream);
