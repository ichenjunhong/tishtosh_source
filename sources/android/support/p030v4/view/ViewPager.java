...
public class ViewPager extends ViewGroup {
    private static final Comparator<C0994b> COMPARATOR = new Comparator<C0994b>() {
        public final /* bridge */ /* synthetic */ int compare(Object obj, Object obj2) {
            return ((C0994b) obj).f3220b - ((C0994b) obj2).f3220b;
        }
    };
    ...
    private static final C1001i sPositionComparator = new C1001i();
    private int mActivePointerId = -1;
    PagerAdapter mAdapter;
    private List<C0996d> mAdapterChangeListeners;
    ...
    private C0997e mInternalPageChangeListener;
    private boolean mIsBeingDragged;
    private boolean mIsScrollStarted;
    private boolean mIsUnableToDrag;
    private final ArrayList<C0994b> mItems = new ArrayList<>();
    ...
    private C0999g mObserver;
    private int mOffscreenPageLimit = 1;
    private C0997e mOnPageChangeListener;
    private List<C0997e> mOnPageChangeListeners;
    private int mPageMargin;
    private C0998f mPageTransformer;
    ...
    private final C0994b mTempItem = new C0994b();
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.f3212b = obtainStyledAttributes.getInteger(0, 48);
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeParcelable(this.f3217b, i);
        }
        ...
        SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f3217b = parcel.readParcelable(classLoader);
            this.f3218c = classLoader;
        }
    }
    ...
    class C0995c extends C1002a {
        /* renamed from: a */
        private boolean m2869a() {
        ...
        public final void mo1322a(View view, AccessibilityEvent accessibilityEvent) {
            ...
            accessibilityEvent.setScrollable(m2869a());
    ...
    public interface C0996d {
        /* renamed from: a */
        void mo1576a(ViewPager viewPager, PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }
    ...
    public interface C0998f {
        /* renamed from: a */
        void mo3111a(View view, float f);
    }

    /* renamed from: android.support.v4.view.ViewPager$g */
    class C0999g extends DataSetObserver {
    ...
    public static class C1000h implements C0997e {
    ...
    static class C1001i implements Comparator<View> {
        C1001i() {
        }
        ...
        public final /* synthetic */ int compare(Object obj, Object obj2) {
            ...
            if (layoutParams.f3211a == layoutParams2.f3211a) {
                i = layoutParams.position - layoutParams2.position;
            } else if (!layoutParams.f3211a) {
                return -1;
            } else {
                i = 1;
            }
    ...
    private void removeNonDecorViews() {
        ...
        while (i < getChildCount()) {
            if (!((LayoutParams) getChildAt(i).getLayoutParams()).f3211a) {
                removeViewAt(i);
                i--;
            }
            i++;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f3216a = this.mCurItem;
        if (this.mAdapter != null) {
            savedState.f3217b = this.mAdapter.saveState();
        }
        return savedState;
    }
    ...
    private C0994b infoForCurrentScrollPosition() {
        float f;
        float f2;
        ...
        while (i < this.mItems.size()) {
            C0994b bVar2 = (C0994b) this.mItems.get(i);
            if (!z) {
                int i3 = i2 + 1;
                if (bVar2.f3220b != i3) {
                    bVar2 = this.mTempItem;
                    bVar2.f3223e = f3 + f4 + f2;
                    bVar2.f3220b = i3;
                    bVar2.f3222d = this.mAdapter.getPageWidth(bVar2.f3220b);
                    i--;
                }
            }
            f3 = bVar2.f3223e;
            float f5 = bVar2.f3222d + f3 + f2;
            if (!z && f < f3) {
                return bVar;
            }
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            if (this.mAdapter != null) {
                ...
                int clientWidth = getClientWidth();
                int scrollX = getScrollX();
                C0994b infoForCurrentScrollPosition = infoForCurrentScrollPosition();
                setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f3220b, ((((float) scrollX) / ((float) clientWidth)) - infoForCurrentScrollPosition.f3223e) / infoForCurrentScrollPosition.f3222d, xVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), true, true, xVelocity);
            }
            endDrag();
    ...
    public void initViewPager() {
        ...
        C1056u.m3031a((View) this, (C1002a) new C0995c());
        ...
        C1056u.m3032a((View) this, (C1051p) new C1051p() {
            ...
            /* renamed from: b */
            private final Rect f3210b = new Rect();
            ...
            public final C1018ac mo1130a(View view, C1018ac acVar) {
                ...
                for (int i = 0; i < childCount; i++) {
                    C1018ac b = C1056u.m3041b(ViewPager.this.getChildAt(i), a);
    ...
    public void dataSetChanged() {
        ...
        while (i2 < this.mItems.size()) {
            C0994b bVar = (C0994b) this.mItems.get(i2);
            int itemPosition = this.mAdapter.getItemPosition(bVar.f3219a);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    this.mAdapter.destroyItem((ViewGroup) this, bVar.f3220b, bVar.f3219a);
                    if (this.mCurItem == bVar.f3220b) {
                        i = Math.max(0, Math.min(this.mCurItem, count - 1));
                    }
                } else if (bVar.f3220b != itemPosition) {
                    if (bVar.f3220b == this.mCurItem) {
                        i = itemPosition;
                    }
                    bVar.f3220b = itemPosition;
                }
                z2 = true;
            }
            i2++;
        ...
        if (z2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (!layoutParams.f3211a) {
                    layoutParams.f3213c = 0.0f;
                }
            }
    ...
    /* access modifiers changed from: 0000 */
    public C0997e setInternalPageChangeListener(C0997e eVar) {
        C0997e eVar2 = this.mInternalPageChangeListener;
        this.mInternalPageChangeListener = eVar;
        return eVar2;
    }

    private static boolean isDecorView(View view) {
        if (view.getClass().getAnnotation(C0993a.class) != null) {
            return true;
        }
        return false;
    }
    ...
    public void removeOnAdapterChangeListener(C0996d dVar) {
    ...
    public void addOnAdapterChangeListener(C0996d dVar) {
        if (this.mAdapterChangeListeners == null) {
    ...
    /* access modifiers changed from: 0000 */
    public C0994b infoForAnyChild(View view) {
        while (true) {
    ...
    /* access modifiers changed from: 0000 */
    public C0994b infoForPosition(int i) {
    ...
    private void dispatchOnPageSelected(int i) {
        ...
        if (this.mOnPageChangeListeners != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0997e eVar = (C0997e) this.mOnPageChangeListeners.get(i2);
                if (eVar != null) {
    ...
    public void addTouchables(ArrayList<View> arrayList) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getVisibility() == 0) {
                C0994b infoForChild = infoForChild(childAt);
                if (infoForChild != null && infoForChild.f3220b == this.mCurItem) {
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt.getVisibility() == 0) {
                C0994b infoForChild = infoForChild(childAt);
                if (infoForChild != null && infoForChild.f3220b == this.mCurItem && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                    return true;
                }
            }
        }
    ...
    /* access modifiers changed from: 0000 */
    public C0994b infoForChild(View view) {
        for (int i = 0; i < this.mItems.size(); i++) {
            C0994b bVar = (C0994b) this.mItems.get(i);
            if (this.mAdapter.isViewFromObject(view, bVar.f3219a)) {
                return bVar;
            }
        }
        return null;
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (this.mAdapter != null) {
            this.mAdapter.restoreState(savedState.f3217b, savedState.f3218c);
            setCurrentItemInternal(savedState.f3216a, false, true);
            return;
        }
        this.mRestoredCurItem = savedState.f3216a;
        this.mRestoredAdapterState = savedState.f3217b;
        this.mRestoredClassLoader = savedState.f3218c;
    }
    ...
    private void completeScroll(boolean z) {
        ...
        if (z3) {
            if (z) {
                C1056u.m3034a((View) this, this.mEndScrollRunnable);
                return;
            }
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() != 0) {
            ...
            int i3 = infoForCurrentScrollPosition.f3220b;
            float f3 = ((((float) i) / f) - infoForCurrentScrollPosition.f3223e) / (infoForCurrentScrollPosition.f3222d + f2);
    ...
    private boolean performDrag(float f) {
        ...
        boolean z3 = false;
        C0994b bVar = (C0994b) this.mItems.get(0);
        C0994b bVar2 = (C0994b) this.mItems.get(this.mItems.size() - 1);
        if (bVar.f3220b != 0) {
            f3 = bVar.f3223e * clientWidth;
            z = false;
        } else {
            z = true;
        }
        if (bVar2.f3220b != this.mAdapter.getCount() - 1) {
            f4 = bVar2.f3223e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
    ...
    public boolean arrowScroll(int r7) {
        ...
        L_0x00b8:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.view.ViewPager.arrowScroll(int):boolean");
    }
    ...
    public void fakeDragBy(float f) {
        if (!this.mFakeDragging) {
            ...
            C0994b bVar2 = (C0994b) this.mItems.get(this.mItems.size() - 1);
            if (bVar.f3220b != 0) {
                f2 = bVar.f3223e * clientWidth;
            }
            if (bVar2.f3220b != this.mAdapter.getCount() - 1) {
                f3 = bVar2.f3223e * clientWidth;
            }
            if (scrollX < f2) {
                scrollX = f2;
            } else if (scrollX > f3) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            int i = 0;
            C0994b bVar = (C0994b) this.mItems.get(0);
            float f6 = bVar.f3223e;
            int size = this.mItems.size();
            int i2 = bVar.f3220b;
            int i3 = ((C0994b) this.mItems.get(size - 1)).f3220b;
            while (i2 < i3) {
                while (i2 > bVar.f3220b && i < size) {
                    i++;
                    bVar = (C0994b) this.mItems.get(i);
                }
                if (i2 == bVar.f3220b) {
                    f2 = (bVar.f3223e + bVar.f3222d) * f4;
                    f = bVar.f3223e + bVar.f3222d + f5;
                } else {
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        ...
        if (this.mAdapterChangeListeners != null && !this.mAdapterChangeListeners.isEmpty()) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ((C0996d) this.mAdapterChangeListeners.get(i2)).mo1576a(this, pagerAdapter2, pagerAdapter);
            }
        }
    }
        ...
        switch (motionEvent.getAction() & NormalGiftView.ALPHA_255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f3220b, ((((float) scrollX) / f2) - infoForCurrentScrollPosition.f3223e) / (infoForCurrentScrollPosition.f3222d + (((float) this.mPageMargin) / f2)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
                    z = resetTouch();
                    break;
                }
                break;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0066, code lost:
        if (r8.f3220b == r0.mCurItem) goto L_0x006d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void populate(int r18) {
        ...
        L_0x004c:
            ...
            android.support.v4.view.ViewPager$b r8 = (android.support.p030v4.view.ViewPager.C0994b) r8
            int r9 = r8.f3220b
            int r10 = r0.mCurItem
        ...
        L_0x0077:
            ...
            android.support.v4.view.ViewPager$b r11 = (android.support.p030v4.view.ViewPager.C0994b) r11
            goto L_0x0088
        L_0x0087:
            r11 = 0
        L_0x0088:
        ...
        L_0x00a6:
            ...
            java.lang.Object r11 = r11.f3219a
            ...
            android.support.v4.view.ViewPager$b r5 = (android.support.p030v4.view.ViewPager.C0994b) r5
            goto L_0x0100
        L_0x00d3:
        ...
        L_0x01ac:
            ...
            android.support.v4.view.ViewPager$LayoutParams r4 = (android.support.p030v4.view.ViewPager.LayoutParams) r4
            r4.f3215e = r2
            boolean r5 = r4.f3211a
        ...
        L_0x0229:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.view.ViewPager.populate(int):void");
    }
    ...
    public void setPageTransformer(boolean z, C0998f fVar) {
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        return ((LayoutParams) ((View) this.mDrawingOrderedChildren.get(i2)).getLayoutParams()).f3215e;
    }

    /* access modifiers changed from: 0000 */
    public C0994b addNewItem(int i, int i2) {
        C0994b bVar = new C0994b();
        bVar.f3220b = i;
        bVar.f3219a = this.mAdapter.instantiateItem((ViewGroup) this, i);
        bVar.f3222d = this.mAdapter.getPageWidth(i);
    ...
    public boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        while (i3 != i4) {
            ...
            if (childAt.getVisibility() == 0) {
                C0994b infoForChild = infoForChild(childAt);
                if (infoForChild != null && infoForChild.f3220b == this.mCurItem && childAt.requestFocus(i, rect)) {
                    return true;
                }
            }
            i3 += i2;
    ...
    public void onMeasure(int r17, int r18) {
        ...
        L_0x003f:
            ...
            android.support.v4.view.ViewPager$LayoutParams r6 = (android.support.p030v4.view.ViewPager.LayoutParams) r6
            if (r6 == 0) goto L_0x00c1
            boolean r10 = r6.f3211a
        ...
        L_0x00de:
            ...
            android.support.v4.view.ViewPager$LayoutParams r5 = (android.support.p030v4.view.ViewPager.LayoutParams) r5
            if (r5 == 0) goto L_0x00f6
            boolean r7 = r5.f3211a
        ...
        L_0x0108:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.view.ViewPager.onMeasure(int, int):void");
    }
    ...
    private void dispatchOnPageScrolled(int i, float f, int i2) {
        ...
        if (this.mOnPageChangeListeners != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                C0997e eVar = (C0997e) this.mOnPageChangeListeners.get(i3);
                if (eVar != null) {
    ...
    public void addView(View view, int i, android.view.ViewGroup.LayoutParams layoutParams) {
        ...
        layoutParams2.f3211a |= isDecorView(view);
        if (!this.mInLayout) {
            super.addView(view, i, layoutParams);
        } else if (layoutParams2 == null || !layoutParams2.f3211a) {
            layoutParams2.f3214d = true;
    ...
    public void setPageTransformer(boolean z, C0998f fVar, int i) {
        boolean z2;
        boolean z3;
        boolean z4;
        int i2 = 1;
    ...
    public void onPageScrolled(int r13, float r14, int r15) {
        ...
        L_0x001d:
            ...
            android.support.v4.view.ViewPager$LayoutParams r9 = (android.support.p030v4.view.ViewPager.LayoutParams) r9
            boolean r10 = r9.f3211a
        ...
        L_0x007b:
            ...
            android.support.v4.view.ViewPager$LayoutParams r0 = (android.support.p030v4.view.ViewPager.LayoutParams) r0
            boolean r0 = r0.f3211a
        ...
        L_0x009f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p030v4.view.ViewPager.onPageScrolled(int, float, int):void");
    }
    ...
    private void calculatePageOffsets(C0994b bVar, int i, C0994b bVar2) {
        float f;
        float f2;
        float f3;
        C0994b bVar3;
        ...
        if (bVar2 != null) {
            int i2 = bVar2.f3220b;
            if (i2 < bVar.f3220b) {
                float f4 = bVar2.f3223e + bVar2.f3222d + f;
                int i3 = i2 + 1;
                int i4 = 0;
                while (i3 <= bVar.f3220b && i4 < this.mItems.size()) {
                    Object obj = this.mItems.get(i4);
                    while (true) {
                        bVar4 = (C0994b) obj;
                        if (i3 > bVar4.f3220b && i4 < this.mItems.size() - 1) {
                            i4++;
                            obj = this.mItems.get(i4);
                        }
                    }
                    while (i3 < bVar4.f3220b) {
            ...
            } else if (i2 > bVar.f3220b) {
                int size = this.mItems.size() - 1;
                float f5 = bVar2.f3223e;
                while (true) {
                    i2--;
                    if (i2 < bVar.f3220b || size < 0) {
                        break;
                    }
                    Object obj2 = this.mItems.get(size);
                    while (true) {
                        bVar3 = (C0994b) obj2;
                        if (i2 < bVar3.f3220b && size > 0) {
                            size--;
                            obj2 = this.mItems.get(size);
                        }
                    }
                    while (i2 > bVar3.f3220b) {
        ...
        int i6 = count - 1;
        if (bVar.f3220b == i6) {
            f3 = (bVar.f3223e + bVar.f3222d) - 1.0f;
        } else {
            f3 = Float.MAX_VALUE;
        }
        this.mLastOffset = f3;
        int i7 = i - 1;
        while (i7 >= 0) {
            C0994b bVar5 = (C0994b) this.mItems.get(i7);
            while (i5 > bVar5.f3220b) {
        ...
        float f7 = bVar.f3223e + bVar.f3222d + f;
        int i8 = bVar.f3220b + 1;
        int i9 = i + 1;
        while (i9 < size2) {
            C0994b bVar6 = (C0994b) this.mItems.get(i9);
            while (i8 < bVar6.f3220b) {
                f7 += this.mAdapter.getPageWidth(i8) + f;
                i8++;
            }
            if (bVar6.f3220b == i6) {
                this.mLastOffset = (bVar6.f3222d + f7) - 1.0f;
            }
            bVar6.f3223e = f7;
            f7 += bVar6.f3222d + f;
            i9++;
    ...
    private void scrollToItem(int i, boolean z, int i2, boolean z2) {
        int i3;
        C0994b infoForPosition = infoForPosition(i);
        if (infoForPosition != null) {
            i3 = (int) (((float) getClientWidth()) * Math.max(this.mFirstOffset, Math.min(infoForPosition.f3223e, this.mLastOffset)));
        } else {
            i3 = 0;
        }
        if (z) {
    ...
    private int determineTargetPage(int i, float f, int i2, int i3) {
        ...
        return Math.max(((C0994b) this.mItems.get(0)).f3220b, Math.min(i, ((C0994b) this.mItems.get(this.mItems.size() - 1)).f3220b));
    }

    private void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        float f;
        if (i2 <= 0 || this.mItems.isEmpty()) {
            C0994b infoForPosition = infoForPosition(this.mCurItem);
            if (infoForPosition != null) {
                f = Math.min(infoForPosition.f3223e, this.mLastOffset);
            } else {
                f = 0.0f;
            }
        ...
        if (this.mAdapter == null || this.mAdapter.getCount() <= 0) {
            ...
            if (i > this.mCurItem + i3 || i < this.mCurItem - i3) {
                for (int i4 = 0; i4 < this.mItems.size(); i4++) {
                    ((C0994b) this.mItems.get(i4)).f3221c = true;
                }
            }
            if (this.mCurItem == i) {
                z3 = false;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.f3211a) {
                    int i14 = layoutParams.f3212b & 7;
                    int i15 = layoutParams.f3212b & 112;
                    if (i14 == 1) {
        ...
        for (int i18 = 0; i18 < childCount; i18++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.f3211a) {
                    C0994b infoForChild = infoForChild(childAt2);
                    if (infoForChild != null) {
                        float f = (float) i17;
                        int i19 = ((int) (infoForChild.f3223e * f)) + i12;
                        if (layoutParams2.f3214d) {
                            layoutParams2.f3214d = false;
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.f3213c), 1073741824), MeasureSpec.makeMeasureSpec((i8 - i11) - i9, 1073741824));
                        }
