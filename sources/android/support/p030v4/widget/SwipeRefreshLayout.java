...
public class SwipeRefreshLayout extends ViewGroup implements C1045j, C1048m {
    ...
    private C1090a mChildScrollUpCallback;
    ...
    private final C1047l mNestedScrollingChildHelper;
    private final C1050o mNestedScrollingParentHelper;
    boolean mNotify;
    ...
    public interface C1090a {
        /* renamed from: a */
        boolean mo3482a(SwipeRefreshLayout swipeRefreshLayout, View view);
    }

    /* renamed from: android.support.v4.widget.SwipeRefreshLayout$b */
    public interface C1091b {
        void onRefresh();
    }
    ...
    public int getNestedScrollAxes() {
        return this.mNestedScrollingParentHelper.f3334a;
    }

    public boolean hasNestedScrollingParent() {
        return this.mNestedScrollingChildHelper.mo3222a();
    }

    public boolean isNestedScrollingEnabled() {
        return this.mNestedScrollingChildHelper.f3329a;
    }
    ...
    public void stopNestedScroll() {
        this.mNestedScrollingChildHelper.mo3231b();
    }
    ...
    private void createProgressView() {
        this.mCircleView = new C1096c(getContext(), -328966);
        this.mProgress = new C1098d(getContext());
        this.mProgress.mo3508a(1);
    ...
    public boolean canChildScrollUp() {
        if (this.mChildScrollUpCallback != null) {
            return this.mChildScrollUpCallback.mo3482a(this, this.mTarget);
        }
    ...
    public void setOnChildScrollUpCallback(C1090a aVar) {
        this.mChildScrollUpCallback = aVar;
    }

    public void setOnRefreshListener(C1091b bVar) {
        this.mListener = bVar;
    }
    ...
    public void setNestedScrollingEnabled(boolean z) {
        this.mNestedScrollingChildHelper.mo3221a(z);
    }
    ...
    public boolean startNestedScroll(int i) {
        return this.mNestedScrollingChildHelper.mo3232b(i);
    }
    ...
    public void onStopNestedScroll(View view) {
        this.mNestedScrollingParentHelper.mo3234a(view);
    ...
    public void requestDisallowInterceptTouchEvent(boolean z) {
        ...
        if (this.mTarget == null || C1056u.m3078x(this.mTarget)) {
    ...
    public void setColorSchemeColors(int... iArr) {
        ensureTarget();
        C1098d dVar = this.mProgress;
        dVar.f3492a.mo3527a(iArr);
        dVar.f3492a.mo3525a(0);
        dVar.invalidateSelf();
    }
    ...
    public void setTargetOffsetTopAndBottom(int i) {
        ...
        C1056u.m3058g(this.mCircleView, i);
        this.mCurrentTargetOffsetTop = this.mCircleView.getTop();
    }
    ...
    public void startScaleDownAnimation(AnimationListener animationListener) {
        ...
        this.mCircleView.mo3497a(animationListener);
        this.mCircleView.clearAnimation();
    ...
    private void finishSpinner(float f) {
        ...
        this.mProgress.mo3505a(0.0f, 0.0f);
        C10865 r0 = null;
        if (!this.mScale) {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.mo3505a(0.0f, Math.min(0.8f, max * 0.8f));
        this.mProgress.mo3504a(Math.min(1.0f, max));
        float f4 = (((max * 0.4f) - 16.0f) + (f3 * 2.0f)) * 0.5f;
        C1098d dVar = this.mProgress;
        dVar.f3492a.f3508g = f4;
        dVar.invalidateSelf();
        setTargetOffsetTopAndBottom(i2 - this.mCurrentTargetOffsetTop);
    }

    public boolean dispatchNestedPreFling(float f, float f2) {
        return this.mNestedScrollingChildHelper.mo3223a(f, f2);
    }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public final void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.mProgress.mo3504a(1.0f - f);
            }
        };
        ...
        this.mNestedScrollingParentHelper = new C1050o(this);
        this.mNestedScrollingChildHelper = new C1047l(this);
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        return this.mNestedScrollingChildHelper.mo3224a(f, f2, z);
    }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i) {
        this.mNestedScrollingParentHelper.mo3236a(view, view2, i);
    ...
    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return this.mNestedScrollingChildHelper.mo3229a(i, i2, iArr, iArr2);
    }
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.mNestedScrollingChildHelper.mo3227a(i, i2, i3, i4, iArr);
    }
