...
public abstract class C0678q extends PagerAdapter {
    private C0679r mCurTransaction;
    private Fragment mCurrentPrimaryItem = null;
    private final C0654k mFragmentManager;
    ...
    public Parcelable saveState() {
        ...
        for (int i = 0; i < this.mFragments.size(); i++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                sb.append(i);
                this.mFragmentManager.mo2227a(bundle, sb.toString(), fragment);
            }
        }
        return bundle;
    }
    ...
    public void finishUpdate(ViewGroup viewGroup) {
        if (this.mCurTransaction != null) {
            this.mCurTransaction.mo2200e();
            this.mCurTransaction = null;
        }
    }

    public C0678q(C0654k kVar) {
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        ...
        if (this.mCurTransaction == null) {
            this.mCurTransaction = this.mFragmentManager.mo2225a();
        }
        ...
        this.mCurTransaction.mo2175a(viewGroup.getId(), item);
        return item;
    }
        ...
        if (parcelable != null) {
            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    ...
                    Fragment a = this.mFragmentManager.mo2223a(bundle, str);
                    if (a != null) {
    ...
    public void destroyItem(ViewGroup viewGroup, int i, Object obj) {
        ...
        if (fragment.isAdded()) {
            obj2 = this.mFragmentManager.mo2221a(fragment);
        } else {
            obj2 = null;
        }
        arrayList.set(i, obj2);
        this.mFragments.set(i, null);
        this.mCurTransaction.mo2177a(fragment);
    }
}
