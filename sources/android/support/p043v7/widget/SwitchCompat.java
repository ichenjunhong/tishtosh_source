...
import android.support.p043v7.p050d.C1205a;
...
public class SwitchCompat extends CompoundButton {
    ...
    private void applyThumbTint() {
        ...
        if (this.mHasThumbTint || this.mHasThumbTintMode) {
            ...
            if (this.mHasThumbTint) {
                C0809a.m2327a(this.mThumbDrawable, this.mThumbTintList);
            }
            if (this.mHasThumbTintMode) {
                C0809a.m2330a(this.mThumbDrawable, this.mThumbTintMode);
            }
    ...
    private void applyTrackTint() {
        ...
        if (this.mHasTrackTint || this.mHasTrackTintMode) {
            ...
            if (this.mHasTrackTint) {
                C0809a.m2327a(this.mTrackDrawable, this.mTrackTintList);
            }
            if (this.mHasTrackTintMode) {
                C0809a.m2330a(this.mTrackDrawable, this.mTrackTintMode);
            }
    ...
    private int getThumbScrollRange() {
        ...
        if (this.mThumbDrawable != null) {
            rect = C1518y.m5426a(this.mThumbDrawable);
        } else {
            rect = C1518y.f5456a;
        }
    ...
    public void setThumbResource(int i) {
        setThumbDrawable(C1124a.m3315b(getContext(), i));
    }
    ...
    public void setTrackResource(int i) {
        setTrackDrawable(C1124a.m3315b(getContext(), i));
    }
    ...
    private void stopDrag(MotionEvent motionEvent) {
        ...
        if (z) {
            ...
            if (Math.abs(xVelocity) > ((float) this.mMinFlingVelocity)) {
                if (!C1467bj.m5138a(this) ? xVelocity <= 0.0f : xVelocity >= 0.0f) {
                    z3 = false;
                }
                z2 = z3;
            } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (background != null) {
                C0809a.m2326a(background, i7, i4, i8, i6);
            }
        }
        super.draw(canvas);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            if (!this.mSplitTrack || drawable2 == null) {
                ...
                Rect a = C1518y.m5426a(drawable2);
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            C0809a.m2324a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            C0809a.m2324a(this.mTrackDrawable, f, f2);
        }
    }
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        setSwitchTypefaceByIndex(a.mo5650a(1, -1), a.mo5650a(2, -1));
        if (a.mo5654a(12, false)) {
            this.mSwitchTransformationMethod = new C1205a(getContext());
        } else {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i8 = rect.right;
        if (this.mThumbDrawable != null) {
            Rect a = C1518y.m5426a(this.mThumbDrawable);
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        C1451bb a = C1451bb.m5032a(context, attributeSet, new int[]{16843044, 16843045, 16843074, R.attr.a26, R.attr.a2r, R.attr.a43, R.attr.a44, R.attr.a46, R.attr.a6l, R.attr.a6m, R.attr.a6n, R.attr.a7j, R.attr.a7k, R.attr.a7l}, i, 0);
        this.mThumbDrawable = a.mo5652a(2);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.mo5652a(11);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = a.mo5658c(0);
        this.mTextOff = a.mo5658c(1);
        this.mShowText = a.mo5654a(3, true);
        this.mThumbTextPadding = a.mo5661e(8, 0);
        this.mSwitchMinWidth = a.mo5661e(5, 0);
        this.mSwitchPadding = a.mo5661e(6, 0);
        this.mSplitTrack = a.mo5654a(4, false);
        ColorStateList e = a.mo5662e(9);
        if (e != null) {
            this.mThumbTintList = e;
            this.mHasThumbTint = true;
        }
        Mode a2 = C1518y.m5425a(a.mo5650a(10, -1), null);
        ...
        ColorStateList e2 = a.mo5662e(12);
        if (e2 != null) {
            this.mTrackTintList = e2;
            this.mHasTrackTint = true;
        }
        Mode a3 = C1518y.m5425a(a.mo5650a(13, -1), null);
