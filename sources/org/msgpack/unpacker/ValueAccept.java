...
final class ValueAccept extends Accept {
    ...
    public final void acceptInteger(short s) throws IOException {
        this.f133416uc.write(ValueFactory.createIntegerValue(s));
    }

    /* access modifiers changed from: 0000 */
    public final void acceptUnsignedInteger(long j) throws IOException {
        if (j < 0) {
            this.f133416uc.write(ValueFactory.createIntegerValue(BigInteger.valueOf(j + Long.MAX_VALUE + 1).setBit(63)));
            return;
        }
        this.f133416uc.write(ValueFactory.createIntegerValue(j));
    }
    ...
    public final void refer(ByteBuffer byteBuffer, boolean z) throws IOException {
        ...
        byteBuffer.get(bArr);
        this.f133416uc.write(ValueFactory.createRawValue(bArr, true));
    }
}
