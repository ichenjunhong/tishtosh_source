...
import org.msgpack.p2696b.C53793e;
...
public class MessagePackUnpacker extends AbstractUnpacker {
    ...
    /* renamed from: in */
    protected final C53793e f133413in;
    ...
    private byte getHeadByte() throws IOException {
        ...
        byte a = this.f133413in.mo113081a();
        this.headByte = a;
        return a;
    }
    ...
    private void readRawBodyCont() throws IOException {
        this.rawFilled += this.f133413in.mo113082a(this.raw, this.rawFilled, this.raw.length - this.rawFilled);
    ...
    public boolean readBoolean() throws IOException {
        ...
        if (headByte2 == 194) {
            ...
            throw new C53798c("Expected Boolean but got not boolean value");
        }
    }
        ...
        if (this.stack.topIsArray()) {
            ...
            if (topCount > 0) {
                if (!z) {
                    ...
                    throw new C53798c("readArrayEnd(check=true) is called but the array is not end");
                }
            }
            this.stack.pop();
            return;
        }
        throw new C53798c("readArrayEnd() is called but readArrayBegin() is not called");
    }
        ...
        if (this.stack.topIsMap()) {
            ...
            if (topCount > 0) {
                if (!z) {
                    ...
                    throw new C53798c("readMapEnd(check=true) is called but the map is not end");
                }
            }
            this.stack.pop();
            return;
        }
        throw new C53798c("readMapEnd() is called but readMapBegin() is not called");
    }
    ...
    public void readValue(Unconverter unconverter) throws IOException {
        ...
        this.valueAccept.f133416uc = unconverter;
        this.stack.checkCount();
    ...
    private boolean tryReferRawBody(C53790b bVar, int i) throws IOException {
        return this.f133413in.mo113083a(bVar, i);
    }

    protected MessagePackUnpacker(C53777a aVar, C53793e eVar) {
        super(aVar);
        this.f133413in = eVar;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x0216, code lost:
        throw new org.msgpack.unpacker.SizeLimitException(com.C2240a.m6772a("Size of raw (%d) over limit at %d", new java.lang.Object[]{java.lang.Integer.valueOf(r9), java.lang.Integer.valueOf(r7.rawSizeLimit)}));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:70:0x0217, code lost:
        r9 = r7.f133413in.mo113086d() & 65535;
     */
    ...
    private boolean readOneWithoutStackLarge(org.msgpack.unpacker.Accept r8, int r9) throws java.io.IOException {
        ...
        L_0x0018:
            ...
            throw r8
        L_0x002e:
            org.msgpack.b.e r9 = r7.f133413in
            int r9 = r9.mo113087e()
            ...
            org.msgpack.unpacker.UnpackerStack r8 = r7.stack
            r8.pushMap(r9)
            org.msgpack.b.e r8 = r7.f133413in
            r8.mo113084b()
            r7.headByte = r2
            return r6
        L_0x004f:
        ...
        L_0x01dd:
            ...
            org.msgpack.b.e r0 = r7.f133413in
            r0.mo113084b()
