...
public abstract class AbstractUnpacker implements Unpacker {
    ...
    protected AbstractUnpacker(C53777a aVar) {
        this.msgpack = aVar;
    }
    ...
    public <T> T read(Class<T> cls) throws IOException {
        ...
        return this.msgpack.mo113063a(cls).read(this, null);
    }
    ...
    public <T> T read(T t) throws IOException {
        ...
        return this.msgpack.mo113063a(t.getClass()).read(this, t);
    }
}
