...
public class Unconverter extends AbstractPacker {
    ...
    public Unconverter(C53777a aVar) {
        super(aVar);
        ...
        if (this.stack.topIsArray()) {
            ...
            if (topCount > 0) {
                if (!z) {
                    ...
                    throw new C53798c("writeArrayEnd(check=true) is called but the array is not end");
                }
            }
            this.stack.pop();
            if (this.stack.top <= 0) {
        ...
        if (this.stack.topIsMap()) {
            ...
            if (topCount > 0) {
                if (!z) {
                    ...
                    throw new C53798c("writeMapEnd(check=true) is called but the map is not end");
                }
            }
            this.stack.pop();
            if (this.stack.top <= 0) {
