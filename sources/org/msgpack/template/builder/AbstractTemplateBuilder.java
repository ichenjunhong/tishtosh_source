...
import org.msgpack.p2695a.C53778a;
import org.msgpack.p2695a.C53779b;
import org.msgpack.p2695a.C53780c;
import org.msgpack.p2695a.C53781d;
import org.msgpack.p2695a.C53782e;
import org.msgpack.p2695a.C53783f;
import org.msgpack.p2695a.C53784g;
import org.msgpack.p2695a.C53785h;
import org.msgpack.p2695a.C53786i;
...
public abstract class AbstractTemplateBuilder implements TemplateBuilder {
    ...
    public FieldOption getFieldOption(Class<?> cls) {
        C53781d dVar = (C53781d) cls.getAnnotation(C53781d.class);
        if (dVar == null) {
            return FieldOption.DEFAULT;
        }
        if (((C53783f) cls.getAnnotation(C53783f.class)) == null) {
            return FieldOption.DEFAULT;
        }
        return dVar.mo113066a();
    }
    ...
    private int getFieldIndex(Field field, int i) {
        C53780c cVar = (C53780c) field.getAnnotation(C53780c.class);
        if (cVar == null) {
            return i + 1;
        }
        return cVar.mo113065a();
    }
    ...
    public static boolean matchAtOrdinalEnumTemplateBuilder(Class<?> cls, boolean z) {
        ...
        if (isAnnotated(cls, C53787j.class) || isAnnotated(cls, C53784g.class)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean matchAtBeansClassTemplateBuilder(Type type, boolean z) {
        Class cls = (Class) type;
        if (z) {
            if (isAnnotated(cls, C53778a.class) || isAnnotated(cls, C53782e.class)) {
                return true;
            }
            return false;
    ...
    public static boolean matchAtClassTemplateBuilder(Class<?> cls, boolean z) {
        if (z) {
            if (isAnnotated(cls, C53781d.class) || isAnnotated(cls, C53783f.class)) {
                return true;
            }
            return false;
        } else if (cls.isEnum() || cls.isInterface()) {
    ...
    private FieldOption getFieldOption(Field field, FieldOption fieldOption) {
        ...
        if (isAnnotated((AccessibleObject) field, C53779b.class)) {
            return FieldOption.IGNORE;
        }
        if (isAnnotated((AccessibleObject) field, C53786i.class)) {
            return FieldOption.OPTIONAL;
        }
        if (isAnnotated((AccessibleObject) field, C53785h.class)) {
