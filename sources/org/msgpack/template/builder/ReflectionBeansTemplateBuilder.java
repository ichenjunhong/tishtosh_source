...
public class ReflectionBeansTemplateBuilder extends ReflectionTemplateBuilder {
    ...
    private int getMethodIndex(Method method) {
        C53780c cVar = (C53780c) method.getAnnotation(C53780c.class);
        if (cVar == null) {
            return -1;
        }
    ...
    private FieldOption getMethodOption(Method method) {
        if (isAnnotated((AccessibleObject) method, C53779b.class)) {
            return FieldOption.IGNORE;
        }
        if (isAnnotated((AccessibleObject) method, C53786i.class)) {
            return FieldOption.OPTIONAL;
        }
        if (isAnnotated((AccessibleObject) method, C53785h.class)) {
    ...
    private boolean isIgnoreProperty(PropertyDescriptor propertyDescriptor) {
        ...
        if (method == null || method2 == null || !Modifier.isPublic(method.getModifiers()) || !Modifier.isPublic(method2.getModifiers()) || isAnnotated((AccessibleObject) method, C53779b.class) || isAnnotated((AccessibleObject) method2, C53779b.class)) {
            return true;
        }
        return false;
    }
