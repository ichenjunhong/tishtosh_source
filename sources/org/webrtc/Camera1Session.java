...
class Camera1Session implements CameraSession {
        ...
        this.camera.setPreviewCallbackWithBuffer(new PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] bArr, Camera camera) {
                ...
                if (camera != Camera1Session.this.camera) {
                    Logging.m114470e("Camera1Session", "Callback from a different camera. This should never happen.");
                } else if (Camera1Session.this.state != SessionState.RUNNING) {
                    Logging.m114469d("Camera1Session", "Bytebuffer frame captured but camera is no longer running.");
                } else {
    ...
    private void startCapturing() {
        Logging.m114469d("Camera1Session", "Start capturing");
        ...
        this.camera.setErrorCallback(new ErrorCallback() {
            public void onError(int i, Camera camera) {
                ...
                Logging.m114470e("Camera1Session", str);
    ...
    public void stop() {
        ...
        Logging.m114469d("Camera1Session", sb.toString());
        checkIsOnCameraThread();
    ...
    public void stopInternal() {
        Logging.m114469d("Camera1Session", "Stop internal");
        checkIsOnCameraThread();
        if (this.state == SessionState.STOPPED) {
            Logging.m114469d("Camera1Session", "Camera is already stopped");
            return;
        }
        ...
        Logging.m114469d("Camera1Session", "Stop done");
    }
    ...
    public final /* synthetic */ void lambda$listenForTextureFrames$0$Camera1Session(VideoFrame videoFrame) {
        ...
        if (this.state != SessionState.RUNNING) {
            Logging.m114469d("Camera1Session", "Texture frame captured but camera is no longer running.");
            return;
        }
        boolean z = true;
    ...
    public static void create(CreateSessionCallback createSessionCallback, Events events2, boolean z, Context context, SurfaceTextureHelper surfaceTextureHelper2, int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            if (open == null) {
                ...
                StringBuilder sb = new StringBuilder("android.hardware.Camera.open returned null for camera id = ");
                sb.append(i5);
                createSessionCallback2.onFailure(failureType, sb.toString());
                return;
            }
            try {
