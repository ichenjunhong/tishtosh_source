...
public class EncodedImage {
    ...
    /* renamed from: qp */
    public final Integer f133441qp;
    ...
    public static class Builder {
        ...
        public EncodedImage createEncodedImage() {
            EncodedImage encodedImage = new EncodedImage(this.buffer, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.completeFrame, this.f133442qp);
            return encodedImage;
        }
