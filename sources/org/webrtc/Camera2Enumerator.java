...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            sb.append(e);
            Logging.m114470e("Camera2Enumerator", sb.toString());
            return new String[0];
        }
    }
    ...
    static List<CaptureFormat> getSupportedFormats(CameraManager cameraManager2, String str) {
        ...
        synchronized (cachedSupportedFormats) {
            ...
            Logging.m114469d("Camera2Enumerator", sb.toString());
            ...
            try {
                ...
                for (Size size : supportedSizes) {
                    ...
                    sb2.append("@");
                    sb2.append(i);
                    Logging.m114469d("Camera2Enumerator", sb2.toString());
                }
                ...
                sb3.append(" ms.");
                Logging.m114469d("Camera2Enumerator", sb3.toString());
                return arrayList;
            } catch (Exception e) {
                StringBuilder sb4 = new StringBuilder("getCameraCharacteristics(): ");
                sb4.append(e);
                Logging.m114470e("Camera2Enumerator", sb4.toString());
