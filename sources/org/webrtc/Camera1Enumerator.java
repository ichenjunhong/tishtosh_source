...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        ...
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
            ...
            if (deviceName != null) {
                ...
                Logging.m114469d("Camera1Enumerator", sb.toString());
            } else {
                StringBuilder sb2 = new StringBuilder("Index: ");
                sb2.append(i);
                sb2.append(". Failed to query camera name.");
                Logging.m114470e("Camera1Enumerator", sb2.toString());
            }
        }
    ...
    private static CameraInfo getCameraInfo(int i) {
        ...
        try {
            ...
            sb.append(i);
            Logging.m114471e("Camera1Enumerator", sb.toString(), e);
            return null;
        }
    }
    ...
    private static java.util.List<org.webrtc.CameraEnumerationAndroid.CaptureFormat> enumerateFormats(int r9) {
        /*
            ...
            org.webrtc.Logging.m114469d(r0, r1)
            ...
            org.webrtc.Logging.m114469d(r3, r4)     // Catch:{ RuntimeException -> 0x00be }
        ...
        L_0x007c:
            ...
            org.webrtc.Logging.m114471e(r4, r5, r2)
        L_0x0090:
            ...
            org.webrtc.Logging.m114469d(r2, r9)
            return r3
        L_0x00b6:
            r9 = move-exception
            r2 = r3
        ...
        L_0x00bf:
            ...
            org.webrtc.Logging.m114471e(r1, r9, r0)     // Catch:{ all -> 0x00bc }
