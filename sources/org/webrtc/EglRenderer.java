...
public class EglRenderer implements VideoSink {
    ...
    static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) {
            try {
                ...
                Logging.m114471e("EglRenderer", "Exception on EglRenderer thread", e);
    ...
    private void notifyFristRenderCallback() {
        synchronized (this.firstRenderLock) {
            Iterator it = this.firstVideoFrameListeners.iterator();
            while (it.hasNext()) {
                ((FirstVideoFrameRenderListener) it.next()).onFirstVideoFrameRender();
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0011, code lost:
        if (r14.eglBase == null) goto L_0x0250;
     */
    ...
    public void bridge$lambda$0$EglRenderer() {
        /*
            ...
            monitor-enter(r0)
            org.webrtc.VideoFrame r1 = r14.pendingFrame     // Catch:{ all -> 0x0259 }
        ...
        L_0x0009:
            org.webrtc.VideoFrame r1 = r14.pendingFrame     // Catch:{ all -> 0x0259 }
            r2 = 0
            r14.pendingFrame = r2     // Catch:{ all -> 0x0259 }
            monitor-exit(r0)     // Catch:{ all -> 0x0259 }
        ...
        L_0x001d:
            ...
            monitor-enter(r0)
            long r2 = r14.minRenderPeriodNs     // Catch:{ all -> 0x024d }
        ...
        L_0x0037:
            ...
            goto L_0x005a
        L_0x0039:
            long r2 = java.lang.System.nanoTime()     // Catch:{ all -> 0x024d }
            long r4 = r14.nextFrameTimeNs     // Catch:{ all -> 0x024d }
            int r7 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r7 >= 0) goto L_0x0049
            java.lang.String r2 = "Skipping frame rendering - fps reduction is active."
            r14.logD(r2)     // Catch:{ all -> 0x024d }
            goto L_0x002d
        L_0x0049:
            long r4 = r14.nextFrameTimeNs     // Catch:{ all -> 0x024d }
            long r6 = r14.minRenderPeriodNs     // Catch:{ all -> 0x024d }
            r8 = 0
            long r4 = r4 + r6
            r14.nextFrameTimeNs = r4     // Catch:{ all -> 0x024d }
            long r4 = r14.nextFrameTimeNs     // Catch:{ all -> 0x024d }
            long r2 = java.lang.Math.max(r4, r2)     // Catch:{ all -> 0x024d }
            r14.nextFrameTimeNs = r2     // Catch:{ all -> 0x024d }
            goto L_0x0037
        L_0x005a:
            monitor-exit(r0)     // Catch:{ all -> 0x024d }
            ...
            monitor-enter(r2)
            float r3 = r14.layoutAspectRatio     // Catch:{ all -> 0x024a }
            r4 = 0
        ...
        L_0x0077:
            r3 = r0
        L_0x0078:
            monitor-exit(r2)     // Catch:{ all -> 0x024a }
            int[] r2 = org.webrtc.EglRenderer.C538253.$SwitchMap$org$webrtc$RendererCommon$ScalingType
        ...
        L_0x00c0:
            ...
            int[] r0 = org.webrtc.EglRenderer.C538253.$SwitchMap$org$webrtc$RendererCommon$ScalingType
        ...
        L_0x023a:
            ...
            boolean r0 = r14.haveRenderFirstVideoFrame
            if (r0 != 0) goto L_0x0246
            r14.notifyFristRenderCallback()
            r14.haveRenderFirstVideoFrame = r10
        L_0x0246:
            r1.release()
            return
        L_0x024a:
    ...
    private void logD(String str) {
        ...
        sb.append(this.name);
        sb.append(str);
        Logging.m114469d("EglRenderer", sb.toString());
    }
    ...
    private void logW(String str) {
        ...
        sb.append(this.name);
        sb.append(str);
        Logging.m114473w("EglRenderer", sb.toString());
    }
