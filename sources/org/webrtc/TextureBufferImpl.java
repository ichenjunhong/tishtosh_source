...
public class TextureBufferImpl implements TextureBuffer {
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        retain();
        TextureBufferImpl textureBufferImpl = new TextureBufferImpl(i, i2, i3, i4, this.type, this.f133443id, matrix2, this.toI420Handler, this.yuvConverter, new TextureBufferImpl$$Lambda$1(this));
