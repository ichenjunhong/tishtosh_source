...
class Camera2Session implements CameraSession {
    ...
    static class CameraCaptureCallback extends CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            ...
            Logging.m114469d("Camera2Session", sb.toString());
        }
    }
    ...
    class CameraStateCallback extends StateCallback {
        ...
        public void onClosed(CameraDevice cameraDevice) {
            ...
            Logging.m114469d("Camera2Session", "Camera device closed.");
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m114469d("Camera2Session", "Camera opened.");
    ...
    class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        private void chooseFocusMode(Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m114469d("Camera2Session", "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m114469d("Camera2Session", "Auto-focus is not available.");
        }
        ...
        private void chooseStabilizationMode(Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m114469d("Camera2Session", "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    Logging.m114469d("Camera2Session", "Using video stabilization.");
                    return;
                }
            }
            Logging.m114469d("Camera2Session", "Stabilization not available.");
        }
        ...
        public final /* synthetic */ void lambda$onConfigured$0$Camera2Session$CaptureSessionCallback(VideoFrame videoFrame) {
            ...
            if (Camera2Session.this.state != SessionState.RUNNING) {
                Logging.m114469d("Camera2Session", "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m114469d("Camera2Session", "Camera capture session configured.");
            ...
            try {
                ...
                Logging.m114469d("Camera2Session", "Camera device successfully started.");
    ...
    public void stopInternal() {
        Logging.m114469d("Camera2Session", "Stop internal");
        checkIsOnCameraThread();
        ...
        Logging.m114469d("Camera2Session", "Stop done");
    }

    private void start() {
        boolean z;
        checkIsOnCameraThread();
        Logging.m114469d("Camera2Session", "start");
        try {
    ...
    private void findCaptureFormat() {
        ...
        Logging.m114469d("Camera2Session", sb2.toString());
        ...
        Logging.m114469d("Camera2Session", sb3.toString());
    }
    ...
    public void reportError(String str) {
        ...
        sb.append(str);
        Logging.m114470e("Camera2Session", sb.toString());
