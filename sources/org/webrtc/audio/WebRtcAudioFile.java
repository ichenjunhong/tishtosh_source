...
class WebRtcAudioFile {
    ...
    WebRtcAudioFile() {
        RXLogging.m25468e("WebRtcAudioRecordFile", "AudioMix WebRtcAudioFile");
    }
    ...
    private boolean checkInfoChange() {
        ...
        try {
            ...
            RXLogging.m25468e("WebRtcAudioRecordFile", "Error when checking file's new format");
            return false;
        }
    }
    ...
    public void uninit() {
        try {
            ...
            RXLogging.m25468e("WebRtcAudioRecordFile", "Error when releasing audio file stream");
        }
    ...
    public boolean readAudioData() {
        ...
        try {
                ...
                switch (dequeueOutputBuffer) {
                    ...
                    case -1:
                        ...
                        if (this.mRetryCount >= 100 && (Build.BRAND.toLowerCase().contains("meizu") || Build.MANUFACTURER.toLowerCase().contains("meizu"))) {
                            ...
                            sb.append(" Force EOS");
                            RXLogging.m25468e("WebRtcAudioRecordFile", sb.toString());
            ...
            RXLogging.m25468e("WebRtcAudioRecordFile", "Error when decoding audio file stream");
        }
    ...
    public void setCurrentFilePosition(long j) {
        if (this.eoOutputStream) {
            try {
                ...
                RXLogging.m25468e("WebRtcAudioRecordFile", "Error when creating audio file decoder");
            }
        }
    ...
    public boolean init(String str) {
        ...
        try {
            ...
            sb.append(str);
            RXLogging.m25467d(str2, sb.toString());
            this.mRetryCount = 0;
