...
public class WebRtcAudioEffects {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f133447ns;
    ...
    private WebRtcAudioEffects() {
        ...
        RXLogging.m25467d("WebRtcAudioEffects", sb.toString());
    }

    public void release() {
        RXLogging.m25467d("WebRtcAudioEffects", "release");
        if (this.aec != null) {
            this.aec.release();
            this.aec = null;
        }
        if (this.f133447ns != null) {
            this.f133447ns.release();
            this.f133447ns = null;
        }
    }
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (contains) {
            ...
            RXLogging.m25471w("WebRtcAudioEffects", sb.toString());
        }
        return contains;
    }
    ...
    public boolean setAEC(boolean z) {
        ...
        if (!canUseAcousticEchoCanceler()) {
            RXLogging.m25471w("WebRtcAudioEffects", "Platform AEC is not supported");
            ...
            RXLogging.m25468e("WebRtcAudioEffects", "Platform AEC state can't be modified while recording");
            return false;
        }
    }
    ...
    public boolean setNS(boolean z) {
        ...
        if (!canUseNoiseSuppressor()) {
            RXLogging.m25471w("WebRtcAudioEffects", "Platform NS is not supported");
            this.shouldEnableNs = false;
            return false;
        } else if (this.f133447ns == null || z == this.shouldEnableNs) {
            this.shouldEnableNs = z;
            return true;
        } else {
            RXLogging.m25468e("WebRtcAudioEffects", "Platform NS state can't be modified while recording");
            return false;
        }
    }
        ...
        if (isAcousticEchoCancelerSupported()) {
            ...
            if (this.aec != null) {
                ...
                if (this.aec.setEnabled(z3) != 0) {
                    RXLogging.m25468e("WebRtcAudioEffects", "Failed to set the AcousticEchoCanceler state");
                }
                ...
                sb2.append(str4);
                RXLogging.m25467d(str5, sb2.toString());
            } else {
                RXLogging.m25468e("WebRtcAudioEffects", "Failed to create the AcousticEchoCanceler instance");
            }
        }
        if (isNoiseSuppressorSupported()) {
            this.f133447ns = NoiseSuppressor.create(i);
            if (this.f133447ns != null) {
                boolean enabled2 = this.f133447ns.getEnabled();
                if (this.shouldEnableNs && canUseNoiseSuppressor()) {
                    z4 = true;
                }
                if (this.f133447ns.setEnabled(z4) != 0) {
                    RXLogging.m25468e("WebRtcAudioEffects", "Failed to set the NoiseSuppressor state");
                }
                ...
                sb3.append(z4);
                sb3.append(", is now: ");
                if (this.f133447ns.getEnabled()) {
                    str2 = "enabled";
                } else {
                    str2 = "disabled";
                }
                sb3.append(str2);
                RXLogging.m25467d(str6, sb3.toString());
                return;
            }
            RXLogging.m25468e("WebRtcAudioEffects", "Failed to create the NoiseSuppressor instance");
        }
    }
}
