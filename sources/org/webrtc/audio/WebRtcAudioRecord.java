...
public class WebRtcAudioRecord {
    ...
    class AudioRecordThread extends Thread {
        ...
        public void stopThread() {
            RXLogging.m25467d("WebRtcAudioRecord", "stopThread");
        ...
        public void run() {
            ...
            RXLogging.m25467d("WebRtcAudioRecord", sb.toString());
            ...
            while (this.keepAlive) {
                ...
                if (read == WebRtcAudioRecord.this.byteBuffer.capacity()) {
                    ...
                    RXLogging.m25468e("WebRtcAudioRecord", sb3);
                    if (read == -3) {
                        this.keepAlive = false;
            ...
            try {
                ...
                RXLogging.m25468e("WebRtcAudioRecord", sb4.toString());
            }
        }
    ...
    private void releaseAudioResources() {
        RXLogging.m25467d("WebRtcAudioRecord", "releaseAudioResources");
    ...
    private boolean stopRecording() {
        boolean z;
        RXLogging.m25467d("WebRtcAudioRecord", "stopRecording");
        ...
        if (!ThreadUtils.joinUninterruptibly(this.audioThread, 2000)) {
            RXLogging.m25468e("WebRtcAudioRecord", "Join of AudioRecordJavaThread timed out");
    ...
    private boolean startRecording() {
        boolean z;
        boolean z2;
        RXLogging.m25467d("WebRtcAudioRecord", "startRecording");
        if (this.audioRecord != null) {
            z = true;
        } else {
            z = false;
    ...
    public static void setErrorCallback(WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback) {
        RXLogging.m25467d("WebRtcAudioRecord", "Set error callback");
    ...
    public static void setMicrophoneMute(boolean z) {
        ...
        sb.append(z);
        sb.append(")");
        RXLogging.m25471w("WebRtcAudioRecord", sb.toString());
        microphoneMute = z;
    }
    ...
    private boolean enableBuiltInAEC(boolean z) {
        ...
        RXLogging.m25468e("WebRtcAudioRecord", "Built-in AEC is not supported on this platform");
        return false;
    }
    ...
    private boolean enableBuiltInNS(boolean z) {
        ...
        RXLogging.m25468e("WebRtcAudioRecord", "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    private void reportWebRtcAudioRecordInitError(String str) {
        ...
        sb.append(str);
        RXLogging.m25468e("WebRtcAudioRecord", sb.toString());
        WebRtcAudioUtils.logAudioState("WebRtcAudioRecord");
    ...
    private int initRecording(int i, int i2, boolean z) {
        ...
        RXLogging.m25467d("WebRtcAudioRecord", sb2.toString());
        ...
        RXLogging.m25467d("WebRtcAudioRecord", sb4.toString());
        int max = Math.max(minBufferSize * 2, this.byteBuffer.capacity());
        StringBuilder sb5 = new StringBuilder("bufferSizeInBytes: ");
        sb5.append(max);
        RXLogging.m25467d("WebRtcAudioRecord", sb5.toString());
        try {
            if (z) {
                i3 = 0;
            } else {
