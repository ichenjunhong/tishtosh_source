...
public class WebRtcAudioManager {
        ...
        class LogVolumeTask extends TimerTask {
            ...
            public void run() {
                ...
                if (mode == 1) {
                    ...
                    sb.append(")");
                    RXLogging.m25467d("WebRtcAudioManager", sb.toString());
                    return;
                }
                if (mode == 3) {
                    ...
                    sb2.append(")");
                    RXLogging.m25467d("WebRtcAudioManager", sb2.toString());
                }
            }
    ...
    private boolean isAAudioSupported() {
        RXLogging.m25471w("WebRtcAudioManager", "AAudio support is currently disabled on all devices!");
        return false;
    }
    ...
    private int getNativeOutputSampleRate() {
        if (WebRtcAudioUtils.runningOnEmulator()) {
            RXLogging.m25467d("WebRtcAudioManager", "Running emulator, overriding sample rate to 8 kHz.");
            return 8000;
