...
public class WebRtcAudioTrack {
    ...
    class AudioTrackThread extends Thread {
        ...
        public void stopThread() {
            RXLogging.m25467d("WebRtcAudioTrack", "stopThread");
        ...
        public void run() {
            ...
            RXLogging.m25467d("WebRtcAudioTrack", sb.toString());
            ...
            while (this.keepAlive) {
                ...
                if (writeBytes != capacity) {
                    ...
                    RXLogging.m25468e("WebRtcAudioTrack", sb2.toString());
                    if (writeBytes < 0) {
                        this.keepAlive = false;
            ...
            if (WebRtcAudioTrack.this.audioTrack != null) {
                RXLogging.m25467d("WebRtcAudioTrack", "Calling AudioTrack.stop...");
                try {
                    WebRtcAudioTrack.this.audioTrack.stop();
                    RXLogging.m25467d("WebRtcAudioTrack", "AudioTrack.stop is done.");
                } catch (Exception e) {
                    StringBuilder sb4 = new StringBuilder("AudioTrack.stop failed: ");
                    sb4.append(e.getMessage());
                    RXLogging.m25468e("WebRtcAudioTrack", sb4.toString());
                }
            }
        }
    ...
    private int getStreamMaxVolume() {
        ...
        RXLogging.m25467d("WebRtcAudioTrack", "getStreamMaxVolume");
    ...
    private int getStreamVolume() {
        boolean z;
        this.threadChecker.checkIsOnValidThread();
        RXLogging.m25467d("WebRtcAudioTrack", "getStreamVolume");
        if (this.audioManager != null) {
            z = true;
        } else {
            z = false;
    ...
    private void releaseAudioResources() {
        RXLogging.m25467d("WebRtcAudioTrack", "releaseAudioResources");
    ...
    private boolean startPlayout() {
        ...
        boolean z2;
        this.threadChecker.checkIsOnValidThread();
        RXLogging.m25467d("WebRtcAudioTrack", "startPlayout");
        if (this.audioTrack != null) {
            z = true;
        } else {
            z = false;
    ...
    private boolean stopPlayout() {
        boolean z;
        this.threadChecker.checkIsOnValidThread();
        RXLogging.m25467d("WebRtcAudioTrack", "stopPlayout");
        if (this.audioThread != null) {
            z = true;
        } else {
            z = false;
        ...
        RXLogging.m25467d("WebRtcAudioTrack", "Stopping the AudioTrackThread...");
        this.audioThread.interrupt();
        if (!ThreadUtils.joinUninterruptibly(this.audioThread, 2000)) {
            RXLogging.m25468e("WebRtcAudioTrack", "Join of AudioTrackThread timed out.");
            WebRtcAudioUtils.logAudioState("WebRtcAudioTrack");
        }
        RXLogging.m25467d("WebRtcAudioTrack", "AudioTrackThread has now been stopped.");
    ...
    public static void setErrorCallback(ErrorCallback errorCallback2) {
        RXLogging.m25467d("WebRtcAudioTrack", "Set extended error callback");
        errorCallback = errorCallback2;
    }

    public static void setErrorCallback(WebRtcAudioTrackErrorCallback webRtcAudioTrackErrorCallback) {
        RXLogging.m25467d("WebRtcAudioTrack", "Set error callback (deprecated");
    ...
    public static void setSpeakerMute(boolean z) {
        ...
        sb.append(z);
        sb.append(")");
        RXLogging.m25471w("WebRtcAudioTrack", sb.toString());
        speakerMute = z;
    }
    ...
    private void reportWebRtcAudioTrackInitError(String str) {
        ...
        sb.append(str);
        RXLogging.m25468e("WebRtcAudioTrack", sb.toString());
        WebRtcAudioUtils.logAudioState("WebRtcAudioTrack");
    ...
    private boolean setStreamVolume(int i) {
        ...
        assertTrue(z);
        if (isVolumeFixed()) {
            RXLogging.m25468e("WebRtcAudioTrack", "The device implements a fixed volume policy.");
            return false;
        }
    ...
    private static AudioTrack createAudioTrackOnLollipopOrHigher(int i, int i2, int i3) {
        int i4;
        RXLogging.m25467d("WebRtcAudioTrack", "createAudioTrackOnLollipopOrHigher");
        if (sForbidVoip) {
            i4 = 3;
        } else {
            i4 = 0;
        ...
        if (i != nativeOutputSampleRate) {
            RXLogging.m25471w("WebRtcAudioTrack", "Unable to use fast mode since requested sample rate is not native");
        }
        if (sForbidVoip) {
            usageAttribute = 1;
        } else {
        ...
        if (usageAttribute != DEFAULT_USAGE) {
            ...
            RXLogging.m25471w("WebRtcAudioTrack", sb2.toString());
        }
    ...
    private boolean initPlayout(int i, int i2, boolean z) {
        ...
        try {
            ...
            RXLogging.m25467d("WebRtcAudioTrack", sb2.toString());
            ...
            RXLogging.m25467d("WebRtcAudioTrack", sb3.toString());
            ...
            RXLogging.m25472w("WebRtcAudioTrack", "initPlayout exception", e2);
