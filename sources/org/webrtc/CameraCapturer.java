...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public final Events cameraSessionEventsHandler = new Events() {
        public void onCameraOpening() {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (CameraCapturer.this.currentSession != null) {
                    Logging.m114473w("CameraCapturer", "onCameraOpening while session was open.");
                } else {
        ...
        public void onCameraClosed(CameraSession cameraSession) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession == CameraCapturer.this.currentSession || CameraCapturer.this.currentSession == null) {
                    ...
                    Logging.m114469d("CameraCapturer", "onCameraClosed from another session.");
                }
            }
        }
        ...
        public void onCameraDisconnected(CameraSession cameraSession) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    Logging.m114473w("CameraCapturer", "onCameraDisconnected from another session.");
                    return;
                }
        ...
        public void onCameraError(CameraSession cameraSession, String str) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    ...
                    sb.append(str);
                    Logging.m114473w("CameraCapturer", sb.toString());
                    return;
                }
        ...
        public void onFrameCaptured(CameraSession cameraSession, VideoFrame videoFrame) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                if (cameraSession != CameraCapturer.this.currentSession) {
                    Logging.m114473w("CameraCapturer", "onFrameCaptured from another session.");
                    return;
                }
    ...
    public final CreateSessionCallback createSessionCallback = new CreateSessionCallback() {
        public void onDone(CameraSession cameraSession) {
            ...
            Logging.m114469d("CameraCapturer", sb.toString());
        ...
        public void onFailure(FailureType failureType, String str) {
            ...
            synchronized (CameraCapturer.this.stateLock) {
                ...
                if (CameraCapturer.this.openAttemptsRemaining <= 0) {
                    ...
                    sb2.append(str);
                    Logging.m114473w("CameraCapturer", sb2.toString());
    ...
    public void dispose() {
        Logging.m114469d("CameraCapturer", "dispose");
        stopCapture();
    }
    ...
    public void checkIsOnCameraThread() {
        if (Thread.currentThread() != this.cameraThreadHandler.getLooper().getThread()) {
            Logging.m114470e("CameraCapturer", "Check is on camera thread failed.");
    ...
    public void printStackTrace() {
        ...
        if (thread != null) {
            ...
            if (stackTrace.length > 0) {
                Logging.m114469d("CameraCapturer", "CameraCapturer stack trace:");
                for (StackTraceElement stackTraceElement : stackTrace) {
                    Logging.m114469d("CameraCapturer", stackTraceElement.toString());
                }
            }
        }
    }
    ...
    public void stopCapture() {
        Logging.m114469d("CameraCapturer", "Stop capture");
        synchronized (this.stateLock) {
            while (this.sessionOpening) {
                Logging.m114469d("CameraCapturer", "Stop capture: Waiting for session to open");
                try {
                    this.stateLock.wait();
                } catch (InterruptedException unused) {
                    Logging.m114473w("CameraCapturer", "Stop capture interrupted while waiting for the session to open.");
                    Thread.currentThread().interrupt();
                    return;
                }
            }
            if (this.currentSession != null) {
                Logging.m114469d("CameraCapturer", "Stop capture: Nulling session");
                ...
                Logging.m114469d("CameraCapturer", "Stop capture: No session open");
            }
        }
        Logging.m114469d("CameraCapturer", "Stop capture done");
    }
    ...
    public void switchCamera(final CameraSwitchHandler cameraSwitchHandler) {
        Logging.m114469d("CameraCapturer", "switchCamera");
        this.cameraThreadHandler.post(new Runnable() {
            public void run() {
    ...
    public void switchCameraInternal(CameraSwitchHandler cameraSwitchHandler) {
        Logging.m114469d("CameraCapturer", "switchCamera internal");
        ...
        synchronized (this.stateLock) {
            if (this.switchState != SwitchState.IDLE) {
                ...
                Logging.m114469d("CameraCapturer", "switchCamera: Stopping session");
                this.cameraStatistics.release();
                this.cameraStatistics = null;
                final CameraSession cameraSession = this.currentSession;
                this.cameraThreadHandler.post(new Runnable() {
                ...
                Logging.m114469d("CameraCapturer", "switchCamera done");
            } else {
    ...
    private void reportCameraSwitchError(String str, CameraSwitchHandler cameraSwitchHandler) {
        Logging.m114470e("CameraCapturer", str);
        if (cameraSwitchHandler != null) {
    ...
    public void startCapture(int i, int i2, int i3) {
        ...
        if (this.applicationContext != null) {
            synchronized (this.stateLock) {
                ...
                Logging.m114473w("CameraCapturer", "Session already open");
                return;
            }
        }
