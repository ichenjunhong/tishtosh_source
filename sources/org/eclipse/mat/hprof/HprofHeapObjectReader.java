...
public class HprofHeapObjectReader implements IObjectReader {
    ...
    public void open(ISnapshot iSnapshot) throws IOException {
        ...
        this.hprofDump = new HprofRandomAccessParser(new File(iSnapshot.getSnapshotInfo().getPath()), Version.valueOf((String) iSnapshot.getSnapshotInfo().getProperty("hprof.version")), iSnapshot.getSnapshotInfo().getIdentifierSize());
        ...
        for (int i3 = 0; i3 < bArr.length; i3 += i) {
            switch (primitiveArrayImpl.getType()) {
                case 4:
                    ...
                    Array.set(newInstance, i2, Boolean.valueOf(z));
                    break;
                case 5:
