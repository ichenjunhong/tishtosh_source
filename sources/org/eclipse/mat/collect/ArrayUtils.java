...
public class ArrayUtils {
    ...
    private static void hybridsortDesc(long[] jArr, int[] iArr, long[] jArr2, int[] iArr2, int i, int i2) {
        ...
        while (true) {
            ...
            if (i5 >= 5000000) {
                int[] splitDesc = splitDesc(jArr, iArr, i3, i4);
                if (splitDesc[0] - i3 <= i4 - splitDesc[1]) {
                    hybridsortDesc(jArr, iArr, jArr2, iArr2, i3, splitDesc[0] - 1);
                    i3 = splitDesc[1] + 1;
                } else {
                    hybridsortDesc(jArr, iArr, jArr2, iArr2, splitDesc[1] + 1, i4);
                    i4 = splitDesc[0] - 1;
                }
            } else if (i5 < 12) {
                for (int i6 = i3; i6 <= i4; i6++) {
                    for (int i7 = i6; i7 > i3; i7--) {
                        ...
                        swap(jArr, iArr, i7, i8);
                    }
                }
                return;
            } else {
                radixsortDesc(jArr, iArr, jArr2, iArr2, i3, i5 + 1);
                return;
            }
        }
    }
    ...
    private static void countsort(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i, int i2, int i3, int i4) {
        int i5;
        int[] iArr5 = new int[UnReadVideoExperiment.BROWSE_RECORD_LIST];
        int[] iArr6 = new int[UnReadVideoExperiment.BROWSE_RECORD_LIST];
        int i6 = i4 * 8;
        int i7 = i3 + i;
        int i8 = i;
        while (true) {
        ...
        while (i < i7) {
            int i14 = (iArr[i] >> i6) & NormalGiftView.ALPHA_255;
    ...
    private static void countsortDesc(long[] jArr, long[] jArr2, int[] iArr, int[] iArr2, int i, int i2, int i3, int i4) {
        int[] iArr3 = new int[UnReadVideoExperiment.BROWSE_RECORD_LIST];
        int[] iArr4 = new int[UnReadVideoExperiment.BROWSE_RECORD_LIST];
        int i5 = i4 * 8;
        int i6 = i3 + i;
