...
/* renamed from: org.eclipse.mat.parser.io.BufferedRandomAccessInputStream */
public class BufferedRandomAccessInputStream extends InputStream {
    ...
    /* renamed from: org.eclipse.mat.parser.io.BufferedRandomAccessInputStream$Page */
    class Page {
        int buf_end;
        byte[] buffer;
        long real_pos_start;
    ...
    public BufferedRandomAccessInputStream(RandomAccessFile randomAccessFile) throws IOException {
        this(randomAccessFile, PreloadTask.BYTE_UNIT_NUMBER);
    }
