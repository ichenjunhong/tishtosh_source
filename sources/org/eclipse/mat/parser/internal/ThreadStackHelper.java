...
class ThreadStackHelper {
    ...
    static org.eclipse.mat.collect.HashMapIntObject<org.eclipse.mat.snapshot.model.IThreadStack> loadThreadsData(org.eclipse.mat.snapshot.ISnapshot r10) throws org.eclipse.mat.SnapshotException {
        /*
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            r0.<init>()
            org.eclipse.mat.snapshot.SnapshotInfo r1 = r10.getSnapshotInfo()
        ...
        L_0x0085:
            ...
            int r6 = readLocalId(r6, r10)     // Catch:{ IOException -> 0x00d6, all -> 0x00d4 }
        ...
        L_0x00b1:
            ...
            int r1 = r10.mapAddressToId(r1)     // Catch:{ IOException -> 0x00d6, all -> 0x00d4 }
    ...
    private static StackFrameImpl[] buildFrames(List<String> list, HashMapIntObject<ArrayInt> hashMapIntObject) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            stackFrameImplArr[i] = new StackFrameImpl((String) list.get(i), iArr);
        }
