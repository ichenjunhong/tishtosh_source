...
public class DominatorTree {
    ...
    static class Calculator {
        ...
        /* renamed from: n */
        private int f133284n;
        IOne2ManyIndex outboundIndex;
        private int[] parent;

        /* renamed from: r */
        private int f133285r;
        private int[] semi;
        ...
        public class FlatDominatorTree {
            ...
            SnapshotImpl dump;
            int[] elements;
            int[] tempIntArray = new int[C30514a.f79747n];
            long[] tempLongArray = new long[C30514a.f79747n];
            ...
            public void sortByTotalSize(int[] iArr) {
                ...
                for (int i = 0; i < length; i++) {
                    jArr[i] = this.f133286ts[iArr[i] + 2];
                }
                if (length > 1) {
                    if (length > 1000000) {
            ...
            public void calculateTotalSizesIterative(int i) throws SnapshotException, IOException {
                ...
                while (i2 > 0) {
                    ...
                    if (successorsEnum2.hasMoreElements()) {
                        ...
                        long[] jArr = this.f133286ts;
                        int i7 = nextElement + 2;
                        if (nextElement < 0) {
                            j = 0;
                        } else {
                            j = (long) Calculator.this.snapshot.getHeapSize(nextElement);
                        }
                        jArr[i7] = j;
                        if (i2 == i3) {
                            int i8 = i3 << 1;
                            ...
                            SuccessorsEnum[] successorsEnumArr2 = new SuccessorsEnum[i8];
                        ...
                        i2--;
                        if (i2 > 0) {
                            long[] jArr2 = this.f133286ts;
                            int i9 = iArr[i2 - 1] + 2;
                            jArr2[i9] = jArr2[i9] + this.f133286ts[i6 + 2];
                        }
                        if (i6 >= 0) {
                            longIndexCollector.set(i6, this.f133286ts[i6 + 2]);
                            i4++;
                            if (i4 % 1000 != 0) {
                                continue;
            ...
            FlatDominatorTree(SnapshotImpl snapshotImpl, int[] iArr, int[] iArr2, int i) throws SnapshotException, IOException {
                ...
                this.dom = iArr;
                this.elements = iArr2;
                this.f133286ts = new long[iArr.length];
        ...
        public void compute() throws IOException, SnapshotException, OperationCanceledException {
            ...
            nextMonitor2.beginTask(Messages.DominatorTree_ComputingDominators, this.f133284n / 1000);
            for (int i = this.f133284n; i >= 2; i--) {
            ...
            for (int i6 = 2; i6 <= this.f133284n; i6++) {
            ...
            if (!nextMonitor.isCanceled()) {
                this.snapshot.getIndexManager().setReader(Index.DOMINATOR, new IntIndexStreamer().writeTo(Index.DOMINATOR.getFile(this.snapshot.getSnapshotInfo().getPrefix()), (IteratorInt) new IteratorInt() {
                    ...
                    public boolean hasNext() {
                        if (this.nextIndex < Calculator.this.dom.length) {
                            return true;
                        }
                        return false;
                    }
        ...
        private void dfs(int i) throws UnsupportedOperationException {
            ...
            while (i2 > 0) {
                ...
                if (this.semi[i5] == 0) {
                    this.f133284n++;
                    this.semi[i5] = this.f133284n;
                    this.vertex[this.f133284n] = i5;
                    this.label[i5] = i5;
                    this.anchestor[i5] = 0;
                }
                if (i6 < iArr5.length) {
        ...
        public Calculator(SnapshotImpl snapshotImpl, IProgressListener iProgressListener) throws SnapshotException {
            ...
            try {
                ...
                this.f133284n = snapshotImpl.getSnapshotInfo().getNumberOfObjects() + 1;
                this.f133285r = 1;
                this.dom = new int[(this.f133284n + 1)];
                this.parent = new int[(this.f133284n + 1)];
                this.anchestor = new int[(this.f133284n + 1)];
                this.vertex = new int[(this.f133284n + 1)];
                this.label = new int[(this.f133284n + 1)];
                this.semi = new int[(this.f133284n + 1)];
                this.bucket = new int[(this.f133284n + 1)];
