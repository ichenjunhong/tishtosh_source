...
import org.eclipse.mat.parser.p2693io.BitOutputStream;
...
public abstract class IndexWriter {
        ...
        public IteratorLong iterator() {
            return new IteratorLong() {
                ...
                public boolean hasNext() {
                    if (this.index < Identifier.this.size) {
                        return true;
                    }
                    return false;
                }
    ...
    public static class InboundWriter {
        ...
        public org.eclipse.mat.parser.index.IIndexReader.IOne2ManyObjectsIndex flush(org.eclipse.mat.util.IProgressListener r14, org.eclipse.mat.parser.index.IndexWriter.KeyWriter r15) throws java.io.IOException {
            ...
            L_0x0027:
                ...
                int[] r3 = r13.segmentSizes     // Catch:{ all -> 0x00b3 }
                r3 = r3[r12]     // Catch:{ all -> 0x00b3 }
                int[] r6 = new int[r3]     // Catch:{ all -> 0x00b3 }
                int[] r3 = r13.segmentSizes     // Catch:{ all -> 0x00b3 }
                r3 = r3[r12]     // Catch:{ all -> 0x00b3 }
                int[] r7 = new int[r3]     // Catch:{ all -> 0x00b3 }
                r3 = 0
            L_0x006e:
                int[] r4 = r13.segmentSizes     // Catch:{ all -> 0x00b3 }
                r4 = r4[r12]     // Catch:{ all -> 0x00b3 }
                if (r3 >= r4) goto L_0x0098
                int r4 = r2.readBit()     // Catch:{ all -> 0x00b3 }
                r5 = 1
            ...
            L_0x007c:
                r5 = 0
            L_0x007d:
                int r4 = r13.bitLength     // Catch:{ all -> 0x00b3 }
                int r4 = r2.readInt(r4)     // Catch:{ all -> 0x00b3 }
                r6[r3] = r4     // Catch:{ all -> 0x00b3 }
                int r4 = r13.bitLength     // Catch:{ all -> 0x00b3 }
                int r4 = r2.readInt(r4)     // Catch:{ all -> 0x00b3 }
                r7[r3] = r4     // Catch:{ all -> 0x00b3 }
                if (r5 == 0) goto L_0x0095
                r4 = r7[r3]     // Catch:{ all -> 0x00b3 }
                int r4 = -1 - r4
                r7[r3] = r4     // Catch:{ all -> 0x00b3 }
            L_0x0095:
                int r3 = r3 + 1
    ...
    public static class IntArray1NWriter {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0032, code lost:
            if (r2.indexFile.exists() == false) goto L_0x0035;
         */
    ...
    public static class IntIndexCollector extends IntIndex<ArrayIntCompressed> implements IOne2OneIndex {
        ...
        public ArrayIntCompressed getPage(int i) {
            ...
            if (i < this.size / this.pageSize) {
                i2 = this.pageSize;
            } else {
                i2 = this.size % this.pageSize;
            }
            ArrayIntCompressed arrayIntCompressed2 = new ArrayIntCompressed(i2, 31 - this.mostSignificantBit, 0);
    ...
    static class IntIndexIterator implements IteratorInt {
        ...
        public boolean hasNext() {
            if (this.nextIndex < this.intArray.size()) {
                return true;
            }
            return false;
        }
    ...
    static abstract class LongIndex {
        HashMapIntLong binarySearchCache = new HashMapIntLong(PreloadTask.BYTE_UNIT_NUMBER);
        int pageSize;
        ...
        public synchronized void unload() {
            ...
            this.binarySearchCache = new HashMapIntLong(PreloadTask.BYTE_UNIT_NUMBER);
        }
    ...
    public static class LongIndexCollector extends LongIndex {
        ...
        public ArrayLongCompressed getPage(int i) {
            ...
            ArrayLongCompressed arrayLongCompressed2 = new ArrayLongCompressed(i2, 63 - this.mostSignificantBit, 0);
    ...
    static class LongIndexIterator implements IteratorLong {
        ...
        public boolean hasNext() {
            if (this.nextIndex < this.longArray.size()) {
                return true;
            }
            return false;
        }
    ...
    public static class LongIndexStreamer extends LongIndex {
        ...
        public IOne2LongIndex writeTo(File file, int i, HashMapIntObject<Object> hashMapIntObject, int i2) throws IOException {
            ...
            int i8 = 0;
            while (i8 < i7) {
                ArrayLongCompressed arrayLongCompressed = (ArrayLongCompressed) hashMapIntObject.get(i8);
                i8++;
                if (i8 < i7) {
                    i4 = i2;
                } else {
    ...
    public static int mostSignificantBit(long j) {
        long j2 = j >>> 32;
        if (j2 == 0) {
            return mostSignificantBit((int) j);
        }
        return mostSignificantBit((int) j2) + 32;
    }
