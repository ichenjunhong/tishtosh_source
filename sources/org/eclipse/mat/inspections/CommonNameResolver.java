...
public class CommonNameResolver {
    ...
    public static class ByteArrayResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            ...
            byte[] bArr = (byte[]) iPrimitiveArray.getValueArray(0, Math.min(iPrimitiveArray.getLength(), PreloadTask.BYTE_UNIT_NUMBER));
            if (bArr == null) {
                return null;
            }
    ...
    public static class CharArrayResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            IPrimitiveArray iPrimitiveArray = (IPrimitiveArray) iObject;
            return PrettyPrinter.arrayAsString(iPrimitiveArray, 0, iPrimitiveArray.getLength(), PreloadTask.BYTE_UNIT_NUMBER);
        }
    }
    ...
    public static class FieldResolver extends AccessibleObjectResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            ...
            IObject iObject4 = (IObject) iObject.resolveValue(LeakCanaryFileProvider.f132049i);
            if (iObject4 == null) {
                return null;
            }
    ...
    public static class StringBufferResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            ...
            return PrettyPrinter.arrayAsString(iPrimitiveArray, 0, num.intValue(), PreloadTask.BYTE_UNIT_NUMBER);
        }
    }
    ...
    public static class StringResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            return PrettyPrinter.objectAsString(iObject, PreloadTask.BYTE_UNIT_NUMBER);
        }
    }
    ...
    public static class ThreadGroupResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            IObject iObject2 = (IObject) iObject.resolveValue(LeakCanaryFileProvider.f132049i);
            if (iObject2 == null) {
                return null;
            }
    ...
    public static class URLResolver implements IClassSpecificNameResolver {
        public String resolve(IObject iObject) throws SnapshotException {
            ...
            IObject iObject3 = (IObject) iObject.resolveValue(LeakCanaryFileProvider.f132050j);
            if (iObject3 != null) {
