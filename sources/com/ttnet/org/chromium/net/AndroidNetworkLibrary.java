...
class AndroidNetworkLibrary {
    ...
    class _lancet {
        ...
        static NetworkInfo m111371xea89a0b0(ConnectivityManager connectivityManager) {
            try {
    ...
    private static boolean getIsRoaming() {
        NetworkInfo com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo = _lancet.m111371xea89a0b0((ConnectivityManager) ContextUtils.getApplicationContext().getSystemService("connectivity"));
        if (com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo == null) {
            return false;
        }
        return com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo.isRoaming();
    }
    ...
    private static String getApnName() {
        ...
        String extraInfo = com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo.getExtraInfo();
    ...
    public static int getWifiSignalLevel(int i) {
        ...
        int intExtra = registerReceiver.getIntExtra("newRssi", DynamicTabYellowPointVersion.DEFAULT);
