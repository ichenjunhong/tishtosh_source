...
public class NetworkChangeNotifierAutoDetect extends BroadcastReceiver {
    ...
    static class ConnectivityManagerDelegate {
        ...
        class _lancet {
            ...
            static NetworkInfo m111372xea89a0b0(ConnectivityManager connectivityManager) {
                try {
            ...
            static NetworkInfo m111373x228a3316(ConnectivityManager connectivityManager, Network network) {
                try {
        ...
        public Network getDefaultNetwork() {
            ...
            try {
                NetworkInfo com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo = _lancet.m111372xea89a0b0(this.mConnectivityManager);
                ...
                for (Network network2 : NetworkChangeNotifierAutoDetect.getAllNetworksFiltered(this, null)) {
                    ...
                    if (networkInfo != null && (networkInfo.getType() == com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo.getType() || networkInfo.getType() == 17)) {
                        network = network2;
                    }
                }
                return network;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:5:0x000d, code lost:
            return com.ttnet.org.chromium.net.NetworkChangeNotifierAutoDetect.ConnectivityManagerDelegate._lancet.m111373x228a3316(r1.mConnectivityManager, r2);
         */
        ...
        private android.net.NetworkInfo getNetworkInfo(android.net.Network r2) {
            /*
                r1 = this;
                android.net.ConnectivityManager r0 = r1.mConnectivityManager     // Catch:{ Throwable -> 0x0007 }
                android.net.NetworkInfo r0 = com.ttnet.org.chromium.net.NetworkChangeNotifierAutoDetect.ConnectivityManagerDelegate._lancet.m111373x228a3316(r0, r2)     // Catch:{ Throwable -> 0x0007 }
                return r0
            L_0x0007:
                android.net.ConnectivityManager r0 = r1.mConnectivityManager     // Catch:{ Throwable -> 0x000e }
                android.net.NetworkInfo r2 = com.ttnet.org.chromium.net.NetworkChangeNotifierAutoDetect.ConnectivityManagerDelegate._lancet.m111373x228a3316(r0, r2)     // Catch:{ Throwable -> 0x000e }
                return r2
            L_0x000e:
                r2 = 0
                return r2
        ...
        public int getConnectionType(Network network) {
            ...
            if (networkInfo != null && networkInfo.getType() == 17) {
                try {
                    networkInfo = _lancet.m111372xea89a0b0(this.mConnectivityManager);
                } catch (Throwable unused) {
                    networkInfo = null;
                }
            }
        ...
        public boolean vpnAccessible(android.net.Network r4) {
            ...
            L_0x0023:
                r1 = move-exception
                com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r2, r1)     // Catch:{ IOException -> 0x0031, all -> 0x002c }
                goto L_0x002b
            L_0x0028:
                r1.close()     // Catch:{ IOException -> 0x0031, all -> 0x002c }
            L_0x002b:
        ...
        public NetworkState getNetworkState(WifiManagerDelegate wifiManagerDelegate) {
            ...
            if (processActiveNetworkInfo == null) {
                ...
                try {
                    ...
                    NetworkState networkState3 = new NetworkState(false, -1, -1, null, false);
