...
public final class CronetUploadDataStream extends UploadDataSink {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0027, code lost:
        postTaskToExecutor(new com.ttnet.org.chromium.net.impl.CronetUploadDataStream.C520033(r6));
     */
    ...
    public final void onError(Throwable th) {
        ...
        if (z) {
            try {
                ...
                Log.m111334e(TAG, "Failure closing data provider", e);
            }
        }
        ...
        synchronized (this.mLock) {
            ...
            if (this.mByteBufferLimit == ((long) this.mByteBuffer.limit())) {
                ...
                if (this.mRemainingLength < 0) {
                    if (this.mLength >= 0) {
                        throw new IllegalArgumentException(C2240a.m6772a("Read upload data length %d exceeds expected length %d", new Object[]{Long.valueOf(this.mLength - this.mRemainingLength), Long.valueOf(this.mLength)}));
                    }
                }
