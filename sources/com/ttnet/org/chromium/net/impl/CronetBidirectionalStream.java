...
public class CronetBidirectionalStream extends ExperimentalBidirectionalStream {
        ...
        postTaskToExecutor(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0049:
                    ...
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.net.impl.CronetBidirectionalStream.C519951.run():void");
            }
        });
    }
    ...
    private void destroyNativeStreamLocked(boolean z) {
        ...
        sb.append(toString());
        Log.m111335i(str, sb.toString(), new Object[0]);
        ...
        synchronized (this.mNativeStreamLock) {
            if (!isDoneLocked()) {
                ...
                try {
                    ...
                    Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception notifying of failed request", e);
                }
            }
        }
    }
