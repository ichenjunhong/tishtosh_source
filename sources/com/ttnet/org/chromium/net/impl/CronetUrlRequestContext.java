...
public class CronetUrlRequestContext extends CronetEngineBase {
    ...
    private void onClientIPChanged(String str) {
        if (this.mEventListener != null) {
            this.mEventListener.onClientIPChanged(str);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0023, code lost:
        ...
        postObservationTaskToExecutor(r1.getExecutor(), new com.ttnet.org.chromium.net.impl.CronetUrlRequestContext.C520185(r3));
     */
    ...
    private static void postObservationTaskToExecutor(Executor executor, Runnable runnable) {
        try {
            ...
            Log.m111334e(LOG_TAG, "Exception posting task to executor", e);
        }
    }
    ...
    private void handleApiResult(boolean z, String str, String str2, String str3, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, boolean z2, long j11, long j12, String str4, String str5, String str6, int i, int i2, String str7) {
        if (this.mAppMonitorProvider != null) {
            this.mAppMonitorProvider.handleApiResult(z, str, str2, str3, j, j2, j3, j4, j5, j6, j7, j8, j9, j10, z2, j11, j12, str4, str5, str6, i, i2, str7);
        }
    }
}
