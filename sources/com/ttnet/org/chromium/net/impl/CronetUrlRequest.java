...
public final class CronetUrlRequest extends UrlRequestBase {
        ...
        postTaskToExecutor(new Runnable() {
            public void run() {
                try {
                    ...
                    Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in onCanceled method", e);
                }
            }
        });
    }
    ...
    public final void RemoveRequestCookieHeader() {
        synchronized (this.mUrlRequestAdapterLock) {
            if (this.mUrlRequestAdapter != 0) {
                nativeRemoveRequestCookieHeader(this.mUrlRequestAdapter);
            }
        }
    }
        ...
        if (this.mMetrics != null) {
            ...
            if (this.mRequestFinishedListener != null) {
                try {
                    ...
                    Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception posting task to executor", e);
                }
            }
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:15:0x0045 A[Catch:{ RuntimeException -> 0x012f }] */
    /* JADX WARNING: Removed duplicated region for block: B:23:0x0073 A[Catch:{ RuntimeException -> 0x012f }] */
    ...
    public final void start() {
        /*
            ...
            monitor-enter(r15)
            r17.checkNotStarted()     // Catch:{ all -> 0x0135 }
            r13 = 1
            com.ttnet.org.chromium.net.impl.CronetUrlRequestContext r0 = r14.mRequestContext     // Catch:{ RuntimeException -> 0x012f }
            long r2 = r0.getUrlRequestContextAdapter()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r4 = r14.mInitialUrl     // Catch:{ RuntimeException -> 0x012f }
            int r5 = r14.mPriority     // Catch:{ RuntimeException -> 0x012f }
            int r6 = r14.mRequestFlag     // Catch:{ RuntimeException -> 0x012f }
            boolean r7 = r14.mDisableCache     // Catch:{ RuntimeException -> 0x012f }
            boolean r8 = r14.mDisableConnectionMigration     // Catch:{ RuntimeException -> 0x012f }
            com.ttnet.org.chromium.net.impl.CronetUrlRequestContext r0 = r14.mRequestContext     // Catch:{ RuntimeException -> 0x012f }
            boolean r0 = r0.hasRequestFinishedListener()     // Catch:{ RuntimeException -> 0x012f }
            r16 = 0
            if (r0 != 0) goto L_0x002a
            com.ttnet.org.chromium.net.impl.VersionSafeCallbacks$RequestFinishedInfoListener r0 = r14.mRequestFinishedListener     // Catch:{ RuntimeException -> 0x012f }
        ...
        L_0x002a:
            r9 = 1
        L_0x002b:
            boolean r10 = r14.mTrafficStatsTagSet     // Catch:{ RuntimeException -> 0x012f }
            int r11 = r14.mTrafficStatsTag     // Catch:{ RuntimeException -> 0x012f }
            boolean r12 = r14.mTrafficStatsUidSet     // Catch:{ RuntimeException -> 0x012f }
            int r0 = r14.mTrafficStatsUid     // Catch:{ RuntimeException -> 0x012f }
            r1 = r17
            r13 = r0
            long r0 = r1.nativeCreateRequestAdapter(r2, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ RuntimeException -> 0x012f }
            r14.mUrlRequestAdapter = r0     // Catch:{ RuntimeException -> 0x012f }
            com.ttnet.org.chromium.net.impl.CronetUrlRequestContext r0 = r14.mRequestContext     // Catch:{ RuntimeException -> 0x012f }
            r0.onRequestStarted()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r0 = r14.mInitialMethod     // Catch:{ RuntimeException -> 0x012f }
            if (r0 == 0) goto L_0x0066
            long r0 = r14.mUrlRequestAdapter     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = r14.mInitialMethod     // Catch:{ RuntimeException -> 0x012f }
            boolean r0 = r14.nativeSetHttpMethod(r0, r2)     // Catch:{ RuntimeException -> 0x012f }
            if (r0 == 0) goto L_0x0050
            goto L_0x0066
        L_0x0050:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ RuntimeException -> 0x012f }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = "Invalid http method "
            r1.<init>(r2)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = r14.mInitialMethod     // Catch:{ RuntimeException -> 0x012f }
            r1.append(r2)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r1 = r1.toString()     // Catch:{ RuntimeException -> 0x012f }
            r0.<init>(r1)     // Catch:{ RuntimeException -> 0x012f }
            throw r0     // Catch:{ RuntimeException -> 0x012f }
        L_0x0066:
            com.ttnet.org.chromium.net.impl.CronetUrlRequest$HeadersList r0 = r14.mRequestHeaders     // Catch:{ RuntimeException -> 0x012f }
            java.util.Iterator r0 = r0.iterator()     // Catch:{ RuntimeException -> 0x012f }
            r13 = 0
        L_0x006d:
            boolean r1 = r0.hasNext()     // Catch:{ RuntimeException -> 0x012f }
            if (r1 == 0) goto L_0x00f3
            java.lang.Object r1 = r0.next()     // Catch:{ RuntimeException -> 0x012f }
            java.util.Map$Entry r1 = (java.util.Map.Entry) r1     // Catch:{ RuntimeException -> 0x012f }
            java.lang.Object r2 = r1.getKey()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r3 = "Content-Type"
            boolean r2 = r2.equalsIgnoreCase(r3)     // Catch:{ RuntimeException -> 0x012f }
            if (r2 == 0) goto L_0x0094
            java.lang.Object r2 = r1.getValue()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ RuntimeException -> 0x012f }
            boolean r2 = r2.isEmpty()     // Catch:{ RuntimeException -> 0x012f }
            if (r2 != 0) goto L_0x0094
            r13 = 1
        L_0x0094:
            java.lang.Object r2 = r1.getKey()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r3 = "Tt-Map-Key"
            boolean r2 = r2.equalsIgnoreCase(r3)     // Catch:{ RuntimeException -> 0x012f }
            ...
            java.lang.Object r2 = r1.getValue()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r2 = (java.lang.String) r2     // Catch:{ RuntimeException -> 0x012f }
            r14.mCronetMapKey = r2     // Catch:{ RuntimeException -> 0x012f }
        L_0x00b6:
            long r2 = r14.mUrlRequestAdapter     // Catch:{ RuntimeException -> 0x012f }
            java.lang.Object r4 = r1.getKey()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ RuntimeException -> 0x012f }
            java.lang.Object r5 = r1.getValue()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r5 = (java.lang.String) r5     // Catch:{ RuntimeException -> 0x012f }
            boolean r2 = r14.nativeAddRequestHeader(r2, r4, r5)     // Catch:{ RuntimeException -> 0x012f }
            if (r2 == 0) goto L_0x00cb
            goto L_0x006d
        L_0x00cb:
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ RuntimeException -> 0x012f }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r3 = "Invalid header "
            r2.<init>(r3)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.Object r3 = r1.getKey()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ RuntimeException -> 0x012f }
            r2.append(r3)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r3 = "="
            r2.append(r3)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.Object r1 = r1.getValue()     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r1 = (java.lang.String) r1     // Catch:{ RuntimeException -> 0x012f }
            r2.append(r1)     // Catch:{ RuntimeException -> 0x012f }
            java.lang.String r1 = r2.toString()     // Catch:{ RuntimeException -> 0x012f }
            r0.<init>(r1)     // Catch:{ RuntimeException -> 0x012f }
            throw r0     // Catch:{ RuntimeException -> 0x012f }
        L_0x00f3:
            long r2 = r14.mUrlRequestAdapter     // Catch:{ RuntimeException -> 0x012f }
            int r4 = r14.mSocketConnectTimeout     // Catch:{ RuntimeException -> 0x012f }
            int r5 = r14.mSocketReadTimeout     // Catch:{ RuntimeException -> 0x012f }
            int r6 = r14.mSocketWriteTimeout     // Catch:{ RuntimeException -> 0x012f }
            r1 = r17
            r1.nativeSetSocketTimeout(r2, r4, r5, r6)     // Catch:{ RuntimeException -> 0x012f }
            long r0 = r14.mUrlRequestAdapter     // Catch:{ RuntimeException -> 0x012f }
            int r2 = r14.mRequestTimeout     // Catch:{ RuntimeException -> 0x012f }
            r14.nativeSetRequestTimeout(r0, r2)     // Catch:{ RuntimeException -> 0x012f }
            com.ttnet.org.chromium.net.impl.CronetUploadDataStream r0 = r14.mUploadDataStream     // Catch:{ RuntimeException -> 0x012f }
            if (r0 == 0) goto L_0x0127
            if (r13 == 0) goto L_0x011c
            r1 = 1
            r14.mStarted = r1     // Catch:{ RuntimeException -> 0x0125 }
            com.ttnet.org.chromium.net.impl.CronetUploadDataStream r0 = r14.mUploadDataStream     // Catch:{ RuntimeException -> 0x0125 }
            com.ttnet.org.chromium.net.impl.CronetUrlRequest$1 r2 = new com.ttnet.org.chromium.net.impl.CronetUrlRequest$1     // Catch:{ RuntimeException -> 0x0125 }
            r2.<init>()     // Catch:{ RuntimeException -> 0x0125 }
            r0.postTaskToExecutor(r2)     // Catch:{ RuntimeException -> 0x0125 }
            monitor-exit(r15)     // Catch:{ all -> 0x0135 }
            return
        L_0x011c:
            r1 = 1
            java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException     // Catch:{ RuntimeException -> 0x0125 }
            java.lang.String r2 = "Requests with upload data must have a Content-Type."
            r0.<init>(r2)     // Catch:{ RuntimeException -> 0x0125 }
            throw r0     // Catch:{ RuntimeException -> 0x0125 }
        L_0x0125:
            r0 = move-exception
            goto L_0x0131
        L_0x0127:
            r1 = 1
            r14.mStarted = r1     // Catch:{ all -> 0x0135 }
            r17.startInternalLocked()     // Catch:{ all -> 0x0135 }
            monitor-exit(r15)     // Catch:{ all -> 0x0135 }
            return
        L_0x012f:
            r0 = move-exception
            r1 = 1
        L_0x0131:
            r14.destroyRequestAdapterLocked(r1)     // Catch:{ all -> 0x0135 }
    ...
    public final void onCallbackException(Exception exc) {
        ...
        Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in CalledByNative method", exc);
    ...
    public final void onUploadException(Throwable th) {
        Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in upload method", th);
        synchronized (this.mUrlRequestAdapterLock) {
            if (this.mUrlRequestAdapter != 0) {
    ...
    private int mapUrlRequestErrorToApiErrorCode(int i) {
        switch (i) {
            ...
            default:
                ...
                sb.append(i);
                Log.m111334e(str, sb.toString(), new Object[0]);
                return i;
        }
    }
    ...
    private void onSucceeded(long j, final String str) {
            ...
            public void run() {
                synchronized (CronetUrlRequest.this.mUrlRequestAdapterLock) {
                    if (!CronetUrlRequest.this.isDoneLocked()) {
                        ...
                        try {
                            CronetUrlRequest.this.mCallback.onSucceeded(CronetUrlRequest.this, CronetUrlRequest.this.mResponseInfo, str);
                            CronetUrlRequest.this.maybeReportMetrics();
                        } catch (Exception e) {
                            Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in onSucceeded method", e);
                        }
                    }
                }
            }
    ...
    public final void AddRequestCookieHeader(String str, String str2) {
        synchronized (this.mUrlRequestAdapterLock) {
            if (this.mUrlRequestAdapter != 0) {
                nativeAddRequestCookieHeader(this.mUrlRequestAdapter, str, str2);
            }
        }
    }
                    ...
                    this.mExecutor.execute(new Runnable() {
                        public void run() {
                            try {
                                ...
                                Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in onFailed method", e);
                            }
                        }
                    });
                } catch (RejectedExecutionException e) {
    ...
    private void onMetricsCollected(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, boolean z, long j14, long j15, String str, long j16, long j17, String str2, String str3) {
        synchronized (this.mUrlRequestAdapterLock) {
            if (this.mMetrics == null) {
                CronetMetrics cronetMetrics = new CronetMetrics(j, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, z, j14, j15, str, j16, j17, str2, str3);
        ...
        postTaskToExecutor(new Runnable() {
            public void run() {
                try {
                    ...
                    Log.m111334e(CronetUrlRequestContext.LOG_TAG, "Exception in onMetricsCollected method", e);
                }
            }
        });
