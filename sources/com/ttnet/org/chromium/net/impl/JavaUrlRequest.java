                    ...
                    public void run() throws Exception {
                        ...
                        if (OutputStreamDataSink.this.mTotalBytes == -1 || OutputStreamDataSink.this.mTotalBytes - OutputStreamDataSink.this.mWrittenBytes >= ((long) OutputStreamDataSink.this.mBuffer.remaining())) {
                            ...
                            if (OutputStreamDataSink.this.mWrittenBytes < OutputStreamDataSink.this.mTotalBytes || (OutputStreamDataSink.this.mTotalBytes == -1 && !z)) {
                                ...
                                JavaUrlRequest.this.enterUploadErrorState(new IllegalArgumentException(C2240a.m6772a("Read upload data length %d exceeds expected length %d", new Object[]{Long.valueOf(OutputStreamDataSink.this.mWrittenBytes), Long.valueOf(OutputStreamDataSink.this.mTotalBytes)})));
                            }
                        } else {
                            JavaUrlRequest.this.enterUploadErrorState(new IllegalArgumentException(C2240a.m6772a("Read upload data length %d exceeds expected length %d", new Object[]{Long.valueOf(OutputStreamDataSink.this.mWrittenBytes + ((long) OutputStreamDataSink.this.mBuffer.remaining())), Long.valueOf(OutputStreamDataSink.this.mTotalBytes)})));
                        }
                    }
                }));
                return;
        ...
        public final Runnable mRunTasks = new Runnable() {
            ...
            public void run() {
                ...
                L_0x0060:
                    ...
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.net.impl.JavaUrlRequest.SerializingExecutor.C520551.run():void");
            }
        };
    ...
    public final void fireOpenConnection() {
        this.mExecutor.execute(errorSetting(new CheckedRunnable() {
            ...
            class _lancet {
                ...
                static void m111376x963129db(HttpURLConnection httpURLConnection, String str, String str2) {
            ...
            public void run() throws Exception {
                if (((Integer) JavaUrlRequest.this.mState.get()).intValue() != 8) {
                    ...
                    for (Entry entry : JavaUrlRequest.this.mRequestHeaders.entrySet()) {
                        _lancet.m111376x963129db(JavaUrlRequest.this.mCurrentUrlConnection, (String) entry.getKey(), (String) entry.getValue());
                    }
    ...
    public final void fireGetHeaders() {
        ...
        this.mExecutor.execute(errorSetting(new CheckedRunnable() {
            ...
            class _lancet {
                ...
                static InputStream m111375xff4d584d(HttpURLConnection httpURLConnection) throws IOException {
                    URLConnection uRLConnection = httpURLConnection;
                    if (C18982g.m46160a(uRLConnection)) {
            ...
            public void run() throws Exception {
                ...
                if (JavaUrlRequest.this.mCurrentUrlConnection != null) {
                    ...
                    if (responseCode < 300 || responseCode >= 400) {
                        ...
                        JavaUrlRequest.this.mResponseChannel = InputStreamChannel.wrap(_lancet.m111375xff4d584d(JavaUrlRequest.this.mCurrentUrlConnection));
                        JavaUrlRequest.this.mCallbackAsync.onResponseStarted(JavaUrlRequest.this.mUrlResponseInfo);
                        return;
                    }
