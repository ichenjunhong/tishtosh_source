...
public class AndroidCellularSignalStrength {
    ...
    public volatile int mSignalLevel = DynamicTabYellowPointVersion.DEFAULT;
    ...
    class CellStateListener extends PhoneStateListener implements ApplicationStateListener {
        ...
        private void register() {
            this.mTelephonyManager.listen(this, UnReadVideoExperiment.BROWSE_RECORD_LIST);
        }

        private void unregister() {
            AndroidCellularSignalStrength.this.mSignalLevel = DynamicTabYellowPointVersion.DEFAULT;
