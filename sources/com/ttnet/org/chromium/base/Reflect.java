...
public class Reflect {
    ...
    /* renamed from: on */
    public static Reflect m111361on(Class<?> cls) {
    ...
    /* renamed from: on */
    public static Reflect m111362on(Object obj) {
    ...
    /* renamed from: on */
    public static Reflect m111363on(String str) throws ReflectException {
        return m111361on(forName(str));
    }
    ...
    /* renamed from: as */
    public <P> P mo107736as(Class<P> cls) {
        final boolean z = this.object instanceof Map;
        C519531 r1 = new InvocationHandler() {
            public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
                int i;
                String name = method.getName();
                try {
                    return Reflect.m111362on(Reflect.this.object).call(name, Reflect.types(objArr), objArr).get();
    ...
    public Reflect create(Object... objArr) throws ReflectException {
        ...
        try {
            return m111364on(type().getDeclaredConstructor(types), objArr);
        } catch (NoSuchMethodException e) {
            for (Constructor constructor : type().getDeclaredConstructors()) {
                if (match(constructor.getParameterTypes(), types)) {
                    return m111364on(constructor, objArr);
                }
            }
            throw new ReflectException((Throwable) e);
        }
    ...
    public Reflect field(String str, Class<?>... clsArr) throws ReflectException {
        try {
            return m111362on(field0(str, clsArr).get(this.object));
        } catch (Exception e) {
            throw new ReflectException((Throwable) e);
        }
    }
    ...
    /* renamed from: on */
    private static Reflect m111364on(Constructor<?> constructor, Object... objArr) throws ReflectException {
        try {
            return m111362on(((Constructor) accessible(constructor)).newInstance(objArr));
        } catch (Exception e) {
            throw new ReflectException((Throwable) e);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0015, code lost:
        return m111365on(similarMethod(r3, r4), r2.object, r5);
     */
    ...
    public com.ttnet.org.chromium.base.Reflect call(java.lang.String r3, java.lang.Class<?>[] r4, java.lang.Object... r5) throws com.ttnet.org.chromium.base.ReflectException {
        /*
            ...
            com.ttnet.org.chromium.base.Reflect r0 = m111365on(r0, r1, r5)     // Catch:{ NoSuchMethodException -> 0x000b }
            return r0
        L_0x000b:
            ...
            com.ttnet.org.chromium.base.Reflect r3 = m111365on(r3, r4, r5)     // Catch:{ NoSuchMethodException -> 0x0016 }
            return r3
        L_0x0016:
            r3 = move-exception
    ...
    /* renamed from: on */
    private static Reflect m111365on(Method method, Object obj, Object... objArr) throws ReflectException {
        try {
            accessible(method);
            if (method.getReturnType() != Void.TYPE) {
                return m111362on(method.invoke(obj, objArr));
            }
            method.invoke(obj, objArr);
            return m111362on(obj);
        } catch (Exception e) {
            throw new ReflectException((Throwable) e);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0040, code lost:
        ...
        com.ttnet.org.chromium.base.Logger.m111346d("Plugin", r15.toString());
        r12 = r12 + 1;
        r11 = r11 + 1;
     */
    ...
    public java.lang.reflect.Method exactMethod(java.lang.String r17, java.lang.Class<?>[] r18, java.lang.Object... r19) throws java.lang.NoSuchMethodException {
        ...
        L_0x003e:
            ...
            com.ttnet.org.chromium.base.Logger.m111346d(r14, r5)
            int r12 = r12 + r10
            int r11 = r11 + 1
            goto L_0x003e
        L_0x0075:
