...
public class ChildProcessConnection {
    ...
    public void dumpProcessStack() {
        ...
        if (iChildProcessService != null) {
            try {
                ...
                Log.m111334e("ChildProcessConn", "Failed to dump process stack.", e);
            }
        }
    }
    ...
    private void doConnectionSetup() {
        try {
            ...
            Log.m111334e("ChildProcessConn", "Failed to setup connection.", e);
        } catch (Throwable th) {
    ...
    public void addModerateBinding() {
        if (!isConnected()) {
            Log.m111344w("ChildProcessConn", "The connection is not bound for %d", Integer.valueOf(getPid()));
            return;
        }
    ...
    public void onServiceDisconnectedOnLauncherThread() {
        if (!this.mServiceDisconnected) {
            ...
            Log.m111344w("ChildProcessConn", "onServiceDisconnected (crash or killed by oom): pid=%d", Integer.valueOf(this.mPid));
            stop();
    ...
    public void onSetupConnectionResult(int i) {
        if (this.mPid != 0) {
            Log.m111334e("ChildProcessConn", "sendPid was called more than once: pid=%d", Integer.valueOf(this.mPid));
            return;
        }
        this.mPid = i;
        if (this.mConnectionCallback != null) {
    ...
    public void onServiceConnectedOnLauncherThread(IBinder iBinder) {
        if (!this.mDidOnServiceConnected) {
            try {
                ...
                Log.m111334e("ChildProcessConn", "Failed to bind service to connection.", e);
            } finally {
    ...
    public void start(boolean z, ServiceCallback serviceCallback) {
        try {
            ...
            if (!bind(z)) {
                Log.m111334e("ChildProcessConn", "Failed to establish the service connection.", new Object[0]);
                notifyChildProcessDied();
            }
        } finally {
    ...
    public void setupConnection(Bundle bundle, List<IBinder> list, ConnectionCallback connectionCallback) {
        if (this.mServiceDisconnected) {
            Log.m111344w("ChildProcessConn", "Tried to setup a connection that already disconnected.", new Object[0]);
    ...
    public ChildProcessConnection(final Context context, ComponentName componentName, boolean z, boolean z2, Bundle bundle, ChildServiceConnectionFactory childServiceConnectionFactory, String str) {
        ...
        C519652 r3 = new ChildServiceConnectionDelegate() {
            /* access modifiers changed from: 0000 */
