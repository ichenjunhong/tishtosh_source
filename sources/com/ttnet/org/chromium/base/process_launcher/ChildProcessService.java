...
public abstract class ChildProcessService extends Service {
    ...
    private final Stub mBinder = new Stub() {
        ...
        public void dumpProcessStack() {
            synchronized (ChildProcessService.this.mLibraryInitializedLock) {
                if (!ChildProcessService.this.mLibraryInitialized) {
                    Log.m111334e("ChildProcessService", "Cannot dump process stack before native is loaded", new Object[0]);
                } else {
        ...
        public boolean bindToCaller() {
            ...
            L_0x0015:
                ...
                com.ttnet.org.chromium.base.Log.m111334e(r2, r4, r5)     // Catch:{ all -> 0x003a }
            ...
            L_0x003a:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.process_launcher.ChildProcessService.C519721.bindToCaller():boolean");
        }
        ...
        public void setupConnection(android.os.Bundle r3, com.ttnet.org.chromium.base.process_launcher.IParentProcess r4, java.util.List<android.os.IBinder> r5) throws android.os.RemoteException {
            /*
                ...
                com.ttnet.org.chromium.base.Log.m111334e(r3, r5, r1)     // Catch:{ all -> 0x0033 }
                r3 = -1
            ...
            L_0x0033:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.process_launcher.ChildProcessService.C519721.setupConnection(android.os.Bundle, com.ttnet.org.chromium.base.process_launcher.IParentProcess, java.util.List):void");
        }
    };
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.m111335i("ChildProcessService", "Destroying ChildProcessService pid=%d", Integer.valueOf(Process.myPid()));
        System.exit(0);
    }

    public void onCreate() {
        super.onCreate();
        Log.m111335i("ChildProcessService", "Creating new ChildProcessService pid=%d", Integer.valueOf(Process.myPid()));
        if (!sCreateCalled) {
            sCreateCalled = true;
                ...
                public void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            Log.m111334e("ChildProcessService", "Failed to load native library.", e);
                            z = false;
                        }
                        if (!z) {
                            System.exit(-1);
                        ...
                        for (int i = 0; i < ChildProcessService.this.mFdInfos.length; i++) {
                            ...
                            if (fileDescriptorsIdsToKeys != null) {
                                str = (String) fileDescriptorsIdsToKeys.get(fileDescriptorInfo.f129616id);
                            } else {
                                str = null;
                            }
                            if (str != null) {
                                ...
                                iArr[i] = fileDescriptorInfo.f129616id;
                            }
                            iArr2[i] = fileDescriptorInfo.f129615fd.detachFd();
                        ...
                        try {
                            ...
                            Log.m111334e("ChildProcessService", "Failed to call clean exit callback.", e2);
                        }
                        ChildProcessService.nativeExitChildProcess();
                    } catch (InterruptedException e3) {
                        Log.m111344w("ChildProcessService", "%s startup failed: %s", "ChildProcessMain", e3);
                    }
                }
            }, "ChildProcessMain");
