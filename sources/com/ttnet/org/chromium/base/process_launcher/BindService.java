...
final class BindService {
    ...
    class _lancet {
        ...
        static boolean m111368x6b13abbd(Context context, Intent intent, ServiceConnection serviceConnection, int i) {
    ...
    static {
        ...
        L_0x007c:
            r1 = move-exception
            com.google.p1067c.p1068a.p1069a.p1070a.p1071a.C17840a.m43752a(r3, r1)     // Catch:{ Exception -> 0x0087, all -> 0x0085 }
            goto L_0x0084
        L_0x0081:
    ...
    private static boolean bindServiceByCall(Context context, Intent intent, ServiceConnection serviceConnection, int i) {
        return _lancet.m111368x6b13abbd(context, intent, serviceConnection, i);
    }
