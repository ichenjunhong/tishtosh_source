...
public abstract class ChildConnectionAllocator {
    ...
    public static class FixedSizeAllocatorImpl extends ChildConnectionAllocator {
        ...
        public void doFree(ChildProcessConnection childProcessConnection) {
            ...
            if (indexOf == -1) {
                Log.m111334e("ChildConnAllocator", "Unable to find connection to free.", new Object[0]);
            } else {
                this.mChildProcessConnections[indexOf] = null;
                this.mFreeConnectionIndices.add(Integer.valueOf(indexOf));
                Log.m111328d("ChildConnAllocator", "Allocator freed a connection, name: %s, slot: %d", this.mServiceClassName, Integer.valueOf(indexOf));
            }
        ...
        public ChildProcessConnection doAllocate(Context context, Bundle bundle) {
            if (this.mFreeConnectionIndices.isEmpty()) {
                Log.m111326d("ChildConnAllocator", "Ran out of services to allocate.");
                return null;
            }
            ...
            Log.m111328d("ChildConnAllocator", "Allocator allocated and bound a connection, name: %s, slot: %d", this.mServiceClassName, Integer.valueOf(intValue));
    ...
    static class VariableSizeAllocatorImpl extends ChildConnectionAllocator {
        static final /* synthetic */ boolean $assertionsDisabled = false;
        private final C0779b<ChildProcessConnection> mAllocatedConnections;
        ...
        private VariableSizeAllocatorImpl(Handler handler, String str, String str2, boolean z, boolean z2, boolean z3) {
            ...
            this.mAllocatedConnections = new C0779b<>();
        }
    }
    ...
    class _lancet {
        ...
        static ApplicationInfo m111369x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    public static ChildConnectionAllocator create(Context context, Handler handler, Runnable runnable, String str, String str2, String str3, boolean z, boolean z2, boolean z3) {
        ...
        String str4 = str;
        try {
            ApplicationInfo com_ss_android_ugc_aweme_lancet_lanch_AwemeMetaDataLancet_getApplicationInfo = _lancet.m111369x89c42dc8(context.getPackageManager(), str, 128);
