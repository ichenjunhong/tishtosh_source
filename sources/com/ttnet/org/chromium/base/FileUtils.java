...
public class FileUtils {
    ...
    public static Uri getUriForFile(File file) {
        ...
        try {
            ...
            sb.append(e);
            Log.m111334e("FileUtils", sb.toString(), new Object[0]);
            uri = null;
        }
        if (uri == null) {
    ...
    public static boolean recursivelyDeleteFile(File file) {
        ...
        if (!delete) {
            Log.m111334e("FileUtils", "Failed to delete: %s", file);
        }
        return delete;
    }
    ...
    public static void copyStreamToFile(InputStream inputStream, File file) throws IOException {
        ...
        try {
            Log.m111335i("FileUtils", "Writing to %s", file);
        ...
        try {
            ...
            if (openFileDescriptor == null) {
                ...
                try {
                    ...
                    sb.append(uri);
                    Log.m111344w(str, sb.toString(), new Object[0]);
                    if (openFileDescriptor != null) {
                ...
                if (fileDescriptor == null) {
                    ...
                    sb2.append(uri);
                    Log.m111344w("FileUtils", sb2.toString(), new Object[0]);
                    if (openFileDescriptor != null) {
                        $closeResource((Throwable) null, openFileDescriptor);
                    }
                    return null;
                ...
                if (decodeFileDescriptor == null) {
                    ...
                    sb3.append(uri);
                    Log.m111344w("FileUtils", sb3.toString(), new Object[0]);
                    if (openFileDescriptor != null) {
                        $closeResource((Throwable) null, openFileDescriptor);
                    }
                    return null;
            ...
            sb4.append(uri);
            Log.m111344w("FileUtils", sb4.toString(), new Object[0]);
            return null;
        }
    }
