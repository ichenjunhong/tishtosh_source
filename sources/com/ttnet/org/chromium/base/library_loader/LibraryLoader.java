...
public class LibraryLoader {
    ...
    private static File getLibraryDir() {
        return new File(C0726c.m2097b(ContextUtils.getApplicationContext()), "native_libraries");
    }
    ...
    private static File makeLibraryDirAndSetPermission() {
        if (!ContextUtils.isIsolatedProcess()) {
            File b = C0726c.m2097b(ContextUtils.getApplicationContext());
    ...
    public static void setEnvForNative() {
        if (BuildConfig.IS_UBSAN && VERSION.SDK_INT >= 21) {
            try {
                ...
                Log.m111344w("LibraryLoader", "failed to set UBSAN_OPTIONS", e);
            }
        }
    }
        ...
        if (listFiles != null) {
            for (File file : listFiles) {
                if (!file.getName().contains(str)) {
                    ...
                    if (!file.delete()) {
                        Log.m111344w("LibraryLoader", "Unable to remove %s", name);
                    } else {
                        Log.m111335i("LibraryLoader", "Removed obsolete file %s", name);
                    }
                }
            }
        }
    ...
    private void initializeAlreadyLocked(int i) throws ProcessInitException {
        if (!this.mInitialized) {
            ...
            if (nativeLibraryLoaded(this.mLibraryProcessType)) {
                Log.m111335i("LibraryLoader", C2240a.m6772a("Expected native library version number \"%s\", actual native library version number \"%s\"", new Object[]{NativeLibraries.sVersionNumber, nativeGetVersionNumber()}), new Object[0]);
            ...
            Log.m111334e("LibraryLoader", "error calling nativeLibraryLoaded", new Object[0]);
    ...
    static String getExtractedLibraryPath(ApplicationInfo applicationInfo, String str) {
        Log.m111344w("LibraryLoader", "Failed to load libName %s, attempting fallback extraction then trying again", str);
    ...
    private void loadAlreadyLocked(android.content.pm.ApplicationInfo r17, boolean r18) throws com.ttnet.org.chromium.base.library_loader.ProcessInitException {
        ...
        L_0x0031:
            ...
            com.ttnet.org.chromium.base.Log.m111335i(r3, r5, r8)     // Catch:{ Throwable -> 0x015e, all -> 0x014f }
            goto L_0x0074
        L_0x005f:
            java.lang.String r3 = "LibraryLoader"
        ...
        L_0x0092:
            ...
            com.ttnet.org.chromium.base.Log.m111334e(r2, r3, r5)     // Catch:{ Throwable -> 0x015e, all -> 0x014f }
        ...
        L_0x00c7:
            ...
            com.ttnet.org.chromium.base.Log.m111335i(r11, r12, r13)     // Catch:{ UnsatisfiedLinkError -> 0x0101 }
        ...
        L_0x0118:
            ...
            java.lang.String r2 = com.C2240a.m6772a(r5, r8)     // Catch:{ Throwable -> 0x015e, all -> 0x014f }
            java.lang.Object[] r3 = new java.lang.Object[r9]     // Catch:{ Throwable -> 0x015e, all -> 0x014f }
            com.ttnet.org.chromium.base.Log.m111335i(r0, r2, r3)     // Catch:{ Throwable -> 0x015e, all -> 0x014f }
            r2 = 1
    ...
    private void loadLibraryWithCustomLinkerAlreadyLocked(Linker linker, String str, String str2) {
        if (linker.isUsingBrowserSharedRelros()) {
            ...
            try {
                ...
                Log.m111344w("LibraryLoader", "Failed to load native library with shared RELRO, retrying without", new Object[0]);
    ...
    public static String makeLibraryPathInZipFile(String str, boolean z, boolean z2) {
        ...
        return C2240a.m6772a("lib/%s/%s%s", new Object[]{str2, str3, System.mapLibraryName(str)});
    }
}
