...
public class Linker {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            if (this.mRelroFd >= 0) {
                ...
                try {
                    ...
                    Log.m111334e("LibraryLoader", "Can't write LibInfo file descriptor to parcel", e);
                }
            }
        }
    }
    ...
    private void ensureInitializedLocked() {
        if (!this.mInitialized) {
            ...
            if (this.mMemoryDeviceConfig == 1) {
                ...
                Log.m111344w("LibraryLoader", "Low-memory device: shared RELROs used in all processes", new Object[0]);
            } else {
                this.mBrowserUsesSharedRelro = false;
            }
    ...
    private void setupBaseLoadAddressLocked() {
        if (this.mBaseLoadAddress == -1) {
            ...
            if (this.mBaseLoadAddress == 0) {
                Log.m111344w("LibraryLoader", "Disabling shared RELROs due address space pressure", new Object[0]);
                this.mBrowserUsesSharedRelro = false;
                this.mWaitForSharedRelros = false;
            }
        }
    ...
    public long getBaseLoadAddress() {
        synchronized (this.mLock) {
            ensureInitializedLocked();
            if (!this.mInBrowserProcess) {
                Log.m111344w("LibraryLoader", "Shared RELRO sections are disabled in this process!", new Object[0]);
                return 0;
            }
        ...
        if (bundle != null && this.mLoadedLibraries != null) {
            ...
            for (Entry entry : createLibInfoMapFromBundle.entrySet()) {
                ...
                if (!nativeUseSharedRelro(str, (LibInfo) entry.getValue())) {
                    ...
                    sb.append(str);
                    Log.m111344w("LibraryLoader", sb.toString(), new Object[0]);
                }
            }
            if (!this.mInBrowserProcess) {
    ...
    private final void runTestRunnerClassForTesting(int i, boolean z) {
        ...
        synchronized (this.mLock) {
            ...
            Log.m111335i("LibraryLoader", "All linker tests passed", new Object[0]);
        }
    }
            ...
            if (!this.mLoadedLibraries.containsKey(str3)) {
                ...
                if (!z || ((!this.mInBrowserProcess || !this.mBrowserUsesSharedRelro) && !this.mWaitForSharedRelros)) {
                    ...
                    if (j > this.mBaseLoadAddress + 201326592) {
                        ...
                        sb.append(str3);
                        String sb2 = sb.toString();
                        Log.m111334e("LibraryLoader", sb2, new Object[0]);
                ...
                if (nativeLoadLibrary(str3, j, libInfo)) {
                    if (NativeLibraries.sEnableLinkerTests) {
                        ...
                        Log.m111335i("LibraryLoader", C2240a.m6773a(Locale.US, "%s: %s %x", new Object[]{str2, str3, Long.valueOf(libInfo.mLoadAddress)}), new Object[0]);
                    }
                    if (this.mInBrowserProcess && !nativeCreateSharedRelro(str3, this.mCurrentLoadAddress, libInfo)) {
                        Log.m111344w("LibraryLoader", C2240a.m6773a(Locale.US, "Could not create shared RELRO for %s at %x", new Object[]{str3, Long.valueOf(this.mCurrentLoadAddress)}), new Object[0]);
                    }
                ...
                Log.m111334e("LibraryLoader", sb4, new Object[0]);
