...
public class BuildInfo {
    ...
    private BuildInfo() {
        ...
        try {
            ...
            Log.m111327d("BuildInfo", "GMS package is not found.", e);
            packageInfo = null;
        }
        if (packageInfo != null) {
        ...
        try {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.abiString = C2240a.m6772a("ABI1: %s, ABI2: %s", new Object[]{Build.CPU_ABI, Build.CPU_ABI2});
            }
            this.extractedFileSuffix = C2240a.m6772a("@%x_%x", new Object[]{Long.valueOf(this.versionCode), Long.valueOf(packageInfo2.lastUpdateTime)});
