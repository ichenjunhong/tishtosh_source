                    ...
                    while (true) {
                        try {
                            ...
                            if (!wrappedReference.mSafeToGc) {
                                String a = C2240a.m6772a("Object of type %s was GC'ed without cleanup. Refer to \"Caused by\" for where object was created.", new Object[]{wrappedReference.mTargetClass.getName()});
        ...
        if (BuildConfig.DCHECK_IS_ON) {
            synchronized (WrappedReference.sActiveWrappers) {
                for (WrappedReference wrappedReference : WrappedReference.sActiveWrappers) {
                    if (!wrappedReference.mSafeToGc) {
                        throw new LifetimeAssertException(C2240a.m6772a("Object of type %s was not destroyed after test completed. Refer to \"Caused by\" for where object was created.", new Object[]{wrappedReference.mTargetClass.getName()}), wrappedReference.mCreationException);
                    }
                }
            }
        }
