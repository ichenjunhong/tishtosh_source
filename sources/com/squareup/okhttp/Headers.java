...
public final class Headers {
            ...
            if (str == null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (charAt <= 31 || charAt >= 127) {
                        throw new IllegalArgumentException(C2240a.m6772a("Unexpected char %#04x at %d in header name: %s", new Object[]{Integer.valueOf(charAt), Integer.valueOf(i), str}));
                    }
                }
                if (str2 != null) {
                    ...
                    for (int i2 = 0; i2 < length2; i2++) {
                        ...
                        if (charAt2 <= 31 || charAt2 >= 127) {
                            throw new IllegalArgumentException(C2240a.m6772a("Unexpected char %#04x at %d in header value: %s", new Object[]{Integer.valueOf(charAt2), Integer.valueOf(i2), str2}));
                        }
                    }
                    return;
                }
    ...
    /* renamed from: of */
    public static Headers m44710of(String... strArr) {
    ...
    /* renamed from: of */
    public static Headers m44709of(Map<String, String> map) {
        if (map != null) {
