...
public final class Util {
    ...
    public static String md5Hex(String str) {
        try {
            return ByteString.m114277of(MessageDigest.getInstance("MD5").digest(str.getBytes("UTF-8"))).hex();
    ...
    public static ByteString sha1(ByteString byteString) {
        try {
            return ByteString.m114277of(MessageDigest.getInstance("SHA-1").digest(byteString.toByteArray()));
