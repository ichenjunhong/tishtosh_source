...
public final class Http2 implements Variant {
    ...
    static final class FrameLogger {
        private static final String[] BINARY = new String[UnReadVideoExperiment.BROWSE_RECORD_LIST];
        ...
        static {
            for (int i = 0; i < BINARY.length; i++) {
                BINARY[i] = C2240a.m6772a("%8s", new Object[]{Integer.toBinaryString(i)}).replace(' ', '0');
            }
            FLAGS[0] = "";
            FLAGS[1] = "END_STREAM";
            int[] iArr = {1};
        ...
        static String formatHeader(boolean z, int i, int i2, byte b, byte b2) {
            ...
            if (b < TYPES.length) {
                ...
                str = C2240a.m6772a("0x%02x", new Object[]{Byte.valueOf(b)});
            }
    ...
    static final class Reader implements FrameReader {
        ...
        public final void readConnectionPreface() throws IOException {
            if (!this.client) {
                ...
                if (Http2.logger.isLoggable(Level.FINE)) {
                    Http2.logger.fine(C2240a.m6772a("<< CONNECTION %s", new Object[]{readByteString.hex()}));
                }
    ...
    static final class Writer implements FrameWriter {
        ...
        public final synchronized void connectionPreface() throws IOException {
            if (this.closed) {
                ...
                if (Http2.logger.isLoggable(Level.FINE)) {
                    Http2.logger.fine(C2240a.m6772a(">> CONNECTION %s", new Object[]{Http2.CONNECTION_PREFACE.hex()}));
                }
