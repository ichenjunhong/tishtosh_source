...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f50887dn;
    private int end;
    private final int length = this.f50887dn.length();
    private int pos;
    ...
    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f50887dn = x500Principal.getName("RFC2253");
    }
    ...
    public final String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f50887dn.toCharArray();
