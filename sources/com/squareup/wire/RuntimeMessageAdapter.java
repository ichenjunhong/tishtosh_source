    ...
    public final M redact(M m) {
        ...
        for (FieldBinding fieldBinding : this.fieldBindings.values()) {
            if (!fieldBinding.redacted || fieldBinding.label != Label.REQUIRED) {
                ...
                throw new UnsupportedOperationException(C2240a.m6772a("Field '%s' in %s is required and cannot be redacted.", new Object[]{fieldBinding.name, this.javaType.getName()}));
            }
        }
