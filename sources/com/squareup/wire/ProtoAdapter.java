...
public abstract class ProtoAdapter<E> {
    public static final ProtoAdapter<Boolean> BOOL = new ProtoAdapter<Boolean>(FieldEncoding.VARINT, Boolean.class) {
        ...
        public final Boolean decode(ProtoReader protoReader) throws IOException {
            ...
            throw new IOException(C2240a.m6772a("Invalid boolean value 0x%02x", new Object[]{Integer.valueOf(readVarint32)}));
        }
    ...
    static {
        C184715 r0 = new ProtoAdapter<Integer>(FieldEncoding.FIXED32, Integer.class) {
            public final int encodedSize(Integer num) {
                return 4;
            }
        ...
        FIXED32 = r0;
        SFIXED32 = r0;
        C184759 r02 = new ProtoAdapter<Long>(FieldEncoding.FIXED64, Long.class) {
            public final int encodedSize(Long l) {
                return 8;
            }
