...
public class KakaoNetworkImpl implements INetwork {
    ...
    class _lancet {
        ...
        static InputStream m44338xff4d584d(HttpURLConnection httpURLConnection) throws IOException {
        ...
        static void m44339x963129db(HttpURLConnection httpURLConnection, String str, String str2) {
            URLConnection uRLConnection = httpURLConnection;
            if (C18982g.m46160a(uRLConnection)) {
    ...
    public void configure() throws IOException {
        ...
        _lancet.m44339x963129db(this.urlConnection, "Connection", "keep-alive");
        if (!this.header.isEmpty()) {
            for (String str : this.header.keySet()) {
                _lancet.m44339x963129db(this.urlConnection, str, (String) this.header.get(str));
            }
        }
        String requestMethod = this.urlConnection.getRequestMethod();
        if ("POST".equals(requestMethod) || "PUT".equals(requestMethod)) {
            _lancet.m44339x963129db(this.urlConnection, "Content-Length", "0");
            ...
            if (!this.params.isEmpty()) {
                ...
                _lancet.m44339x963129db(this.urlConnection, "Content-Type", multipartRequestEntity.getContentType());
            } else {
                multipartRequestEntity = null;
            }
            if (i > 0) {
                this.urlConnection.setFixedLengthStreamingMode(i);
                _lancet.m44339x963129db(this.urlConnection, "Content-Length", String.valueOf(i));
            }
    ...
    private InputStream getInputStream(HttpURLConnection httpURLConnection) throws IOException {
        if (httpURLConnection.getResponseCode() < 400) {
            return _lancet.m44338xff4d584d(httpURLConnection);
        }
