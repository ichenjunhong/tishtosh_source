...
public final class Utility {
    ...
    class _lancet {
        ...
        static ApplicationInfo m44343x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    public static String getMetadata(Context context, String str) {
        try {
            ApplicationInfo com_ss_android_ugc_aweme_lancet_lanch_AwemeMetaDataLancet_getApplicationInfo = _lancet.m44343x89c42dc8(context.getPackageManager(), context.getPackageName(), 128);
