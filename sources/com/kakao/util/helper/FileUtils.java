...
public class FileUtils {
    ...
    public static File getExternalStorageCacheDir() {
        File file = new File(C2240a.m6773a(Locale.US, "%s/%s", new Object[]{getExternalStorageDataDir(), "cache"}));
        if (!file.exists() && !file.mkdirs()) {
            StringBuilder sb = new StringBuilder("failed to create dir: ");
            sb.append(file.getPath());
            Logger.m44352e(sb.toString());
        }
        return file;
    }

    public static File getExternalStorageDataDir() {
        File file = new File(C2240a.m6773a(Locale.US, "%s/Android/data/%s", new Object[]{getExternalStorageDirectory(), "com.kakao.sdk"}));
        if (!file.exists() && !file.mkdirs()) {
            StringBuilder sb = new StringBuilder("failed to create dir: ");
            sb.append(file.getPath());
            Logger.m44352e(sb.toString());
    ...
    public static File getExternalStorageTempFile(String str) {
        ...
        return new File(getExternalStorageTempDir(), C2240a.m6773a(Locale.US, "temp_%s.%s", new Object[]{Long.valueOf(System.currentTimeMillis()), str2}));
    }
