...
public class UserManagement {
    ...
    /* renamed from: me */
    public Future<MeV2Response> mo35957me(MeV2ResponseCallback meV2ResponseCallback) {
        return this.taskQueue.addTask(new KakaoResultTask<MeV2Response>(meV2ResponseCallback) {
            public MeV2Response call() throws Exception {
                return UserManagement.this.api.mo35968me(null, Boolean.valueOf(true));
            }
        });
    }
    ...
    /* renamed from: me */
    public Future<MeV2Response> mo35958me(final List<String> list, MeV2ResponseCallback meV2ResponseCallback) {
        return this.taskQueue.addTask(new KakaoResultTask<MeV2Response>(meV2ResponseCallback) {
            public MeV2Response call() throws Exception {
                return UserManagement.this.api.mo35968me(list, Boolean.valueOf(true));
            }
        });
    }
