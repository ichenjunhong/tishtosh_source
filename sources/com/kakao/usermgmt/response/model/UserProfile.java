...
public class UserProfile implements Parcelable, User {
    ...
    public void saveUserToCache() {
        ...
        if (appCache != null) {
            ...
            bundle.putLong("com.kakao.user.userId", this.f50160id);
    ...
    public UserProfile(ResponseBody responseBody) throws ResponseBodyException {
        this.f50160id = responseBody.getLong("id");
        if (this.f50160id > 0) {
    ...
    public UserProfile(SharedPreferencesCache sharedPreferencesCache) {
        this.f50160id = sharedPreferencesCache.getLong("com.kakao.user.userId").longValue();
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeLong(this.f50160id);
