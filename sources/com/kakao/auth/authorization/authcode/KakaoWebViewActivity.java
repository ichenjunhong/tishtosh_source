...
public class KakaoWebViewActivity extends Activity {
    ...
    class KakaoWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsConfirm(android.webkit.WebView r8, java.lang.String r9, java.lang.String r10, final android.webkit.JsResult r11) {
            ...
            L_0x0077:
                ...
                com.kakao.util.helper.log.Logger.m44352e(r2)     // Catch:{ all -> 0x00cc }
    ...
    class KakaoWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView webView, final SslErrorHandler sslErrorHandler, final SslError sslError) {
            ...
            builder.setTitle(KakaoWebViewActivity.this.getString(R.string.e0b));
            builder.setMessage(KakaoWebViewActivity.this.getString(R.string.c5w));
            KakaoWebViewActivity.this.shouldProceedWithSslError = false;
            builder.setNegativeButton(KakaoWebViewActivity.this.getString(R.string.vm), new OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                }
            });
            builder.setPositiveButton(KakaoWebViewActivity.this.getString(R.string.vn), new OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void sendCancelToListener() {
        sendErrorToListener(new KakaoException(ErrorType.CANCELED_OPERATION, getString(R.string.l8)));
    }

    private void unRegisterSmsReceiverIfNeeded() {
        if (smsReceiver != null) {
            try {
                Logger.m44344d("unregisterSmsReceiver");
    ...
    private void registerSmsReceiverIfNeeded() {
        if (this.useSmsReceiver && smsReceiver == null) {
            Logger.m44344d("registerSmsReceiver");
            smsReceiver = new SmsReceiver(new ISmsReceiver() {
                ...
                public void onCompleteSms(String str) {
                    Logger.m44346d("++ onCompleteSms(%s)", str);
                    if (!TextUtils.isEmpty(str)) {
                        String a = C2240a.m6773a(Locale.US, "javascript:insertSms('%s')", new Object[]{str});
    ...
    public void openImageChooserActivity() {
        ...
        startActivityForResult(Intent.createChooser(intent, getString(R.string.bqp)), 9999);
    }

    private void initUi() {
        this.webView = (WebView) findViewById(R.id.duj);
        this.progressBar = (ProgressBar) findViewById(R.id.c66);
        this.webView.setBackgroundResource(17170443);
        this.webView.setVerticalScrollBarEnabled(false);
        this.webView.setHorizontalScrollBarEnabled(false);
        this.webView.setWebViewClient(C13482c.m27232a(new KakaoWebViewClient()));
    ...
    public String createCameraAccessibleScript(Uri uri) {
        ...
        if (VERSION.SDK_INT < 16 || C0726c.m2090a((Context) this, "android.permission.READ_EXTERNAL_STORAGE") == 0) {
            i = 1;
        } else {
            i = 0;
        }
        return C2240a.m6773a(Locale.US, "%s(%d)", new Object[]{queryParameter, Integer.valueOf(i)});
    }
    ...
    public void processCameraAccessibleScript(String str) {
        if (str == null) {
            Logger.m44376w("Callback function was not provide. Ignoring custom scheme (%s)", this.url);
        } else if (VERSION.SDK_INT >= 19) {
            this.webView.evaluateJavascript(str, new ValueCallback<String>() {
                public void onReceiveValue(String str) {
                    Logger.m44346d("received value from javascript: %s", str);
                }
            });
        } else {
            _lancet.com_ss_android_ugc_aweme_lancet_H5UrlCheckLancet_loadUrl(this.webView, C2240a.m6773a(Locale.US, "javascript:%s", new Object[]{str}));
        }
    }
