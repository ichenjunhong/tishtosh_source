...
class TalkAuthCodeService implements AuthCodeService {
    ...
    public AuthorizationResult parseAuthCodeIntent(int i, int i2, Intent intent) {
        ...
        if (intent == null || i2 == 0) {
            authorizationResult = AuthorizationResult.createAuthCodeCancelResult(this.context.getString(R.string.l8));
            ...
            if (string != null || string2 == null || !string2.startsWith(this.redirectUriString)) {
                ...
                if (string3 != null) {
                    Logger.m44361i(string3, new Object[0]);
                }
            ...
            return AuthorizationResult.createAuthCodeCancelResult(this.context.getString(R.string.l8));
        }
