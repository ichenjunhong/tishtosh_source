...
import com.zego.zegoliveroom.callback.p2624im.IZegoBigRoomMessageCallback;
import com.zego.zegoliveroom.callback.p2624im.IZegoIMCallback;
import com.zego.zegoliveroom.callback.p2624im.IZegoRoomMessageCallback;
...
public final class ZegoLiveRoom implements IJniZegoIMCallback, IJniZegoLiveRoomCallback {
    ...
    public final boolean setNoiseSuppressMode(int i) {
        return ZegoLiveRoomJNI.setNoiseSuppressMode(i);
    }

    public final boolean setPlayStreamFocus(String str) {
    ...
    public final void enableAudioPostp(boolean z, String str) {
    ...
    public final void setPublishEncryptKey(byte[] bArr, int i) {
    ...
    public final void updatePlayDecryptKey(String str, byte[] bArr) {
        ZegoLiveRoomJNI.updatePlayDecryptKey(str, bArr);
    }

    public static void _logPrint(String str, Object... objArr) {
        ZegoLiveRoomJNI.logPrint(C2240a.m6772a(str, objArr));
    }
    ...
    public final ZegoAudioFrame onAudioPostp(ZegoAudioFrame zegoAudioFrame, String str) {
        IZegoAudioPostpCallback iZegoAudioPostpCallback = this.mZegoAudioPostpCB;
        if (iZegoAudioPostpCallback != null) {
            return iZegoAudioPostpCallback.onAudioPostp(zegoAudioFrame, str);
        }
        return zegoAudioFrame;
    }
    ...
    public final void setAudioPostpCallback(IZegoAudioPostpCallback iZegoAudioPostpCallback, ZegoExtPrepSet zegoExtPrepSet) {
        boolean z;
        ...
        ZegoLiveRoomJNI.setAudioPostpCallback(z, zegoExtPrepSet);
    }

    public final void setAudioPrepCallback(IZegoAudioPrepCallback2 iZegoAudioPrepCallback2, ZegoExtPrepSet zegoExtPrepSet) {
        boolean z;
        ...
        ZegoLiveRoomJNI.setAudioPrepCallback(z, zegoExtPrepSet);
    }
