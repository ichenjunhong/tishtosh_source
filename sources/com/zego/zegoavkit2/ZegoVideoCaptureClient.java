...
public class ZegoVideoCaptureClient implements Client {
    ...
    public void onEncodedFrameCaptured(ByteBuffer byteBuffer, int i, VideoCodecConfig videoCodecConfig, boolean z, double d) {
        ...
        if (this.pthis != 0) {
            on_encoded_frame_captured(this.pthis, byteBuffer, i, videoCodecConfig2.width, videoCodecConfig2.height, videoCodecConfig2.codec_type, videoCodecConfig2.rotation, z, d);
        }
    }
