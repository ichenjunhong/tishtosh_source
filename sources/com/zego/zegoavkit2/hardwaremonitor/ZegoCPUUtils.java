...
public class ZegoCPUUtils {
    ...
    public static double getSystemCPUUsage() {
        ...
        if (mLastAllCpuForSystem == ProfileUiInitOptimizeEnterThreshold.DEFAULT && mLastIdleCpu == ProfileUiInitOptimizeEnterThreshold.DEFAULT) {
        ...
        if (d5 > ProfileUiInitOptimizeEnterThreshold.DEFAULT && d6 > ProfileUiInitOptimizeEnterThreshold.DEFAULT) {
            double div = div((d5 - d6) * 100.0d, d5, 2);
            if (div >= ProfileUiInitOptimizeEnterThreshold.DEFAULT) {
                d3 = div;
            }
        }
        mLastAllCpuForSystem = d2;
    ...
    public static double getProcessCPUUsage(int i) {
        ...
        if (mLastAllCpu == ProfileUiInitOptimizeEnterThreshold.DEFAULT && mLastProcessCpu == ProfileUiInitOptimizeEnterThreshold.DEFAULT) {
            mLastAllCpu = d2;
            mLastProcessCpu = d;
            return ProfileUiInitOptimizeEnterThreshold.DEFAULT;
        }
        if (d2 - mLastAllCpu > ProfileUiInitOptimizeEnterThreshold.DEFAULT) {
