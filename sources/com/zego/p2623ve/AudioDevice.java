...
public class AudioDevice {
    ...
    protected int _framesPerBuffer = UnReadVideoExperiment.BROWSE_RECORD_LIST;
    ...
    /* renamed from: com.zego.ve.AudioDevice$SilentPlayer */
    public class SilentPlayer {
        ...
        /* renamed from: com.zego.ve.AudioDevice$SilentPlayer$PlaybackThread */
            ...
            public void run() {
                ...
                AudioDevice.this._phoneStateListener = new PhoneStateListener() {
                    public void onCallStateChanged(int i, String str) {
                        ...
                        String str2 = "device";
                        StringBuilder sb = new StringBuilder("trace interruption on call state changed: ");
                        sb.append(i);
                        sb.append(", num: ");
                        if (str == null) {
                ...
                try {
                    ...
                    StringBuilder sb = new StringBuilder("trace interruption init call state: ");
                    sb.append(callState);
                    Log.m111994i("device", sb.toString());
                } catch (Throwable th) {
                    StringBuilder sb2 = new StringBuilder("initPhoneStateListener failed, ");
                    sb2.append(th);
                    Log.m111992e("device", sb2.toString());
        ...
        this._handler.post(new Runnable() {
            public void run() {
                try {
                    ...
                    sb.append(th);
                    Log.m111992e("device", sb.toString());
                }
            }
        });
    }
    ...
    public int EnableHWKaraoke(int i) {
        boolean z;
        StringBuilder sb = new StringBuilder("EnableHWKaraoke ");
        sb.append(i);
        Log.m111994i("device", sb.toString());
        if (this._hwAudioKit != null) {
            ...
            hwAudioKit.enableKaraokeFeature(z);
            if (i == 1) {
    ...
    public int InitCapDev(int i) {
        ...
        while (true) {
            if (i2 >= this._capSampleRateTable.length) {
                break;
            }
            this._capSampleRate = this._capSampleRateTable[i2];
            int minBufferSize = AudioRecord.getMinBufferSize(this._capSampleRate, i4, 2);
            if (minBufferSize < this._capSampleRate * i) {
                minBufferSize = this._capSampleRate * i;
            }
            try {
                ...
                if (this._capDev == null) {
                    ...
                    Log.m111998w("device", "AudioRecord state is not AudioRecord.STATE_INITIALIZED\n");
                    this._capDev.release();
                    this._capDev = null;
                    i3 = 1;
                }
    ...
    public android.media.AudioTrack createAudioTrack(int r10, int r11) {
        ...
        L_0x0023:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.zego.p2623ve.AudioDevice.createAudioTrack(int, int):android.media.AudioTrack");
    }

    public int Init(long j, boolean z) {
