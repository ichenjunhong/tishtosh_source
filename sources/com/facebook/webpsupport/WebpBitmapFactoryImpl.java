...
public class WebpBitmapFactoryImpl implements C13733b {
    public static final boolean IN_BITMAP_SUPPORTED;
    private static C13732a mBitmapCreator;
    private static C13734a mWebpErrorLogger;
    ...
    public void setBitmapCreator(C13732a aVar) {
        mBitmapCreator = aVar;
    }

    public void setWebpErrorLogger(C13734a aVar) {
    ...
    public static Bitmap hookDecodeStream(InputStream inputStream, Rect rect, Options options) {
        ...
        if (!C13735c.f35722a || !C13735c.m27786a(webpHeader, 0, 20)) {
    ...
    public static Bitmap hookDecodeByteArray(byte[] bArr, int i, int i2, Options options) {
        Bitmap bitmap;
        C14225d.m29166a();
        if (!C13735c.f35722a || !C13735c.m27786a(bArr, i, i2)) {
