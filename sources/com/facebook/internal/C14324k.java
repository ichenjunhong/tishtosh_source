...
public final class C14324k {

    /* renamed from: a */
    private static final HashSet<String> f37271a;
    ...
    /* renamed from: a */
    public static boolean m29377a(Context context, String str) {
        ...
        try {
            ...
            for (Signature byteArray : packageInfo.signatures) {
                if (!f37271a.contains(C14277aa.m29254a("SHA-1", byteArray.toByteArray()))) {
                    return false;
                }
            }
            return true;
