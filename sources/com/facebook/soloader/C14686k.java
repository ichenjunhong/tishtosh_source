...
public final class C14686k {

    /* renamed from: com.facebook.soloader.k$a */
    static final class C14687a {
    ...
    /* renamed from: a */
    public static String[] m30039a() {
        if (VERSION.SDK_INT >= 21) {
            return C14687a.getSupportedAbis();
        }
        return new String[]{Build.CPU_ABI, Build.CPU_ABI2};
    }

    /* renamed from: a */
    public static int m30035a(Context context) {
    ...
    static void m30040b(java.io.File r3) throws java.io.IOException {
        /*
        ...
        L_0x005f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.soloader.C14686k.m30040b(java.io.File):void");
    }

    /* renamed from: a */
    public static void m30038a(File file) throws IOException {
        if (file.isDirectory()) {
    ...
    /* renamed from: a */
    public static int m30037a(String[] strArr, String str) {
    ...
    /* renamed from: a */
    static int m30036a(RandomAccessFile randomAccessFile, InputStream inputStream, int i, byte[] bArr) throws IOException {
        int i2 = 0;
