...
final class C2506c {
    ...
    static class C2507a extends HashMap<String, Object> {
        ...
        static class C2508c {
            ...
            /* renamed from: ˏ */
            public final boolean mo6994(C2508c cVar) {
                return m7357(cVar.f7787, cVar.f7789);
            }

            /* renamed from: ˋ */
            static String m7356(String str) throws Exception {
            ...
            /* renamed from: ˏ */
            static C2508c m7358(String str) {
                if (str == null) {
                    return new C2508c(0, "");
                }
                ...
                return new C2508c(Long.parseLong(split[0]), split[1]);
            }

            C2508c(long j, String str) {
                this.f7788 = new Object();
                this.f7787 = 0;
                this.f7789 = "";
                this.f7787 = j;
                this.f7789 = str;
            ...
            private boolean m7357(long r9, java.lang.String r11) {
                /*
                    r8 = this;
                    java.lang.Object r0 = r8.f7788
                    monitor-enter(r0)
                    r1 = 0
                    if (r11 == 0) goto L_0x0028
                    java.lang.String r2 = r8.f7789     // Catch:{ all -> 0x0025 }
                    boolean r2 = r11.equals(r2)     // Catch:{ all -> 0x0025 }
                    if (r2 != 0) goto L_0x0028
                    long r2 = r8.f7787     // Catch:{ all -> 0x0025 }
                    r4 = 0
                    long r2 = r9 - r2
                ...
                L_0x001d:
                    if (r2 == 0) goto L_0x0028
                    r8.f7787 = r9     // Catch:{ all -> 0x0025 }
                    r8.f7789 = r11     // Catch:{ all -> 0x0025 }
                ...
                L_0x0028:
                    ...
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.C2506c.C2507a.C2508c.m7357(long, java.lang.String):boolean");
            }
        }

        /* renamed from: ˏ */
        private String m7353() {
            boolean z;
            char c;
            try {
                String num = Integer.toString(VERSION.SDK_INT);
                String obj = this.f7785.get(m7352(12, 0, 0).intern()).toString();
                String obj2 = this.f7785.get(m7352(5, 12, 0).intern()).toString();
                if (obj2 == null) {
                    obj2 = m7352(8, 17, 0).intern();
                    int i = f7781 + 119;
                    f7783 = i % 128;
                    int i2 = i % 2;
                }
                ...
                sb.reverse();
                StringBuilder r2 = m7354(num, obj2, sb.toString());
                ...
                r2.insert(0, m7352(3, 25, 13186).intern());
                return r2.toString();
            } catch (Exception e) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(m7352(42, 28, 4051).intern());
                sb2.append(e);
                AFLogger.afRDLog(sb2.toString());
                return m7352(7, 70, 903).intern();
            }
        }

        /* renamed from: ॱ */
        private String m7355() {
            String str;
            boolean z;
            boolean z2;
            int i;
            ...
            try {
                String obj = this.f7785.get(m7352(12, 0, 0).intern()).toString();
                String obj2 = this.f7785.get(m7352(15, 77, 7243).intern()).toString();
                String replaceAll = m7352(6, 92, 0).intern().replaceAll(m7352(5, 98, 0).intern(), "");
                StringBuilder sb = new StringBuilder();
                sb.append(obj);
                sb.append(obj2);
                sb.append(replaceAll);
                String r7 = C2536r.m7419(sb.toString());
                StringBuilder sb2 = new StringBuilder();
                sb2.append(str2);
                ...
                sb3.append(m7352(44, 103, 65324).intern());
                sb3.append(e);
                AFLogger.afRDLog(sb3.toString());
                StringBuilder sb4 = new StringBuilder();
                sb4.append(str2);
                sb4.append(m7352(18, 147, 36288).intern());
                str = sb4.toString();
            }
            try {
                Intent registerReceiver = this.f7786.registerReceiver(null, new IntentFilter(m7352(37, 165, 0).intern()));
                ...
                if (z) {
                    ...
                    if (z3) {
                        i2 = registerReceiver.getIntExtra(m7352(11, 202, 0).intern(), -2700);
                    } else {
                        i2 = registerReceiver.getIntExtra(m7352(26, 19887, 0).intern(), 22337);
                    }
                }
                if (!this.f7786.getApplicationInfo().nativeLibraryDir.contains(m7352(3, 213, 0).intern())) {
                    z2 = false;
                } else {
                    z2 = true;
                }
                ...
                int size = ((SensorManager) this.f7786.getSystemService(m7352(6, 216, 0).intern())).getSensorList(-1).size();
                StringBuilder sb5 = new StringBuilder();
                sb5.append(m7352(1, 222, 0).intern());
                sb5.append(i2);
                sb5.append(m7352(2, 223, 0).intern());
                sb5.append(i);
                sb5.append(m7352(2, 225, 0).intern());
                sb5.append(size);
                sb5.append(m7352(2, 227, 15188).intern());
                sb5.append(this.f7785.size());
                String obj3 = sb5.toString();
                StringBuilder sb6 = new StringBuilder();
                sb6.append(str);
                sb6.append(C2508c.m7356(obj3));
                return sb6.toString();
            } catch (Exception e2) {
                StringBuilder sb7 = new StringBuilder();
                sb7.append(m7352(44, 103, 65324).intern());
                sb7.append(e2);
                AFLogger.afRDLog(sb7.toString());
                StringBuilder sb8 = new StringBuilder();
                sb8.append(str);
                sb8.append(m7352(16, 229, 20055).intern());
                return sb8.toString();
            }
        }

        /* renamed from: ˏ */
        private static StringBuilder m7354(String... strArr) throws Exception {
            char c;
            int i;
            char c2;
        ...
        C2507a(Map<String, Object> map, Context context) {
            this.f7785 = map;
            this.f7786 = context;
            put(m7353(), m7355());
        }
        ...
        /* renamed from: ˊ */
        private static String m7352(int i, int i2, char c) {
            boolean z;
            char c2;
            int i3 = f7781 + 109;
            f7783 = i3 % 128;
            ...
            while (true) {
                ...
                if (!z) {
                    ...
                    if (c2 != '8') {
                        cArr[i5] = (char) ((int) ((((long) f7782[i2 + i5]) ^ (((long) i5) * f7784)) ^ ((long) c)));
                        i5++;
                    } else {
                        cArr[i5] = (char) ((int) ((((long) f7782[i2 + i5]) - (((long) i5) ^ f7784)) / ((long) c)));
                        i5 += 73;
    ...
    /* renamed from: ˊ */
    private static String m7344(Context context) {
        boolean z;
    ...
    /* renamed from: ˋ */
    private static boolean m7349(String str) {
        char c;
        int i = f7778 + 39;
        f7780 = i % 128;
        int i2 = i % 2;
    ...
    /* renamed from: ˎ */
    private static String m7350(String str) {
        boolean z;
        char c;
        if (str.contains(m7347(1, 169, 0).intern())) {
            z = true;
        } else {
            z = false;
        }
        ...
        String[] split = str.split(m7347(2, 170, 0).intern());
        int length = split.length;
        StringBuilder sb = new StringBuilder();
        int i = length - 1;
        sb.append(split[i]);
        sb.append(m7347(1, 169, 0).intern());
        int i2 = f7780 + 67;
        f7778 = i2 % 128;
        int i3 = i2 % 2;
        int i4 = 1;
        while (i4 < i) {
            ...
            if (c != '?') {
                sb.append(split[i4]);
                sb.append(m7347(1, 4461, 0).intern());
                i4 += 54;
            } else {
                sb.append(split[i4]);
                sb.append(m7347(1, 169, 0).intern());
    ...
    /* renamed from: ˏ */
    private static String m7351(Context context) {
        char c;
        String str;
        if (!System.getProperties().containsKey(m7347(14, 172, 0).intern())) {
            c = 'T';
        } else {
            c = 'O';
        }
        if (c != 'T') {
            ...
            int i2 = i % 2;
            try {
                Matcher matcher = Pattern.compile(m7347(10, 192, 0).intern()).matcher(context.getCacheDir().getPath().replace(m7347(6, 186, 0).intern(), ""));
                if (matcher.find()) {
                    str = matcher.group(1);
                    int i3 = f7780 + 53;
                    f7778 = i3 % 128;
                ...
                String intern = m7347(17, 202, 0).intern();
                StringBuilder sb = new StringBuilder();
                sb.append(m7347(41, 219, 0).intern());
                sb.append(e);
                r0.mo7040(intern, sb.toString());
                return null;
            }
        }
        str = null;
    ...
    /* renamed from: ˊ */
    private static String m7346(String str, Long l) {
        char c;
        boolean z;
        char c2;
        char c3;
        ...
        if (c3 != 31) {
            ...
            if (z2) {
                sb.insert(23, m7347(1, 35, 0).intern());
            } else {
                sb.insert(40, m7347(0, 86, 0).intern());
            }
        }
    ...
    /* renamed from: ˋ */
    private static String m7348(Context context, String str) {
        char c;
        char c2;
        PackageManager packageManager = context.getPackageManager();
        Class<PackageManager> cls = PackageManager.class;
        try {
            Iterator it = ((List) cls.getDeclaredMethod(m7347(24, 260, 0).intern(), new Class[]{Integer.TYPE}).invoke(packageManager, new Object[]{Integer.valueOf(0)})).iterator();
            int i = f7780 + 49;
            f7778 = i % 128;
            int i2 = i % 2;
            do {
            ...
            C2537s r12 = C2537s.m7429();
            String intern = m7347(24, 284, 0).intern();
            StringBuilder sb = new StringBuilder();
            sb.append(m7347(47, 308, 37908).intern());
            sb.append(e);
            r12.mo7040(intern, sb.toString());
        } catch (NoSuchMethodException e2) {
            C2537s r122 = C2537s.m7429();
            String intern2 = m7347(24, 284, 0).intern();
            StringBuilder sb2 = new StringBuilder();
            sb2.append(m7347(47, 308, 37908).intern());
            sb2.append(e2);
            r122.mo7040(intern2, sb2.toString());
        } catch (InvocationTargetException e3) {
            C2537s r123 = C2537s.m7429();
            String intern3 = m7347(24, 284, 0).intern();
            StringBuilder sb3 = new StringBuilder();
            sb3.append(m7347(47, 308, 37908).intern());
            sb3.append(e3);
            r123.mo7040(intern3, sb3.toString());
        }
    }
    ...
    /* renamed from: ˊ */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static java.lang.String m7345(android.content.Context r13, long r14) {
        /*
            ...
            r4 = 34
            r5 = 0
            java.lang.String r3 = m7347(r4, r5, r3)
            ...
            java.lang.String r3 = m7347(r9, r7, r5)
        L_0x002d:
            java.lang.String r3 = r3.intern()
            goto L_0x0040
        L_0x0032:
            ...
            f7780 = r10
            int r3 = r3 % r6
            java.lang.String r3 = m7347(r9, r4, r8)
            goto L_0x002d
        L_0x0040:
            r1.append(r3)
            ...
            java.lang.String r11 = m7350(r10)
            java.lang.String r12 = m7347(r9, r4, r8)
            java.lang.String r12 = r12.intern()
            r1.append(r12)
            r3.append(r11)
            java.lang.String r11 = m7351(r13)
            r12 = 90
        ...
        L_0x006b:
            ...
            java.lang.String r11 = m7347(r9, r4, r8)
            java.lang.String r11 = r11.intern()
            r1.append(r11)
            r3.append(r10)
            goto L_0x008a
        L_0x007c:
            java.lang.String r11 = m7347(r9, r7, r5)
            java.lang.String r11 = r11.intern()
            r1.append(r11)
            r3.append(r10)
        L_0x008a:
            java.lang.String r11 = m7344(r13)
        ...
        L_0x009f:
            ...
            r3.append(r10)
        L_0x00ad:
            java.lang.String r10 = m7348(r13, r10)
            r3.append(r10)
            ...
            java.lang.String r13 = m7347(r13, r3, r12)     // Catch:{ NameNotFoundException -> 0x0222 }
            ...
            r13 = 25
            r3 = 86
            java.lang.String r13 = m7347(r13, r3, r5)
            java.lang.String r13 = r13.intern()
            boolean r13 = m7349(r13)
            if (r13 != 0) goto L_0x0112
            java.lang.String r13 = m7347(r9, r7, r5)
        L_0x010d:
            java.lang.String r13 = r13.intern()
            goto L_0x012c
        L_0x0112:
            ...
            java.lang.String r13 = m7347(r9, r4, r8)
            goto L_0x010d
        L_0x0122:
            r13 = 99
            java.lang.String r13 = m7347(r9, r13, r8)
            java.lang.String r13 = r13.intern()
        L_0x012c:
            r2.append(r13)
            r13 = 23
        ...
        L_0x019d:
            ...
            java.lang.String r13 = m7347(r13, r3, r10)
            java.lang.String r13 = r13.intern()
            boolean r13 = m7349(r13)
            r3 = 72
        ...
        L_0x01cc:
            ...
            java.lang.String r13 = com.appsflyer.C2536r.m7419(r13)
            java.lang.String r13 = com.appsflyer.C2536r.m7421(r13)
            ...
            java.lang.String r13 = m7346(r13, r14)
            return r13
        L_0x0222:
            r13 = 32
            r14 = 54
            java.lang.String r13 = m7347(r13, r14, r5)
            java.lang.String r13 = r13.intern()
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.C2506c.m7345(android.content.Context, long):java.lang.String");
    }

    /* renamed from: ˋ */
    private static String m7347(int i, int i2, char c) {
        char c2;
        char c3;
        char[] cArr = new char[i];
        int i3 = f7780 + 91;
        ...
        while (true) {
            ...
            if (c3 != 10) {
                cArr[i4] = (char) ((int) ((((long) f7777[i2 + i4]) ^ (((long) i4) * f7779)) ^ ((long) c)));
                i4++;
            } else {
                cArr[i4] = (char) ((int) ((((long) f7777[i2 - i4]) * (((long) i4) & f7779)) ^ ((long) c)));
                i4 += 119;
