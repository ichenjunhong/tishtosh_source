...
final class C2523l {
    ...
    static class C2524a extends IllegalStateException {
        C2524a(String str) {
            super(str);
        }
    }
    ...
    /* renamed from: ॱ */
    static C2529o m7395(ContentResolver contentResolver) {
        String str;
        C2529o oVar = null;
        ...
        if (AppsFlyerProperties.getInstance().getString("amazon_aid") == null && "Amazon".equals(Build.MANUFACTURER)) {
            ...
            if (i == 0) {
                oVar = new C2529o(C2530a.AMAZON, Secure.getString(contentResolver, "advertising_id"), false);
            } else if (i != 2) {
                String str2 = "";
                try {
                ...
                oVar = new C2529o(C2530a.AMAZON, str, true);
            }
        }
        return oVar;
    }
    ...
    static void m7394(android.content.Context r9, java.util.Map<java.lang.String, java.lang.Object> r10) {
        /*
        ...
        L_0x001c:
            ...
            com.google.android.gms.ads.b.a$a r5 = com.google.android.gms.ads.p1029b.C14902a.m30575a(r9)     // Catch:{ Throwable -> 0x0059 }
            if (r5 == 0) goto L_0x004c
            java.lang.String r6 = r5.f38442a     // Catch:{ Throwable -> 0x0059 }
            boolean r5 = r5.f38443b     // Catch:{ Throwable -> 0x004a }
            r5 = r5 ^ r3
        ...
        L_0x005b:
            ...
            com.appsflyer.h$e r2 = com.appsflyer.C2517h.m7377(r9)     // Catch:{ Throwable -> 0x009e }
            java.lang.String r6 = r2.f7822     // Catch:{ Throwable -> 0x009e }
            boolean r2 = r2.f7821     // Catch:{ Throwable -> 0x009e }
            r2 = r2 ^ r3
        ...
        L_0x0152:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.C2523l.m7394(android.content.Context, java.util.Map):void");
    }
}
