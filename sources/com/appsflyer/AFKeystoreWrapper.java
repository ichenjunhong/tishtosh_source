...
class AFKeystoreWrapper {
    ...
    /* renamed from: ॱ */
    private final Object f7698 = new Object();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005b, code lost:
        r7.f7696 = r3[1].trim();
        r7.f7694 = java.lang.Integer.parseInt(r1[1].trim());
     */
    ...
    public final boolean mo6917() {
        /*
            r7 = this;
            java.lang.Object r0 = r7.f7698
            monitor-enter(r0)
            java.security.KeyStore r1 = r7.f7695     // Catch:{ all -> 0x0091 }
            r2 = 1
            r3 = 0
            if (r1 == 0) goto L_0x008e
            java.security.KeyStore r1 = r7.f7695     // Catch:{ Throwable -> 0x0072 }
        ...
        L_0x0091:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.AFKeystoreWrapper.mo6917():boolean");
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: ˊ */
    public final void mo6916(String str) {
        this.f7696 = str;
        this.f7694 = 0;
        m7252(m7253());
    }
    ...
    public AFKeystoreWrapper(Context context) {
        ...
        try {
            this.f7695 = KeyStore.getInstance("AndroidKeyStore");
            this.f7695.load(null);
    ...
    private void m7252(String str) {
        ...
        try {
            ...
            synchronized (this.f7698) {
                if (!this.f7695.containsAlias(str)) {
                    if (VERSION.SDK_INT >= 23) {
                        ...
                        algorithmParameterSpec = new KeyPairGeneratorSpec.Builder(this.f7697).setAlias(str).setSubject(new X500Principal("CN=AndroidSDK, O=AppsFlyer")).setSerialNumber(BigInteger.ONE).setStartDate(instance.getTime()).setEndDate(instance2.getTime()).build();
                    }
