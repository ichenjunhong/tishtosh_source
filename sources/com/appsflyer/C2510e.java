...
final class C2510e {
    ...
    static android.location.Location m7363(android.content.Context r7) {
        /*
            r0 = 0
            ...
            boolean r3 = m7362(r7, r3)     // Catch:{ Throwable -> 0x005c }
        ...
        L_0x0024:
            ...
            boolean r7 = m7362(r7, r4)     // Catch:{ Throwable -> 0x005c }
        ...
        L_0x005c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.C2510e.m7363(android.content.Context):android.location.Location");
    }

    /* renamed from: ˊ */
    private static boolean m7362(Context context, String[] strArr) {
        for (String r3 : strArr) {
            if (C25121.m7369(context, r3)) {
                return true;
            }
        }
        return false;
