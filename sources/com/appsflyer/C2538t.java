...
final class C2538t {
    ...
    private static java.lang.String m7442(java.io.File r5) {
        /*
            r0 = 0
        ...
        L_0x005b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.C2538t.m7442(java.io.File):java.lang.String");
    }

    /* renamed from: ˊ */
    public static synchronized String m7443(WeakReference<Context> weakReference) {
        String str;
        synchronized (C2538t.class) {
            ...
            if (f7899 == null) {
                String str3 = null;
                if (weakReference.get() != null) {
                    str3 = C35807d.m80935a((Context) weakReference.get(), "appsflyer-data", 0).getString("AF_INSTALLATION", null);
                }
                if (str3 != null) {
                    f7899 = str3;
                } else {
                    try {
                        ...
                        String str4 = f7899;
                        Editor edit = C35807d.m80935a((Context) weakReference.get(), "appsflyer-data", 0).edit();
                ...
                if (f7899 != null) {
                    AppsFlyerProperties.getInstance().set("uid", f7899);
                }
            }
            String str5 = f7899;
            return str5;
