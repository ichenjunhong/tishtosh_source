...
public class CacheManager {
    ...
    /* renamed from: ˎ */
    private static CacheManager f7790 = new CacheManager();
    ...
    private static com.appsflyer.cache.RequestCacheData m7360(java.io.File r4) {
        /*
            r0 = 0
            ...
            r3.f7791 = r4     // Catch:{ Exception -> 0x002a, all -> 0x001f }
        ...
        L_0x002f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.cache.CacheManager.m7360(java.io.File):com.appsflyer.cache.RequestCacheData");
    }
    ...
    public void cacheRequest(com.appsflyer.cache.RequestCacheData r6, android.content.Context r7) {
        ...
        L_0x0022:
            ...
            java.lang.String r0 = r6.f7794     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            r7.write(r0)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            r0 = 10
            r7.write(r0)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            java.lang.String r1 = "url="
            r7.write(r1)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            java.lang.String r1 = r6.f7793     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            r7.write(r1)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            r7.write(r0)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            java.lang.String r1 = "data="
            r7.write(r1)     // Catch:{ Exception -> 0x0088, all -> 0x007d }
            java.lang.String r6 = r6.f7792     // Catch:{ Exception -> 0x0088, all -> 0x007d }
