...
/* renamed from: com.benchmark.i */
public interface C2651i extends IInterface {

    /* renamed from: com.benchmark.i$a */
    public static abstract class C2652a extends Binder implements C2651i {

        /* renamed from: com.benchmark.i$a$a */
        static class C2653a implements C2651i {

            /* renamed from: a */
            private IBinder f8096a;

            public final IBinder asBinder() {
                return this.f8096a;
            }

            C2653a(IBinder iBinder) {
                this.f8096a = iBinder;
            }

            /* renamed from: a */
            public final void mo7178a(Benchmark benchmark) throws RemoteException {
                ...
                try {
                    ...
                    this.f8096a.transact(3, obtain, obtain2, 0);
            ...
            /* renamed from: b */
            public final void mo7180b(Benchmark benchmark, BenchmarkResult benchmarkResult) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.benchmark.IBMCallback");
                    ...
                    this.f8096a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            /* renamed from: a */
            public final void mo7179a(Benchmark benchmark, BenchmarkResult benchmarkResult) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.benchmark.IBMCallback");
                    ...
                    this.f8096a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public boolean onTransact(int r4, android.os.Parcel r5, android.os.Parcel r6, int r7) throws android.os.RemoteException {
            ...
            L_0x007c:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.benchmark.C2651i.C2652a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    /* renamed from: a */
    void mo7178a(Benchmark benchmark) throws RemoteException;

    /* renamed from: a */
    void mo7179a(Benchmark benchmark, BenchmarkResult benchmarkResult) throws RemoteException;

    /* renamed from: b */
    void mo7180b(Benchmark benchmark, BenchmarkResult benchmarkResult) throws RemoteException;
}
