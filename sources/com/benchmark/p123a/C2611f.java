...
/* renamed from: com.benchmark.a.f */
public final class C2611f extends C2625t {
    /* renamed from: c */
    ...
    public final int mo7172d() {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            i2 = a.faceBeauty(a.f126670b);
            if (i2 != 0) {
                break;
            }
        }
        a.f126671c.mo98737a("runFaceBeauty");
        return i2;
    }

    public C2611f(Benchmark benchmark) {
        super(benchmark);
    }
}
