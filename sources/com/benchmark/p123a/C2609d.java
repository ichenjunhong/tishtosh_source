...
/* renamed from: com.benchmark.a.d */
public final class C2609d extends C2625t {
    /* renamed from: c */
    ...
    public final int mo7172d() {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            i2 = a.embossProcessGPU(a.f126670b);
            if (i2 != 0) {
                break;
            }
        }
        a.f126671c.mo98737a("runEmbossProcessGPU");
        return i2;
    }

    public C2609d(Benchmark benchmark) {
        super(benchmark);
    }
}
