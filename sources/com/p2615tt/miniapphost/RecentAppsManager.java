...
import com.p2615tt.miniapphost.recent.DataChangeListener;
import com.p2615tt.miniapphost.recent.IRecentAppsManager;
    ...
    public IRecentAppsManager getImpl() {
        if (this.recentAppsImpl == null) {
            try {
                ...
                AppBrandLogger.m111323e("RecentAppsManager", e);
            }
        }
