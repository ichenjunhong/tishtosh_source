package com.p2615tt.miniapphost.entity;
...
public class MicroSchemaEntity {
    ...
    private static JSONObject getJsonFromMap(Map map) {
        ...
        try {
            ...
            AppBrandLogger.m111323e("MicroSchemaEntity", e.toString());
            return null;
        }
    }
    ...
    private static boolean isReservedField(String str) {
        if (!TextUtils.isEmpty(str) && !str.equals(C42311c.f106863g) && !str.equals("app_id") && !str.equals("meta") && !str.equals("scene") && !str.equals("version_type") && !str.equals("token") && !str.equals("start_page") && !str.equals("query") && !str.equals("bdp_log") && !str.equals("launch_mode") && !str.equals("inspect") && !str.equals("referer_info") && !str.equals(LeakCanaryFileProvider.f132050j) && !str.equals("bdpsum")) {
            return false;
        }
        return true;
    }
    ...
    private static String toHexString(byte... bArr) {
        ...
        for (int i3 = 0; i3 < bArr.length; i3++) {
            if (bArr[i3] < 0) {
                i = bArr[i3] + UnReadVideoExperiment.BROWSE_RECORD_LIST;
            } else {
                i = bArr[i3];
            }
            int i4 = i2 + 1;
