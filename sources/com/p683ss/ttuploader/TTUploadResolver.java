...
import com.C2240a;
import com.p683ss.ttuploader.net.IPCache;
import com.p683ss.ttuploader.net.TTUploadDNSInfo;
import com.p683ss.ttuploader.net.TTUploadDNSParser;
import com.p683ss.ttuploader.net.TTUploadDNSParserListener;
...
public class TTUploadResolver implements TTUploadDNSParserListener {
    ...
    static class ParserHost implements Runnable {
        ...
        public void run() {
            /*
                r5 = this;
                int r0 = com.p683ss.ttuploader.TTUploadResolver.mIsUseTTnetDNS
                r1 = 1
                r2 = 0
                r3 = 0
                if (r0 != r1) goto L_0x001e
                java.lang.String r0 = r5.mHostName     // Catch:{ Throwable -> 0x001e }
                java.util.List r0 = com.bytedance.ttnet.C13303d.m26789a(r0)     // Catch:{ Throwable -> 0x001e }
            ...
            L_0x0032:
                ...
                com.p683ss.ttuploader.TTUploadResolver.putHostInfo(r0, r2)
                long r3 = java.lang.System.currentTimeMillis()
                r2.time = r3
            L_0x005c:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttuploader.TTUploadResolver.ParserHost.run():void");
        }
    ...
    private void getAddressInfoVersion_1(String str) {
        ...
        if (str == null || str.length() <= 0 || "".equals(str)) {
            ...
            if (this.mHostInfo != null) {
                if (this.mHostInfo.f128647ip == null || System.currentTimeMillis() - this.mHostInfo.time >= ((long) HOST_MAX_CACHE_TIME)) {
                    mCacheHosts.remove(str);
                    this.mHostInfo = null;
                } else {
                    this.mIPStr = new String[1];
                    this.mIPStr[0] = this.mHostInfo.f128647ip;
                    this.mRet = true;
                    return;
                }
            }
    ...
    private void getAddressInfoVersion_2(String str) {
        TTUploadLog.m110631d("TTUploadResolver", "----add host to parser");
        this.mHostName = str;
        TTUploadDNSInfo tTUploadDNSInfo = IPCache.getInstance().get(str);
        if (!(tTUploadDNSInfo == null || tTUploadDNSInfo.mIpList == null)) {
            long currentTimeMillis = System.currentTimeMillis();
            TTUploadLog.m110631d("TTUploadResolver", C2240a.m6772a("get result from cache expiredT:%d curT:%d ", new Object[]{Long.valueOf(tTUploadDNSInfo.mExpiredTime), Long.valueOf(currentTimeMillis)}));
            if (tTUploadDNSInfo.mExpiredTime <= currentTimeMillis) {
                TTUploadLog.m110631d("TTUploadResolver", C2240a.m6772a("has expired try call parse:", new Object[0]));
            ...
            if (split != null && split.length > 0) {
                ...
                this.mRet = true;
                TTUploadLog.m110631d("TTUploadResolver", C2240a.m6772a("get result from cache suc, ip:%s ", new Object[]{split[0]}));
            }
        }
        if (!this.mRet) {
            TTUploadLog.m110631d("TTUploadResolver", "****add host to parser");
    ...
    public void onCompletion(int i, String str, String str2, long j, String str3) {
        TTUploadLog.m110631d("TTUploadResolver", C2240a.m6772a("notify result host:%s iplist:%s ", new Object[]{str, str2}));
        if (!this.mRet) {
