...
public class NetUtils {
    ...
    /* renamed from: com.ss.ttuploader.net.NetUtils$_lancet */
    class _lancet {
        private _lancet() {
        }

        /* renamed from: com_ss_android_ugc_aweme_lancet_network_ConnecttivityManagerLancet_getActiveNetworkInfo */
        static NetworkInfo m110637xea89a0b0(ConnectivityManager connectivityManager) {
            try {
    ...
    public static NetworkInfo getNetworkInfo(Context context) {
        try {
            return _lancet.m110637xea89a0b0((ConnectivityManager) context.getSystemService("connectivity"));
