...
import com.p683ss.ttuploader.net.TTVNetClient.CompletionListener;
...
public class HTTPDNS extends BaseDNS {
    ...
    private TTUploadDNSInfo parserResult(JSONObject jSONObject) {
        ...
        if (this.mHttpDNSType == 2 || this.mHttpDNSType == 1) {
            ...
            if (optJSONArray == null || optJSONArray.length() == 0) {
                TTUploadLog.m110631d("HTTPDNS", C2240a.m6772a("no ips in json, type:%d", new Object[]{Integer.valueOf(this.mHttpDNSType)}));
                return null;
            }
    ...
    public void _handleResponse(JSONObject jSONObject, Error error) {
        TTUploadLog.m110631d("HTTPDNS", C2240a.m6772a("****http dns id:%s", new Object[]{this.mId}));
        ...
        if (error != null) {
            ...
            TTUploadLog.m110631d("HTTPDNS", C2240a.m6772a("http dns json is empty type:%d", new Object[]{Integer.valueOf(this.mHttpDNSType)}));
        } else {
