...
public class TTUploadDNSParserBridge implements TTUploadDNSParserListener {
    ...
    public String getResult() {
        ...
        try {
            ...
            sb.append(str);
            TTUploadLog.m110631d("TTUploadDNSParserBridge", sb.toString());
            return str;
        } catch (Throwable th) {
            this.lock.unlock();
            throw th;
    ...
    public int start(long j, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            sb2.append(str);
            TTUploadLog.m110631d("TTUploadDNSParserBridge", sb2.toString());
            return -1;
        }
        this.lock.lock();
        this.handle = j;
        try {
            ...
            if (tTUploadDNSInfo != null) {
                ...
                TTUploadLog.m110631d("TTUploadDNSParserBridge", C2240a.m6772a("get result from cache expiredT:%d curT:%d ", new Object[]{Long.valueOf(tTUploadDNSInfo.mExpiredTime), Long.valueOf(currentTimeMillis)}));
                if (tTUploadDNSInfo.mExpiredTime <= currentTimeMillis) {
                    TTUploadLog.m110631d("TTUploadDNSParserBridge", C2240a.m6772a("has expired try call parse:", new Object[0]));
                ...
                TTUploadLog.m110631d("TTUploadDNSParserBridge", "****add host to parser");
    ...
    public void onCompletion(int i, String str, String str2, long j, String str3) {
        ...
        try {
            if (!this.isFinish) {
                TTUploadLog.m110631d("TTUploadDNSParserBridge", C2240a.m6772a("receive completion code:%d result:%s", new Object[]{Integer.valueOf(i), str2}));
                this.ipList = str2;
                this.isFinish = true;
                if (this.handle != 0) {
                ...
                TTUploadLog.m110631d("TTUploadDNSParserBridge", C2240a.m6772a("has finished not nedd cur completion code:%d result:%s expiredTime:%lld", new Object[]{Integer.valueOf(i), str2, Long.valueOf(j)}));
            }
        } finally {
            this.lock.unlock();
        }
