...
/* renamed from: com.ss.ttvideoengine.metrics.FirstFrameMetrics */
class FirstFrameMetrics implements IMediaMetrics {
    ...
    public void logMetric(VideoEvent videoEvent) {
        ...
        if (videoEvent != null) {
            long j2 = 0;
            if (videoEvent.tranFirstPacketT > 0) {
                j = videoEvent.tranFirstPacketT - videoEvent.prepare_start_time;
            } else {
                j = 0;
            }
            ...
            this.mFirstFrameRenderDuration = videoEvent.f128666vt - videoEvent.prepare_start_time;
            if (videoEvent.playbackBufferEndT > 0) {
                j2 = videoEvent.playbackBufferEndT - videoEvent.prepare_start_time;
            }
    ...
    public void logMetric(VideoEventOnePlay videoEventOnePlay) {
        ...
        if (videoEventOnePlay != null) {
            ...
            this.mFirstFrameRenderDuration = videoEventOnePlay.f128682vt - videoEventOnePlay.prepare_start_time;
