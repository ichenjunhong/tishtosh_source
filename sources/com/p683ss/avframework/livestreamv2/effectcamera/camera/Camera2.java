package com.p683ss.avframework.livestreamv2.effectcamera.camera;
...
import com.p683ss.avframework.livestreamv2.effectcamera.camera.IESCameraInterface.ZoomListener;
...
public class Camera2 implements IESCameraInterface {
    ...
    public CaptureCallback mSessionCaptureCallback = new CaptureCallback() {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            ...
            LogUtils.m109996e("Camera2", sb.toString(), new Object[0]);
        }

        public void onCaptureProgressed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureResult captureResult) {
            LogUtils.m109993d("Camera2", C2240a.m6772a("onCaptureProgressed: state[AE, AF, AWB] = [%d, %d, %d]", new Object[]{captureResult.get(CaptureResult.CONTROL_AE_STATE), captureResult.get(CaptureResult.CONTROL_AF_STATE), captureResult.get(CaptureResult.CONTROL_AWB_STATE)}), new Object[0]);
        }
    };
    public volatile int mSessionState = 0;
    private StateCallback mStateCallback = new StateCallback() {
        public void onDisconnected(CameraDevice cameraDevice) {
            LogUtils.m109993d("Camera2", "StateCallback::onDisconnected...", new Object[0]);
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            LogUtils.m109993d("Camera2", sb.toString(), new Object[0]);
    ...
    public void close() {
        LogUtils.m109993d("Camera2", "close...", new Object[0]);
    ...
    public void cancelAutoFocus() {
        if (this.mSessionState == 1) {
            LogUtils.m109993d("Camera2", "Camera is opening, ignore cancelAutoFocus operation.", new Object[0]);
    ...
    public void updatePreview() {
        LogUtils.m109993d("Camera2", "updatePreview", new Object[0]);
        if (this.mCameraDevice != null && this.mCaptureRequestBuilder != null) {
            try {
                ...
                LogUtils.m109993d("Camera2", "send capture request...", new Object[0]);
            } catch (CameraAccessException unused) {
                this.mSessionState = 0;
    ...
    public void init(CameraParams cameraParams) {
        if (cameraParams == null || !cameraParams.isValid()) {
            LogUtils.m109996e("Camera2", "Invalid CameraParams", new Object[0]);
            return;
        }
    ...
    public void startPreview(SurfaceTexture surfaceTexture) {
        ...
        if (this.mCameraDevice != null && surfaceTexture != null) {
            if (this.mSessionState != 1) {
                LogUtils.m109993d("Camera2", "preview is opening, ignore start operation.", new Object[0]);
                return;
            }
            String str = "Camera2";
            try {
                ...
                LogUtils.m109993d(str, sb2.toString(), new Object[0]);
                ...
                this.mCameraDevice.createCaptureSession(arrayList, new CameraCaptureSession.StateCallback() {
                    public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
                        LogUtils.m109993d("Camera2", "onConfigureFailed...", new Object[0]);
                        Camera2.this.mSessionState = 0;
                    }

                    public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        LogUtils.m109993d("Camera2", "onConfigured...", new Object[0]);
    ...
    public void changeCamera(int i, CameraListener cameraListener) {
        LogUtils.m109993d("Camera2", "changeCamera...", new Object[0]);
        if (this.mSessionState == 1) {
            LogUtils.m109993d("Camera2", "Camera is opening, ignore changeCamera operation.", new Object[0]);
            return;
        }
        close();
    ...
    private boolean isHardwareLevelSupported(CameraCharacteristics cameraCharacteristics, int i) {
        ...
        if (intValue < 0 || intValue > 3) {
            ...
            if (this.mDeviceHardwareSupportedLevel >= i) {
                ...
                LogUtils.m109999i("Camera2", sb2.toString(), new Object[0]);
                return true;
            }
            ...
            LogUtils.m109996e("Camera2", sb3.toString(), new Object[0]);
            return false;
        }
    }
    ...
    private Rect _calculateFocusRect(View view, float[] fArr, int i) {
        ...
        sb2.append("]");
        LogUtils.m109999i("onAreaTouchEvent", sb2.toString(), new Object[0]);
        float f6 = fArr[0];
        float f7 = fArr[1];
        ...
        if (rect2 == null) {
            LogUtils.m110005w("Camera2", "can't get crop region", new Object[0]);
            rect2 = rect;
        }
        ...
        sb3.append("]");
        LogUtils.m109993d("Camera2", sb3.toString(), new Object[0]);
        return rect3;
    }

    public boolean setFocusAreas(View view, float[] fArr, int i) {
        LogUtils.m109993d("Camera2", "setFocusAreas...", new Object[0]);
        if (this.mSessionState == 1) {
            LogUtils.m109993d("Camera2", "Camera is opening, ignore setFocusAreas operation.", new Object[0]);
            return false;
        } else if (this.mCaptureRequestBuilder == null || this.mCameraDevice == null || this.mCameraCaptureSession == null) {
            LogUtils.m109996e("Camera2", "Set focus failed, you must open camera first.", new Object[0]);
            return false;
        } else if (this.mManualFocusEngaged) {
            LogUtils.m110005w("Camera2", "Manual focus already engaged", new Object[0]);
            return true;
        } else {
            Rect _calculateFocusRect = _calculateFocusRect(view, fArr, i);
            C510446 r8 = new CaptureCallback() {
                public void onCaptureProgressed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureResult captureResult) {
                ...
                public void onCaptureCompleted(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, TotalCaptureResult totalCaptureResult) {
                    ...
                    if (num != null) {
                        ...
                        if (4 == num.intValue() || 5 == num.intValue()) {
                            LogUtils.m109999i("Camera2", "Capture focused!!", new Object[0]);
                        }
                    } else {
                        LogUtils.m110005w("Camera2", "afState is null", new Object[0]);
                    }
                    Camera2.this.mManualFocusEngaged = false;
            ...
            try {
                ...
                if (isMeteringAreaAFSupported()) {
                    ...
                    LogUtils.m110005w("Camera2", "do not support MeteringAreaAF!", new Object[0]);
                }
