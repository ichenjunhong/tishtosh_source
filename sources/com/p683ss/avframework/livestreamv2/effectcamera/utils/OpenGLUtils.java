...
public class OpenGLUtils {
    private static final String FAIL_RES = C2240a.m6773a(Locale.US, "{%s: false}", new Object[]{RES});
    ...
    public static void checkGlError(String str) {
        ...
        if (glGetError != 0) {
            ...
            LogUtils.m109996e("GLES", sb.toString(), new Object[0]);
        }
    }
    ...
    public static String loadTexture(String str) {
        ...
        return C2240a.m6773a(Locale.US, "{%s: true, %s: %d, %s: %d, %s: %d}", new Object[]{RES, WIDTH, Integer.valueOf(decodeFile.getWidth()), HEIGHT, Integer.valueOf(decodeFile.getHeight()), TEXTURE_ID, Integer.valueOf(loadTexture(decodeFile, -1, false))});
    }
    ...
    private static int loadShader(String str, int i) {
        ...
        LogUtils.m109996e("Load Shader Failed", sb.toString(), new Object[0]);
        return 0;
    }
    ...
    public static int loadProgram(String str, String str2) {
        ...
        if (loadShader == 0) {
            LogUtils.m109993d("Load Program", "Vertex Shader Failed", new Object[0]);
            return 0;
        }
        int loadShader2 = loadShader(str2, 35632);
        if (loadShader2 == 0) {
            LogUtils.m109993d("Load Program", "Fragment Shader Failed", new Object[0]);
            return 0;
        }
        ...
        if (iArr[0] <= 0) {
            LogUtils.m109993d("Load Program", "Linking Failed", new Object[0]);
            return 0;
        }
