package com.p683ss.avframework.livestreamv2.effectcamera.display;
...
import com.p683ss.avframework.livestreamv2.effectcamera.camera.IESCameraProxy;
import com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.StateListener;
import com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType;
import com.p683ss.avframework.livestreamv2.effectcamera.model.BeautyBean;
import com.p683ss.avframework.livestreamv2.effectcamera.model.ComposerNodes;
import com.p683ss.avframework.livestreamv2.effectcamera.model.EffectBean;
import com.p683ss.avframework.livestreamv2.effectcamera.model.FilterBean;
import com.p683ss.avframework.livestreamv2.effectcamera.model.ReshapeFaceBean;
import com.p683ss.avframework.livestreamv2.effectcamera.render.EffectCallback;
import com.p683ss.avframework.livestreamv2.effectcamera.render.EffectRender;
import com.p683ss.avframework.livestreamv2.effectcamera.render.EffectRender.OnMicrophoneDetectResultListener;
import com.p683ss.avframework.livestreamv2.effectcamera.render.EffectRender.OnRefreshFaceDataListener;
import com.p683ss.avframework.livestreamv2.effectcamera.render.EffectRender.Rotation;
import com.p683ss.avframework.livestreamv2.effectcamera.render.FrameRender;
import com.p683ss.avframework.livestreamv2.effectcamera.render.FrameRender.GLCallback;
import com.p683ss.avframework.livestreamv2.effectcamera.render.IAudioPlayer.IFactory;
import com.p683ss.avframework.livestreamv2.effectcamera.utils.Accelerometer;
import com.p683ss.avframework.livestreamv2.effectcamera.utils.LogUtils;
...
public class CameraDisplay2 {
    ...
    public OnFrameAvailableListener mOnFrameAvailableListener = new OnFrameAvailableListener() {
        public void onFrameAvailable(SurfaceTexture surfaceTexture) {
            ...
            AVLog.logToIODevice2(4, str, sb.toString(), null, "CameraDisplay2.java:onFrameAvailable:1", 10000);
    ...
    public void onPause() {
        LogUtils.m109999i(this.TAG, "onPause", new Object[0]);
    }

    public void onResume() {
        LogUtils.m109999i(this.TAG, "onResume", new Object[0]);
    }
    ...
    public void deleteTextures() {
        LogUtils.m109999i(this.TAG, "delete textures", new Object[0]);
    ...
    public int changeCamera() {
        ...
        L_0x004c:
            ...
            com.ss.avframework.livestreamv2.effectcamera.common.TCState$TCStateType r1 = com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType.PreProcessFail     // Catch:{ all -> 0x0092 }
        ...
        L_0x007e:
            ...
            return r2
        L_0x0087:
            com.ss.avframework.livestreamv2.effectcamera.common.TCState$TCStateType r1 = com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType.CameraOpenFail     // Catch:{ all -> 0x0092 }
        ...
        L_0x0092:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.changeCamera():int");
    }
    ...
    public void enableMockFace(boolean z) {
        ...
        if (i != 0) {
            ...
            sb.append(i);
            LogUtils.m109996e(str, sb.toString(), new Object[0]);
        }
    }
    ...
    public void setEffect(String str, boolean z) {
        ...
        sb.append(str);
        LogUtils.m109993d(str2, sb.toString(), new Object[0]);
        ...
        if (this.mEffectRender != null) {
            ...
            if (effect != 0) {
                ...
                sb2.append(") failed: ");
                sb2.append(effect);
                LogUtils.m109996e(str3, sb2.toString(), new Object[0]);
            }
        }
    }
    ...
    public int setFilter(String str, float f) {
        ...
        sb.append(str);
        LogUtils.m109999i(str2, sb.toString(), new Object[0]);
        if (TextUtils.isEmpty(str)) {
            str = "";
        }
    ...
    public void setCustomEffect(String str, String str2, boolean z) {
        ...
        sb.append(str2);
        LogUtils.m109993d(str3, sb.toString(), new Object[0]);
    ...
    public int setFilter(String str, String str2, float f) {
        ...
        sb.append("position: ");
        sb.append(f);
        LogUtils.m109999i(str3, sb.toString(), new Object[0]);
        ...
        this.mFrameRender.setGLCallback(new GLCallback() {
            ...
            public void onOpenGLCreate() {
                /*
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r1 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    javax.microedition.khronos.egl.EGLContext r0 = r0.eglGetCurrentContext()
                    r1.mEglContext = r0
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r0 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    int r0 = r0.mTextureId
                    r1 = -1
                    if (r0 != r1) goto L_0x0048
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r0 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    int r2 = com.p683ss.avframework.livestreamv2.effectcamera.utils.OpenGLUtils.getExternalOESTextureID()
                    r0.mTextureId = r2
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r0 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    android.graphics.SurfaceTexture r2 = new android.graphics.SurfaceTexture
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r3 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                ...
                L_0x0048:
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r4 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    com.ss.avframework.livestreamv2.effectcamera.model.EffectBean r4 = r4.mCurEffectBean
                    java.lang.String r4 = r4.getResPath()
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r5 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                ...
                L_0x00bd:
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r6 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                ...
                L_0x016f:
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.model.ComposerNodes$ComposerNode r3 = (com.p683ss.avframework.livestreamv2.effectcamera.model.ComposerNodes.ComposerNode) r3
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r4 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                ...
                L_0x018f:
                    ...
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    com.ss.avframework.livestreamv2.effectcamera.common.TCState$TCStateType r3 = com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType.EffectInitSucceed
                    java.lang.String r4 = "Init Succeed"
                    r2.pushInfo(r3, r0, r4)
                    goto L_0x01ec
                L_0x01e3:
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this
                    com.ss.avframework.livestreamv2.effectcamera.common.TCState$TCStateType r3 = com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType.EffectInitFail
                ...
                L_0x01ec:
                    ...
                    monitor-enter(r0)
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ all -> 0x021a }
                    com.ss.avframework.livestreamv2.effectcamera.camera.IESCameraProxy r2 = r2.mCameraProxy     // Catch:{ all -> 0x021a }
                    if (r2 == 0) goto L_0x0218
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ Exception -> 0x0203 }
                    com.ss.avframework.livestreamv2.effectcamera.camera.IESCameraProxy r2 = r2.mCameraProxy     // Catch:{ Exception -> 0x0203 }
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r3 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ Exception -> 0x0203 }
                    android.graphics.SurfaceTexture r3 = r3.mSurfaceTexture     // Catch:{ Exception -> 0x0203 }
                    r2.startPreview(r3)     // Catch:{ Exception -> 0x0203 }
                    goto L_0x020c
                L_0x0203:
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ all -> 0x021a }
                    com.ss.avframework.livestreamv2.effectcamera.common.TCState$TCStateType r3 = com.p683ss.avframework.livestreamv2.effectcamera.common.TCState.TCStateType.PreProcessFail     // Catch:{ all -> 0x021a }
                    java.lang.String r4 = "startPreview failed"
                    r2.pushError(r3, r1, r4)     // Catch:{ all -> 0x021a }
                L_0x020c:
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r1 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ all -> 0x021a }
                    com.ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2 r2 = com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.this     // Catch:{ all -> 0x021a }
                    com.ss.avframework.livestreamv2.effectcamera.camera.IESCameraProxy r2 = r2.mCameraProxy     // Catch:{ all -> 0x021a }
                ...
                L_0x021a:
                    ...
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.C510582.onOpenGLCreate():void");
            }
            ...
            public void onFrameAvailable(int i, long j, Bundle bundle) {
                synchronized (this) {
                    if (CameraDisplay2.this.mFrameListener != null) {
                        ...
                        sb.append(", timestamp ");
                        sb.append(j);
                        AVLog.logToIODevice2(4, str, sb.toString(), null, "CameraDisplay2.java:onFrameAvailable:2", 10000);
