...
import com.p683ss.avframework.livestreamv2.effectcamera.camera.AbsIESCameraProxy;
import com.p683ss.avframework.livestreamv2.effectcamera.camera.CameraListener;
import com.p683ss.avframework.livestreamv2.effectcamera.camera.CameraParams;
import com.p683ss.avframework.livestreamv2.effectcamera.camera.IESCamera2Proxy;
import com.p683ss.avframework.livestreamv2.effectcamera.camera.IESCameraProxy;
import com.p683ss.avframework.livestreamv2.effectcamera.common.IESEGLContextFactory;
import com.p683ss.avframework.livestreamv2.effectcamera.common.IESEGLContextFactory.IESEGLContextStateListener;
...
import com.p683ss.avframework.livestreamv2.effectcamera.model.ComposerNodes.ComposerNode;
...
import com.p683ss.avframework.livestreamv2.effectcamera.render.PreRender;
...
public class CameraDisplay implements Renderer {
    ...
    public void onPause() {
        ...
        LogUtils.m109993d(this.TAG, "Release camera", new Object[0]);
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        LogUtils.m109999i(this.TAG, "onSurfaceCreated", new Object[0]);
        if (!this.mIsPaused) {
            if (this.mTextureId == -1) {
    ...
    public void onSurfaceChanged(GL10 gl10, int i, int i2) {
        LogUtils.m109999i(this.TAG, "onSurfaceChanged", new Object[0]);
        if (!this.mIsPaused) {
            adjustViewPort(i, i2);
            this.mStartTime = System.currentTimeMillis();
        }
