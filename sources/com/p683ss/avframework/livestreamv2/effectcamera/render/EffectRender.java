package com.p683ss.avframework.livestreamv2.effectcamera.render;
...
public class EffectRender {
    ...
    public int setCameraPosition(CameraPosition cameraPosition) {
        ...
        return nativeSetCameraPosition(this.mNativePtr, cameraPosition.f127772id);
    }
    ...
    public int setFaceBeauty(String str, float f, float f2, float f3) {
        ...
        if (nativeSetFaceBeauty != 0) {
            ...
            LogUtils.m109996e("EffectRender", sb.toString(), new Object[0]);
        }
    ...
    public int process(int i, int i2, int i3, int i4, Rotation rotation, double d) {
        ...
        return nativeProcess(this.mNativePtr, i, i2, rotation.f127773id, d);
    }
