...
import com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2;
import com.p683ss.avframework.livestreamv2.effectcamera.display.CameraDisplay2.FrameListener;
...
public class EffectCameraWrapperImpl extends EffectCameraWrapper implements Callback, StateListener, FrameListener {
    public static final String TAG = "com.ss.avframework.livestreamv2.core.EffectCameraWrapperImpl";
    ...
    public void setABInfoToEffect(JSONObject jSONObject) {
    }
        ...
        this.mWorkHandler.post(new Runnable() {
            public void run() {
                if (EffectCameraWrapperImpl.this.mStatus == 4) {
                    AVLog.m110008e(EffectCameraWrapperImpl.TAG, "Status exception at startCapture");
