package com.p683ss.avframework.livestreamv2.capture;
...
import com.p683ss.avframework.capture.video.ExternalVideoCapturer;
import com.p683ss.avframework.capture.video.VideoCapturer.VideoCapturerObserver;
...
import com.p683ss.avframework.utils.ThreadUtils.ThreadChecker;
import java.lang.ref.WeakReference;

/* renamed from: com.ss.avframework.livestreamv2.capture.CameraVideoCapturer */
public class CameraVideoCapturer extends ExternalVideoCapturer implements C20209a, IVideoCapturerControl {
    private int mCameraCaptureHeight;
    private int mCameraCaptureWidth;
    private C20208g mCapture;
    ...
    class CameraObserver implements C20209a {
        private WeakReference<C20209a> mCameraObserverWeakReference;

        public void onCaptureStopped(int i) {
            if (this.mCameraObserverWeakReference.get() != null) {
                ((C20209a) this.mCameraObserverWeakReference.get()).onCaptureStopped(i);
            }
        }

        public CameraObserver(WeakReference<C20209a> weakReference) {
            this.mCameraObserverWeakReference = weakReference;
        }

        public void onCaptureStarted(int i, int i2) {
            if (this.mCameraObserverWeakReference.get() != null) {
                ((C20209a) this.mCameraObserverWeakReference.get()).onCaptureStarted(i, i2);
            }
        }

        public void onError(int i, String str) {
            if (this.mCameraObserverWeakReference.get() != null) {
                ((C20209a) this.mCameraObserverWeakReference.get()).onError(i, str);
            }
        }

        public void onInfo(int i, int i2, String str) {
            if (this.mCameraObserverWeakReference.get() != null) {
                ((C20209a) this.mCameraObserverWeakReference.get()).onInfo(i, i2, str);
            }
        }
    }
    ...
    public void cancelAudioFocus() {
        if (this.mCapture != null) {
            try {
                C20241k.INSTANCE.cancelFocus(this.mCapture);
    ...
    public Range getExposureCompensationRange() {
        if (this.mCapture != null) {
            C20276a cameraECInfo = C20241k.INSTANCE.getCameraECInfo(this.mCapture);
            if (cameraECInfo != null) {
                Range range = new Range();
                range.max = (float) cameraECInfo.f55745a;
                range.min = (float) cameraECInfo.f55747c;
                return range;
            }
        }
        return null;
    ...
    public void switchCamera() {
        try {
            ...
            this.mFront = i;
            C20241k.INSTANCE.switchCamera(this.mCapture, this.mFront);
        } catch (Throwable unused) {
            this.mHandler.post(new Runnable() {
                public void run() {
    ...
    public void tryDeliverFrame() {
        ...
        if (this.mStatus != 1 || !this.mNewTexture || !this.mBufferAlreadyReturn) {
            ...
            sb5.append(sb2);
            AVLog.logToIODevice2(5, "CameraVideoCapturer", sb4, null, sb5.toString(), 10000);
            return;
        }
    ...
    public int setExposureCompensation(float f) {
        ...
        if (exposureCompensationRange != null && ((f <= exposureCompensationRange.max || f >= exposureCompensationRange.min) && this.mCapture != null)) {
            try {
                ...
                C20241k.INSTANCE.setExposureCompensation(this.mCapture, (int) f);
    ...
    public int toggleFlashLight(boolean z) {
        ...
        if (this.mCapture != null) {
            try {
                ...
                C20241k.INSTANCE.toggleTorch(this.mCapture, z);
                postAndWait(this.mHandler, 1000, new Runnable() {
                    public void run() {
                        int i;
                        int[] iArr = iArr;
                ...
                if (CameraVideoCapturer.this.mOesTex > 0 && glRenderDrawer != null && glTextureFrameBuffer != null && glTextureFrameBuffer.getFrameBufferId() > 0) {
                    if (!(glTextureFrameBuffer.getWidth() == CameraVideoCapturer.this.mOutWidth && glTextureFrameBuffer.getHeight() == CameraVideoCapturer.this.mOutHeight)) {
                        try {
                            ...
                            AVLog.m110008e("CameraVideoCapturer", sb.toString());
                            return;
                        }
                    }
    ...
    public void onCaptureStarted(final int r11, int r12) {
        /*
            ...
            com.p683ss.avframework.utils.AVLog.iow(r11, r12)
            return
        L_0x000c:
        ...
        L_0x003b:
            ...
            com.p683ss.avframework.utils.AVLog.ioi(r11, r0)
        ...
        L_0x0051:
            ...
            com.ss.android.ttvecamera.g.c$a r12 = new com.ss.android.ttvecamera.g.c$a     // Catch:{ all -> 0x009c }
            ...
            com.ss.android.ttvecamera.g r2 = r10.mCapture     // Catch:{ all -> 0x009c }
            r2.mo42790a(r12)     // Catch:{ all -> 0x009c }
            com.ss.android.ttvecamera.g r12 = r10.mCapture     // Catch:{ Exception -> 0x0080 }
            int r12 = r12.mo42792b()     // Catch:{ Exception -> 0x0080 }
            goto L_0x0086
        L_0x0080:
            r11 = move-exception
            r12 = -1
        ...
        L_0x00a5:
            ...
            r0.<init>(r11)
            com.p683ss.avframework.utils.ThreadUtils.invokeAtFrontUninterruptibly(r12, r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.capture.CameraVideoCapturer.onCaptureStarted(int, int):void");
    }
    ...
    private boolean postAndWait(android.os.Handler r5, long r6, final java.lang.Runnable r8) {
        ...
        L_0x002b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.capture.CameraVideoCapturer.postAndWait(android.os.Handler, long, java.lang.Runnable):boolean");
    }
    ...
    public void start(int i, int i2, int i3) {
        ...
        synchronized (this.mObject) {
            if (this.mCapture != null) {
                ...
                C20275l lVar = new C20275l(context, i4, this.mCameraCaptureWidth, this.mCameraCaptureHeight);
                lVar.f55723e = this.mFront;
                lVar.f55736r = 0;
                lVar.f55743y = false;
                lVar.f55737s.putBoolean("enableFrontFacingVideoContinueFocus", true);
                int a = this.mCapture.mo42791a(lVar);
                if (a != 0) {
    ...
    public int setFocusAreas(int i, int i2, int i3, int i4) {
        ...
        if (this.mCapture != null) {
            try {
                ...
                this.mCapture.mo42789a(i, i2, 0.15f, i3, i4);
    ...
    public CameraVideoCapturer(Handler handler, boolean z, VideoCapturerObserver videoCapturerObserver, Context context, boolean z2) {
        ...
        this.mCapture = new C20208g(new CameraObserver(new WeakReference(this)));
        this.mFront = z ? 1 : 0;
        ...
        this.mDisplayRotation = C20285m.m50044a(this.mContext);
