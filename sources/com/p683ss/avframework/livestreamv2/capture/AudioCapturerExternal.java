...
public class AudioCapturerExternal extends AudioCapturer {
    ...
    /* renamed from: m */
    private int f127770m;
    private com.p683ss.avframework.capture.audio.AudioCapturer.AudioCaptureObserver mAudioCaptureObserver;
    ...
    public AudioCapturerExternal(int i, int i2, int i3, Handler handler, com.p683ss.avframework.capture.audio.AudioCapturer.AudioCaptureObserver audioCaptureObserver) {
