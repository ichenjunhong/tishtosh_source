...
import com.p683ss.avframework.capture.audio.AudioCapturer.AudioCaptureObserver;
import com.p683ss.avframework.capture.audio.AudioCapturerAudioRecord;
import com.p683ss.avframework.capture.audio.AudioCapturerOpensles;
import com.p683ss.avframework.codec.DefaultVideoEncoderFactory;
import com.p683ss.avframework.effect.IVideoEffectProcessor;
import com.p683ss.avframework.engine.AudioDeviceModule;
import com.p683ss.avframework.engine.AudioSource.PowerObserver;
import com.p683ss.avframework.engine.AudioTrack;
import com.p683ss.avframework.engine.MediaEncodeStream;
import com.p683ss.avframework.engine.MediaEncodeStream.Observer;
import com.p683ss.avframework.engine.MediaEngineFactory;
import com.p683ss.avframework.engine.MediaTrack;
import com.p683ss.avframework.engine.Transport;
import com.p683ss.avframework.engine.Transport.EventObserver;
import com.p683ss.avframework.engine.VideoEncoderFactory;
import com.p683ss.avframework.engine.VideoSink;
import com.p683ss.avframework.engine.VideoTrack;
...
import com.p683ss.avframework.livestreamv2.capture.LiveStreamAudioCapture;
...
import com.p683ss.avframework.livestreamv2.filter.FilterManager;
import com.p683ss.avframework.livestreamv2.filter.FilterManager.EffectInputAudioStream;
import com.p683ss.avframework.livestreamv2.filter.FilterManager.InputAudioStreamObserver;
...
import com.p683ss.avframework.livestreamv2.filter.LiveCoreKaraokFilter;
...
import com.p683ss.avframework.livestreamv2.recorder.IRecorderManager.Config;
import com.p683ss.avframework.livestreamv2.recorder.IRecorderManager.IRecorderListener;
import com.p683ss.avframework.livestreamv2.recorder.RecorderManager;
...
import com.p683ss.avframework.transport.LibRTMPTransport;
...
public class LiveStream implements AudioCaptureObserver, PowerObserver, Observer, EventObserver, ILiveStream, LiveStreamVideoCapture.Observer {
    ...
    public IAudioFrameAvailableListener mExternalAudioFrameListener;
        ...
        return new IInputAudioStream() {
            ...
            public String name() {
                if (LiveStream.this.mAudioTrack != null) {
                    return LiveStream.this.mAudioTrack.mo99896id();
                }
                return "";
            }
        ...
        return new IInputVideoStream() {
            ...
            public String name() {
                if (LiveStream.this.mVideoTrack != null) {
                    return LiveStream.this.mVideoTrack.mo99896id();
                }
                return "";
            }
    ...
    public void onRtmpSendTooSlow() {
        AVLog.m110007d("LiveStream", "Net is too weak.");
    }
    ...
    public void addTrackToEncodeStream() {
        if (!(this.mMediaEncodeStream == null || this.mVideoTrack == null)) {
            ...
            this.mMediaEncodeStream.setOriginVideoTrack(this.mVideoTrack.mo99896id());
            addStreamsToEncodeStream(true);
            this.mMediaEncodeStream.setVideoMixerDescription(this.mVideoTrack.mo99896id(), this.mOriginVideoStreamDescription);
        }
        if (!(this.mMediaEncodeStream == null || this.mAudioTrack == null)) {
            this.mMediaEncodeStream.removeTrack(this.mAudioTrack);
            removeStreamsFromEncodeStream(false);
            this.mMediaEncodeStream.addTrack(this.mAudioTrack);
            this.mMediaEncodeStream.setOriginAudioTrack(this.mAudioTrack.mo99896id());
            addStreamsToEncodeStream(false);
            this.mMediaEncodeStream.setAudioMixerDescription(this.mAudioTrack.mo99896id(), this.mOriginAudioStreamDescription);
            if (this.mAudioCapture != null) {
    ...
    public void onReleaseSafe() {
        ...
        if (this.mFilterManager != null) {
            if (this.mFilterManager instanceof FilterManager) {
                if (this.mAudioFrameAvailableSink != null) {
                    this.mAudioFrameAvailableSink.removeListener((FilterManager) this.mFilterManager);
                }
        ...
        while (true) {
            if (this.mAvailableVideoEncoders == null) {
                ...
                if (GetSupportedFormats != null) {
                    ...
                    AVLog.m110007d("LiveStream", sb.toString());
    ...
    private void creatVideoTrack() {
        ...
        if (this.mVideoCapturer != null) {
            ...
            if ((this.mFilterManager instanceof FilterManager) && !this.mEffectInited) {
                FilterManager filterManager = (FilterManager) this.mFilterManager;
    ...
    public void doBackgroundPause() {
        ...
        if (this.mLiveStreamBuilder == null) {
            ...
            i = this.mLiveStreamBuilder.getBgMode();
        }
        sb.append(i);
        sb.append(", status ");
        ...
        if (this.mAudioFilterManager != null && (this.mAudioFilterManager instanceof LiveCoreKaraokFilter)) {
            ((LiveCoreKaraokFilter) this.mAudioFilterManager).onPause();
        }
        if (this.mStatus.get() != 7 && liveStreamBuilder != null) {
            ...
            } else if (!(this.mAudioCapture == null || !(this.mAudioCapture instanceof LiveStreamAudioCapture) || this.mLiveStreamBuilder.getBgMode() == 1)) {
    ...
    public void doBackgroundResume() {
        ...
        if (this.mStatus.get() != 7 && liveStreamBuilder != null) {
            ...
            if (this.mAudioFilterManager != null && (this.mAudioFilterManager instanceof LiveCoreKaraokFilter)) {
                ((LiveCoreKaraokFilter) this.mAudioFilterManager).onResume();
            }
        }
    }
    ...
    public synchronized void release() {
        /*
            r7 = this;
            monitor-enter(r7)
            r7.stopCaptureSource()     // Catch:{ all -> 0x00d2 }
            r7.stopRecord()     // Catch:{ all -> 0x00d2 }
            r7.stop()     // Catch:{ all -> 0x00d2 }
            r0 = 1
            boolean[] r1 = new boolean[r0]     // Catch:{ all -> 0x00d2 }
            r2 = 0
            r1[r2] = r0     // Catch:{ all -> 0x00d2 }
            java.util.concurrent.atomic.AtomicInteger r0 = r7.mStatus     // Catch:{ all -> 0x00d2 }
            int r0 = r0.get()     // Catch:{ all -> 0x00d2 }
            r3 = 7
            if (r0 == r3) goto L_0x006d
            android.os.Handler r0 = r7.mWorkThreadHandler     // Catch:{ all -> 0x00d2 }
            com.ss.avframework.livestreamv2.LiveStream$15 r4 = new com.ss.avframework.livestreamv2.LiveStream$15     // Catch:{ all -> 0x00d2 }
            r4.<init>(r1)     // Catch:{ all -> 0x00d2 }
            r0.post(r4)     // Catch:{ all -> 0x00d2 }
            java.lang.Object r0 = r7.mReleaseFence     // Catch:{ all -> 0x00d2 }
            monitor-enter(r0)     // Catch:{ all -> 0x00d2 }
            java.lang.Object r4 = r7.mReleaseFence     // Catch:{ Throwable -> 0x0069 }
            r5 = 3000(0xbb8, double:1.482E-320)
            r4.wait(r5)     // Catch:{ Throwable -> 0x0069 }
            boolean r4 = r1[r2]     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x0069
            java.lang.String r4 = "LiveStream"
            java.lang.String r5 = "Waiting work thread timeout with dump thread stack:"
            com.p683ss.avframework.utils.AVLog.iow(r4, r5)     // Catch:{ Throwable -> 0x0069 }
            android.os.Handler r4 = r7.mWorkThreadHandler     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x004f
            android.os.Handler r4 = r7.mWorkThreadHandler     // Catch:{ Throwable -> 0x0069 }
            android.os.Looper r4 = r4.getLooper()     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x004f
            java.lang.Thread r4 = r4.getThread()     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x004f
            java.lang.String r5 = "LiveStream"
            dumpJavaThreadStackIfNeed(r4, r5)     // Catch:{ Throwable -> 0x0069 }
        L_0x004f:
            android.os.Handler r4 = r7.mVideoCaptureHandler     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x0069
            android.os.Handler r4 = r7.mVideoCaptureHandler     // Catch:{ Throwable -> 0x0069 }
            android.os.Looper r4 = r4.getLooper()     // Catch:{ Throwable -> 0x0069 }
            if (r4 == 0) goto L_0x0069
        ...
        L_0x006d:
            java.util.concurrent.atomic.AtomicInteger r0 = r7.mStatus     // Catch:{ all -> 0x00d2 }
            r0.set(r3)     // Catch:{ all -> 0x00d2 }
            boolean r0 = r1[r2]     // Catch:{ all -> 0x00d2 }
            if (r0 == 0) goto L_0x008f
            com.ss.avframework.capture.audio.AudioCapturer r0 = r7.mAudioCapture     // Catch:{ all -> 0x00d2 }
            if (r0 == 0) goto L_0x007f
            com.ss.avframework.capture.audio.AudioCapturer r0 = r7.mAudioCapture     // Catch:{ all -> 0x00d2 }
            r0.stop()     // Catch:{ all -> 0x00d2 }
        L_0x007f:
            com.ss.avframework.livestreamv2.capture.LiveStreamVideoCapture r0 = r7.mVideoCapturer     // Catch:{ all -> 0x00d2 }
        ...
        L_0x0088:
            ...
            com.p683ss.avframework.utils.AVLog.iow(r0, r1)     // Catch:{ all -> 0x00d2 }
        L_0x008f:
            com.ss.avframework.livestreamv2.log.LiveStreamLogService r0 = r7.mStreamLogService     // Catch:{ all -> 0x00d2 }
            r0.close()     // Catch:{ all -> 0x00d2 }
            int r0 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x00d2 }
            r1 = 18
            if (r0 < r1) goto L_0x00aa
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x00d2 }
            if (r0 == 0) goto L_0x00b3
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ Throwable -> 0x00a4 }
            r0.quitSafely()     // Catch:{ Throwable -> 0x00a4 }
            goto L_0x00b3
        L_0x00a4:
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x00d2 }
            r0.quit()     // Catch:{ all -> 0x00d2 }
            goto L_0x00b3
        L_0x00aa:
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x00d2 }
            if (r0 == 0) goto L_0x00b3
        ...
        L_0x00b3:
            r0 = 0
            r7.workThread = r0     // Catch:{ all -> 0x00d2 }
            android.os.HandlerThread r1 = r7.dataNotifyThread     // Catch:{ all -> 0x00d2 }
            r1.quit()     // Catch:{ all -> 0x00d2 }
            r7.dataNotifyThread = r0     // Catch:{ all -> 0x00d2 }
            com.ss.avframework.livestreamv2.LiveStream$16 r0 = new com.ss.avframework.livestreamv2.LiveStream$16     // Catch:{ all -> 0x00d2 }
            r0.<init>()     // Catch:{ all -> 0x00d2 }
            r7.mInfoListener = r0     // Catch:{ all -> 0x00d2 }
            com.ss.avframework.livestreamv2.LiveStream$17 r0 = new com.ss.avframework.livestreamv2.LiveStream$17     // Catch:{ all -> 0x00d2 }
            r0.<init>()     // Catch:{ all -> 0x00d2 }
            r7.mErrorListener = r0     // Catch:{ all -> 0x00d2 }
            com.ss.avframework.livestreamv2.LiveStreamBuilder r0 = r7.mLiveStreamBuilder     // Catch:{ all -> 0x00d2 }
            r0.releaseHandles()     // Catch:{ all -> 0x00d2 }
            monitor-exit(r7)
            return
        L_0x00d2:
            r0 = move-exception
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.LiveStream.release():void");
    }
    ...
    private void setupParameter() {
        ...
        if (this.mRTMPTransport != null) {
            AVLog.m110007d("LiveStream", "Dump default rtmp config:");
            ...
            AVLog.m110007d("LiveStream", "Dump update rtmp config:");
            this.mTransportOpt.dump();
        }
        if (this.mEncodeStreamOpt != null) {
    ...
    public void setDns(final C51201e eVar) {
        if (this.mWorkThreadHandler != null) {
            this.mWorkThreadHandler.post(new Runnable() {
                public void run() {
                    boolean z;
            ...
            this.mWorkThreadHandler.post(new Runnable() {
                public void run() {
                    if (LiveStream.this.mStatus.get() != 7) {
                        ...
                        if (LiveStream.this.mTextureFrameAvailableSink == null) {
                            LiveStream.this.setupTextureFrameAvailableListener(new TextureFrameAvailableSink(LiveStream.this.mLiveStreamBuilder.getVideoWidth(), LiveStream.this.mLiveStreamBuilder.getVideoHeight()));
                        }
    ...
    private int getCurrentCaptureDevice(boolean z) {
        ...
        if (audioCapturer != null) {
            if (audioCapturer instanceof LiveStreamAudioCapture) {
                i = ((LiveStreamAudioCapture) audioCapturer).getCurrentCaptureDevice();
            } else if (audioCapturer instanceof AudioCapturerOpensles) {
                i = 2;
            } else if (audioCapturer instanceof AudioCapturerAudioRecord) {
                i = 1;
            }
        }
        return i;
    ...
    public void changeBitrateForInteractMode(boolean z) {
        int videoClientMixerBitrate = this.mLiveStreamBuilder.getVideoClientMixerBitrate();
        int videoClientMixerMinBitrate = this.mLiveStreamBuilder.getVideoClientMixerMinBitrate();
        int videoClientMixerMaxBitrate = this.mLiveStreamBuilder.getVideoClientMixerMaxBitrate();
        int videoBitrate = this.mLiveStreamBuilder.getVideoBitrate();
        ...
        if (videoMinBitrate != videoClientMixerMinBitrate || videoMaxBitrate != videoClientMixerMaxBitrate || videoBitrate != videoClientMixerBitrate) {
            if (z) {
                updateClientMixerBitrate(videoClientMixerBitrate, videoClientMixerMinBitrate, videoClientMixerMaxBitrate, z);
            } else {
                updateClientMixerBitrate(videoBitrate, videoMinBitrate, videoMaxBitrate, z);
            }
        }
    }
    ...
    public boolean getLiveStreamInfo(LiveStreamReport liveStreamReport) {
        ...
        if (!z) {
            AVLog.m110011w("LiveStream", "Maybe be stream will be release.");
            return false;
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.lang.String[] getOptUrlAndEvaluateSymbol(com.p683ss.p2549c.p2550a.p2551a.p2554b.C51201e r13, java.lang.String r14) {
        /*
            r12 = this;
        ...
        L_0x0040:
            ...
            java.lang.String r3 = com.p683ss.p2549c.p2550a.p2551a.p2554b.C51199c.m110107a(r2, r13)
            boolean r5 = android.text.TextUtils.isEmpty(r3)
            if (r5 != 0) goto L_0x0093
            java.lang.String r13 = r13.mo101716a(r2, r3)
            r0[r9] = r13
        ...
        L_0x0093:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.LiveStream.getOptUrlAndEvaluateSymbol(com.ss.c.a.a.b.e, java.lang.String):java.lang.String[]");
    }
    ...
    private boolean shouldReconnectWitchCurrentUrl(int i, int i2, long j) {
        ...
        if (isUsingOptimizedUrl()) {
            ...
            if ((!this.mEnableUrlFallBack || this.mUris.size() <= 1 || this.mUriReachable != 0) && this.mRtmpReConnectCounts < this.mLiveStreamBuilder.getRtmpReconnectCounts()) {
                return true;
            }
            return false;
        }
    ...
    public void onRtmpFailed(int i, int i2, long j) {
        if (this.mStatus.get() != 8) {
            ...
            if (liveStreamBuilder != null) {
                ...
                if (this.mUris != null) {
                    boolean z = true;
                    if (this.mUris.size() > 1 && this.mEnableUrlFallBack) {
                        this.mUris.remove(0);
                        this.mUriReachable = -1;
                        this.mOptUrlReachable = -1;
                        this.mFirstConnect = true;
    ...
    private void updateClientMixerBitrate(int i, int i2, int i3, boolean z) {
        Handler handler = this.mWorkThreadHandler;
        final int i4 = i3;
        final int i5 = i2;
        final int i6 = i;
        final boolean z2 = z;
        C5090518 r1 = new Runnable() {
            public void run() {
                if (LiveStream.this.mRTMPTransport != null && LiveStream.this.mTransportOpt != null) {
                    LiveStream.this.mTransportOpt.setLong("rtmp_max_video_bitrate", (long) i4);
                    LiveStream.this.mTransportOpt.setLong("rtmp_min_video_bitrate", (long) i5);
                    LiveStream.this.mTransportOpt.setLong("rtmp_init_video_bitrate", (long) i6);
                    LiveStream.this.mRTMPTransport.setParameter(LiveStream.this.mTransportOpt);
                    LiveStream.this.mStreamLogService.onClientMixerBitrateAdjust(i6, i5, i4, z2);
                }
            }
        };
        handler.post(r1);
                    ...
                    if (LiveStream.this.mStatus.get() != 7 && LiveStream.this.mStatus.get() != 8) {
                        ...
                        switch (i3) {
                            ...
                            case 1:
                                ...
                                sb.append(j5);
                                AVLog.ioi("LiveStream", sb.toString());
                                LiveStream.this.mStreamLogService.onRTMPEnd(200, LiveStream.this.mRtmpReConnectCounts, LiveStream.this.mFirstConnect, str2, j5);
                            ...
                            case 9:
                                ...
                                break;
                            case 10:
                                StringBuilder sb8 = new StringBuilder("Rtmp connecting failed: error code ");
                                sb8.append(i4);
                                AVLog.ioe("LiveStream", sb8.toString());
                                LiveStream.this.onRtmpFailed(i3, i4, j2);
                                return;
                        }
                    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int addSeiField(java.lang.String r11, java.lang.Object r12, int r13, boolean r14, boolean r15) {
        /*
            r10 = this;
            com.ss.avframework.engine.VideoTrack r0 = r10.mVideoTrack
            if (r14 != 0) goto L_0x0015
            if (r0 == 0) goto L_0x0015
            com.ss.avframework.engine.VsyncModule r1 = r10.getEncodeStreamVsyncModule()
            if (r1 == 0) goto L_0x0015
            java.lang.String r0 = r0.mo99896id()
            long r0 = r1.lastTimeMills(r0)
            goto L_0x0017
        L_0x0015:
            r0 = 0
        L_0x0017:
            r6 = r0
            com.ss.avframework.engine.Transport r0 = r10.mRTMPTransport
            if (r0 == 0) goto L_0x0028
            com.ss.avframework.engine.Transport r2 = r10.mRTMPTransport
            r3 = r11
            r4 = r12
            r5 = r13
            r8 = r14
            r9 = r15
            int r11 = r2.addSeiField(r3, r4, r5, r6, r8, r9)
            return r11
        L_0x0028:
            r11 = -1
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.LiveStream.addSeiField(java.lang.String, java.lang.Object, int, boolean, boolean):int");
    }
    ...
    public void vsyncEvent(VsyncModule vsyncModule, int i, int i2, long j, String str) {
        ...
        switch (i3) {
            case 100:
                ...
                AVLog.logToIODevice2(5, "LiveStream", sb2.toString(), null, "LiveStream.java:vsyncEvent:2", 10000);
                VsyncModule vsyncModule2 = vsyncModule;
            ...
            case BaseNotice.HASHTAG /*101*/:
                ...
                sb3.append(str2);
                sb3.append(")");
                AVLog.logToIODevice2(5, "LiveStream", sb3.toString(), null, "LiveStream.java:vsyncEvent:1", 10000);
                return;
        }
    }
    ...
    protected LiveStream(LiveStreamBuilder liveStreamBuilder, Handler handler, Handler handler2, AudioDeviceModule audioDeviceModule, IVideoEffectProcessor iVideoEffectProcessor) {
        ...
        if (handler != null) {
            ...
            AVLog.m110011w("LiveStream", " Using extern thread as workThread");
        } else {
