package com.p683ss.avframework.livestreamv2.recorder;
...
import com.p683ss.avframework.engine.Transport.FeedbackObserver;
import com.p683ss.avframework.engine.Transport.MediaPacket;
...
import com.p683ss.avframework.recorder.MediaRecorder;
import com.p683ss.avframework.recorder.NativeMp4Recorder;
import com.p683ss.avframework.recorder.SystemMediaRecorder;
...
public class RecorderManager implements VideoCapturerObserver, Observer, EventObserver, IRecorderManager {
    ...
    public synchronized void release() {
        ...
        if (this.mRecordThreadHandler != null) {
            ThreadUtils.invokeAtFrontUninterruptibly(this.mRecordThreadHandler, (Runnable) new Runnable() {
                public void run() {
                    AVLog.m110009i("RecorderManager", "recordManager thread exit done.");
                }
            });
    ...
    public void onWriteFile(MediaPacket mediaPacket) {
        ...
        if (mediaPacket.isVideo && this.mVideoRecordIdx >= 0 && this.mRecorder != null) {
            ...
            AVLog.m110011w(str4, sb.toString());
        } else {
    ...
    private void createRecordVideoTrack(MediaPacket mediaPacket, boolean z) {
        ...
        if (findNextNal <= 0 || findNextNal >= slice.capacity()) {
            ...
            if (findNextNal2 <= 0 && slice.capacity() < 50) {
                ...
                AVLog.m110011w("RecorderManager", "Not found spspps");
                return;
            } else if (findNextNal2 > 0) {
        ...
        if (i2 <= 0 || i <= 0) {
            AVLog.m110011w("RecorderManager", "Not found spspps on recorder.");
            return;
        }
        slice.position(0);
                ...
                public void run() {
                    ...
                    if (2 == i) {
                        ...
                        if (bool || !string.equalsIgnoreCase("video/x264")) {
                            ...
                            AVLog.m110007d("RecorderManager", "Update recorder encoder to soft.");
                            return;
                        }
                        RecorderManager.this.mState.set(3);
    ...
    public void onTransportEvent(int i, int i2, long j, String str) {
        if (this.mRecordThreadHandler != null) {
            ...
            final int i4 = i2;
            final long j2 = j;
            C511233 r0 = new Runnable() {
                public void run() {
                    switch (i3) {
                        case 1:
                            AVLog.m110007d("RecorderManager", "Recording on native.");
                            return;
                        case 2:
                            AVLog.m110007d("RecorderManager", "Recorded on native.");
                            break;
                        case 3:
                            RecorderManager.this.mState.set(3);
                            IRecorderListener iRecorderListener = RecorderManager.this.mListener;
