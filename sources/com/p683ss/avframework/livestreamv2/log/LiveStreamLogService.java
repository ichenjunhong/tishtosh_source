package com.p683ss.avframework.livestreamv2.log;
...
public class LiveStreamLogService implements Callback {
    ...
    public JSONObject createCommonLog() {
        ...
        try {
            return new JSONObject().put("product_line", CustomActionPushReceiver.f104061f).put(C42311c.f106863g, "2.0.0").put("live_sdk_version", str).put("report_version", 5).put("product_line", CustomActionPushReceiver.f104061f).put("timestamp", System.currentTimeMillis()).put("mode", "push").put("project_key", this.mProjectKey).put("cdn_ip", this.mRemoteIP).put("url", str2).put("hit_node_optimize", z).put("evaluator_symbol", str3).put("qId", str4).put("live_stream_session_id", str5);
        } catch (JSONException unused) {
            return null;
        }
    }
    ...
    public void onClientMixerBitrateAdjust(int i, int i2, int i3, boolean z) {
        String str;
        JSONObject createCommonLog = createCommonLog();
        if (createCommonLog != null) {
            try {
                JSONObject put = createCommonLog.put("event_key", "bitrate_adjust").put("default_bitrate", i).put("min_bitrate", i2).put("max_bitrate", i3);
                String str2 = "message";
                if (z) {
                    str = "ClientMixerMode";
                } else {
    ...
    public void onRTMPEnd(int r15, int r16, boolean r17, java.lang.String r18, long r19) {
        ...
        L_0x00af:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.livestreamv2.log.LiveStreamLogService.onRTMPEnd(int, int, boolean, java.lang.String, long):void");
    }
}
