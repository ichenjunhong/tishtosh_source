package com.p683ss.avframework.capture.video;
...
import com.p683ss.avframework.buffer.SurfaceTextureHelper.OnTextureFrameAvailableListener;
...
public class ScreenVideoCapturer extends VideoCapturer implements OnTextureFrameAvailableListener {
    ...
    public synchronized void startCapture(int r2, int r3, int r4) {
        ...
        L_0x0052:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.capture.video.ScreenVideoCapturer.startCapture(int, int, int):void");
    }
}
