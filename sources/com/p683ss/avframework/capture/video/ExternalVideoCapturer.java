...
public class ExternalVideoCapturer extends VideoCapturer implements ToI420Interface {
    ...
    public I420Buffer toI420(final TextureBuffer textureBuffer) {
        ...
        if (this.mStatus != 1) {
            AVLog.m110008e("ExternalVideoCapturer", "VideoCapturer already release.");
        ...
        C508734 r1 = new Runnable() {
            public void run() {
                ...
                if (ExternalVideoCapturer.this.mStatus != 1) {
                    ...
                    sb5.append(sb2);
                    AVLog.logToIODevice2(5, "ExternalVideoCapturer", sb4, null, sb5.toString(), 10000);
                    iArr2[0] = -1;
                } else if (ExternalVideoCapturer.this.mBufferAlreadyReturn || !ExternalVideoCapturer.this.mSigBufferMode) {
                    ...
                    sb10.append(sb7);
                    AVLog.logToIODevice2(5, "ExternalVideoCapturer", sb9, null, sb10.toString(), 10000);
                    iArr2[0] = -2;
                }
            }
        };
