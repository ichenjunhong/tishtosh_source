...
public class AudioCapturerAudioRecord extends AudioCapturer {
    ...
    class AudioRecordThread extends Thread {
        ...
        public void stopThread() {
            AVLog.m110007d(AudioCapturerAudioRecord.TAG, "stopThread");
        ...
        public void run() {
            ...
            while (this.keepAlive) {
                ...
                if (i == AudioCapturerAudioRecord.this.mByteBuffer.capacity()) {
                    ...
                    sb.append(i);
                    AVLog.m110008e(AudioCapturerAudioRecord.TAG, sb.toString());
                    if (i == -3) {
                        this.keepAlive = false;
                        String str2 = new String("AudioRecord read error, invalid operation");
                        AVLog.m110008e(AudioCapturerAudioRecord.TAG, str2);
    ...
    private void startRecording() {
        AVLog.m110007d(TAG, "startRecording");
        try {
            ...
            AVLog.m110011w(TAG, illegalStateException.getMessage());
    ...
    public synchronized void stop() {
        ...
        L_0x0014:
            ...
            com.p683ss.avframework.utils.AVLog.iow(r0, r2)     // Catch:{ IllegalStateException -> 0x0025 }
            goto L_0x003d
        L_0x0025:
            r0 = move-exception
            ...
            com.p683ss.avframework.utils.AVLog.ioe(r2, r0)     // Catch:{ all -> 0x0054 }
        L_0x003d:
            android.media.AudioRecord r0 = r5.mAudioRecord     // Catch:{ all -> 0x0054 }
            ...
            com.p683ss.avframework.utils.AVLog.iow(r0, r2)     // Catch:{ all -> 0x0054 }
        L_0x004b:
        ...
        L_0x0054:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.capture.audio.AudioCapturerAudioRecord.stop():void");
    }
    ...
    public void start() {
        ...
        AVLog.m110007d(str, sb2.toString());
        ...
        if (this.mByteBuffer.hasArray()) {
            ...
            try {
                ...
                if (this.mChannel != 1) {
                    ...
                    this.mChannel = 1;
                    AVLog.m110007d(TAG, "AudioRecord trying mono...");
                    start();
                    return;
                }
