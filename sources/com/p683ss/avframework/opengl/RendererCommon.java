...
public class RendererCommon {
    ...
    public static void calcWindRatio(boolean r0, boolean r1, boolean r2, int r3, int r4, int r5, int r6, float[] r7) {
        ...
        L_0x0037:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.opengl.RendererCommon.calcWindRatio(boolean, boolean, boolean, int, int, int, int, float[]):void");
    }
}
