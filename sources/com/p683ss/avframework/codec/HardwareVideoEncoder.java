...
class HardwareVideoEncoder extends VideoEncoder {
        ...
        return new Thread() {
            ...
            public void run() {
                /*
                    r2 = this;
                L_0x0000:
                    com.ss.avframework.codec.HardwareVideoEncoder r0 = com.p683ss.avframework.codec.HardwareVideoEncoder.this
                    boolean r0 = r0.running
                    if (r0 == 0) goto L_0x001e
                    com.ss.avframework.codec.HardwareVideoEncoder r0 = com.p683ss.avframework.codec.HardwareVideoEncoder.this
                    java.lang.Object r0 = r0.readEncoderDataFence
                    monitor-enter(r0)
                    com.ss.avframework.codec.HardwareVideoEncoder r1 = com.p683ss.avframework.codec.HardwareVideoEncoder.this     // Catch:{ InterruptedException -> 0x0015 }
                ...
                L_0x001e:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.codec.HardwareVideoEncoder.C508901.run():void");
            }
        };
    }
    ...
    private int getOneColorFormat() {
        ...
        for (int i = 0; i < colorFormats.length; i++) {
            if (colorFormats[i] == 2130708361) {
                AVLog.m110007d("HardwareVideoEncoder", "colorFormat support COLOR_FormatSurface");
    ...
    private MediaCodecInfo getMediaCodecInfo21() {
        ...
        for (MediaCodecInfo mediaCodecInfo : codecInfos) {
            if (mediaCodecInfo != null && mediaCodecInfo.isEncoder()) {
                ...
                sb.append(name);
                AVLog.m110007d("HardwareVideoEncoder", sb.toString());
                if (!name.startsWith("OMX.google.") && !name.startsWith("OMX.Nvidia.") && !name.equals("OMX.TI.DUCATI1.VIDEO.H264E")) {
    ...
    public void releaseCodecOnOutputThread() {
        AVLog.m110007d("HardwareVideoEncoder", "Releasing MediaCodec on output thread");
        try {
            ...
            sb.append(e);
            AVLog.m110008e("HardwareVideoEncoder", sb.toString());
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            ...
            sb2.append(e2);
            AVLog.m110008e("HardwareVideoEncoder", sb2.toString());
            this.shutdownException = e2;
        }
        AVLog.m110007d("HardwareVideoEncoder", "Release on output thread done");
    }
    ...
    public boolean InitEncoder(TEBundle tEBundle) {
        ...
        AVLog.m110008e("HardwareVideoEncoder", "Value of TEBundle.kKeyVideoConfigurationType error, should be 1 (Annex-B)");
        return false;
    }
    ...
    private int encodeTextureBuffer(VideoFrame videoFrame) {
        try {
            ...
            AVLog.m110008e("HardwareVideoEncoder", sb4.toString());
            return -2;
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean initEncodeInternal(com.p683ss.avframework.utils.TEBundle r13) {
        /*
            r12 = this;
            r0 = -1
        ...
        L_0x007c:
            ...
            com.p683ss.avframework.utils.AVLog.m110007d(r9, r10)     // Catch:{ Exception -> 0x01b9 }
        ...
        L_0x00d7:
            ...
            com.p683ss.avframework.utils.AVLog.m110007d(r13, r0)     // Catch:{ Exception -> 0x01b9 }
        ...
        L_0x01b9:
            ...
            com.p683ss.avframework.utils.AVLog.m110008e(r0, r13)
            r12.release()
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.avframework.codec.HardwareVideoEncoder.initEncodeInternal(com.ss.avframework.utils.TEBundle):boolean");
    }
    ...
    private int encodeByteBuffer(VideoFrame videoFrame, Buffer buffer, int i) {
        ...
        try {
            ...
            if (dequeueInputBuffer == -1) {
                AVLog.m110007d("HardwareVideoEncoder", "Dropped frame, no input buffers available");
                return -2;
            }
            try {
            ...
            AVLog.m110008e("HardwareVideoEncoder", sb3.toString());
            return -1;
        }
    }
