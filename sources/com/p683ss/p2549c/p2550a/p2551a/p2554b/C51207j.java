...
/* renamed from: com.ss.c.a.a.b.j */
final class C51207j implements Callable<C51206i> {

    /* renamed from: a */
    private static Pattern f127891a;

    /* renamed from: b */
    private final String f127892b;

    /* renamed from: c */
    private final int f127893c = 10;
    ...
    public com.p683ss.p2549c.p2550a.p2551a.p2554b.C51206i call() throws java.lang.Exception {
        /*
            r13 = this;
            int r0 = r13.f127893c
            r1 = 0
            if (r0 != 0) goto L_0x000f
            com.ss.c.a.a.b.i r0 = new com.ss.c.a.a.b.i
            java.lang.String r2 = r13.f127892b
            int r3 = r13.f127893c
            r0.<init>(r2, r1, r3)
            return r0
        L_0x000f:
            ...
            r5 = 0
            int r6 = r13.f127893c     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            ...
            java.lang.String r5 = r13.f127892b     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            r6 = 1
            r4[r6] = r5     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            java.lang.String r0 = com.C2240a.m6773a(r0, r2, r4)     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
        ...
        L_0x0043:
            ...
            java.util.regex.Pattern r8 = f127891a     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
            ...
            com.ss.c.a.a.b.a.a r11 = new com.ss.c.a.a.b.a.a     // Catch:{ Exception -> 0x0043 }
            r11.<init>(r8, r9, r7)     // Catch:{ Exception -> 0x0043 }
            r5.add(r11)     // Catch:{ Exception -> 0x0043 }
            goto L_0x0043
        L_0x0077:
            com.ss.c.a.a.b.i r3 = new com.ss.c.a.a.b.i     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
            java.lang.String r4 = r13.f127892b     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
            int r6 = r13.f127893c     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
        ...
        L_0x00b7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.p2549c.p2550a.p2551a.p2554b.C51207j.call():com.ss.c.a.a.b.i");
    }

    C51207j(String str, int i) {
        this.f127892b = str;
        if (f127891a == null) {
            f127891a = Pattern.compile(".*?icmp_seq=(\\d+).*?ttl=(\\d+).*?time=([\\d^\\.]+|[1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*).*?ms");
        }
    }
}
