...
import com.p683ss.texturerender.VideoSurfaceTexture.TextureDrawCallback;
...
public class VideoSurface extends Surface implements Callback, TextureDrawCallback {
    ...
    public void release() {
        ...
        sb.append(this);
        sb.append("release");
        TextureRenderLog.m110623d("VideoSurface", sb.toString());
        super.release();
        releaseTexture();
    ...
    public boolean handleMessage(Message message) {
        if (!(message.what != 4096 || this.mDrawFrameListener == null || this.mSurfaceTexture == null)) {
            ...
            if (i != serial) {
                StringBuilder sb = new StringBuilder("serial change :");
                sb.append(i);
                sb.append(", ");
                sb.append(serial);
                TextureRenderLog.m110623d("VideoSurface", sb.toString());
