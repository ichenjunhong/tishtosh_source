...
public class HTTPDNS extends BaseDNS {
    ...
    public void _handleResponse(JSONObject jSONObject, Error error) {
        ...
        AVMDLLog.m110472d("HTTPDNS", C2240a.m6772a("****http dns id:%s", new Object[]{this.mId}));
        ...
        if (error != null) {
            ...
            new Error(this.mHttpDNSType, this.mHostname, this.mId, C2240a.m6772a("HTTP dns empty, type:%d", new Object[]{Integer.valueOf(this.mHttpDNSType)}));
        } else {
            try {
                aVMDLDNSInfo = parserResult(jSONObject);
            } catch (Throwable th) {
                AVMDLLog.m110472d("HTTPDNS", C2240a.m6772a("handle response exception:%s", new Object[]{th.toString()}));
                aVMDLDNSInfo = null;
            }
