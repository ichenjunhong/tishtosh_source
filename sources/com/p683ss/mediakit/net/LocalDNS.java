...
public class LocalDNS extends BaseDNS {
    ...
    static class MyRunnable implements Runnable {
        ...
        public void run() {
            AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("----implement delayed check for local dns", new Object[0]));
            LocalDNS localDNS = (LocalDNS) this.mLocalDNSRef.get();
            if (localDNS == null) {
                AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end implement delayed check for local dns, dns object null", new Object[0]));
                return;
            }
            if (!localDNS.mRet) {
                localDNS.cancel();
                AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end implement delayed check cancel local dns,", new Object[0]));
    ...
    public void start() {
        try {
            this.mFuture = AVMDLThreadPool.addExecuteTask(new Runnable() {
                public void run() {
                    String sb;
                    AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("----call local dns, host:%s", new Object[]{LocalDNS.this.mHostname}));
                    try {
                        ...
                        if (LocalDNS.this.mAddress == null) {
                            AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end call local dns, not get address host:%s", new Object[]{LocalDNS.this.mHostname}));
                        ...
                        if (TextUtils.isEmpty(str)) {
                            AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end call local dns, iplist null host:%s", new Object[]{LocalDNS.this.mHostname}));
                        ...
                        AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end call local dns, suc iplist:%s host:%s", new Object[]{str, LocalDNS.this.mHostname}));
                        ...
                        LocalDNS.this.mRet = true;
                        AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end call local dns, end exception:%s host:%s", new Object[]{th, LocalDNS.this.mHostname}));
            ...
            AVMDLLog.m110472d("LocalDNS", C2240a.m6772a("****end call local dns, exception:%s host:%s", new Object[]{e, this.mHostname}));
