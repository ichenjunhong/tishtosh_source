...
public final class C51382c {

    /* renamed from: a */
    private static final FileFilter f128479a = new FileFilter() {
    ...
    /* renamed from: a */
    public static String m110508a() {
        JSONObject jSONObject = new JSONObject();
        try {
            HashMap b = m110511b();
            jSONObject.put("core", m110512c());
            jSONObject.put("pc", m110510a(b, "Processor"));
            jSONObject.put("hw", m110510a(b, "Hardware"));
            jSONObject.put("max", m110509a("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_max_freq"));
            jSONObject.put("min", m110509a("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_min_freq"));
            jSONObject.put("ft", m110510a(b, "Features"));
    ...
    private static java.lang.String m110509a(java.lang.String r4) {
        /*
            r0 = 0
        ...
        L_0x0048:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.sys.ces.p2580a.C51382c.m110509a(java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    private static String m110510a(HashMap<String, String> hashMap, String str) {
        String str2;
        try {
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.HashMap<java.lang.String, java.lang.String> m110511b() {
        /*
        ...
        L_0x0065:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.sys.ces.p2580a.C51382c.m110511b():java.util.HashMap");
    }

    /* renamed from: c */
    private static int m110512c() {
        try {
            return new File("/sys/devices/system/cpu/").listFiles(f128479a).length;
        } catch (Throwable unused) {
            return -1;
        }
    }
