...
/* renamed from: com.ss.video.rtc.interact.render.opengl.EglBase14 */
class EglBase14 implements EglBase {
    ...
    /* renamed from: com.ss.video.rtc.interact.render.opengl.EglBase14$Context */
    ...
    public static boolean isEGL14Supported() {
        ...
        sb.append(z);
        LogUtil.m110872i(str, sb.toString());
        if (CURRENT_SDK_VERSION >= 18) {
            return true;
        }
        return false;
