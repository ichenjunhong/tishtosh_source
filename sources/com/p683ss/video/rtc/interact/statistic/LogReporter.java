...
import com.p683ss.ugc.live.sdk.message.BuildConfig;
...
/* renamed from: com.ss.video.rtc.interact.statistic.LogReporter */
public class LogReporter {
    ...
    /* renamed from: com.ss.video.rtc.interact.statistic.LogReporter$LogReportCallback */
    public interface LogReportCallback {
        void onFirstRemoteVideoRender(String str);
    }
        ...
        if (this.mReportCallback == null) {
            this.mReportCallback = new LogReportCallback() {
                public void onFirstRemoteVideoRender(String str) {
                    LogReporter.this.onFirstRemoteVideoRender(str);
                }
            };
        }
        ...
        if (this.mStartJoiningTs > 0 && this.isFirstLocalExternalVideoFrame) {
            ...
            if (createCommonLog != null) {
                try {
                    ...
                    LogUtil.m110871e("live_client_monitor_log", String.valueOf(e));
                }
            }
        }
    }
        ...
        if (this.mLogReportCallback != null) {
            try {
                if (!"rtc_push_stream".equals(jSONObject.getString("event_key"))) {
                    LogUtil.m110872i("live_client_monitor_log", jSONObject.toString());
                }
            } catch (JSONException e) {
                LogUtil.m110871e("live_client_monitor_log", String.valueOf(e));
            }
    ...
    private JSONObject createCommonLog(String str) {
        ...
        String str3;
        try {
            JSONObject put = new JSONObject().put(C42311c.f106863g, BuildConfig.VERSION_NAME).put("event_key", str).put("mode", "rtc").put("timestamp", System.currentTimeMillis()).put("project_key", this.mConfig.getProjectKey()).put("report_version", 5).put("product_line", CustomActionPushReceiver.f104061f);
            ...
            JSONObject put2 = put.put(str4, str2).put("rtc_type", getInteractType(this.mConfig.getInteractMode())).put("rtc_vendor", getVendorName(this.mConfig.getVendor())).put("rtc_role", getCharacterName(this.mConfig.getCharacter())).put("rtc_version", this.mThirdPartySdkVersion).put("rtc_sdk_version", "2.7.12-6").put("rtc_app_channel", this.mConfig.getAppChannel()).put("rtc_report_id", this.sLogId.incrementAndGet());
        ...
        if (createCommonLog != null) {
            try {
                ...
                if (this.mConfig.getSdkParams() != null) {
                    str4 = this.mConfig.getSdkParams().toString();
                }
                StringBuilder sb = new StringBuilder();
                sb.append(this.mConfig.getInteractId());
                StringBuilder sb2 = new StringBuilder();
                ...
                sb3.append(this.mConfig.getUserId());
                JSONObject put = createCommonLog.put("error_code", i).put("rtc_video_profile", getVideoQuality(this.mConfig.getVideoQuality())).put("link_id", sb.toString()).put("rtc_user_id", sb2.toString()).put("account", sb3.toString());
                String str5 = "rtc_token";
                if (str == null) {
                    str = "";
                }
                JSONObject put2 = put.put(str5, str).put("useSdkParam", this.mConfig.isUseRtcExtParams() ? 1 : 0);
                String str6 = "sdkParams";
                if (str4 == null) {
                    str4 = "";
                }
                JSONObject put3 = put2.put(str6, str4).put("width", videoQuality.getWidth()).put("height", videoQuality.getHeight()).put("fps", videoQuality.getFps()).put("video_bitrate", videoQuality.getBitrate()).put("rtc_mix_audio_profile", genMixAudioReportJson(mixStreamConfig)).put("mix_video_profile", genMixVideoReportJson(mixStreamConfig)).put("default_server_first", isUseDefaultSignalingServerFirstFromRtcExt ? 1 : 0);
                String str7 = "rtc_app_id";
                if (str2 == null) {
                    str2 = "";
                }
                JSONObject put4 = put3.put(str7, str2).put("rtc_switch_app_id", z);
                String str8 = "mix_type";
                if (this.mConfig.isClientMixStream()) {
                    str3 = "client";
                } else {
                    str3 = "server";
                ...
                LogUtil.m110874w("live_client_monitor_log", String.valueOf(e));
            }
        }
    }

    public void onInteractStatus(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, int i9, int i10, String str, String str2, String str3, ProcInfo procInfo, LocalUserStatisticInfo localUserStatisticInfo, int i11) {
        String str4;
        ...
        if (createCommonLog != null) {
            ...
            try {
                ...
                int i18 = i7;
                int i19 = i8;
                JSONObject put = createCommonLog.put("send_audio_bitrate", i).put("receive_audio_bitrate", i2).put("send_video_bitrate", i3).put("receive_video_bitrate", i4).put("user_count", i9).put("real_video_framerate", i5).put("preview_fps", i6).put("width", i7).put("height", i8).put("avg_vps_elapse", (double) f).put("stream_statistics", str2).put("rtc_app_cpu", procInfo.getAppCpuUsed()).put("rtc_sys_cpu", procInfo.getTotalCpuUsed()).put("rtc_app_memory", (int) procInfo.getAppUsedMemory()).put("rtc_sys_memory", (int) procInfo.getSystemUsedMemory()).put("send_vencode_fps", localUserStatisticInfo.getSendVencodeFps()).put("send_video_loss", localUserStatisticInfo.getSendVideoLoss()).put("send_audio_loss", localUserStatisticInfo.getSendAudioLoss()).put("send_audio_rtt", localUserStatisticInfo.getSendAudioRtt()).put("send_video_rtt", localUserStatisticInfo.getSendVideoRtt()).put("remote_user_info", str3).put("send_encode_fps", i10);
                String str5 = "mix_type";
                if (!this.mConfig.isEnableMixStream()) {
                    str4 = "none";
                ...
                put.put(str5, str4).put("rtc_tx_quality", i11);
                reportLog(createCommonLog);
