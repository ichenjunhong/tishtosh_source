...
/* renamed from: com.ss.video.rtc.interact.controller.SEIHelper */
public class SEIHelper {
    private Callback mCallback;
    private long mSeiTimestamp;

    /* renamed from: com.ss.video.rtc.interact.controller.SEIHelper$Callback */
    ...
    public void updateSei(String str) {
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                LogUtil.m110871e("SEIHelper", e.toString());
            }
        }
    }
    ...
    private SEI createSeiFromCommon(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (jSONObject2.has("uid")) {
                size.interactId(jSONObject2.opt("uid").toString());
            }
            boolean z2 = true;
            ...
            if (jSONObject2.has("mute_audio")) {
                if (jSONObject2.optInt("mute_audio") != 1) {
                    z2 = false;
                }
                size.muteAudio(z2);
            }
