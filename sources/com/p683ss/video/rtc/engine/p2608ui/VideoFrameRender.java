...
import com.p683ss.video.rtc.engine.adapter.VideoFrameConverter;
import com.p683ss.video.rtc.engine.mediaio.AutoReleaseJavaI420Buffer;
import com.p683ss.video.rtc.engine.mediaio.IVideoFrameConsumer;
import com.p683ss.video.rtc.engine.mediaio.SurfaceEglRender;
import com.p683ss.video.rtc.engine.mediaio.TextureEglRenderer;
...
public class VideoFrameRender implements OnLayoutChangeListener, IVideoFrameConsumer, RenderView, RendererEvents {
    ...
    private boolean mHasRevicedFirstFrame;
    private OnEglSurfaceCreated mOnEglSurfaceCreatedCallback;
    private long mReceiveFirstTimeStmap;
    ...
    /* renamed from: com.ss.video.rtc.engine.ui.VideoFrameRender$FirstVideoFrameRenderListener */
    ...
    private void notifyFristRenderCallback() {
        if (!this.firstVideoFrameListeners.isEmpty()) {
            int currentTimeMillis = (int) (System.currentTimeMillis() - this.mReceiveFirstTimeStmap);
            Iterator it = this.firstVideoFrameListeners.iterator();
            while (it.hasNext()) {
                ((FirstVideoFrameRenderListener) it.next()).onFirstVideoFrameRender(currentTimeMillis);
            }
        }
    }
    ...
    public synchronized void onDispose() {
        ...
        if (this.firstVideoFrameListeners != null) {
    ...
    private void updateSurfaceSize() {
        ...
        LogUtil.m110864d("VideoFrameRender", sb.toString());
    ...
    public synchronized void setFristVideoFrameRenderListener(FirstVideoFrameRenderListener firstVideoFrameRenderListener) {
    ...
    public VideoFrameRender(String str) {
        ...
        this.mOnEglSurfaceCreatedCallback = new VideoFrameRender$$Lambda$0(this);
    }
    ...
    public void onVideoFrame(VideoFrame videoFrame) {
        if (this.mEglSurfaceCreated) {
            if (!this.mHasRevicedFirstFrame) {
                this.mReceiveFirstTimeStmap = System.currentTimeMillis();
                this.mHasRevicedFirstFrame = true;
            }
