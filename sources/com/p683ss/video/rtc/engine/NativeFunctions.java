...
public final class NativeFunctions {
    ...
    public static native void nativeForceGlobalAPIServer(boolean z);
    ...
    public static native boolean nativePushExternalVideoFrame(long j, VideoFrame videoFrame, ByteBuffer byteBuffer, long j2);
    ...
    public static native void nativeRemoteFristVideoFrameRendered(long j, String str, int i);
    ...
    public static native void nativeSdkAPICallBack(long j, int i, String str, String str2);
    ...
    public static native void nativeSetPlaybackAudioFrameBeforeMixingParameters(long j, int i, int i2);
