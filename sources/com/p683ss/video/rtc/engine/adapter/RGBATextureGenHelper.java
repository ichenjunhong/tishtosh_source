...
import com.p683ss.video.rtc.engine.utils.GLUtils;
...
public class RGBATextureGenHelper {
    ...
    private void releaseGlTextures() {
        GLES20.glDeleteTextures(1, new int[]{this.textureYID}, 0);
        GLES20.glDeleteTextures(1, new int[]{this.textureUID}, 0);
        GLES20.glDeleteTextures(1, new int[]{this.textureVID}, 0);
        GLES20.glDeleteTextures(1, new int[]{this.texturesRGBAID}, 0);
    }
    ...
    private int initProgram() {
        ...
        if (iArr[0] == 0) {
            LogUtil.m110865e("RGBATextureGenHelper", "Could not compile shader:");
            StringBuilder sb = new StringBuilder(" ");
            sb.append(GLES20.glGetShaderInfoLog(loadShader2));
            LogUtil.m110865e("RGBATextureGenHelper", sb.toString());
        }
        ...
        LogUtil.m110865e("RGBATextureGenHelper", "Could not link program: ");
        LogUtil.m110865e("RGBATextureGenHelper", GLES20.glGetProgramInfoLog(glCreateProgram));
