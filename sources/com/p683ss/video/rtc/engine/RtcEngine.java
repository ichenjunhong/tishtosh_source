...
import com.p683ss.video.rtc.engine.loader.RtcNativeLibraryLoaderImpl;
...
import com.p683ss.video.rtc.engine.utils.RtcEglContextChecker;
...
public abstract class RtcEngine {
    ...
    public abstract boolean setPlaybackAudioFrameBeforeMixingParameters(int i, int i2);
    ...
    public static String getSdkVersion() {
        return C51644RtcEngineImpl.getSDKVersion();
    }
    ...
    public static void ForceGlobalAPIServer(boolean z) {
        C51644RtcEngineImpl.ForceGlobalAPIServer(z);
    }

    public static void setApiServerHost(String[] strArr) {
        C51644RtcEngineImpl.setApiServerHost(strArr);
    }
    ...
    public static void setSignalingServer(String str) {
        C51644RtcEngineImpl.setSignalingServer(str);
    }

    public static void useDefaultSignalingServer(boolean z) {
        C51644RtcEngineImpl.useDefaultSignalingServer(z);
    }

    public static FeedbackOptions getFeedbackContent(Context context) {
        return C51644RtcEngineImpl.getFeedbackContent(context);
    }

    public static int setDeviceId(String str) {
        return C51644RtcEngineImpl.setDeviceId(str);
    }
    ...
    public static void setRtcEngineEventHandler(IRtcEngineEventHandler iRtcEngineEventHandler) {
        if (mInstance != null) {
            C51644RtcEngineImpl.setRtcEngineEventHandler(iRtcEngineEventHandler);
        }
    }
    ...
    public static void setRtcNativeLibraryLoader(RtcNativeLibraryLoader rtcNativeLibraryLoader) {
        ...
        LogUtil.m110867i("RtcEngine", sb.toString());
    ...
    public static synchronized RtcEngine create(Context context, String str, IRtcEngineEventHandler iRtcEngineEventHandler, boolean z) {
        synchronized (RtcEngine.class) {
            ...
            if (mInstance == null) {
                mInstance = new C51644RtcEngineImpl(context, str, iRtcEngineEventHandler, null);
            }
            C51644RtcEngineImpl rtcEngineImpl = mInstance;
    ...
    public static synchronized RtcEngine create(Context context, String str, IRtcEngineEventHandler iRtcEngineEventHandler, boolean z, android.opengl.EGLContext eGLContext) {
        synchronized (RtcEngine.class) {
            ...
            if (mInstance == null) {
                mInstance = new C51644RtcEngineImpl(context, str, iRtcEngineEventHandler, eGLContext);
            }
            C51644RtcEngineImpl rtcEngineImpl = mInstance;
            return rtcEngineImpl;
        }
    ...
    public static synchronized RtcEngine create(Context context, String str, IRtcEngineEventHandler iRtcEngineEventHandler, boolean z, Object obj) {
        synchronized (RtcEngine.class) {
            if (context == null) {
                return null;
            }
