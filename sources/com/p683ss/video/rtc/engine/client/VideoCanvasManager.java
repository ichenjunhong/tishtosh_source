package com.p683ss.video.rtc.engine.client;
...
public class VideoCanvasManager {
    ...
    private String buildKey(String str, boolean z) {
        ...
        objArr[1] = str2;
        return C2240a.m6772a(str3, objArr);
    }

    public void add(String str, boolean z, VideoCanvas videoCanvas) {
        LogUtil.m110864d("VideoCanvasManager", C2240a.m6772a("call-add uid: %s, isScreen: %s, VideoCanvas: %s", new Object[]{str, Boolean.valueOf(z), videoCanvas}));
    ...
    private void checkAndUpdateVideoCanvasState(String str, VideoCanvas videoCanvas, VideoCanvas videoCanvas2) {
        int i = 0;
        LogUtil.m110864d("VideoCanvasManager", C2240a.m6772a("call-checkAndUpdateVideoCanvasState, key: %s, currentVideoCanvas: %s, oldVideoCanvas: %s", new Object[]{str, videoCanvas, videoCanvas2}));
        if (!(videoCanvas2 == null || videoCanvas2.view == null)) {
            if (videoCanvas != null && videoCanvas.view != null && videoCanvas.getValidRenderView() == videoCanvas2.getValidRenderView()) {
                LogUtil.m110864d("TAG", "oldView is current view, just break");
                ...
                LogUtil.m110864d("TAG", sb.toString());
        ...
        if (!(videoCanvas == null || (videoCanvas.textureView == null && videoCanvas.surfaceView == null && videoCanvas.surface == null))) {
            ...
            sb4.append(i);
            LogUtil.m110864d("TAG", sb4.toString());
            if (getRefCount(videoCanvas.getValidRenderView()) == 0) {
                ...
                LogUtil.m110864d("TAG", "currentVideoCanvas.setRenderView");
