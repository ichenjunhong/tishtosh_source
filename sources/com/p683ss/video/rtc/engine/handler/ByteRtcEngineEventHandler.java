...
import com.p683ss.video.rtc.engine.ByteStream;
import com.p683ss.video.rtc.engine.InternalAudioVolumeInfo;
import com.p683ss.video.rtc.engine.InternalLocalAudioStats;
import com.p683ss.video.rtc.engine.InternalLocalVideoStats;
import com.p683ss.video.rtc.engine.InternalRemoteAudioStats;
import com.p683ss.video.rtc.engine.InternalRemoteVideoStats;
import com.p683ss.video.rtc.engine.InternalRtcStats;
import com.p683ss.video.rtc.engine.RtcEngineImpl.C51644RtcEngineImpl;
import com.p683ss.video.rtc.engine.SubscribeConfig;
import com.p683ss.video.rtc.engine.SubscribeState;
import com.p683ss.video.rtc.engine.handler.IRtcEngineEventHandler.AudioVolumeInfo;
...
public class ByteRtcEngineEventHandler {
    ...
    public void onAudioMixingFinished() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onAudioMixingFinished...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onAudioMixingFinished();
            }
        } catch (Exception e) {
            StringBuilder sb = new StringBuilder("onAudioMixingFinished callback catch exception.\n");
            sb.append(e.getMessage());
            LogUtil.m110864d("ByteRtcEngineEventHandler", sb.toString());
        }
    }

    public void onCameraReady() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onCameraReady...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onCameraReady();
            }
        } catch (Exception e) {
    ...
    public void onConnectionBanned() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onConnectionBanned...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionBanned();
            }
        } catch (Exception e) {
    ...
    public void onConnectionInterrupted() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onConnectionInterrupt...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionInterrupted();
            }
        } catch (Exception e) {
    ...
    public void onConnectionLost() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onConnectionLost...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionLost();
            }
        } catch (Exception e) {
    ...
    public void onMediaEngineLoadSuccess() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onMediaEngineLoadSuccess...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onMediaEngineLoadSuccess();
            }
        } catch (Exception e) {
    ...
    public void onMediaEngineStartCallSuccess() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onMediaEngineStartCallSuccess...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onMediaEngineStartCallSuccess();
            }
        } catch (Exception e) {
    ...
    public void onRequestToken() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onRequestToken...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onRequestToken();
            }
        } catch (Exception e) {
    ...
    public void onVideoStopped() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onVideoStopped...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onVideoStopped();
            }
        } catch (Exception e) {
    ...
    public void onWebsocketConnected() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onWebsocketConnected...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionStateChanged(3, -1);
            }
        } catch (Exception e) {
    ...
    public void onWebsocketConnecting() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onWebsocketConnecting...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionStateChanged(2, -1);
            }
        } catch (Exception e) {
    ...
    public void onWebsocketDisconnected() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onWebsocketDisconnected...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionStateChanged(1, -1);
            }
        } catch (Exception e) {
    ...
    public void onWebsocketReconnecting() {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onWebsocketReconnecting...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onConnectionStateChanged(4, -1);
            }
        } catch (Exception e) {
    ...
    public ByteRtcEngineEventHandler(C51644RtcEngineImpl rtcEngineImpl) {
    ...
    public void onActiveSpeaker(String str) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onActiveSpeaker(str);
            }
        } catch (Exception e) {
            StringBuilder sb2 = new StringBuilder("onActiveSpeaker callback catch exception.\n");
            sb2.append(e.getMessage());
            LogUtil.m110864d("ByteRtcEngineEventHandler", sb2.toString());
        }
    }
    ...
    public void onAudioEffectFinished(int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onAudioEffectFinished(i);
            }
        } catch (Exception e) {
    ...
    public void onCustomMessage(String str) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onCustomMessage(str);
            }
        } catch (Exception e) {
    ...
    public void onError(int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onError(i);
            }
        } catch (Exception e) {
    ...
    public void onFirstLocalAudioFrame(int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstLocalAudioFrame(i);
            }
        } catch (Exception e) {
    ...
    public void onLastmileQuality(int i) {
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onLastmileQuality(i);
            }
        } catch (Exception e) {
    ...
    public void onLeaveChannel(InternalRtcStats internalRtcStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onLeaveChannel...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onLeaveChannel(new RtcStats(internalRtcStats));
            }
        } catch (Exception e) {
    ...
    public void onLocalAudioStats(InternalLocalAudioStats internalLocalAudioStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onLocalAudioStats...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onLocalAudioStats(new LocalAudioStats(internalLocalAudioStats));
            }
        } catch (Exception e) {
    ...
    public void onLocalVideoStats(InternalLocalVideoStats internalLocalVideoStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onLocalVideoStats...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onLocalVideoStats(new LocalVideoStats(internalLocalVideoStats));
            }
        } catch (Exception e) {
    ...
    public void onNetStateChanged(int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onNetStateChanged(i);
            }
        } catch (Exception e) {
    ...
    public void onRemoteAudioStats(InternalRemoteAudioStats internalRemoteAudioStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onRemoteAudioStats...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onRemoteAudioStats(new RemoteAudioStats(internalRemoteAudioStats));
            }
        } catch (Exception e) {
    ...
    public void onRemoteVideoStats(InternalRemoteVideoStats internalRemoteVideoStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onRemoteVideoStats...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onRemoteVideoStats(new RemoteVideoStats(internalRemoteVideoStats));
            }
        } catch (Exception e) {
    ...
    public void onResponse(String str) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onResponse(str);
            }
        } catch (Exception e) {
    ...
    public void onRtcStats(InternalRtcStats internalRtcStats) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onRtcStats...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onRtcStats(new RtcStats(internalRtcStats));
            }
        } catch (Exception e) {
    ...
    public void onStreamAdd(ByteStream byteStream) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onStreamAdd...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamAdd(byteStream);
            }
        } catch (Exception e) {
    ...
    public void onStreamPublishSucceed(String str) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onStreamPublishSucceed...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamPublishSucceed(str);
            }
        } catch (Exception e) {
    ...
    public void onStreamRemove(ByteStream byteStream) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamRemove(byteStream);
            }
        } catch (Exception e) {
    ...
    public void onWarning(int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onWarning(i);
            }
        } catch (Exception e) {
    ...
    public void uploadLogFinished(boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().uploadLogFinished(z);
            }
        } catch (Exception e) {
    ...
    public void onAudioRouteChanged(int i) {
        ...
        try {
            if (this.mRtcEngineImpl != null) {
                if (i == 0) {
                    ((C51644RtcEngineImpl) this.mRtcEngineImpl.get()).setHeadsetConnectionStatus(true);
                } else {
                    ((C51644RtcEngineImpl) this.mRtcEngineImpl.get()).setHeadsetConnectionStatus(false);
                }
            }
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onAudioRouteChanged(i);
            }
        } catch (Exception e) {
    ...
    public void onAudioVolumeIndication(InternalAudioVolumeInfo[] internalAudioVolumeInfoArr, int i) {
        try {
            ...
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onAudioVolumeIndication(audioVolumeInfoArr, i);
            }
        } catch (Exception e) {
    ...
    public void onMessageReceived(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onMessageReceived(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onMessageSendResult(long j, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onMessageSendResult(j, i);
            }
        } catch (Exception e) {
    ...
    public void OnTranscodingError(String str, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamPublished(str, i);
            }
        } catch (Exception e) {
    ...
    public void onApiCallExecuted(String str, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onApiCallExecuted(str, i);
            }
        } catch (Exception e) {
    ...
    public void onClientRoleChanged(int i, int i2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onClientRoleChanged(i, i2);
            }
        } catch (Exception e) {
    ...
    public void onFirstRemoteAudioFrame(String str, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstRemoteAudioFrame(str, (long) i);
            }
        } catch (Exception e) {
    ...
    public void onInviteAcceptedByPeer(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onInviteAcceptedByPeer(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onInviteEndByMyself(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onInviteEndByMyself(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onInviteEndByPeer(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onInviteEndByPeer(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onInviteReceivedByPeer(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onInviteReceivedByPeer(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onScreenStreamRemove(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onScreenStreamRemove(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onSetupVideoError(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onSetupVideoError(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onStreamRemove(String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamRemove(str, str2);
            }
        } catch (Exception e) {
    ...
    public void onUserEnableAudio(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserEnableAudio(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserEnableLocalAudio(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserEnableLocalAudio(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserEnableLocalVideo(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserEnableLocalVideo(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserEnableVideo(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserEnableVideo(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserJoined(String str, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserJoined(str, i);
            }
        } catch (Exception e) {
    ...
    public void onUserMuteAudio(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserMuteAudio(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserMuteVideo(String str, boolean z) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserMuteVideo(str, z);
            }
        } catch (Exception e) {
    ...
    public void onUserOffline(String str, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onUserOffline(str, i);
            }
        } catch (Exception e) {
        ...
        try {
            if ("live_webrtc_monitor_log".equals(str)) {
                try {
                    ...
                    if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                        C51644RtcEngineImpl.getRtcEngineHandler().onLogReport(str, jSONObject);
                    }
                    try {
                        ...
                        sb.append(e.getMessage());
                        LogUtil.m110864d(str3, sb.toString());
                        return;
                    }
            ...
            LogUtil.m110867i(str, str2);
        } catch (Exception e3) {
            StringBuilder sb3 = new StringBuilder("onLogReport callback catch exception.\n");
            sb3.append(e3.getMessage());
            LogUtil.m110864d("ByteRtcEngineEventHandler", sb3.toString());
        }
    }

    public void onJoinChannelSuccess(String str, String str2, int i) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onJoinChannelSuccess...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onJoinChannelSuccess(str, str2, i);
            }
        } catch (Exception e) {
    ...
    public void onRejoinChannelSuccess(String str, String str2, int i) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onRejoinChannelSuccess...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onRejoinChannelSuccess(str, str2, i);
            }
        } catch (Exception e) {
    ...
    public void onStreamSubscribed(int i, String str, SubscribeConfig subscribeConfig) {
        LogUtil.m110864d("ByteRtcEngineEventHandler", "onStreamSubscribed...");
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamSubscribed(SubscribeState.values()[i], str, subscribeConfig);
            }
        } catch (Exception e) {
    ...
    public void onFirstLocalScreenFrame(int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstLocalScreenFrame(i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onFirstLocalVideoFrame(int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstLocalVideoFrame(i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onInviteFailed(String str, String str2, int i) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onInviteFailed(str, str2, i);
            }
        } catch (Exception e) {
    ...
    public void onNetworkQuality(String str, int i, int i2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onNetworkQuality(str, i3, i4);
            }
        } catch (Exception e) {
    ...
    public void onProviderEvent(int i, String str, String str2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onProviderEvent(i, str, str2);
            }
        } catch (Exception e) {
    ...
    public void onStreamMessage(String str, int i, byte[] bArr) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamMessage(str, i, bArr);
            }
        } catch (Exception e) {
    ...
    public void onAudioQuality(String str, int i, short s, short s2) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onAudioQuality(str, i, s, s2);
            }
        } catch (Exception e) {
    ...
    public void onFirstRemoteScreenFrame(String str, int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstRemoteScreenFrame(str, i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onFirstRemoteVideoDecoded(String str, int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstRemoteVideoDecoded(str, i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onFirstRemoteVideoFrame(String str, int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onFirstRemoteVideoFrame(str, i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onVideoSizeChanged(String str, int i, int i2, int i3) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onVideoSizeChanged(str, i, i2, i3);
            }
        } catch (Exception e) {
    ...
    public void onStreamMessageError(String str, int i, int i2, int i3, int i4) {
        ...
        try {
            if (C51644RtcEngineImpl.getRtcEngineHandler() != null) {
                C51644RtcEngineImpl.getRtcEngineHandler().onStreamMessageError(str, i, i2, i3, i4);
            }
        } catch (Exception e) {
