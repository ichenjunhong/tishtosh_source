package com.p683ss.video.rtc.engine.live;
...
public class LiveTranscoding {
    ...
    public static class Layout {
        ...
        public static class Region {
            ...
            /* renamed from: h */
            public double f128966h;
            public int renderMode;
            public String uid;

            /* renamed from: w */
            public double f128967w;

            /* renamed from: x */
            public double f128968x;

            /* renamed from: y */
            public double f128969y;
            public int zorder;
            ...
            try {
                if (this.regions != null) {
                    for (Region region : this.regions) {
                        ...
                        jSONObject3.put("x", region.f128968x);
                        jSONObject3.put("y", region.f128969y);
                        jSONObject3.put("w", region.f128967w);
                        jSONObject3.put("h", region.f128966h);
                ...
                LogUtil.m110869w("LiveTranscoding", "create layout json message happen exception", e);
                return null;
            }
        }
        ...
        try {
            ...
            if (this.layout.regions != null) {
                ...
                while (i < length) {
                    ...
                    int i2 = length;
                    jSONObject8.put("x", region.f128968x);
                    jSONObject8.put("y", region.f128969y);
                    jSONObject8.put("w", region.f128967w);
                    jSONObject8.put("h", region.f128966h);
            ...
            LogUtil.m110869w("LiveTranscoding", "get json message happen exception", e);
            return null;
        }
    }
