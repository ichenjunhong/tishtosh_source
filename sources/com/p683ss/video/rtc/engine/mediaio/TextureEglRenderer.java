...
import com.p683ss.video.rtc.engine.p2608ui.VideoFrameRender.OnEglSurfaceCreated;
...
public class TextureEglRenderer extends EglRenderer implements SurfaceTextureListener {
    ...
    public void release() {
        LogUtil.m110864d("TextureEglRenderer", "release");
        this.hasInit = false;
        super.release();
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        LogUtil.m110864d("TextureEglRenderer", "onSurfaceTextureDestroyed");
    ...
    public void bind(TextureView textureView, OnEglSurfaceCreated onEglSurfaceCreated) {
        if (!this.hasInit) {
            LogUtil.m110864d("TextureEglRenderer", "TextureView not init");
            return;
        }
        LogUtil.m110864d("TextureEglRenderer", "bind");
    ...
    public void init(Context context, int[] iArr, GlDrawer glDrawer) {
        ThreadUtils.checkIsOnMainThread();
        LogUtil.m110864d("TextureEglRenderer", "init");
        this.hasInit = true;
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ThreadUtils.checkIsOnMainThread();
        LogUtil.m110864d("TextureEglRenderer", "onSurfaceTextureAvailable");
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        LogUtil.m110864d("TextureEglRenderer", "onSurfaceTextureSizeChanged");
        if (this.mSurfaceTextureListener != null) {
