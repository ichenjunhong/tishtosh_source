...
public class SurfaceEglRender extends SurfaceEglRenderer {
    ...
    public void release() {
        this.hasInit = false;
        LogUtil.m110864d("SurfaceEglRender", "release");
        super.release();
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        LogUtil.m110864d("SurfaceEglRender", "surfaceDestroyed");
    }

    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        super.surfaceCreated(surfaceHolder);
        LogUtil.m110864d("SurfaceEglRender", "surfaceCreated");
    ...
    public void bind(SurfaceView surfaceView) {
        if (!this.hasInit) {
            LogUtil.m110864d("SurfaceEglRender", "surfaceView not init!");
            return;
        }
        LogUtil.m110864d("SurfaceEglRender", "bind");
    ...
    public void init(Context context, int[] iArr, GlDrawer glDrawer) {
        ...
        LogUtil.m110864d("SurfaceEglRender", "init");
        this.hasInit = true;
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        ...
        LogUtil.m110864d("SurfaceEglRender", "surfaceChanged");
    }
}
