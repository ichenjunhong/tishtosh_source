...
import com.p683ss.video.rtc.engine.InternalVideoStreamDescription;
import com.p683ss.video.rtc.engine.LogReport;
import com.p683ss.video.rtc.engine.NativeFunctions;
import com.p683ss.video.rtc.engine.PublisherConfiguration;
import com.p683ss.video.rtc.engine.RtcEngineEx;
import com.p683ss.video.rtc.engine.SubscribeConfig;
import com.p683ss.video.rtc.engine.VideoCanvas;
import com.p683ss.video.rtc.engine.VideoStreamDescription;
import com.p683ss.video.rtc.engine.adapter.VideoSinkAdapter;
import com.p683ss.video.rtc.engine.client.IVideoRenderer;
import com.p683ss.video.rtc.engine.client.VideoCanvasManager;
import com.p683ss.video.rtc.engine.client.VideoSinkManager;
import com.p683ss.video.rtc.engine.data.ByteRtcData;
import com.p683ss.video.rtc.engine.handler.ByteRtcAudioFrameObserver;
import com.p683ss.video.rtc.engine.handler.ByteRtcEngineEventHandler;
import com.p683ss.video.rtc.engine.handler.ByteRtcEngineInternalEventHandler;
import com.p683ss.video.rtc.engine.handler.ByteRtcVideoFrameObserver;
import com.p683ss.video.rtc.engine.handler.EngineAudioDeviceEventHandler;
...
import com.p683ss.video.rtc.engine.handler.IRtcEngineInternalEventHandler;
import com.p683ss.video.rtc.engine.live.LiveTranscoding;
import com.p683ss.video.rtc.engine.live.LiveTranscoding.Layout;
import com.p683ss.video.rtc.engine.loader.RtcNativeLibraryListenerImpl;
import com.p683ss.video.rtc.engine.loader.RtcNativeLibraryLoaderListener;
import com.p683ss.video.rtc.engine.mediaio.IFrameRender;
import com.p683ss.video.rtc.engine.mediaio.IVideoSink;
import com.p683ss.video.rtc.engine.p2608ui.RenderView;
import com.p683ss.video.rtc.engine.p2608ui.VideoFrameRender;
import com.p683ss.video.rtc.engine.p2608ui.VideoFrameRender.FirstVideoFrameRenderListener;
import com.p683ss.video.rtc.engine.utils.AudioUtils;
import com.p683ss.video.rtc.engine.utils.ExtVideoFrame;
import com.p683ss.video.rtc.engine.utils.LogUtil;
import com.p683ss.video.rtc.engine.utils.LogUtil.LoggerSink;
import com.p683ss.video.rtc.engine.utils.VideoFrameConverter;
import com.p683ss.video.rtc.engine.video.VideoCapture;
import com.p683ss.video.rtc.engine.video.VideoEncoderConfiguration.ORIENTATION_MODE;
import com.p683ss.video.rtc.engine.video.VideoFrameDeliver;
import java.io.File;
...
public final class C51644RtcEngineImpl extends RtcEngineEx {
    private static WeakReference<IAudioFrameObserver> mAudioFrameObserver;
    private static C51644RtcEngineImpl mInstance;
    ...
    public long mNativeByteRtcEngine = -1;
    ...
    public static IAudioFrameObserver getAudioFrameObserver() {
        ...
        return (IAudioFrameObserver) mAudioFrameObserver.get();
    }
    ...
    public final IRtcEngineInternalEventHandler getRtcEngineInternalEventHandler() {
        if (this.mRtcEngineInternalEventHandler == null) {
            return null;
        }
        return (IRtcEngineInternalEventHandler) this.mRtcEngineInternalEventHandler.get();
    }
    ...
    private void checkAudioRouter() {
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, checkAudioRouter failed.");
    ...
    public final void disableLiveTranscoding() {
        LogUtil.m110864d("RtcEngineImpl", "disableLiveTranscoding...");
        this.mEnableTranscode = false;
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, disableLiveTranscoding failed.");
        } else {
    ...
    public final int getAudioMixingCurrentPosition() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, getAudioMixingCurrentPosition failed.");
        return -1;
    }
    ...
    public final int getAudioMixingDuration() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, getAudioMixingDuration failed.");
        return -1;
    }
    ...
    public final int pauseAllEffects() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pauseAllEffects failed.");
        return -1;
    }

    public final int pauseAudio() {
        LogUtil.m110864d("RtcEngineImpl", "pauseAudio.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pauseAudio failed.");
            return -1;
        }
    ...
    public final int pauseAudioMixing() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pauseAudioMixing failed.");
        return -1;
    }
    ...
    public final int publishScreen() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, publishScreen failed.");
        return -1;
    }
    ...
    public final int resumeAllEffects() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, resumeAllEffects failed.");
        return -1;
    }

    public final int resumeAudio() {
        LogUtil.m110864d("RtcEngineImpl", "resumeAudio.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, resumeAudio failed.");
            return -1;
        }
    ...
    public final int resumeAudioMixing() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, resumeAudioMixing failed.");
        return -1;
    }

    public final int startPreview() {
        LogUtil.m110864d("RtcEngineImpl", "startPreview.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, startPreview failed.");
            return -1;
        }
    ...
    public final int stopAllEffects() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, stopAllEffects failed.");
        return -1;
    }

    public final int stopAudioMixing() {
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, stopAudioMixing failed.");
            return -1;
        }
    ...
    public final int stopPreview() {
        LogUtil.m110864d("RtcEngineImpl", "stopPreview.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, stopPreview failed.");
            return -1;
        }
    ...
    public final int switchCamera() {
        LogUtil.m110864d("RtcEngineImpl", "switchCamera");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, switchCamera failed.");
            return -1;
        }
    ...
    public final int unloadAllEffects() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, unloadAllEffects failed.");
        return -1;
    }
    ...
    public final int unpublishScreen() {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, unpublishScreen failed.");
        return -1;
    }

    public static IRtcEngineEventHandler getRtcEngineHandler() {
        synchronized (C51644RtcEngineImpl.class) {
            if (!mLibraryLoaded) {
                loadSoFile();
            }
            if (mInstance != null) {
    ...
    public final int disableAudio() {
        LogUtil.m110864d("RtcEngineImpl", "disableAudio.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, disableAudio failed.");
            return -1;
        }
    ...
    public final int disableVideo() {
        LogUtil.m110864d("RtcEngineImpl", "disableVideo.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, disableVideo failed.");
            return -1;
        }
    ...
    public final int enableAudio() {
        LogUtil.m110864d("RtcEngineImpl", "enableAudio.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableAudio failed.");
            return -1;
        }
    ...
    public final int enableVideo() {
        LogUtil.m110864d("RtcEngineImpl", "enableVideo.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableVideo failed.");
            return -1;
        }
    ...
    private static void loadSoFile() {
        if (mLibraryLoaded) {
            ...
            try {
                ...
                LogUtil.m110866e("RtcEngineImpl", "Failed to load native library: bytertc", e);
                mRtcNativeLibraryListener.onLoadError("bytertc");
            }
        }
    }
    ...
    public final void doDestroy() {
        LogUtil.m110864d("RtcEngineImpl", "destroy RtcEngineImpl.");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, no need to destroy now.");
            return;
        }
    ...
    public final int leaveChannel() {
        LogUtil.m110864d("RtcEngineImpl", "leaveChannel");
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, leaveChannel failed.");
            return -1;
        }
    ...
    public static void setApiServerHost(String[] strArr) {
        ...
        if (strArr.length > 1) {
            LogUtil.m110864d("RtcEngineImpl", "Native sdk only support only on now, Need to change later.");
        }
    ...
    public final int adjustAudioMixingPlayoutVolume(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, adjustAudioMixingPlayoutVolume failed.");
        return -1;
    }
    ...
    public final int adjustAudioMixingPublishVolume(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, adjustAudioMixingPublishVolume failed.");
        return -1;
    }
    ...
    public final int adjustAudioMixingVolume(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, adjustAudioMixingVolume failed.");
        return -1;
    }

    public final int adjustPlaybackSignalVolume(int i) {
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, adjustPlaybackSignalVolume failed.");
            return -1;
        }
    ...
    public final int adjustRecordingSignalVolume(int i) {
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, adjustRecordingSignalVolume failed.");
            return -1;
        }
    ...
    public final int getEffectVolume(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, getEffectVolume failed.");
        return -1;
    }
    ...
    public final /* synthetic */ void lambda$setupLocalScreen$9$RtcEngineImpl(VideoCanvas videoCanvas) {
        ...
        this.mVideoFrameDeliver.setScreenLocalUid(videoCanvas.uid);
    ...
    public final int pauseEffect(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pauseEffect failed.");
        return -1;
    }
    ...
    public final int resumeEffect(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, resumeEffect failed.");
        return -1;
    }

    public final void sendCustomMessage(String str) {
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, sendCustomMessage failed.");
        } else {
    ...
    public final int setAudioMixingPosition(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setAudioMixingPosition failed.");
        return -1;
    }
    ...
    public final int setEffectsVolume(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setEffectsVolume failed.");
        return -1;
    }
    ...
    public final int stopEffect(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, stopEffect failed.");
        return -1;
    }
    ...
    public final int unloadEffect(int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, unloadEffect failed.");
        return -1;
    }
    ...
    public static void setRtcEngineEventHandler(IRtcEngineEventHandler iRtcEngineEventHandler) {
        LogUtil.m110864d("RtcEngineImpl", "setRtcEngineEventHandler");
        synchronized (C51644RtcEngineImpl.class) {
            if (!mLibraryLoaded) {
                loadSoFile();
            }
    ...
    public final void enableAutoSubscribe(boolean z) {
        ...
        sb.append(z);
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableAutoSubscribe failed.");
        } else {
    ...
    public final int enableLocalAudio(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableLocalAudio failed.");
            return -1;
        }
    ...
    public final int enableLocalVideo(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableLocalVideo failed.");
            return -1;
        }
    ...
    public final void enableSubscribeLocalStream(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableSubscribeLocalStream failed.");
        } else {
    ...
    public final /* synthetic */ void lambda$setupLocalVideo$5$RtcEngineImpl(VideoCanvas videoCanvas) {
        ...
        if (videoCanvas.view != null) {
            ...
            this.mVideoFrameDeliver.setVideoLocalUid(videoCanvas.uid);
    ...
    public final /* synthetic */ void lambda$setupRemoteVideo$4$RtcEngineImpl(final VideoCanvas videoCanvas) {
        ...
        if (videoCanvas.view instanceof VideoFrameRender) {
            ((VideoFrameRender) videoCanvas.view).setFristVideoFrameRenderListener(new FirstVideoFrameRenderListener() {
                public void onFirstVideoFrameRender(int i) {
                    NativeFunctions.nativeRemoteFristVideoFrameRendered(C51644RtcEngineImpl.this.mNativeByteRtcEngine, videoCanvas.uid, i);
                }
            });
        }
    ...
    public final int muteAllRemoteAudioStreams(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteAllRemoteAudioStreams failed.");
            return -1;
        }
    ...
    public final int muteAllRemoteVideoStreams(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteAllRemoteVideoStreams failed.");
            return -1;
        }
    ...
    public final int muteLocalAudioStream(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteLocalAudioStream failed.");
            return -1;
        }
    ...
    public final int muteLocalVideoStream(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteLocalVideoStream failed.");
            return -1;
        }
    ...
    public final boolean pushExternalVideoFrame(ExtVideoFrame extVideoFrame) {
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pushExternalVideoFrame failed.");
            return false;
        }
        VideoFrameConverter videoFrameConverter = this.mVideoFrameConverter;
        RtcEngineImpl$$Lambda$7 rtcEngineImpl$$Lambda$7 = new RtcEngineImpl$$Lambda$7(this, extVideoFrame, videoFrame, currentTimeMillis);
        videoFrameConverter.post(rtcEngineImpl$$Lambda$7);
        return true;
    }
    ...
    public final boolean pushScreenFrame(ExtVideoFrame extVideoFrame) {
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pushScreenFrame failed.");
            return false;
        }
    ...
    public final int setChannelProfile(int i) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setChannelProfile failed.");
            return -1;
        }
    ...
    public final int setClientRole(int i) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setClientRole failed.");
            return -1;
        }
    ...
    public final int setDefaultAudioRouteToSpeakerPhone(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setDefaultAudioRouteToSpeakerPhone failed.");
            return -1;
        }
    ...
    public final int setDefaultMuteAllRemoteAudioStreams(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setDefaultMuteAllRemoteAudioStreams failed.");
            return -1;
        }
    ...
    public final int setDefaultMuteAllRemoteVideoStreams(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setDefaultMuteAllRemoteVideoStreams failed.");
            return -1;
        }
    ...
    public final int setEnableSpeakerphone(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setEnableSpeakerphone failed.");
            return -1;
        }
    ...
    public final void setHeadsetConnectionStatus(boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setHeadsetConnectionStatus failed.");
        } else {
    ...
    public final int setMediaServerAddr(String str) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setMediaServerAddr failed.");
            return -1;
        }
    ...
    public final int setupLocalScreen(VideoCanvas videoCanvas) {
        if (videoCanvas == null || videoCanvas.uid == null || videoCanvas.uid.isEmpty()) {
            LogUtil.m110867i("RtcEngineImpl", "EventType: setupLocalScreen canvas is null");
            return -1;
        }
        StringBuilder sb = new StringBuilder("EventType: setupLocalScreen canvas:");
        sb.append(videoCanvas.hashCode());
        LogUtil.m110867i("RtcEngineImpl", sb.toString());
    ...
    public final void setupRemoteScreen(VideoCanvas videoCanvas) {
        if (videoCanvas == null) {
            LogUtil.m110867i("RtcEngineImpl", "EventType: setupRemoteScreen canvas is null");
            return;
        }
    ...
    public final void unSubscribe(String str) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, unSubscribe failed.");
        } else {
    ...
    private int setupVideoViewOnMainThread(VideoCanvas videoCanvas) {
        ...
        try {
            LogUtil.m110868w("RtcEngineImpl", "setup video view on main thread");
            LogUtil.m110864d("RtcEngineImpl", "setupVideoViewOnMainThread-createEglContext");
            videoCanvas.view.init(this.mRootEglBase.getEglBaseContext());
            if (videoCanvas.view instanceof VideoFrameRender) {
                LogUtil.m110864d("RtcEngineImpl", "setupVideoViewOnMainThread-createSurface");
            ...
            LogUtil.m110869w("RtcEngineImpl", "setup video view on main thread happen exception", e);
            return -1;
        }
    }

    public final void enableLiveTranscoding(LiveTranscoding liveTranscoding) {
        LogUtil.m110864d("RtcEngineImpl", "enableLiveTranscoding...");
        if (liveTranscoding == null) {
            LogUtil.m110864d("RtcEngineImpl", "enableLiveTranscoding...liveTranscode is null, no effect, please check.");
        } else if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableLiveTranscoding failed.");
        } else {
    ...
    public final void setVideoCompositingLayout(Layout layout) {
        LogUtil.m110864d("RtcEngineImpl", "setVideoCompositingLayout...");
        if (this.mLiveTranscoding == null) {
            LogUtil.m110864d("RtcEngineImpl", "setVideoCompositingLayout...mLiveTranscoding is null, no effect, please check.");
        } else if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setVideoCompositingLayout failed.");
        } else {
    ...
    public final int preloadEffect(int i, String str) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, preloadEffect failed.");
        return -1;
    }
    ...
    public final boolean pullExternalAudioFrame(byte[] bArr, int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pullExternalAudioFrame failed.");
        return false;
    }
    ...
    public final boolean pushExternalAudioFrame(byte[] bArr, int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, pushExternalAudioFrame failed.");
        return false;
    }
    ...
    public final long sendMessage(String str, String str2) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, sendMessage failed.");
        return -1;
    }
    ...
    public final int setVolumeOfEffect(int i, int i2) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setVolumeOfEffect failed.");
        return -1;
    }
    ...
    public final int enableAudioVolumeIndication(int i, int i2) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, enableAudioVolumeIndication failed.");
            return -1;
        }
    ...
    public final int muteRemoteAudioStream(String str, boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteRemoteAudioStream failed.");
            return -1;
        }
    ...
    public final int muteRemoteVideoStream(String str, boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, muteRemoteVideoStream failed.");
            return -1;
        }
    ...
    public final int setVideoProfile(int i, boolean z) {
        ...
        LogUtil.m110864d("RtcEngineImpl", sb.toString());
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setVideoProfile failed.");
            return -1;
        }
    ...
    public final void subscribeStream(String str, SubscribeConfig subscribeConfig) {
        ...
        if (subscribeConfig != null) {
            if (this.mNativeByteRtcEngine == -1) {
                LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, subscribeStream failed.");
            } else {
    ...
    public final boolean pushExternalVideoFrame(ExtVideoFrame extVideoFrame, boolean z) {
        ...
        if (z) {
            NativeFunctions.nativePushExternalVideoFrame(this.mNativeByteRtcEngine, videoFrame2, VideoFrameConverter.getFrameExtendedData(extVideoFrame), currentTimeMillis);
            videoFrame2.release();
        } else {
            VideoFrameConverter videoFrameConverter = this.mVideoFrameConverter;
            RtcEngineImpl$$Lambda$8 rtcEngineImpl$$Lambda$8 = new RtcEngineImpl$$Lambda$8(this, extVideoFrame, videoFrame2, currentTimeMillis);
            videoFrameConverter.post(rtcEngineImpl$$Lambda$8);
        }
        return true;
    }
    ...
    public final int setVideoResolutions(VideoStreamDescription[] videoStreamDescriptionArr, ORIENTATION_MODE orientation_mode) {
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setVideoResolutions failed.");
            return -1;
        }
        ArrayList arrayList = new ArrayList();
        for (VideoStreamDescription videoStreamDescription : videoStreamDescriptionArr) {
            if (!videoStreamDescription.isValid()) {
                LogUtil.m110865e("RtcEngineImpl", "setVideoResolutions with illegal params");
                return -2;
            }
    ...
    /* access modifiers changed from: 0000 */
    public final /* synthetic */ void lambda$pushExternalVideoFrame$7$RtcEngineImpl(ExtVideoFrame extVideoFrame, VideoFrame videoFrame, long j) {
        NativeFunctions.nativePushExternalVideoFrame(this.mNativeByteRtcEngine, videoFrame, VideoFrameConverter.getFrameExtendedData(extVideoFrame), j);
        videoFrame.release();
    }

    /* access modifiers changed from: 0000 */
    public final /* synthetic */ void lambda$pushExternalVideoFrame$8$RtcEngineImpl(ExtVideoFrame extVideoFrame, VideoFrame videoFrame, long j) {
        NativeFunctions.nativePushExternalVideoFrame(this.mNativeByteRtcEngine, videoFrame, VideoFrameConverter.getFrameExtendedData(extVideoFrame), j);
        videoFrame.release();
    }
    ...
    public final void setExternalVideoSource(boolean z, boolean z2, boolean z3) {
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setExternalVideoSource failed.");
        } else {
    ...
    static final /* synthetic */ void lambda$new$0$RtcEngineImpl(RtcLogLevel rtcLogLevel, String str, Throwable th) {
        ...
        if (rtcEngineHandler != null) {
            try {
                ...
                LogUtil.m110865e("RtcEngineImpl", sb.toString());
            }
        }
    }
    ...
    private void setupRemoteVideoInternal(IFrameRender iFrameRender, String str, boolean z) {
        ...
        if (z) {
            if (iFrameRender != null) {
                this.mVideoFrameDeliver.setScreenLocalUid(str);
    ...
    public final int startAudioMixing(String str, boolean z, boolean z2, int i) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, startAudioMixing failed.");
        return -1;
    }

    private int setLocalRenderInternal(IVideoSink iVideoSink, String str, boolean z, boolean z2) {
        if (iVideoSink == null) {
            LogUtil.m110867i("RtcEngineImpl", "EventType: setLocalRenderInternal videoSink is null");
            return -1;
        }
    ...
    private int setupRemoteVideoRenderInternal(IVideoSink iVideoSink, String str, boolean z, boolean z2) {
        if (iVideoSink == null) {
            LogUtil.m110867i("RtcEngineImpl", "EventType: setupRemoteRenderInternal videoSink is null");
            return -1;
        }
    ...
    public final boolean setExternalAudioDevice(boolean z, int i, int i2, int i3) {
        if (i != 8000 && i != 16000 && i != 32000 && i != 44100 && i != 48000) {
            ...
            sb2.append(i2);
            LogUtil.m110867i("RtcEngineImpl", sb2.toString());
            return false;
        } else if (i3 != 1 && i3 != 2) {
            StringBuilder sb3 = new StringBuilder("playout channel num should be in [ 1 / 2 ], but it is setted to be:  ");
            sb3.append(i3);
            LogUtil.m110867i("RtcEngineImpl", sb3.toString());
            return false;
        } else if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setExternalAudioDevice failed.");
            return false;
        } else {
    ...
    public final int setVideoResolution(int i, int i2, int i3, int i4) {
        LogUtil.m110864d("RtcEngineImpl", C2240a.m6772a("setVideoResolution, width: %d, height: %d, frameRate: %d, bitrate: %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)}));
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, setVideoResolution failed.");
            return -1;
        }
    ...
    public C51644RtcEngineImpl(Context context, String str, IRtcEngineEventHandler iRtcEngineEventHandler, Object obj) {
        boolean z = true;
        ...
        this.mVideoFrameConverter = new VideoFrameConverter(z);
        ...
        VideoCapture.setEglBaseContext(this.mRootEglBase.getEglBaseContext());
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "create native engine error, native engine is invalid.");
        } else {
    ...
    public final int playEffect(int i, String str, boolean z, int i2, int i3) {
        ...
        LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, playEffect failed.");
        return -1;
    }
    ...
    public final int joinChannel(String str, String str2, PublisherConfiguration publisherConfiguration, String str3, String str4) {
        ...
        if (this.mNativeByteRtcEngine == -1) {
            LogUtil.m110865e("RtcEngineImpl", "native engine is invalid, joinChannel failed.");
            return -1;
        }
        ...
        if (AudioUtils.isInOpenSLESBlackModelSet()) {
            ...
            LogUtil.m110868w("RtcEngineImpl", sb2.toString());
            ...
            LogUtil.m110868w("RtcEngineImpl", sb3.toString());
        }
