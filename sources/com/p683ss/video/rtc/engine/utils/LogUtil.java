...
public class LogUtil {
    ...
    /* renamed from: d */
    public static void m110864d(String str, String str2) {
        if (RtcLogLevel.RTC_LOG_LEVEL_DEBUG.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s] %s [msg:%s]", new Object[]{"DEBUG", getTraceInfo(), str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_DEBUG, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), null);
        }
    }

    /* renamed from: e */
    public static void m110865e(String str, String str2) {
        if (RtcLogLevel.RTC_LOG_LEVEL_ERROR.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s] %s [msg:%s]", new Object[]{"ERROR", getTraceInfo(), str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_ERROR, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), null);
        }
    }

    /* renamed from: i */
    public static void m110867i(String str, String str2) {
        if (RtcLogLevel.RTC_LOG_LEVEL_INFO.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s] %s [msg:%s]", new Object[]{"INFO", getTraceInfo(), str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_INFO, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), null);
        }
    }

    /* renamed from: w */
    public static void m110868w(String str, String str2) {
        if (RtcLogLevel.RTC_LOG_LEVEL_WARNING.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s] %s [msg:%s]", new Object[]{"WARNING", getTraceInfo(), str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_WARNING, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), null);
        }
    }
    ...
    /* renamed from: e */
    public static void m110866e(String str, String str2, Throwable th) {
        if (RtcLogLevel.RTC_LOG_LEVEL_ERROR.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s][msg:%s]", new Object[]{"ERROR", str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_ERROR, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), th);
        }
    }

    /* renamed from: w */
    public static void m110869w(String str, String str2, Throwable th) {
        if (RtcLogLevel.RTC_LOG_LEVEL_WARNING.compareTo(sLogLevel) >= 0) {
            String a = C2240a.m6772a("[%s][msg:%s]", new Object[]{"WARNING", str2});
            notifyLoggerSinks(RtcLogLevel.RTC_LOG_LEVEL_WARNING, C2240a.m6772a("[%s:%s]:%s", new Object[]{"BYTERTC", str, a}), th);
        }
    }
}
