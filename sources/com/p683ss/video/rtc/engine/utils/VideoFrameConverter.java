...
public class VideoFrameConverter {
    ...
    public synchronized org.webrtc.VideoFrame converterExtFrametoVideoFrame(com.p683ss.video.rtc.engine.utils.ExtVideoFrame r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            r0 = 0
        ...
        L_0x001e:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110868w(r5, r1)     // Catch:{ all -> 0x005f }
            monitor-exit(r4)
            return r0
        L_0x0027:
        ...
        L_0x005f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.video.rtc.engine.utils.VideoFrameConverter.converterExtFrametoVideoFrame(com.ss.video.rtc.engine.utils.ExtVideoFrame):org.webrtc.VideoFrame");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized org.webrtc.VideoFrame getVideoFrame(com.p683ss.video.rtc.engine.utils.ExtVideoFrame r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            r0 = 0
            if (r6 == 0) goto L_0x0098
            boolean r1 = r5.mIsStart     // Catch:{ all -> 0x0095 }
            if (r1 != 0) goto L_0x000a
            goto L_0x0098
        L_0x000a:
            int r1 = r6.format     // Catch:{ all -> 0x0095 }
            r2 = 11
            r3 = 10
        ...
        L_0x0022:
            ...
            java.lang.String r1 = "pushExternalVideoFrame ExtVideoFrame type is not available"
            com.p683ss.video.rtc.engine.utils.LogUtil.m110868w(r6, r1)     // Catch:{ all -> 0x0095 }
            monitor-exit(r5)
            return r0
        L_0x002b:
            int r0 = r6.stride     // Catch:{ all -> 0x0095 }
            int r1 = r6.height     // Catch:{ all -> 0x0095 }
            org.webrtc.VideoFrame r6 = r6.getVideoFrame(r0, r1)     // Catch:{ all -> 0x0095 }
            monitor-exit(r5)
            return r6
        L_0x0035:
            java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0095 }
            android.opengl.EGLContext r1 = r6.eglContext14     // Catch:{ all -> 0x0095 }
            if (r1 == 0) goto L_0x0046
            android.opengl.EGLContext r1 = r6.eglContext14     // Catch:{ all -> 0x0095 }
            int r2 = r6.stride     // Catch:{ all -> 0x0095 }
            int r4 = r6.height     // Catch:{ all -> 0x0095 }
            r5.updateEglContext(r1, r2, r4)     // Catch:{ all -> 0x0095 }
            goto L_0x0053
        L_0x0046:
            javax.microedition.khronos.egl.EGLContext r1 = r6.eglContext11     // Catch:{ all -> 0x0095 }
            ...
            r5.updateEglContext(r1, r2, r4)     // Catch:{ all -> 0x0095 }
        L_0x0053:
            com.ss.video.rtc.engine.utils.TextureHelper r1 = r5.mTextureHelper     // Catch:{ all -> 0x0095 }
            if (r1 == 0) goto L_0x0093
            boolean r1 = r5.mIsConvertYUV     // Catch:{ all -> 0x0095 }
            if (r1 != 0) goto L_0x0089
            boolean r1 = sEnableTextureCopy     // Catch:{ all -> 0x0095 }
            if (r1 == 0) goto L_0x0089
            com.ss.video.rtc.engine.utils.TextureHelper r1 = r5.mTextureHelper     // Catch:{ all -> 0x0095 }
            int r1 = r1.dequeueTexture()     // Catch:{ all -> 0x0095 }
            if (r1 != 0) goto L_0x0069
            monitor-exit(r5)
            return r0
        L_0x0069:
            com.ss.video.rtc.engine.utils.TextureHelper r0 = r5.mTextureHelper     // Catch:{ all -> 0x0095 }
            int r2 = r6.format     // Catch:{ all -> 0x0095 }
            int r4 = r6.textureID     // Catch:{ all -> 0x0095 }
            r0.drawTexture(r2, r4, r1)     // Catch:{ all -> 0x0095 }
            r6.textureID = r1     // Catch:{ all -> 0x0095 }
            r6.format = r3     // Catch:{ all -> 0x0095 }
            java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0095 }
            com.ss.video.rtc.engine.utils.TextureHelper r0 = r5.mTextureHelper     // Catch:{ all -> 0x0095 }
            int r1 = r6.stride     // Catch:{ all -> 0x0095 }
            int r2 = r6.height     // Catch:{ all -> 0x0095 }
            com.ss.video.rtc.engine.utils.VideoFrameConverter$$Lambda$0 r3 = new com.ss.video.rtc.engine.utils.VideoFrameConverter$$Lambda$0     // Catch:{ all -> 0x0095 }
            r3.<init>(r5, r6)     // Catch:{ all -> 0x0095 }
            org.webrtc.VideoFrame r0 = r6.getVideoFrame(r0, r1, r2, r3)     // Catch:{ all -> 0x0095 }
            goto L_0x0093
        L_0x0089:
            com.ss.video.rtc.engine.utils.TextureHelper r0 = r5.mTextureHelper     // Catch:{ all -> 0x0095 }
            int r1 = r6.stride     // Catch:{ all -> 0x0095 }
            int r2 = r6.height     // Catch:{ all -> 0x0095 }
            org.webrtc.VideoFrame r0 = r6.getVideoFrame(r0, r1, r2)     // Catch:{ all -> 0x0095 }
        L_0x0093:
            monitor-exit(r5)
            return r0
        L_0x0095:
        ...
        L_0x0098:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.video.rtc.engine.utils.VideoFrameConverter.getVideoFrame(com.ss.video.rtc.engine.utils.ExtVideoFrame):org.webrtc.VideoFrame");
    }
    ...
    private void updateEglContext(EGLContext eGLContext, int i, int i2) {
        if (this.mTextureHelper == null) {
            ...
            LogUtil.m110867i("zhendachang", "create  egl14 texture helper");
            return;
        }
        if (this.mContextObject != eGLContext) {
            ...
            sb.append(eGLContext);
            LogUtil.m110867i("VideoFrameConverter", sb.toString());
        }
    }
    ...
    private void updateEglContext(javax.microedition.khronos.egl.EGLContext eGLContext, int i, int i2) {
        if (this.mTextureHelper == null) {
            ...
            this.mContextObject = eGLContext;
            LogUtil.m110867i("zhendachang", "create  egl10 texture helper");
            return;
        }
        if (this.mContextObject != eGLContext) {
            this.mContextObject = eGLContext;
