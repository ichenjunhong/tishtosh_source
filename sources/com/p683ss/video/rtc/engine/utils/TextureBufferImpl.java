...
public class TextureBufferImpl implements EglContextCarrier, TextureBuffer {
    ...
    public void saveMyBitmap(java.lang.String r7, byte[] r8, int r9, int r10) {
        /*
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110867i(r9, r10)
        ...
        L_0x003a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.video.rtc.engine.utils.TextureBufferImpl.saveMyBitmap(java.lang.String, byte[], int, int):void");
    }
    ...
    public Buffer scaleAndFill(int i, int i2, int i3, int i4) {
        ...
        TextureBufferImpl textureBufferImpl = new TextureBufferImpl(i, i2, this.type, this.f128970id, matrix, this.textureHelper, new Runnable() {
            public void run() {
    ...
    public Buffer cropAndScale(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        TextureBufferImpl textureBufferImpl = new TextureBufferImpl(i5, i6, this.type, this.f128970id, matrix, this.textureHelper, new Runnable() {
            public void run() {
                TextureBufferImpl.this.release();
            }
        });
