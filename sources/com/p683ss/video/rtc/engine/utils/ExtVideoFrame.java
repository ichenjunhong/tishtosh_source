...
public class ExtVideoFrame {
        ...
        if (i5 == 1) {
            ...
            switch (i5) {
                ...
                case 11:
                    ...
                    return videoFrame2;
                default:
                    LogUtil.m110868w("ExtVideoFrame", "texture or yuv picture format is not support");
                    return null;
            }
        }
    }
        ...
        if (i == 1) {
            ...
            switch (i) {
                ...
                case 11:
                    break;
                default:
                    LogUtil.m110868w("ExtVideoFrame", "picture format is not support");
                    break;
            }
            return null;
        }
    ...
    public String toString() {
        ...
        sb.append(", videoFrameExtendedData=");
        sb.append(this.videoFrameExtendedData);
        sb.append('}');
        return sb.toString();
    }
    ...
    public VideoFrame getVideoFrame(TextureHelper textureHelper, int i, int i2) {
        ...
        int i3 = this.format;
        if (i3 == 1 || i3 == 3) {
            return getVideoFrame(textureHelper, i, i2, null);
        }
        switch (i3) {
            case 10:
                float f = (float) i;
                ...
                if (((float) this.stride) / ((float) this.height) >= f3) {
                    TextureBufferImpl textureBufferImpl = new TextureBufferImpl(this.stride, this.height, Type.RGB, this.textureID, RendererCommon.convertMatrixToAndroidGraphicsMatrix(this.transform), textureHelper, null);
                    buffer = textureBufferImpl.cropAndScale((this.stride - ((int) (((float) this.height) * f3))) / 2, 0, (int) (f3 * ((float) this.height)), this.height, i, i2);
                } else {
                    TextureBufferImpl textureBufferImpl2 = new TextureBufferImpl(this.stride, this.height, Type.RGB, this.textureID, RendererCommon.convertMatrixToAndroidGraphicsMatrix(this.transform), textureHelper, null);
                    float f4 = f2 / f;
                    buffer = textureBufferImpl2.cropAndScale(0, (this.height - ((int) (((float) this.stride) * f4))) / 2, this.stride, (int) (f4 * ((float) this.stride)), i, i2);
                }
                return new VideoFrame(buffer.toI420(), this.rotation, this.timeStamp);
            case 11:
                float f5 = (float) i;
                float f6 = (float) i2;
                float f7 = f5 / f6;
                if (((float) this.stride) / ((float) this.height) >= f7) {
                    TextureBufferImpl textureBufferImpl3 = new TextureBufferImpl(this.stride, this.height, Type.OES, this.textureID, RendererCommon.convertMatrixToAndroidGraphicsMatrix(this.transform), textureHelper, null);
                    buffer2 = textureBufferImpl3.cropAndScale((this.stride - ((int) (((float) this.height) * f7))) / 2, 0, (int) (f7 * ((float) this.height)), this.height, i, i2);
                } else {
                    TextureBufferImpl textureBufferImpl4 = new TextureBufferImpl(this.stride, this.height, Type.OES, this.textureID, RendererCommon.convertMatrixToAndroidGraphicsMatrix(this.transform), textureHelper, null);
                    float f8 = f6 / f5;
                    buffer2 = textureBufferImpl4.cropAndScale(0, (this.height - ((int) (((float) this.stride) * f8))) / 2, this.stride, (int) (f8 * ((float) this.stride)), i, i2);
                }
                return new VideoFrame(buffer2.toI420(), this.rotation, this.timeStamp);
            default:
                LogUtil.m110868w("ExtVideoFrame", "texture or yuv picture format is not support");
                return null;
        }
