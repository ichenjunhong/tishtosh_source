...
class ControllerStopState extends ControllerBaseState {
    ...
    ControllerStopState(IAudioRoutingController iAudioRoutingController) {
        ...
        LogUtil.m110867i("ControllerBaseState", "Monitor stopped");
    }
    ...
    public void onEvent(int i, int i2) {
        ...
        sb.append(", info: ");
        sb.append(i2);
        LogUtil.m110864d("ControllerBaseState", sb.toString());
        try {
            ...
            LogUtil.m110866e("ControllerBaseState", "onEvent: Exception ", e);
        }
    }
}
