package com.p683ss.video.rtc.engine.utils.audioRouting.receiver;
...
public class BTHeadsetBroadcastReceiver extends BaseAudioDeviceBroadcastReceiver {
    ...
    private void onBlueToothDeviceOffline(BluetoothDevice bluetoothDevice) {
        if (this.mBTDeviceManager.isDevicePlugged() && bluetoothDevice != null) {
            ...
            LogUtil.m110867i("BTHeadsetBroadcastReceiver", sb.toString());
            ...
            if (defaultAdapter != null && 2 != defaultAdapter.getProfileConnectionState(1)) {
                ...
                LogUtil.m110867i("BTHeadsetBroadcastReceiver", sb2.toString());
    ...
    public void onReceive(android.content.Context r5, android.content.Intent r6) {
        /*
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110864d(r1, r0)
        ...
        L_0x0040:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110867i(r0, r5)
            return
        L_0x005c:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110867i(r5, r6)
            return
        L_0x0075:
        ...
        L_0x0137:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110864d(r0, r6)
            switch(r5) {
        ...
        L_0x0169:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110867i(r6, r5)
            return
        L_0x017d:
            java.lang.String r5 = "BTHeadsetBroadcastReceiver"
        ...
        L_0x0247:
            ...
            com.p683ss.video.rtc.engine.utils.LogUtil.m110864d(r1, r5)
        ...
        L_0x02c4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.video.rtc.engine.utils.audioRouting.receiver.BTHeadsetBroadcastReceiver.onReceive(android.content.Context, android.content.Intent):void");
    }
}
