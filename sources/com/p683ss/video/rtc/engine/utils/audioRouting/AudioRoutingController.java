package com.p683ss.video.rtc.engine.utils.audioRouting;
...
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.BluetoothHeadsetScoDeviceManager;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.BluetoothHeadsetScoDeviceManager.OnBTScoDeviceCallback;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.EarpieceDeviceManager;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.SpeakerphoneDeviceManager;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.WiredHeadsetDeviceManager;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.WiredHeadsetDeviceManager.OnDeviceCallback;
import com.p683ss.video.rtc.engine.utils.audioRouting.controllerState.EventDispatcher;
...
public class AudioRoutingController extends BaseAudioRoutingController {
    ...
    public void uninitialize() {
        LogUtil.m110864d("AudioRoutingController", "uninitialize");
        this.mWiredHeadsetDeviceManager.destory();
        this.mBTScoDeviceManager.destory();
    }

    public int initialize() {
        LogUtil.m110867i("AudioRoutingController", "initialize +");
        Context context = (Context) this.mContext.get();
        if (context == null) {
            LogUtil.m110865e("AudioRoutingController", "context has been GCed");
            return -1;
        } else if (getAudioManager() == null) {
            LogUtil.m110865e("AudioRoutingController", "invalid context: can't get AudioManager");
            return -1;
        } else {
            ...
            this.mWiredHeadsetDeviceManager = new WiredHeadsetDeviceManager(context, new OnDeviceCallback() {
                ...
                public void onError(int i, String str) {
                    LogUtil.m110867i("AudioRoutingController", str);
            ...
            this.mBTScoDeviceManager = new BluetoothHeadsetScoDeviceManager(context, this.mEventHandler, new OnBTScoDeviceCallback() {
                public void onScoConnected() {
                    LogUtil.m110867i("AudioRoutingController", "BTHeadset w/o mic connected");
                }

                public void onScoDisconnected() {
                    LogUtil.m110867i("AudioRoutingController", "BTHeadset w/o mic disconnected");
                }

                public void onDeviceOffline() {
                    LogUtil.m110867i("AudioRoutingController", "BTHeadset disconnected");
                    AudioRoutingController.this.sendEvent(22, 0);
                }

                public void onDeviceOnline() {
                    LogUtil.m110867i("AudioRoutingController", "BTHeadset Device connected");
    ...
    public int updateBluetoothSco(int i) {
        LogUtil.m110864d("AudioRoutingController", "updateBluetoothSco sco started");
    ...
    public void setAudioRouting(int i) {
        ...
        LogUtil.m110867i("AudioRoutingController", sb.toString());
        if (5 == i) {
            try {
                ...
                LogUtil.m110865e("AudioRoutingController", sb2.toString());
    ...
    public void resetAudioRouting(boolean z) {
        ...
        sb2.append(getAudioRouteDesc(queryCurrentAudioRouting()));
        LogUtil.m110867i("AudioRoutingController", sb2.toString());
    ...
    public void sendEvent(int i, int i2) {
        ...
        LogUtil.m110864d("AudioRoutingController", sb.toString());
