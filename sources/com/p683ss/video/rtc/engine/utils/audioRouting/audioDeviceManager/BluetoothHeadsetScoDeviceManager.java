package com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager;
...
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.base.BaseHotplugAudioDeviceManager;
import com.p683ss.video.rtc.engine.utils.audioRouting.audioDeviceManager.base.IAudioDeviceManager.OnHotPlugDeviceCallback;
import com.p683ss.video.rtc.engine.utils.audioRouting.receiver.BTHeadsetBroadcastReceiver;
import com.p683ss.video.rtc.engine.utils.audioRouting.receiver.base.BaseAudioDeviceBroadcastReceiver;
...
public class BluetoothHeadsetScoDeviceManager extends BaseHotplugAudioDeviceManager {
    ...
    private ServiceListener createBTHeadsetListener() {
        return new ServiceListener() {
            public void onServiceDisconnected(int i) {
                ...
                sb.append(" =? headset(1");
                sb.append(")");
                LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", sb.toString());
                if (i == 1) {
                    StringBuilder sb2 = new StringBuilder("on BT service disconnected: ");
                    sb2.append(i);
                    LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", sb2.toString());
    ...
    public void cancelBluetoothSCOConnTimer() {
        LogUtil.m110864d("BluetoothHeadsetScoDeviceManager", "cancel bluetooth timer");
    ...
    private void startBluetoothSCOConnTimer() {
        LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", "start bluetooth timer");
    ...
    private void stopBtSco() {
        ...
        if (audioManager == null) {
            LogUtil.m110865e("BluetoothHeadsetScoDeviceManager", "invalid context: can't get AudioManager");
            this.mCallback.onError(-1002, "invalid context: can't get AudioManager");
            return;
        }
        LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", "try to stopping bt sco ");
    ...
    private void initBluetoothHeadset() {
        ...
        if (context != null) {
            if (context.checkCallingOrSelfPermission("android.permission.BLUETOOTH") != 0) {
                LogUtil.m110868w("BluetoothHeadsetScoDeviceManager", "do not support BT monitoring on this device");
            } else if (!hasPermission(context)) {
                LogUtil.m110868w("BluetoothHeadsetScoDeviceManager", "lacks BLUETOOTH permission");
            } else if (this.mBTHeadsetListener != null) {
                LogUtil.m110868w("BluetoothHeadsetScoDeviceManager", "Bluetooth service Listener already been initialized");
            } else {
                this.mBTAdapter = BluetoothAdapter.getDefaultAdapter();
                if (this.mBTAdapter == null) {
                    LogUtil.m110865e("BluetoothHeadsetScoDeviceManager", "initialize: failed to get bluetooth adapter!!");
                    return;
                }
                try {
                    ...
                    LogUtil.m110865e("BluetoothHeadsetScoDeviceManager", sb.toString());
                }
    ...
    public void bridge$lambda$0$BluetoothHeadsetScoDeviceManager() {
        ...
        if (audioManager.isBluetoothScoOn()) {
            LogUtil.m110864d("BluetoothHeadsetScoDeviceManager", "SCO connected");
            z = true;
        } else {
            LogUtil.m110864d("BluetoothHeadsetScoDeviceManager", "SCO is not connected");
            z = false;
        }
        if (this.mScoConnectionAttempts < 5) {
            ...
            sb.append(btStateAsString(getActiveState()));
            sb.append("]");
            LogUtil.m110864d("BluetoothHeadsetScoDeviceManager", sb.toString());
            ...
            LogUtil.m110865e("BluetoothHeadsetScoDeviceManager", "start bluetooth sco timeout");
            this.mScoConnectionAttempts = 0;
    ...
    private void checkAndActiveSCO() {
        ...
        if (!audioManager.isBluetoothScoOn()) {
            ...
            LogUtil.m110864d("BluetoothHeadsetScoDeviceManager", sb2.toString());
            startBluetoothSCOConnTimer();
            this.mScoConnectionAttempts++;
            doActiveSco(audioManager);
        }
    ...
    public void onStickyIntentFoundWhenRegister(Intent intent) {
        if (TextUtils.equals(intent.getAction(), "android.media.ACTION_SCO_AUDIO_STATE_UPDATED")) {
            if (intent.getIntExtra("android.media.extra.SCO_AUDIO_STATE", 0) != 1) {
                LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", "initial Bluetooth SCO device unconnected");
            } else {
                LogUtil.m110867i("BluetoothHeadsetScoDeviceManager", "initial Bluetooth SCO device connected");
                onScoConnected();
            }
        }
    }
    ...
    private void doActiveSco(AudioManager audioManager) {
        ...
        if (isDevicePlugged()) {
            try {
                ...
                LogUtil.m110865e("BluetoothHeadsetScoDeviceManager", e.getMessage());
            }
        } else {
