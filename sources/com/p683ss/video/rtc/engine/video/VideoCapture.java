...
public class VideoCapture {
    public static Context sEglBaseContext;
    ...
    private WeakReference<android.content.Context> mContextRef;
    ...
    public void release() {
        try {
            ...
            LogUtil.m110864d("VideoCapture", sb.toString());
        }
    }

    public void stopCapture() {
        try {
            LogUtil.m110867i("VideoCapture", "stopCapture...");
    ...
    public static void setEglBaseContext(Context context) {
        sEglBaseContext = context;
    }

    VideoCapture(long j) {
        try {
            LogUtil.m110867i("VideoCapture", "VideoCapture Created...");
            this.mHasFatalException = false;
            this.mContextRef = new WeakReference<>(C51644RtcEngineImpl.getApplicationContext());
    ...
    private CameraVideoCapturer createVideoCapturer(int i) {
        ...
        try {
            ...
            sb.append(e.getMessage());
            LogUtil.m110867i("VideoCapture", sb.toString());
            return null;
        }
    }

    private void startVideoCapture(int i, int i2, int i3) {
        LogUtil.m110867i("VideoCapture", "startVideoCapture... ");
        if (this.mVideoCapturer != null) {
            try {
    ...
    public void startCapture(int i, int i2, int i3) {
        try {
            LogUtil.m110867i("VideoCapture", "startCapture...");
            this.mWidth = i;
            this.mHeight = i2;
            if (!this.mHasFatalException && this.mContextRef != null) {
                if (this.mContextRef.get() != null) {
                    ...
                    if (this.mVideoCapturer != null) {
                        this.mVideoCapturer.initialize(this.mSurfaceTextureHelper, (android.content.Context) this.mContextRef.get(), this.localCapturerObserver);
