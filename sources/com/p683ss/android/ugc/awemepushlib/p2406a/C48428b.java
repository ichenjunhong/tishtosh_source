...
public final class C48428b implements Serializable {
    public int alertType;
    public transient JSONObject appData;
    public String callback;
    public C48429a extra;
    public int filter = 1;
    public boolean functionalPush;

    /* renamed from: id */
    public int f121792id;
    ...
    /* renamed from: com.ss.android.ugc.awemepushlib.a.b$a */
    public static final class C48429a implements Serializable {
        ...
        /* renamed from: a */
        static C48429a m104785a(String str) {
            boolean z;
            C48429a aVar = new C48429a();
            try {
                aVar.rawExtra = str;
                ...
                aVar.customAction = jSONObject.optString(CustomActionPushReceiver.f104060e);
                aVar.inAppPushTitle = jSONObject.optString("in_app_push_title");
                aVar.redBadgeOnly = jSONObject.optInt("red_badge_only", -1);
                if (!TextUtils.isEmpty(aVar.soundUrl)) {
                    aVar.soundId = C9395d.m18571a(aVar.soundUrl);
                }
                ...
                aVar.turn_screen_on = C48432a.m104797a(jSONObject, "turn_screen_on", false);
                aVar.user_system_style = C48432a.m104797a(jSONObject, "use_system_style", true);
                aVar.is_notification_top = C48432a.m104797a(jSONObject, "is_notification_top", false);
                ...
                aVar.isZeroVibrate = C48432a.m104797a(jSONObject, "is_zero_vibrate", true);
                aVar.bg_color = jSONObject.optString("bg_color", "");
                aVar.style = jSONObject.optInt("notification_style", -1);
                aVar.isGroupSummary = C48432a.m104797a(jSONObject, "is_group_summary", true);
                ...
                aVar.allowBannerDelete = C48432a.m104797a(jSONObject, "allow_banner_delete", true);
    ...
    public static C48428b from(String str) {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        C48428b bVar = new C48428b();
        bVar.rawJson = str;
        try {
            JSONObject jSONObject = new JSONObject(str);
            bVar.originData = jSONObject;
            bVar.f121792id = jSONObject.optInt("id", 0);
            bVar.title = jSONObject.optString("title");
            bVar.text = jSONObject.optString("text");
            bVar.pass_through = jSONObject.optInt("pass_through", 1);
            bVar.openUrl = jSONObject.optString(C23060d.f61428b);
            ...
            bVar.led = C48432a.m104797a(jSONObject, "use_led", false);
            bVar.sound = C48432a.m104797a(jSONObject, "sound", false);
            bVar.vibrator = C48432a.m104797a(jSONObject, "use_vibrator", false);
            bVar.preloadArticle = C48432a.m104797a(jSONObject, "preload_article", false);
            bVar.appData = jSONObject.optJSONObject("app_data");
            bVar.extra = C48429a.m104785a(optString);
