...
public final class C20482f {
    /* renamed from: a */
    public static final CAMERA_FACING_ID m51066a(int i) {
        switch (i) {
            case 0:
    ...
    /* renamed from: b */
    public static final CAMERA_TYPE m51067b(int i) {
        switch (i) {
            case 0:
    ...
    /* renamed from: c */
    public static final CAMERA_FLASH_MODE m51068c(int i) {
        switch (i) {
            case 0:
