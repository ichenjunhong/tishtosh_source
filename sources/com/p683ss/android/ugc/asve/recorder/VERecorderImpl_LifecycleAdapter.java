...
public class VERecorderImpl_LifecycleAdapter implements C0167d {

    /* renamed from: a */
    final VERecorderImpl f55975a;

    VERecorderImpl_LifecycleAdapter(VERecorderImpl vERecorderImpl) {
        this.f55975a = vERecorderImpl;
    }
    ...
    public final void mo313a(C0184k kVar, C0177a aVar, boolean z, C0197q qVar) {
        ...
        if (!z && aVar == C0177a.ON_DESTROY) {
            if (!z2 || qVar.mo344a("release", 1)) {
                this.f55975a.release();
            }
        }
    }
}
