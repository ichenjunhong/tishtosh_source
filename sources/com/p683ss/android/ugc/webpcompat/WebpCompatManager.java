...
public class WebpCompatManager {
    ...
    private boolean loadDexposedLibrary() {
        try {
            if (!useLibrarian || mContext == null) {
                ...
                C11511a.m23579a("dexposed", mContext);
            }
            return true;
        } catch (Throwable th) {
            if (this.mWebpErrorCallback != null) {
    ...
    public synchronized void init(com.p683ss.android.ugc.webpcompat.IWebpErrorCallback r9) {
        /*
            r8 = this;
            monitor-enter(r8)
        ...
        L_0x0097:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.webpcompat.WebpCompatManager.init(com.ss.android.ugc.webpcompat.IWebpErrorCallback):void");
    }
