...
public class ComposerHelper {
    ...
    public static ComposerNode parseComposerMaterial(String str, String str2, String str3) {
        ...
        try {
            JSONArray jSONArray = new JSONObject(iVar.mo96262c(sb.toString())).getJSONObject("effect").getJSONArray("Link");
            if (jSONArray.length() <= 0) {
                return null;
            }
            String string = jSONArray.getJSONObject(0).getString(LeakCanaryFileProvider.f132050j);
            if (!jSONArray.getJSONObject(0).getString("type").toLowerCase().equals("composer")) {
                return null;
            }
            C48671i iVar2 = C48671i.f122310a;
            StringBuilder sb2 = new StringBuilder();
            sb2.append(str);
            sb2.append(File.separator);
            sb2.append(string);
            sb2.append("content.json");
            JSONObject jSONObject = new JSONObject(iVar2.mo96262c(sb2.toString()));
    ...
    public static ComposerNode parseComposerNode(JSONObject jSONObject, String str, String str2) {
        try {
            ...
            composerNode.default_value = (float) jSONObject.optDouble("default_value", ProfileUiInitOptimizeEnterThreshold.DEFAULT);
            composerNode.min_value = (float) jSONObject.optDouble("min_value", ProfileUiInitOptimizeEnterThreshold.DEFAULT);
            composerNode.max_value = (float) jSONObject.optDouble("max_value", ProfileUiInitOptimizeEnterThreshold.DEFAULT);
            ...
            if (jSONObject.has("nodes")) {
                ...
                if (optJSONObject != null) {
                    str4 = optJSONObject.optString(C42311c.f106863g, "0");
                }
