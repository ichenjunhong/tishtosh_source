package com.p683ss.android.ugc.effectmanager.model;
...
public class ExtendedUrlModel extends UrlModel {
    ...
    static /* synthetic */ class C489071 {
        static final /* synthetic */ int[] $SwitchMap$com$ss$android$ugc$effectmanager$FetchModelType = new int[C48901i.values().length];
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.effectmanager.model.ExtendedUrlModel.C489071.<clinit>():void");
        }
    }
    ...
    public List<String> getUrl(C48901i iVar) {
        if (C489071.$SwitchMap$com$ss$android$ugc$effectmanager$FetchModelType[iVar.ordinal()] != 1) {
