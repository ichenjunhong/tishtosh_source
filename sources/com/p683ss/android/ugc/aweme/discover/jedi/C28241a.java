...
public abstract class C28241a<D> extends C28550bj<D> implements C11791ad<C23473i>, C11872h {

    /* renamed from: a */
    public C23473i f74114a = new C23473i();

    /* renamed from: b */
    private HashMap f74115b;

    /* renamed from: a */
    public View mo56545a(int i) {
        if (this.f74115b == null) {
            this.f74115b = new HashMap();
        }
        View view = (View) this.f74115b.get(Integer.valueOf(i));
        if (view == null) {
            View view2 = getView();
            if (view2 == null) {
                return null;
            ...
            this.f74115b.put(Integer.valueOf(i), view);
        }
        return view;
    }
