...
public class PoiLabelsLayout extends LinearLayout {
    ...
    /* renamed from: a */
    private int[] f100942a;

    /* renamed from: b */
    private SparseIntArray f100943b = new SparseIntArray();
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.f100942a != null && this.f100942a.length != 0) {
                ...
                if (measuredWidth != 0) {
                    ...
                    for (int i7 = 0; i7 < childCount; i7++) {
                        ...
                        if (childAt.getVisibility() == 8) {
                            ...
                            i5 += measuredWidth2;
                            this.f100943b.put(i7, measuredWidth2);
                        }
                    }
                    if (i5 > measuredWidth) {
                        for (int i8 : this.f100942a) {
                            View childAt2 = getChildAt(i8);
                            if (childAt2.getVisibility() != 8) {
                                i5 -= this.f100943b.get(i8);
