...
public final class AwemeToolFeedbackInfo {
    @C17952c(mo34828a = "cancel_count")
    private final int cancelCount;
    private final int count;
    @C17952c(mo34828a = "e_code")
    ...
    public static /* synthetic */ com.p683ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackInfo copy$default(com.p683ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackInfo r3, java.lang.String r4, int r5, int r6, int r7, java.util.List<com.p683ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackECode> r8, int r9, java.lang.Object r10) {
        /*
            r10 = r9 & 1
        ...
        L_0x0021:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackInfo.copy$default(com.ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackInfo, java.lang.String, int, int, int, java.util.List, int, java.lang.Object):com.ss.android.ugc.aweme.feedback.runtime.behavior.strategy.AwemeToolFeedbackInfo");
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AwemeToolFeedbackInfo) {
                ...
                if (C52711k.m112239a((Object) this.name, (Object) awemeToolFeedbackInfo.name)) {
                    if (this.count == awemeToolFeedbackInfo.count) {
                        if (this.successCount == awemeToolFeedbackInfo.successCount) {
                            if (!(this.cancelCount == awemeToolFeedbackInfo.cancelCount) || !C52711k.m112239a((Object) this.eCode, (Object) awemeToolFeedbackInfo.eCode)) {
                                return false;
                            }
                        }
                    }
    ...
    public /* synthetic */ AwemeToolFeedbackInfo(String str, int i, int i2, int i3, List list, int i4, C52707g gVar) {
        int i5;
        int i6;
        if ((i4 & 1) != 0) {
            str = "";
