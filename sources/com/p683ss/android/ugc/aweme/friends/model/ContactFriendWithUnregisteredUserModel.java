...
public class ContactFriendWithUnregisteredUserModel extends ContactFriendModel {
    ...
    static final /* synthetic */ FriendList lambda$fetchList$0$ContactFriendWithUnregisteredUserModel(C0013i iVar) throws Exception {
        return (FriendList) iVar.mo34e();
    }

    /* access modifiers changed from: 0000 */
    public final /* synthetic */ FriendList lambda$fetchList$1$ContactFriendWithUnregisteredUserModel(C0013i iVar) throws Exception {
    ...
    public void handleData(FriendList<User> friendList) {
        ...
        boolean z2 = false;
        if (friendList == null || (C9376b.m18558a((Collection<T>) friendList.friends) && C9376b.m18558a((Collection<T>) friendList.unregisteredUser))) {
            z = true;
        } else {
            z = false;
        }
    ...
    private synchronized void addAll(java.util.List<com.p683ss.android.ugc.aweme.profile.model.User> r8, java.util.List<com.p683ss.android.ugc.aweme.friends.model.UnRegisteredUser> r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x0010:
            ...
            com.ss.android.ugc.aweme.friends.model.UnRegisteredUser r2 = (com.p683ss.android.ugc.aweme.friends.model.UnRegisteredUser) r2     // Catch:{ all -> 0x0087 }
        ...
        L_0x003a:
            ...
            boolean r9 = r9 instanceof com.p683ss.android.ugc.aweme.friends.model.Friend     // Catch:{ all -> 0x0087 }
        ...
        L_0x0056:
            ...
            com.ss.android.ugc.aweme.profile.model.User r5 = (com.p683ss.android.ugc.aweme.profile.model.User) r5     // Catch:{ all -> 0x0087 }
            boolean r5 = r5 instanceof com.p683ss.android.ugc.aweme.friends.model.Friend     // Catch:{ all -> 0x0087 }
        ...
        L_0x006f:
            boolean r8 = com.bytedance.common.utility.p522b.C9376b.m18558a(r1)     // Catch:{ all -> 0x0087 }
            ...
            com.ss.android.ugc.aweme.friends.model.Friend r8 = (com.p683ss.android.ugc.aweme.friends.model.Friend) r8     // Catch:{ all -> 0x0087 }
        ...
        L_0x0087:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.friends.model.ContactFriendWithUnregisteredUserModel.addAll(java.util.List, java.util.List):void");
    }

    public void fetchList(int i, int i2, int i3) {
        if (this.mCountOnly) {
            this.mFriendApi.queryContactsFriendsCountOnly(i, i2, i3, 1).mo29c(ContactFriendWithUnregisteredUserModel$$Lambda$0.$instance).mo19a((C0011g<TResult, TContinuationResult>) new C37776h<TResult,TContinuationResult>(this.mHandler, 0));
        } else {
            this.mFriendApi.queryContactsFriends(i, i2, i3).mo29c(new ContactFriendWithUnregisteredUserModel$$Lambda$1(this)).mo19a((C0011g<TResult, TContinuationResult>) new C37776h<TResult,TContinuationResult>(this.mHandler, 0));
        }
    }
}
