...
public abstract class JediBaseActivity extends AmeSSActivity implements C11791ad<C23473i>, C11872h {

    /* renamed from: a */
    public C23473i f62527a = new C23473i();

    /* renamed from: b */
    private HashMap f62528b;

    /* renamed from: a */
    public View mo48631a(int i) {
        if (this.f62528b == null) {
            this.f62528b = new HashMap();
        }
        View view = (View) this.f62528b.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        View findViewById = findViewById(i);
        this.f62528b.put(Integer.valueOf(i), findViewById);
        return findViewById;
    }
