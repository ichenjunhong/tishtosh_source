...
public abstract class C23462b extends C23526a implements C11791ad<C23473i>, C11872h {

    /* renamed from: a */
    public C23473i f62531a = new C23473i();

    /* renamed from: b */
    private HashMap f62532b;
    ...
    public View mo48632a(int i) {
        ...
        View view = (View) this.f62532b.get(Integer.valueOf(i));
        if (view == null) {
            View view2 = getView();
            if (view2 == null) {
                return null;
            ...
            this.f62532b.put(Integer.valueOf(i), view);
        }
        return view;
    }
