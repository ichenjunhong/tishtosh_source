...
public class MusicModel implements C37283j, Serializable {
    ...
    public boolean isPlayUrlValid() {
        if (this.playUrl != null && !TextUtils.isEmpty(this.playUrl.getUri()) && !C47917gi.m103681a((Collection<? extends T>) this.playUrl.getUrlList())) {
            return true;
        }
        return false;
    }
