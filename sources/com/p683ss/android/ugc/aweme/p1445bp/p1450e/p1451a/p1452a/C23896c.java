...
/* renamed from: com.ss.android.ugc.aweme.bp.e.a.a.c */
public final class C23896c extends C23895b {
    ...
    public final long mo49502b() {
        ...
        if (effectListModel != null) {
            ...
            if (effectPointModels != null && (!effectPointModels.isEmpty())) {
                EffectListModel effectListModel2 = this.f63565a.f76125C;
                C52711k.m112236a((Object) effectListModel2, "draft.effectListModel");
                ArrayList effectPointModels2 = effectListModel2.getEffectPointModels();
                C52711k.m112236a((Object) effectPointModels2, "draft.effectListModel.effectPointModels");
                Iterable b = C52575l.m112128b((Iterable<? extends T>) effectPointModels2);
