...
/* renamed from: com.ss.android.ugc.aweme.notification.newstyle.b.b */
public final class C38273b extends C38275c {

    /* renamed from: com.ss.android.ugc.aweme.notification.newstyle.b.b$a */
    public static final class C38274a implements C38276d {
        C38274a() {
        }
        ...
        public final String mo78247a() {
            String string = C11010c.m22280a().getString(R.string.ck0);
            C52711k.m112236a((Object) string, "AppContextManager.getApp…fication_group_assistant)");
            return string;
        }
        ...
        public final void mo78249a(C1352v vVar, BaseNotice baseNotice, int i, HashMap<String, BaseNotice> hashMap, boolean z) {
            ...
            if (vVar instanceof C38280g) {
                ((C38280g) vVar).mo78253a(baseNotice, z);
            }
        }
    }
