...
public class BulletEventObserver_LifecycleAdapter implements C0167d {

    /* renamed from: a */
    final BulletEventObserver f63971a;

    BulletEventObserver_LifecycleAdapter(BulletEventObserver bulletEventObserver) {
        this.f63971a = bulletEventObserver;
    }
