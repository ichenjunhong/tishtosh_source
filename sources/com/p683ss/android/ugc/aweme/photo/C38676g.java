...
public final class C38676g {

    /* renamed from: a */
    private static final String[] f98371a = {"_id", "_data", "date_added", "width", "height", "mime_type", "latitude", "longitude", "date_modified"};
    ...
    public static java.util.List<com.p683ss.android.ugc.aweme.music.mediachoose.helper.MediaModel> m86027a(android.content.Context r18) {
        /*
            ...
            java.lang.String[] r4 = f98371a     // Catch:{ Exception -> 0x00d2 }
            r5 = 0
            r6 = 0
        ...
        L_0x007a:
            ...
            goto L_0x00d3
        L_0x007f:
            java.lang.String r10 = com.p683ss.android.ugc.aweme.photo.C38677h.m86028a(r5)     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
        L_0x0083:
        ...
        L_0x009b:
            boolean r10 = com.p683ss.android.medialib.C19319g.m47185a(r5)     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            if (r10 == 0) goto L_0x00bc
            ...
            r10.f95383b = r5     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.f95384c = r6     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.f95390i = r8     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.f95391j = r9     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.f95392k = r11     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.f95393l = r13     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r10.mo76674a(r0)     // Catch:{ Exception -> 0x00c0, all -> 0x00ca }
            r1 = r16
        ...
        L_0x00d2:
            r0 = move-exception
        L_0x00d3:
            com.p683ss.android.ugc.aweme.framework.p1780a.C32458a.m75148a(r0)     // Catch:{ all -> 0x00cf }
        ...
        L_0x00e1:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.photo.C38676g.m86027a(android.content.Context):java.util.List");
    }
}
