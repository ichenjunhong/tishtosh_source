...
/* renamed from: com.ss.android.ugc.aweme.sticker.presenter.handler.b.a.d */
public final class C46311d implements C46307a {

    /* renamed from: a */
    private final ShortVideoContext f116846a;

    public C46311d(ShortVideoContext shortVideoContext) {
        C52711k.m112240b(shortVideoContext, "shortVideoContext");
        this.f116846a = shortVideoContext;
    }
    ...
    public final void mo93037a(Effect effect, String str, String str2, String str3) {
        ...
        ShortVideoContext shortVideoContext = this.f116846a;
        C52847n[] nVarArr = new C52847n[4];
        nVarArr[0] = C52856t.m112465a("picture_source", str);
