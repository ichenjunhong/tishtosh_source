...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.bx */
public final class C33802bx extends C33803by {

    /* renamed from: u */
    private C33820cn f87686u;
    ...
    public final void mo71779a() {
        ...
        this.f87686u = new C33820cn(this.f87704f);
    }
    ...
    public C33802bx(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, BaseContent baseContent, int i) {
        ...
        this.f87686u.mo71862a(this.f87712n);
    }
}
