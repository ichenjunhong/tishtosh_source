...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.cm */
public final class C33819cm extends C33818cl {

    /* renamed from: u */
    private C33820cn f87756u;
    ...
    public final void mo71779a() {
        ...
        this.f87756u = new C33820cn(this.f87704f);
    }
    ...
    public C33819cm(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, BaseContent baseContent, int i) {
        ...
        this.f87756u.mo71862a(this.f87712n);
    }
}
