...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.q */
public final class C33875q extends C33876r {

    /* renamed from: w */
    private C33820cn f87864w;
    ...
    public final void mo71779a() {
        ...
        this.f87864w = new C33820cn(this.f87704f);
    }
    ...
    public C33875q(View view, int i) {
        super(view, i);
    }

    /* renamed from: a */
    public final void mo71780a(C11207p pVar, C11207p pVar2, CommentContent commentContent, int i) {
        super.mo71780a(pVar, pVar2, commentContent, i);
        this.f87864w.mo71862a(this.f87712n);
    }
}
