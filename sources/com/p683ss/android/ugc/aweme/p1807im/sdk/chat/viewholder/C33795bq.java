...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.bq */
public final class C33795bq extends C33796br {

    /* renamed from: u */
    private C33820cn f87671u;
    ...
    public final void mo71779a() {
        ...
        this.f87671u = new C33820cn(this.f87704f);
    }
    ...
    public C33795bq(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, BaseContent baseContent, int i) {
        ...
        this.f87671u.mo71862a(this.f87712n);
    }
}
