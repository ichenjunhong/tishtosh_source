...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.az */
public final class C33777az extends C33775ax {

    /* renamed from: u */
    private C33820cn f87632u;
    ...
    public final void mo71779a() {
        ...
        this.f87632u = new C33820cn(this.f87704f);
    }
    ...
    public C33777az(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, ShareAwemeContent shareAwemeContent, int i) {
        ...
        this.f87632u.mo71862a(this.f87712n);
    }
}
