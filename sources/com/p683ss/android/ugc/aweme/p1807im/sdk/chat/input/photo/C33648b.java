...
public final class C33648b {

    /* renamed from: a */
    private static final String[] f87265a = {"_id", "_data", "date_added", "width", "height", "mime_type"};
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x00e7, code lost:
        r2 = (com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33647a) r1.next();
        r2.f87260a = m77091b(com.bytedance.ies.ugc.p694a.C11010c.m22280a(), r2.f87262c, r13);
     */
    ...
    public static java.util.List<com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33647a> m77090a(boolean r13) {
        /*
        ...
        L_0x0081:
            ...
            com.ss.android.ugc.aweme.im.sdk.chat.input.photo.a r3 = m77087a(r0, r2)     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            ...
            r3.f87263d = r4     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            r3.f87264e = r2     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            java.lang.String r1 = r1.getParent()     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            r3.f87261b = r1     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            java.lang.String r1 = r12.getString(r10)     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
            r3.f87262c = r1     // Catch:{ Exception -> 0x00d2, all -> 0x004b }
        ...
        L_0x00e1:
            ...
            com.ss.android.ugc.aweme.im.sdk.chat.input.photo.a r2 = (com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33647a) r2
            android.content.Context r3 = com.bytedance.ies.ugc.p694a.C11010c.m22280a()
            java.lang.String r4 = r2.f87262c
            int r3 = m77091b(r3, r4, r13)
            r2.f87260a = r3
            goto L_0x00e1
        L_0x00fa:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33648b.m77090a(boolean):java.util.List");
    }

    /* renamed from: a */
    private static C33647a m77087a(List<C33647a> list, String str) {
        for (int i = 0; i < list.size(); i++) {
            C33647a aVar = (C33647a) list.get(i);
            if (TextUtils.equals(aVar.f87264e, str)) {
                return aVar;
            }
        }
        return null;
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int m77091b(android.content.Context r10, java.lang.String r11, boolean r12) {
        /*
            ...
            java.lang.String[] r2 = f87265a     // Catch:{ Exception -> 0x0074, all -> 0x002f }
        ...
        L_0x0077:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33648b.m77091b(android.content.Context, java.lang.String, boolean):int");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.List<com.p683ss.android.p1099a.C18489a> m77089a(android.content.Context r18, java.lang.String r19, boolean r20) {
        /*
            ...
            java.lang.String[] r14 = f87265a     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
        ...
        L_0x0079:
            ...
            com.ss.android.a.a r2 = new com.ss.android.a.a     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.<init>(r12)     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.f50916b = r0     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.f50917c = r14     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.f50919e = r5     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.f50920f = r8     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
            r2.f50918d = r4     // Catch:{ Exception -> 0x00b9, all -> 0x0056 }
        ...
        L_0x00be:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33648b.m77089a(android.content.Context, java.lang.String, boolean):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.List<com.p683ss.android.p1099a.C18489a> m77088a(android.content.Context r16, int r17, int r18, int r19, boolean r20) {
        /*
            java.util.ArrayList r0 = new java.util.ArrayList
            ...
            r12 = 3
            r4[r12] = r5
            java.lang.String r5 = com.C2240a.m6773a(r1, r2, r4)
            java.lang.String r7 = "date_added DESC"
            r1 = 0
            android.content.ContentResolver r2 = r16.getContentResolver()     // Catch:{ Exception -> 0x00b8, all -> 0x00b0 }
            java.lang.String[] r4 = f87265a     // Catch:{ Exception -> 0x00b8, all -> 0x00b0 }
            r6 = 0
        ...
        L_0x007b:
            boolean r15 = com.p683ss.android.ugc.aweme.video.C48016e.m103944b(r1)     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            if (r15 == 0) goto L_0x00a4
        ...
        L_0x008b:
            com.ss.android.a.a r8 = new com.ss.android.a.a     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            r8.<init>(r3)     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            r8.f50916b = r1     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            r8.f50917c = r5     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            r8.f50919e = r7     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
            r8.f50920f = r13     // Catch:{ Exception -> 0x00ae, all -> 0x00ac }
        ...
        L_0x00bd:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.p1807im.sdk.chat.input.photo.C33648b.m77088a(android.content.Context, int, int, int, boolean):java.util.List");
    }
}
