...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.bi */
public final class C33787bi extends C33788bj {

    /* renamed from: u */
    private C33820cn f87658u;
    ...
    public final void mo71779a() {
        ...
        this.f87658u = new C33820cn(this.f87704f);
    }
    ...
    public C33787bi(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, BaseContent baseContent, int i) {
        ...
        this.f87658u.mo71862a(this.f87712n);
    }
}
