...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ci */
public final class C33815ci extends C33814ch {

    /* renamed from: u */
    private C33820cn f87750u;
    ...
    public final void mo71779a() {
        ...
        this.f87750u = new C33820cn(this.f87704f);
    }
    ...
    public C33815ci(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, ShareUserContent shareUserContent, int i) {
        ...
        this.f87750u.mo71862a(this.f87712n);
    }
}
