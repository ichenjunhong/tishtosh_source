...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.v */
public final class C33881v extends C33880u {

    /* renamed from: u */
    private C33820cn f87876u;
    ...
    public final void mo71779a() {
        ...
        this.f87876u = new C33820cn(this.f87704f);
    }
    ...
    public C33881v(View view, int i) {
        super(view, i);
    }

    /* renamed from: a */
    public final void mo71780a(C11207p pVar, C11207p pVar2, DouYinRedPacketContent douYinRedPacketContent, int i) {
        super.mo71780a(pVar, pVar2, douYinRedPacketContent, i);
        this.f87876u.mo71862a(this.f87712n);
    }
}
