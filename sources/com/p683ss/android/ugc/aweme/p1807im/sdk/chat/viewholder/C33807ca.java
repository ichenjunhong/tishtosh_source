...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ca */
public final class C33807ca extends C33808cb {

    /* renamed from: u */
    private C33820cn f87725u;
    ...
    public final void mo71779a() {
        ...
        this.f87725u = new C33820cn(this.f87704f);
    }
    ...
    public C33807ca(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo71780a(C11207p pVar, C11207p pVar2, BaseContent baseContent, int i) {
        ...
        this.f87725u.mo71862a(this.f87712n);
    }
}
