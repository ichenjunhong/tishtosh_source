...
public final class SettingCombineDataModel {
    ...
    public static /* synthetic */ SettingCombineDataModel copy$default(SettingCombineDataModel settingCombineDataModel, AwemeSettingCombineModel awemeSettingCombineModel, UserSettingCombineModel userSettingCombineModel2, CommerceSettingCombineModel commerceSettingCombineModel2, AbTestCombineModel abTestCombineModel2, ShareSettingCombineModel shareSettingCombineModel2, RateSettingCombineModel rateSettingCombineModel2, SameCityCombineModel sameCityCombineModel, NoticeCountCombineModel noticeCountCombineModel, LiveSettingCombineModel liveSettingCombineModel, ComplianceSettingCombineModel complianceSettingCombineModel, YellowPointCombineModel yellowPointCombineModel, int i, Object obj) {
        ...
        int i2 = i;
        return settingCombineDataModel.copy((i2 & 1) != 0 ? settingCombineDataModel2.awemeSetting : awemeSettingCombineModel, (i2 & 2) != 0 ? settingCombineDataModel2.userSettingCombineModel : userSettingCombineModel2, (i2 & 4) != 0 ? settingCombineDataModel2.commerceSettingCombineModel : commerceSettingCombineModel2, (i2 & 8) != 0 ? settingCombineDataModel2.abTestCombineModel : abTestCombineModel2, (i2 & 16) != 0 ? settingCombineDataModel2.shareSettingCombineModel : shareSettingCombineModel2, (i2 & 32) != 0 ? settingCombineDataModel2.rateSettingCombineModel : rateSettingCombineModel2, (i2 & 64) != 0 ? settingCombineDataModel2.sameCityModel : sameCityCombineModel, (i2 & 128) != 0 ? settingCombineDataModel2.noticeCountModel : noticeCountCombineModel, (i2 & UnReadVideoExperiment.BROWSE_RECORD_LIST) != 0 ? settingCombineDataModel2.liveSetting : liveSettingCombineModel, (i2 & UnReadVideoExperiment.LIKE_USER_LIST) != 0 ? settingCombineDataModel2.complianceSetting : complianceSettingCombineModel, (i2 & PreloadTask.BYTE_UNIT_NUMBER) != 0 ? settingCombineDataModel2.yellowPointModel : yellowPointCombineModel);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0074, code lost:
        if (p2628d.p2639f.p2641b.C52711k.m112239a((java.lang.Object) r2.yellowPointModel, (java.lang.Object) r3.yellowPointModel) != false) goto L_0x0079;
     */
    ...
    public final boolean equals(java.lang.Object r3) {
        /*
            ...
            boolean r0 = r3 instanceof com.p683ss.android.ugc.aweme.requestcombine.model.SettingCombineDataModel
            if (r0 == 0) goto L_0x0077
            com.ss.android.ugc.aweme.requestcombine.model.SettingCombineDataModel r3 = (com.p683ss.android.ugc.aweme.requestcombine.model.SettingCombineDataModel) r3
        ...
        L_0x0079:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.requestcombine.model.SettingCombineDataModel.equals(java.lang.Object):boolean");
    }
    ...
    public final void setAbTestCombineModel(AbTestCombineModel abTestCombineModel2) {
        C52711k.m112240b(abTestCombineModel2, "<set-?>");
    ...
    public final void setAwemeSetting(AwemeSettingCombineModel awemeSettingCombineModel) {
        C52711k.m112240b(awemeSettingCombineModel, "<set-?>");
    ...
    public final void setCommerceSettingCombineModel(CommerceSettingCombineModel commerceSettingCombineModel2) {
        C52711k.m112240b(commerceSettingCombineModel2, "<set-?>");
    ...
    public final void setComplianceSetting(ComplianceSettingCombineModel complianceSettingCombineModel) {
        C52711k.m112240b(complianceSettingCombineModel, "<set-?>");
    ...
    public final void setLiveSetting(LiveSettingCombineModel liveSettingCombineModel) {
        C52711k.m112240b(liveSettingCombineModel, "<set-?>");
    ...
    public final void setNoticeCountModel(NoticeCountCombineModel noticeCountCombineModel) {
        C52711k.m112240b(noticeCountCombineModel, "<set-?>");
    ...
    public final void setRateSettingCombineModel(RateSettingCombineModel rateSettingCombineModel2) {
        C52711k.m112240b(rateSettingCombineModel2, "<set-?>");
    ...
    public final void setSameCityModel(SameCityCombineModel sameCityCombineModel) {
        C52711k.m112240b(sameCityCombineModel, "<set-?>");
    ...
    public final void setShareSettingCombineModel(ShareSettingCombineModel shareSettingCombineModel2) {
        C52711k.m112240b(shareSettingCombineModel2, "<set-?>");
    ...
    public final void setUserSettingCombineModel(UserSettingCombineModel userSettingCombineModel2) {
        C52711k.m112240b(userSettingCombineModel2, "<set-?>");
    ...
    public final void setYellowPointModel(YellowPointCombineModel yellowPointCombineModel) {
        C52711k.m112240b(yellowPointCombineModel, "<set-?>");
    ...
    public SettingCombineDataModel(AwemeSettingCombineModel awemeSettingCombineModel, UserSettingCombineModel userSettingCombineModel2, CommerceSettingCombineModel commerceSettingCombineModel2, AbTestCombineModel abTestCombineModel2, ShareSettingCombineModel shareSettingCombineModel2, RateSettingCombineModel rateSettingCombineModel2, SameCityCombineModel sameCityCombineModel, NoticeCountCombineModel noticeCountCombineModel, LiveSettingCombineModel liveSettingCombineModel, ComplianceSettingCombineModel complianceSettingCombineModel, YellowPointCombineModel yellowPointCombineModel) {
        C52711k.m112240b(awemeSettingCombineModel, "awemeSetting");
        C52711k.m112240b(userSettingCombineModel2, "userSettingCombineModel");
        C52711k.m112240b(commerceSettingCombineModel2, "commerceSettingCombineModel");
        C52711k.m112240b(abTestCombineModel2, "abTestCombineModel");
        C52711k.m112240b(shareSettingCombineModel2, "shareSettingCombineModel");
        C52711k.m112240b(rateSettingCombineModel2, "rateSettingCombineModel");
        C52711k.m112240b(sameCityCombineModel, "sameCityModel");
        C52711k.m112240b(noticeCountCombineModel, "noticeCountModel");
        C52711k.m112240b(liveSettingCombineModel, "liveSetting");
        C52711k.m112240b(complianceSettingCombineModel, "complianceSetting");
        C52711k.m112240b(yellowPointCombineModel, "yellowPointModel");
        this.awemeSetting = awemeSettingCombineModel;
        this.userSettingCombineModel = userSettingCombineModel2;
        this.commerceSettingCombineModel = commerceSettingCombineModel2;
        this.abTestCombineModel = abTestCombineModel2;
