...
public final class AdTagGroup extends ViewGroup {
    ...
    public final void setTagList(String[] strArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            frameLayout.setPadding(C22444k.m55474a(4.0d), C22444k.m55474a(2.0d), C22444k.m55474a(4.0d), C22444k.m55474a(2.0d));
            Context context = getContext();
            C52711k.m112236a((Object) context, "context");
            frameLayout.setBackground(context.getResources().getDrawable(R.drawable.gp));
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (i7 != 0) {
                    ...
                    if (childAt.getMeasuredWidth() + i6 + this.f60447a >= size) {
                        break;
                    }
                    childAt.layout(this.f60447a + i6, 0, childAt.getMeasuredWidth() + i6 + this.f60447a, childAt.getMeasuredHeight());
                    i6 += this.f60447a;
    ...
    public AdTagGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f60447a = C22444k.m55474a(4.0d);
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (true) {
            ...
            if (i5 != 0) {
                C52711k.m112236a((Object) childAt, "view");
                if (childAt.getMeasuredWidth() + i6 + this.f60447a >= i3) {
                    break;
                }
                childAt.layout(this.f60447a + i6, 0, childAt.getMeasuredWidth() + i6 + this.f60447a, childAt.getMeasuredHeight());
                i6 += this.f60447a;
