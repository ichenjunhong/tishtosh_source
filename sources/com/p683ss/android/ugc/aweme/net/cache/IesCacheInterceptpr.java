...
public class IesCacheInterceptpr implements C12727a {
    /* renamed from: b */
    public static C12799u m84272b(C12728a aVar) throws Exception {
        C12686c a = aVar.mo23899a();
        C37755d a2 = C37756e.m84279a(a);
        if (a2 == null) {
            return aVar.mo23900a(a);
        }
        C12799u a3 = C37756e.m84278a(a, aVar, a2);
        if (a3 != null) {
            return a3;
        }
        return aVar.mo23900a(a);
