...
public class OpenShortVideoMethod_LifecycleAdapter implements C0167d {

    /* renamed from: a */
    final OpenShortVideoMethod f77876a;

    OpenShortVideoMethod_LifecycleAdapter(OpenShortVideoMethod openShortVideoMethod) {
        this.f77876a = openShortVideoMethod;
    }
