...
public class OpenFeedsFlowMethod_LifecycleAdapter implements C0167d {

    /* renamed from: a */
    final OpenFeedsFlowMethod f77871a;

    OpenFeedsFlowMethod_LifecycleAdapter(OpenFeedsFlowMethod openFeedsFlowMethod) {
        this.f77871a = openFeedsFlowMethod;
    }
