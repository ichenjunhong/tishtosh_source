...
public class ChannelUploadHelper {
    ...
    public static String getChannel() {
        if (TextUtils.isEmpty(mChannel)) {
            mChannel = C23859b.m58575b().mo49468b(C11010c.m22280a(), "pre_install_channel", (String) null);
        }
        return mChannel;
    }
    ...
    public static String getSystemRecordChannel() {
        if (TextUtils.isEmpty(mChannel)) {
            String b = C23859b.m58575b().mo49468b(C11010c.m22280a(), "pre_install_channel", "");
            mChannel = b;
            if (TextUtils.isEmpty(b)) {
                ...
                if (!TextUtils.isEmpty(fileContent)) {
                    try {
                        ...
                        mChannel = optString;
                        C23859b.m58575b().mo49465a(C11010c.m22280a(), "pre_install_channel", optString);
    ...
    public static void parseFile() {
        ...
        if (!TextUtils.isEmpty(fileContent)) {
            try {
                ...
                jSONObject.optString(C42311c.f106863g);
                jSONObject.optInt("update_version_code");
                jSONObject.optString("product_name");
                mChannel = optString;
                StringBuilder sb = new StringBuilder();
                sb.append(C11010c.m22289j());
                C26890h.m65006a(C11010c.m22280a(), "pre_install_check", "app_start", "0", 0, C23088c.m56631a().mo47824a("package", C11010c.m22280a().getPackageName()).mo47824a("app_id", sb.toString()).mo47824a("app_name", C11010c.m22283d()).mo47824a("device_id", AppLog.getServerDeviceId()).mo47824a("system_record_channel", optString).mo47824a("channel", C11010c.m22295p()).mo47825b());
                C23859b.m58575b().mo49465a(C11010c.m22280a(), "pre_install_channel", optString);
            } catch (Exception unused) {
            }
        }
    ...
    private static java.lang.String readTextFile(java.util.List<java.lang.String> r6) {
        ...
        L_0x00bf:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.app.ChannelUploadHelper.readTextFile(java.util.List):java.lang.String");
    }
}
