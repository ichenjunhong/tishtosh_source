...
public abstract class BaseCommentJediWidget extends Widget implements C11872h {

    /* renamed from: com.ss.android.ugc.aweme.comment.widgets.BaseCommentJediWidget$a */
    protected static final class C25428a<T extends View> {
        ...
        public C25428a(int i) {
            this.f67260b = i;
        }

        /* renamed from: a */
        public final T mo52027a(BaseCommentJediWidget baseCommentJediWidget, C52767h<?> hVar) {
            C52711k.m112240b(baseCommentJediWidget, "thisRef");
            C52711k.m112240b(hVar, "property");
            if (this.f67259a == null) {
                View view = baseCommentJediWidget.f34862e;
                if (view == null) {
                    C52711k.m112234a();
                }
                T findViewById = view.findViewById(this.f67260b);
                if (findViewById == null) {
                    C52711k.m112234a();
                }
                this.f67259a = findViewById;
            }
            T t = this.f67259a;
            if (t == null) {
    ...
    /* renamed from: a */
    protected static <T extends View> C25428a<T> m61836a(int i) {
        return new C25428a<>(i);
    }

    /* renamed from: a */
    protected static void m61837a(View... viewArr) {
