...
final class C47283c {
    /* renamed from: a */
    static C12799u m102639a(MvNetInterceptor mvNetInterceptor, C12728a aVar) throws Exception {
        if (!(aVar.mo23901b() instanceof C23259b)) {
            return MvNetInterceptor.m102631b(aVar);
        }
        ...
        bVar.mo48195a(mvNetInterceptor.getClass().getSimpleName());
        bVar.f62194F = SystemClock.uptimeMillis();
        C12799u b = MvNetInterceptor.m102631b(aVar);
        if (bVar.f62195G > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f62195G;
            String simpleName = mvNetInterceptor.getClass().getSimpleName();
