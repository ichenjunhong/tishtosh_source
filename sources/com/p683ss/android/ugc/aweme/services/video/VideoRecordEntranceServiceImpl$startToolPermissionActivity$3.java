...
public final class VideoRecordEntranceServiceImpl$startToolPermissionActivity$3 implements C39598a {
    ...
    public final void onSuccess() {
        C45435f.m99016a(this.$context, this.$intent, this.$recreateSupport, this.$clearOld, this.$isBack2Main);
    }
