...
public final class VideoExposureData {
    ...
    public static /* synthetic */ VideoExposureData copy$default(VideoExposureData videoExposureData, String str, float f, String str2, String str3, String str4, String str5, boolean z, String str6, AVUploadSaveModel aVUploadSaveModel, int i, String str7, String str8, int i2, Object obj) {
        ...
        int i3 = i2;
        return videoExposureData.copy((i3 & 1) != 0 ? videoExposureData2.path : str, (i3 & 2) != 0 ? videoExposureData2.videoCoverStartTm : f, (i3 & 4) != 0 ? videoExposureData2.mainBusinessData : str2, (i3 & 8) != 0 ? videoExposureData2.outPutFile : str3, (i3 & 16) != 0 ? videoExposureData2.inputVideoFile : str4, (i3 & 32) != 0 ? videoExposureData2.creationId : str5, (i3 & 64) != 0 ? videoExposureData2.isSaveLocal : z, (i3 & 128) != 0 ? videoExposureData2.localFinalPath : str6, (i3 & UnReadVideoExperiment.BROWSE_RECORD_LIST) != 0 ? videoExposureData2.avUploadSaveModel : aVUploadSaveModel, (i3 & UnReadVideoExperiment.LIKE_USER_LIST) != 0 ? videoExposureData2.origin : i, (i3 & PreloadTask.BYTE_UNIT_NUMBER) != 0 ? videoExposureData2.draftPrimaryKey : str7, (i3 & 2048) != 0 ? videoExposureData2.shootWay : str8);
    }
    ...
    public final VideoExposureData copy(String str, float f, String str2, String str3, String str4, String str5, boolean z, String str6, AVUploadSaveModel aVUploadSaveModel, int i, String str7, String str8) {
        ...
        String str10 = str3;
        C52711k.m112240b(str10, "outPutFile");
        String str11 = str4;
        C52711k.m112240b(str11, "inputVideoFile");
        String str12 = str5;
        C52711k.m112240b(str12, "creationId");
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof VideoExposureData) {
                ...
                if (C52711k.m112239a((Object) this.path, (Object) videoExposureData.path) && Float.compare(this.videoCoverStartTm, videoExposureData.videoCoverStartTm) == 0 && C52711k.m112239a((Object) this.mainBusinessData, (Object) videoExposureData.mainBusinessData) && C52711k.m112239a((Object) this.outPutFile, (Object) videoExposureData.outPutFile) && C52711k.m112239a((Object) this.inputVideoFile, (Object) videoExposureData.inputVideoFile) && C52711k.m112239a((Object) this.creationId, (Object) videoExposureData.creationId)) {
                    if ((this.isSaveLocal == videoExposureData.isSaveLocal) && C52711k.m112239a((Object) this.localFinalPath, (Object) videoExposureData.localFinalPath) && C52711k.m112239a((Object) this.avUploadSaveModel, (Object) videoExposureData.avUploadSaveModel)) {
                        if (!(this.origin == videoExposureData.origin) || !C52711k.m112239a((Object) this.draftPrimaryKey, (Object) videoExposureData.draftPrimaryKey) || !C52711k.m112239a((Object) this.shootWay, (Object) videoExposureData.shootWay)) {
                            return false;
                        }
                    }
                }
    ...
    public VideoExposureData(String str, float f, String str2, String str3, String str4, String str5, boolean z, String str6, AVUploadSaveModel aVUploadSaveModel, int i, String str7, String str8) {
        C52711k.m112240b(str, LeakCanaryFileProvider.f132050j);
        C52711k.m112240b(str3, "outPutFile");
        C52711k.m112240b(str4, "inputVideoFile");
