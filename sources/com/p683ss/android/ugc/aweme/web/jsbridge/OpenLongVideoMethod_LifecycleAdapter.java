...
public class OpenLongVideoMethod_LifecycleAdapter implements C0167d {

    /* renamed from: a */
    final OpenLongVideoMethod f121520a;

    OpenLongVideoMethod_LifecycleAdapter(OpenLongVideoMethod openLongVideoMethod) {
        this.f121520a = openLongVideoMethod;
    }
