...
/* renamed from: com.ss.android.ugc.aweme.challenge.ui.ad */
public final class C24630ad extends C1331h {

    /* renamed from: a */
    private final int f65184a;

    private C24630ad(int i) {
        this.f65184a = i;
    }

    public C24630ad(int i, int i2) {
        this(i);
    }
        ...
        if (gridLayoutManager != null) {
            ...
            if (bVar != null) {
                ...
                if (bVar.mo4690a(f) == 1) {
                    ...
                    rect.left = (this.f65184a * a) / i;
                    rect.right = this.f65184a - (((a + 1) * this.f65184a) / i);
                    if (bVar.mo4694c(f, i) > 0) {
                        rect.top = this.f65184a;
                    }
                }
            }
        }
