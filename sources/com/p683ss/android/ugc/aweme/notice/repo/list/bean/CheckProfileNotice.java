...
public final class CheckProfileNotice {
    ...
    public static /* synthetic */ com.p683ss.android.ugc.aweme.notice.repo.list.bean.CheckProfileNotice copy$default(com.p683ss.android.ugc.aweme.notice.repo.list.bean.CheckProfileNotice r0, int r1, java.util.List<com.p683ss.android.ugc.aweme.profile.model.User> r2, long r3, int r5, java.lang.Object r6) {
        /*
            r6 = r5 & 1
        ...
        L_0x0012:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.notice.repo.list.bean.CheckProfileNotice.copy$default(com.ss.android.ugc.aweme.notice.repo.list.bean.CheckProfileNotice, int, java.util.List, long, int, java.lang.Object):com.ss.android.ugc.aweme.notice.repo.list.bean.CheckProfileNotice");
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof CheckProfileNotice) {
                ...
                if ((this.countOfUser == checkProfileNotice.countOfUser) && C52711k.m112239a((Object) this.users, (Object) checkProfileNotice.users)) {
    ...
    public /* synthetic */ CheckProfileNotice(int i, List list, long j, int i2, C52707g gVar) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        if ((i2 & 2) != 0) {
