...
public final class C47776cn {

    /* renamed from: a */
    public static final C47776cn f120296a = new C47776cn();

    private C47776cn() {
    }

    /* renamed from: a */
    public static boolean m103402a(Context context, int i, String str, List<? extends C18956k> list, String str2, String str3, String str4, C18915b<String> bVar, String str5, C18919f fVar) throws Throwable {
        int i2;
        int i3;
        boolean z;
        String str6 = str2;
            ...
            if (kVar != null) {
                ...
                if (!C9431p.m18664a(str8)) {
                    ...
                    try {
                        ...
                        if (!z) {
                            throw th;
                        } else if (!C47777co.m103403a(context)) {
                            return false;
                        } else {
                            i4 = i3;
                        }
