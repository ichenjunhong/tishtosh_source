...
public final class PromotionAppointment implements Serializable {
    @C17952c(mo34828a = "appointment_num")
    private int appointmentNum;
    @C17952c(mo34828a = "is_appointment")
    private boolean isAppointment;
    @C17952c(mo34828a = "server_time")
    private long serverTime;
    @C17952c(mo34828a = "show_label")
    private String showLabel;
    @C17952c(mo34828a = "show_text")
    private String showText;
    @C17952c(mo34828a = "start_time")
    private long startTime;
    @C17952c(mo34828a = "start_time_text")
        ...
        if (this != obj) {
            if (obj instanceof PromotionAppointment) {
                ...
                if (this.startTime == promotionAppointment.startTime) {
                    if ((this.serverTime == promotionAppointment.serverTime) && C52711k.m112239a((Object) this.startTimeText, (Object) promotionAppointment.startTimeText) && C52711k.m112239a((Object) this.showText, (Object) promotionAppointment.showText) && C52711k.m112239a((Object) this.showLabel, (Object) promotionAppointment.showLabel)) {
    ...
    public /* synthetic */ PromotionAppointment(long j, long j2, String str, String str2, String str3, boolean z, int i, int i2, C52707g gVar) {
        long j3;
        String str4;
        String str5;
        String str6;
