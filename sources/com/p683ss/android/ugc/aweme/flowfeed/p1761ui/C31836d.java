...
public final class C31836d extends ScrollingMovementMethod {

    /* renamed from: b */
    private static C31836d f83195b;

    /* renamed from: c */
    private static Object f83196c = new Concrete();
    ...
    private C31836d(int i) {
        this.f83197a = i;
    }

    /* renamed from: a */
    public static MovementMethod m74193a(int i) {
        if (f83195b == null) {
            f83195b = new C31836d(i);
            return f83195b;
        } else if (f83195b.f83197a == i) {
            return f83195b;
        } else {
            return new C31836d(i);
        }
    }

    /* access modifiers changed from: protected */
    public final boolean down(TextView textView, Spannable spannable) {
        if (m74194a(3, textView, spannable)) {
            return true;
        }
    ...
    /* access modifiers changed from: protected */
    /* renamed from: up */
    public final boolean mo64941up(TextView textView, Spannable spannable) {
        if (m74194a(2, textView, spannable)) {
            return true;
        }
    ...
    public final boolean onTouchEvent(TextView textView, Spannable spannable, MotionEvent motionEvent) {
        ...
        if (action == 1 || action == 0) {
            ...
            if (lineForVertical == 0 && x < this.f83197a) {
                return false;
            }
    ...
    /* renamed from: a */
    private static boolean m74194a(int i, TextView textView, Spannable spannable) {
        Layout layout = textView.getLayout();
        ...
        if (min < 0 && spannable.getSpanStart(f83196c) >= 0) {
    ...
    public final boolean handleMovementKey(TextView textView, Spannable spannable, int i, int i2, KeyEvent keyEvent) {
        if ((i == 23 || i == 66) && KeyEvent.metaStateHasNoModifiers(i2) && keyEvent.getAction() == 0 && keyEvent.getRepeatCount() == 0 && m74194a(1, textView, spannable)) {
            return true;
        }
