...
public final class C21021e {
    /* renamed from: a */
    public static String m53409a(Bundle bundle) {
        if (bundle == null) {
            return "";
        }
    ...
    /* renamed from: b */
    public static String m53412b(Bundle bundle) {
        if (bundle == null) {
            return "";
        }
    ...
    /* renamed from: a */
    public static JSONObject m53411a(Map<String, String> map) {
    ...
    /* renamed from: a */
    public static String m53410a(String str) {
