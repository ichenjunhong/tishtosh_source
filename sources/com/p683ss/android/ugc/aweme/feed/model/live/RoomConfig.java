...
public class RoomConfig implements Serializable {
    ...
    @C17952c(mo34828a = "enable_emoji")
    public int enableEmoji;
    @C17952c(mo34828a = "enable_fans_club")
    public int enableFansClub;
    @C17952c(mo34828a = "enable_hourly_list")
    public int enableHourRank;
    @C17952c(mo34828a = "enable_send_barrage")
    public int enableSendBarrage;
    @C17952c(mo34828a = "enable_send_comment")
    public int enableSendComment;
    @C17952c(mo34828a = "enable_send_gift")
    public int enableSendGift;
    @C17952c(mo34828a = "enable_send_gift_guide")
    public int enableSendGiftGuide;
    @C17952c(mo34828a = "enable_send_shortcut_gift")
    public int enableSendShortcutGift;
    @C17952c(mo34828a = "enable_share")
