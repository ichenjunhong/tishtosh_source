    ...
    static class CommentEggDataNode {
        ...
        private void preLoadEggSource() {
            for (int i = 0; i < this.eggCount; i++) {
                C0013i.m16a((Callable<TResult>) new CommentEggDataManager$CommentEggDataNode$$Lambda$0<TResult>(this, ((ItemCommentEggData) this.itemCommentEggGroup.commentEggData.get(i)).materialUrl));
            }
        }
        ...
        public final /* synthetic */ Object mo61965xd28361bd(final String str) throws Exception {
            if (TextUtils.isEmpty(str)) {
                return null;
            }
            if (C26515i.m64159a(Uri.parse(str))) {
                this.preloadSet.add(str);
                return null;
            }
            C26515i.m64158a(str, (C26517a) new C26517a() {
