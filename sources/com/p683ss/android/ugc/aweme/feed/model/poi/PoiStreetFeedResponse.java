...
public final class PoiStreetFeedResponse {
    ...
    @C17952c(mo34828a = "page_view_count")
    ...
    public static /* synthetic */ com.p683ss.android.ugc.aweme.feed.model.poi.PoiStreetFeedResponse copy$default(com.p683ss.android.ugc.aweme.feed.model.poi.PoiStreetFeedResponse r3, int r4, int r5, java.lang.String r6, com.p683ss.android.ugc.aweme.feed.model.LogPbBean r7, java.util.List<com.p683ss.android.ugc.aweme.feed.model.Aweme> r8, int r9, java.lang.Object r10) {
        /*
            r10 = r9 & 1
        ...
        L_0x0021:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ugc.aweme.feed.model.poi.PoiStreetFeedResponse.copy$default(com.ss.android.ugc.aweme.feed.model.poi.PoiStreetFeedResponse, int, int, java.lang.String, com.ss.android.ugc.aweme.feed.model.LogPbBean, java.util.List, int, java.lang.Object):com.ss.android.ugc.aweme.feed.model.poi.PoiStreetFeedResponse");
    }
        ...
        if (this != obj) {
            if (obj instanceof PoiStreetFeedResponse) {
                ...
                if (this.code == poiStreetFeedResponse.code) {
                    if (!(this.hasMore == poiStreetFeedResponse.hasMore) || !C52711k.m112239a((Object) this.pageViewCount, (Object) poiStreetFeedResponse.pageViewCount) || !C52711k.m112239a((Object) this.logPb, (Object) poiStreetFeedResponse.logPb) || !C52711k.m112239a((Object) this.poiAwemeList, (Object) poiStreetFeedResponse.poiAwemeList)) {
                        return false;
                    }
                }
            }
    ...
    public /* synthetic */ PoiStreetFeedResponse(int i, int i2, String str, LogPbBean logPbBean, List list, int i3, C52707g gVar) {
        int i4;
        if ((i3 & 1) != 0) {
            i = 0;
        }
