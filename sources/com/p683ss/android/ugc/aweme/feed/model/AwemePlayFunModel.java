...
public final class AwemePlayFunModel implements Serializable {
    ...
    @C17952c(mo34828a = "start_duration")
    ...
    public static /* synthetic */ AwemePlayFunModel copy$default(AwemePlayFunModel awemePlayFunModel, UrlModel urlModel, String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, int i, int i2, Object obj) {
        ...
        int i3 = i2;
        return awemePlayFunModel.copy((i3 & 1) != 0 ? awemePlayFunModel2.imageInfo : urlModel, (i3 & 2) != 0 ? awemePlayFunModel2.tips : str, (i3 & 4) != 0 ? awemePlayFunModel2.startDuration : f, (i3 & 8) != 0 ? awemePlayFunModel2.endDuration : f2, (i3 & 16) != 0 ? awemePlayFunModel2.showDuration : f3, (i3 & 32) != 0 ? awemePlayFunModel2.showTime : f4, (i3 & 64) != 0 ? awemePlayFunModel2.positionX : f5, (i3 & 128) != 0 ? awemePlayFunModel2.positionY : f6, (i3 & UnReadVideoExperiment.BROWSE_RECORD_LIST) != 0 ? awemePlayFunModel2.size : f7, (i3 & UnReadVideoExperiment.LIKE_USER_LIST) != 0 ? awemePlayFunModel2.angle : i);
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AwemePlayFunModel) {
                ...
                if (C52711k.m112239a((Object) this.imageInfo, (Object) awemePlayFunModel.imageInfo) && C52711k.m112239a((Object) this.tips, (Object) awemePlayFunModel.tips) && Float.compare(this.startDuration, awemePlayFunModel.startDuration) == 0 && Float.compare(this.endDuration, awemePlayFunModel.endDuration) == 0 && Float.compare(this.showDuration, awemePlayFunModel.showDuration) == 0 && Float.compare(this.showTime, awemePlayFunModel.showTime) == 0 && Float.compare(this.positionX, awemePlayFunModel.positionX) == 0 && Float.compare(this.positionY, awemePlayFunModel.positionY) == 0 && Float.compare(this.size, awemePlayFunModel.size) == 0) {
    ...
    public /* synthetic */ AwemePlayFunModel(UrlModel urlModel, String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, int i, int i2, C52707g gVar) {
        float f8;
        float f9;
        float f10;
        float f11;
