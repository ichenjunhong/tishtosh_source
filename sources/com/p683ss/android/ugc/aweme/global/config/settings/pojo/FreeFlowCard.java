...
public final class FreeFlowCard extends Message<FreeFlowCard, Builder> {
    ...
    static final class ProtoAdapter_FreeFlowCard extends DefaultValueProtoAdapter<FreeFlowCard> {
        ...
        public final FreeFlowCard decode(ProtoReader protoReader, FreeFlowCard freeFlowCard) throws IOException {
            Builder builder;
            FreeFlowCard freeFlowCard2 = (FreeFlowCard) C10617a.m21405a().mo18840a(FreeFlowCard.class, freeFlowCard);
    ...
    public final String getEntryUrl() throws C10174a {
    ...
    public final String getEntryUrlText() throws C10174a {
    ...
    public final String getToastSlogan() throws C10174a {
    ...
    public final String getToastTitle() throws C10174a {
    ...
    public final Integer getToastType() throws C10174a {
    ...
    public final String getToastUrl() throws C10174a {
    ...
    public final String getToastUrlText() throws C10174a {
