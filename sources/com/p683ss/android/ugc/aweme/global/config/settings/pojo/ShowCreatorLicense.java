...
public final class ShowCreatorLicense extends Message<ShowCreatorLicense, Builder> {
    ...
    static final class ProtoAdapter_ShowCreatorLicense extends DefaultValueProtoAdapter<ShowCreatorLicense> {
        ...
        public final ShowCreatorLicense decode(ProtoReader protoReader, ShowCreatorLicense showCreatorLicense) throws IOException {
            Builder builder;
            ShowCreatorLicense showCreatorLicense2 = (ShowCreatorLicense) C10617a.m21405a().mo18840a(ShowCreatorLicense.class, showCreatorLicense);
    ...
    public final Integer getClickType() throws C10174a {
    ...
    public final String getPopupContent() throws C10174a {
    ...
    public final Integer getPopupInterval() throws C10174a {
    ...
    public final String getPopupLinkText() throws C10174a {
    ...
    public final String getPopupMsg() throws C10174a {
    ...
    public final Integer getPopupTimesLimit() throws C10174a {
    ...
    public final String getPopupTitle() throws C10174a {
    ...
    public final String getPopupUrl() throws C10174a {
    ...
    public final Integer getShow() throws C10174a {
        if (this.show != null) {
            return this.show;
        }
        throw new C10174a();
