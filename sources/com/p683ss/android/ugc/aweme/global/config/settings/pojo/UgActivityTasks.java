...
public final class UgActivityTasks extends Message<UgActivityTasks, Builder> {
    ...
    static final class ProtoAdapter_UgActivityTasks extends DefaultValueProtoAdapter<UgActivityTasks> {
        ...
        public final UgActivityTasks decode(ProtoReader protoReader, UgActivityTasks ugActivityTasks) throws IOException {
            Builder builder;
            UgActivityTasks ugActivityTasks2 = (UgActivityTasks) C10617a.m21405a().mo18840a(UgActivityTasks.class, ugActivityTasks);
    ...
    public final String getTaskId() throws C10174a {
    ...
    public final Integer getTaskType() throws C10174a {
    ...
    public final Long getTime() throws C10174a {
        if (this.time != null) {
            return this.time;
        }
        throw new C10174a();
