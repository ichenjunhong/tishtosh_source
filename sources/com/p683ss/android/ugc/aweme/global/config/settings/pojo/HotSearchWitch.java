...
public final class HotSearchWitch extends Message<HotSearchWitch, Builder> {
    ...
    static final class ProtoAdapter_HotSearchWitch extends DefaultValueProtoAdapter<HotSearchWitch> {
        ...
        public final HotSearchWitch decode(ProtoReader protoReader, HotSearchWitch hotSearchWitch) throws IOException {
            Builder builder;
            HotSearchWitch hotSearchWitch2 = (HotSearchWitch) C10617a.m21405a().mo18840a(HotSearchWitch.class, hotSearchWitch);
    ...
    public final Boolean getHotsearchAwemeBillboardSwitch() throws C10174a {
    ...
    public final Boolean getHotsearchBillboardSwitch() throws C10174a {
    ...
    public final Boolean getHotsearchMusicBillboardSwitch() throws C10174a {
    ...
    public final Boolean getHotsearchPositiveEnergyBillboardSwitch() throws C10174a {
    ...
    public final Boolean getHotsearchStarBillboardSwitch() throws C10174a {
