...
public final class ActivityStruct extends Message<ActivityStruct, Builder> {
    ...
    static final class ProtoAdapter_ActivityStruct extends DefaultValueProtoAdapter<ActivityStruct> {
        ...
        public final ActivityStruct decode(ProtoReader protoReader, ActivityStruct activityStruct) throws IOException {
            Builder builder;
            ActivityStruct activityStruct2 = (ActivityStruct) C10617a.m21405a().mo18840a(ActivityStruct.class, activityStruct);
    ...
    public final String getActivityName() throws C10174a {
    ...
    public final UrlModel getCommentIcon() throws C10174a {
    ...
    public final UrlModel getDiggIcon() throws C10174a {
    ...
    public final Boolean getInActivity() throws C10174a {
    ...
    public final UrlModel getShareIcon() throws C10174a {
    ...
    public final UrlModel getShareTipIcon() throws C10174a {
    ...
    public final UrlModel getShotIcon() throws C10174a {
    ...
    public final UrlModel getUndiggIcon() throws C10174a {
    ...
    public final WatermarkStruct getWatermarkStruct() throws C10174a {
