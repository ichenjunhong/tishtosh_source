...
public final class CommerceEggConfig extends Message<CommerceEggConfig, Builder> {
    ...
    static final class ProtoAdapter_CommerceEggConfig extends DefaultValueProtoAdapter<CommerceEggConfig> {
        ...
        public final CommerceEggConfig decode(ProtoReader protoReader, CommerceEggConfig commerceEggConfig) throws IOException {
            Builder builder;
            CommerceEggConfig commerceEggConfig2 = (CommerceEggConfig) C10617a.m21405a().mo18840a(CommerceEggConfig.class, commerceEggConfig);
    ...
    public final Boolean getEnableCommentEggRefactor() throws C10174a {
    ...
    public final Boolean getEnableDiggEggRefactor() throws C10174a {
    ...
    public final Boolean getEnableSearchEggRefactor() throws C10174a {
