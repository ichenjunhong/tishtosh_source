...
public final class TextFontStyleData extends Message<TextFontStyleData, Builder> {
    ...
    static final class ProtoAdapter_TextFontStyleData extends DefaultValueProtoAdapter<TextFontStyleData> {
        ...
        public final TextFontStyleData decode(ProtoReader protoReader, TextFontStyleData textFontStyleData) throws IOException {
            Builder builder;
            TextFontStyleData textFontStyleData2 = (TextFontStyleData) C10617a.m21405a().mo18840a(TextFontStyleData.class, textFontStyleData);
    ...
    public final Integer getEnableBgColor() throws C10174a {
    ...
    public final Integer getEnableMaskblurLightColor() throws C10174a {
    ...
    public final Integer getExtraType() throws C10174a {
    ...
    public final String getFontName() throws C10174a {
