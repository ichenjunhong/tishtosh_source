...
public final class UgAwemeActivitySetting extends Message<UgAwemeActivitySetting, Builder> {
    ...
    static final class ProtoAdapter_UgAwemeActivitySetting extends DefaultValueProtoAdapter<UgAwemeActivitySetting> {
        ...
        public final UgAwemeActivitySetting decode(ProtoReader protoReader, UgAwemeActivitySetting ugAwemeActivitySetting) throws IOException {
            Builder builder;
            UgAwemeActivitySetting ugAwemeActivitySetting2 = (UgAwemeActivitySetting) C10617a.m21405a().mo18840a(UgAwemeActivitySetting.class, ugAwemeActivitySetting);
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            newMutableList.add(UgActivityTasks.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(UgActivityTasks.class)));
                            break;
                        case 11:
    ...
    public final Long getActivityEndTime() throws C10174a {
    ...
    public final String getActivityId() throws C10174a {
    ...
    public final Long getActivityStartTime() throws C10174a {
    ...
    public final UgChannelPopup getChannelPopup() throws C10174a {
    ...
    public final Boolean getIsNewUser() throws C10174a {
    ...
    public final UgLoginBanner getLoginBanner() throws C10174a {
    ...
    public final UgNewFeedPendant getNewFeedPendant() throws C10174a {
    ...
    public final Boolean getOverallSwitch() throws C10174a {
    ...
    public final UgProfileActivityButton getProfileActivityButton() throws C10174a {
    ...
    public final UgProfileTabGuide getProfileTabGuide() throws C10174a {
