...
public final class GlobalTips extends Message<GlobalTips, Builder> {
    ...
    static final class ProtoAdapter_GlobalTips extends DefaultValueProtoAdapter<GlobalTips> {
        ...
        public final GlobalTips decode(ProtoReader protoReader, GlobalTips globalTips) throws IOException {
            Builder builder;
            GlobalTips globalTips2 = (GlobalTips) C10617a.m21405a().mo18840a(GlobalTips.class, globalTips);
            if (globalTips2 != null) {
    ...
    public final String getAtTooMore() throws C10174a {
    ...
    public final String getDraftPublish() throws C10174a {
    ...
    public final String getNetWeak() throws C10174a {
    ...
    public final String getNotComment() throws C10174a {
    ...
    public final String getNotHasMore() throws C10174a {
    ...
    public final String getNotShare() throws C10174a {
    ...
    public final String getSearchTips() throws C10174a {
    ...
    public final String getSelfSeeNotShare() throws C10174a {
    ...
    public final String getShareFail() throws C10174a {
