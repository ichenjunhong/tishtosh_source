...
public final class LinkPlan extends Message<LinkPlan, Builder> {
    ...
    static final class ProtoAdapter_LinkPlan extends DefaultValueProtoAdapter<LinkPlan> {
        ...
        public final LinkPlan decode(ProtoReader protoReader, LinkPlan linkPlan) throws IOException {
            Builder builder;
            LinkPlan linkPlan2 = (LinkPlan) C10617a.m21405a().mo18840a(LinkPlan.class, linkPlan);
            if (linkPlan2 != null) {
    ...
    public final String getInfo() throws C10174a {
        if (this.info != null) {
            return this.info;
        }
        throw new C10174a();
    ...
    public final String getSettings() throws C10174a {
