...
public final class CommentListAdMigration extends Message<CommentListAdMigration, Builder> {
    ...
    static final class ProtoAdapter_CommentListAdMigration extends DefaultValueProtoAdapter<CommentListAdMigration> {
        ...
        public final CommentListAdMigration decode(ProtoReader protoReader, CommentListAdMigration commentListAdMigration) throws IOException {
            Builder builder;
            CommentListAdMigration commentListAdMigration2 = (CommentListAdMigration) C10617a.m21405a().mo18840a(CommentListAdMigration.class, commentListAdMigration);
    ...
    public final String getEnterpriseTag() throws C10174a {
    ...
    public final String getLinkTag() throws C10174a {
    ...
    public final String getStarAtlasTag() throws C10174a {
    ...
    public final String getTaskTag() throws C10174a {
