...
public final class ContentLanguageGuideSetting extends Message<ContentLanguageGuideSetting, Builder> {
    ...
    static final class ProtoAdapter_ContentLanguageGuideSetting extends DefaultValueProtoAdapter<ContentLanguageGuideSetting> {
        ...
        public final ContentLanguageGuideSetting decode(ProtoReader protoReader, ContentLanguageGuideSetting contentLanguageGuideSetting) throws IOException {
            Builder builder;
            ContentLanguageGuideSetting contentLanguageGuideSetting2 = (ContentLanguageGuideSetting) C10617a.m21405a().mo18840a(ContentLanguageGuideSetting.class, contentLanguageGuideSetting);
    ...
    public final String getCode() throws C10174a {
        if (this.code != null) {
            return this.code;
        }
        throw new C10174a();
    ...
    public final String getEnName() throws C10174a {
    ...
    public final String getHighlightColor() throws C10174a {
    ...
    public final String getIcon() throws C10174a {
        if (this.icon != null) {
            return this.icon;
        }
        throw new C10174a();
    ...
    public final String getLocalName() throws C10174a {
