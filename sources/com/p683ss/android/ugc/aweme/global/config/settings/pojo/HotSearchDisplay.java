...
public final class HotSearchDisplay extends Message<HotSearchDisplay, Builder> {
    ...
    static final class ProtoAdapter_HotSearchDisplay extends DefaultValueProtoAdapter<HotSearchDisplay> {
        ...
        public final HotSearchDisplay decode(ProtoReader protoReader, HotSearchDisplay hotSearchDisplay) throws IOException {
            Builder builder;
            HotSearchDisplay hotSearchDisplay2 = (HotSearchDisplay) C10617a.m21405a().mo18840a(HotSearchDisplay.class, hotSearchDisplay);
    ...
    public final Integer getMostDisplayTimes() throws C10174a {
    ...
    public final Long getOneDisplayIntervals() throws C10174a {
    ...
    public final Integer getOpMostDisplayTimes() throws C10174a {
    ...
    public final Long getOpOneDisplayIntervals() throws C10174a {
