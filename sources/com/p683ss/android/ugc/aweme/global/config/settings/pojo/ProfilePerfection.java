...
public final class ProfilePerfection extends Message<ProfilePerfection, Builder> {
    ...
    static final class ProtoAdapter_ProfilePerfection extends DefaultValueProtoAdapter<ProfilePerfection> {
        ...
        public final ProfilePerfection decode(ProtoReader protoReader, ProfilePerfection profilePerfection) throws IOException {
            Builder builder;
            ProfilePerfection profilePerfection2 = (ProfilePerfection) C10617a.m21405a().mo18840a(ProfilePerfection.class, profilePerfection);
    ...
    public final Float getAvatar() throws C10174a {
        if (this.avatar != null) {
            return this.avatar;
        }
        throw new C10174a();
    ...
    public final Float getBirthday() throws C10174a {
    ...
    public final Float getGender() throws C10174a {
        if (this.gender != null) {
            return this.gender;
        }
        throw new C10174a();
    ...
    public final Float getLocation() throws C10174a {
    ...
    public final Float getNickname() throws C10174a {
    ...
    public final Float getSchool() throws C10174a {
        if (this.school != null) {
            return this.school;
        }
        throw new C10174a();
    ...
    public final Float getShortId() throws C10174a {
    ...
    public final Float getSignature() throws C10174a {
