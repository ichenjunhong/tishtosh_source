...
public final class AwemeFEConfigs extends Message<AwemeFEConfigs, Builder> {
    ...
    static final class ProtoAdapter_AwemeFEConfigs extends DefaultValueProtoAdapter<AwemeFEConfigs> {
        ...
        public final AwemeFEConfigs decode(ProtoReader protoReader, AwemeFEConfigs awemeFEConfigs) throws IOException {
            Builder builder;
            AwemeFEConfigs awemeFEConfigs2 = (AwemeFEConfigs) C10617a.m21405a().mo18840a(AwemeFEConfigs.class, awemeFEConfigs);
    ...
    public final BusinessEC getBusinessEc() throws C10174a {
    ...
    public final GoodsReport getGoodsReport() throws C10174a {
    ...
    public final LinkPlan getLinkPlan() throws C10174a {
    ...
    public final ShopLiveConfig getLive() throws C10174a {
        if (this.live != null) {
            return this.live;
        }
        throw new C10174a();
    ...
    public final MpTab getMpTab() throws C10174a {
        if (this.mp_tab != null) {
            return this.mp_tab;
        }
        throw new C10174a();
    ...
    public final PoiConfig getPoiErrorReport() throws C10174a {
    ...
    public final String getSeedLabel() throws C10174a {
    ...
    public final Seeding getSeeding() throws C10174a {
    ...
    public final StarAtlasOrder getStarAtlasOrder() throws C10174a {
    ...
    public final VideoAuth getVideoAuth() throws C10174a {
