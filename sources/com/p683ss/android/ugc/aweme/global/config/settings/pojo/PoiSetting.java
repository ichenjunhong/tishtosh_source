...
public final class PoiSetting extends Message<PoiSetting, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<PoiSetting, Builder> {
        ...
        public final PoiSetting build() {
            ...
            throw C10619c.m21408a(this.location_update_interval, "location_update_interval", this.report_gps, "report_gps", this.report_interval_seconds, "report_interval_seconds", this.report_at_start, "report_at_start", this.nearby_location_prompt_interval, "nearby_location_prompt_interval");
        }
    ...
    static final class ProtoAdapter_PoiSetting extends DefaultValueProtoAdapter<PoiSetting> {
        ...
        public final PoiSetting decode(ProtoReader protoReader, PoiSetting poiSetting) throws IOException {
            Builder builder;
            PoiSetting poiSetting2 = (PoiSetting) C10617a.m21405a().mo18840a(PoiSetting.class, poiSetting);
            if (poiSetting2 != null) {
    ...
    public final Integer getCollectHintActionInterval() throws C10174a {
    ...
    public final Integer getCollectHintDisplayInterval() throws C10174a {
    ...
    public final String getLifeServiceAssistantUrl() throws C10174a {
    ...
    public final Integer getMaxPicSize() throws C10174a {
    ...
    public final String getMerchantManagementUrl() throws C10174a {
    ...
    public final String getMerchantSettleUrl() throws C10174a {
    ...
    public final Integer getPoiLocationCacheDuration() throws C10174a {
    ...
    public final Long getPoiLocationDelayUpload() throws C10174a {
    ...
    public final Integer getPoiOpenRegeo() throws C10174a {
    ...
    public final String getPoiQaListUrl() throws C10174a {
    ...
    public final String getPoiRegionList() throws C10174a {
    ...
    public final Integer getReportBssMax() throws C10174a {
    ...
    public final Integer getReportWifiMax() throws C10174a {
