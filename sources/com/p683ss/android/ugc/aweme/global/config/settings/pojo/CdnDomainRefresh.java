...
public final class CdnDomainRefresh extends Message<CdnDomainRefresh, Builder> {
    ...
    static final class ProtoAdapter_CdnDomainRefresh extends DefaultValueProtoAdapter<CdnDomainRefresh> {
        ...
        public final CdnDomainRefresh decode(ProtoReader protoReader, CdnDomainRefresh cdnDomainRefresh) throws IOException {
            Builder builder;
            CdnDomainRefresh cdnDomainRefresh2 = (CdnDomainRefresh) C10617a.m21405a().mo18840a(CdnDomainRefresh.class, cdnDomainRefresh);
    ...
    public final Integer getKeepaliveTimeout() throws C10174a {
    ...
    public final Integer getRefreshInterval() throws C10174a {
    ...
    public final Boolean getRefreshSwitch() throws C10174a {
