...
public final class ShoppingConfig extends Message<ShoppingConfig, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<ShoppingConfig, Builder> {
        ...
        public final ShoppingConfig build() {
            ...
            throw C10619c.m21408a(this.preload_data_wait_duration, "preload_data_wait_duration");
        }
    ...
    static final class ProtoAdapter_ShoppingConfig extends DefaultValueProtoAdapter<ShoppingConfig> {
        ...
        public final ShoppingConfig decode(ProtoReader protoReader, ShoppingConfig shoppingConfig) throws IOException {
            Builder builder;
            ShoppingConfig shoppingConfig2 = (ShoppingConfig) C10617a.m21405a().mo18840a(ShoppingConfig.class, shoppingConfig);
    ...
    public final Integer getCardShowDuration() throws C10174a {
    ...
    public final Boolean getDisableCard() throws C10174a {
    ...
    public final Boolean getDisableWant() throws C10174a {
    ...
    public final Boolean getEnableFloatVideo() throws C10174a {
    ...
    public final Boolean getEnableUser() throws C10174a {
    ...
    public final Boolean getLawWindow() throws C10174a {
    ...
    public final ShoppingLiveConfig getLive() throws C10174a {
        if (this.live != null) {
            return this.live;
        }
        throw new C10174a();
    ...
    public final ShoppingNewbieHelp getNewbieHelp() throws C10174a {
    ...
    public final String getOrderShareIntroUrl() throws C10174a {
