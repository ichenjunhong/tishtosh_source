...
public final class NewYearConfig extends Message<NewYearConfig, Builder> {
    ...
    static final class ProtoAdapter_NewYearConfig extends DefaultValueProtoAdapter<NewYearConfig> {
        ...
        public final NewYearConfig decode(ProtoReader protoReader, NewYearConfig newYearConfig) throws IOException {
            Builder builder;
            NewYearConfig newYearConfig2 = (NewYearConfig) C10617a.m21405a().mo18840a(NewYearConfig.class, newYearConfig);
    ...
    public final Integer getAutoFoldVvCount() throws C10174a {
    ...
    public final Boolean getDisabled() throws C10174a {
    ...
    public final Integer getMaxAmount() throws C10174a {
    ...
    public final String getNewyearTestDomain() throws C10174a {
    ...
    public final Boolean getNewyearTestSwitch() throws C10174a {
    ...
    public final Boolean getShowNewyearFreshButton() throws C10174a {
    ...
    public final String getToken() throws C10174a {
        if (this.token != null) {
            return this.token;
        }
        throw new C10174a();
