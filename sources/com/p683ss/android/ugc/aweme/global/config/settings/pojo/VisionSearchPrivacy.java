...
public final class VisionSearchPrivacy extends Message<VisionSearchPrivacy, Builder> {
    ...
    static final class ProtoAdapter_VisionSearchPrivacy extends DefaultValueProtoAdapter<VisionSearchPrivacy> {
        ...
        public final VisionSearchPrivacy decode(ProtoReader protoReader, VisionSearchPrivacy visionSearchPrivacy) throws IOException {
            Builder builder;
            VisionSearchPrivacy visionSearchPrivacy2 = (VisionSearchPrivacy) C10617a.m21405a().mo18840a(VisionSearchPrivacy.class, visionSearchPrivacy);
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            newMutableList.add(VisionSearchPrivacyLink.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(VisionSearchPrivacyLink.class)));
                            break;
                        default:
                            try {
