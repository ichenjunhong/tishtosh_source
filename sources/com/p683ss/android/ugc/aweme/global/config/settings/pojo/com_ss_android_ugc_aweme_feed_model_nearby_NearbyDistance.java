...
public final class com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance extends Message<com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance, Builder> {
    public static final DefaultValueProtoAdapter<com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance> ADAPTER = new C32830xb3dad81c();
    ...
    static final class C32830xb3dad81c extends DefaultValueProtoAdapter<com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance> {
        ...
        public final com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance decode(ProtoReader protoReader, com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance com_ss_android_ugc_aweme_feed_model_nearby_nearbydistance) throws IOException {
            Builder builder;
            com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance com_ss_android_ugc_aweme_feed_model_nearby_nearbydistance2 = (com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance) C10617a.m21405a().mo18840a(com_ss_android_ugc_aweme_feed_model_nearby_NearbyDistance.class, com_ss_android_ugc_aweme_feed_model_nearby_nearbydistance);
    ...
    public final Integer getMax() throws C10174a {
        if (this.max != null) {
            return this.max;
        }
        throw new C10174a();
    ...
    public final Integer getMin() throws C10174a {
        if (this.min != null) {
            return this.min;
        }
        throw new C10174a();
