...
public final class UpdateUserConfig extends Message<UpdateUserConfig, Builder> {
    ...
    static final class ProtoAdapter_UpdateUserConfig extends DefaultValueProtoAdapter<UpdateUserConfig> {
        ...
        public final UpdateUserConfig decode(ProtoReader protoReader, UpdateUserConfig updateUserConfig) throws IOException {
            Builder builder;
            UpdateUserConfig updateUserConfig2 = (UpdateUserConfig) C10617a.m21405a().mo18840a(UpdateUserConfig.class, updateUserConfig);
    ...
    public final String getWxToastContent() throws C10174a {
    ...
    public final Boolean getWxToastEnable() throws C10174a {
    ...
    public final Integer getWxToastFrequence() throws C10174a {
    ...
    public final Integer getWxToastPosition() throws C10174a {
