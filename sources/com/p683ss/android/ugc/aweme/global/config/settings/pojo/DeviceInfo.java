...
public final class DeviceInfo extends Message<DeviceInfo, Builder> {
    ...
    static final class ProtoAdapter_DeviceInfo extends DefaultValueProtoAdapter<DeviceInfo> {
        ...
        public final DeviceInfo decode(ProtoReader protoReader, DeviceInfo deviceInfo) throws IOException {
            Builder builder;
            DeviceInfo deviceInfo2 = (DeviceInfo) C10617a.m21405a().mo18840a(DeviceInfo.class, deviceInfo);
            if (deviceInfo2 != null) {
    ...
    public final String getBrand() throws C10174a {
        if (this.brand != null) {
            return this.brand;
        }
        throw new C10174a();
    ...
    public final String getDevice() throws C10174a {
        if (this.device != null) {
            return this.device;
        }
        throw new C10174a();
    ...
    public final String getModel() throws C10174a {
        if (this.model != null) {
            return this.model;
        }
        throw new C10174a();
