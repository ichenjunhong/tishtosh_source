...
public final class BindWindowsStruct extends Message<BindWindowsStruct, Builder> {
    ...
    static final class ProtoAdapter_BindWindowsStruct extends DefaultValueProtoAdapter<BindWindowsStruct> {
        ...
        public final BindWindowsStruct decode(ProtoReader protoReader, BindWindowsStruct bindWindowsStruct) throws IOException {
            Builder builder;
            BindWindowsStruct bindWindowsStruct2 = (BindWindowsStruct) C10617a.m21405a().mo18840a(BindWindowsStruct.class, bindWindowsStruct);
    ...
    public final String getBindDesc() throws C10174a {
    ...
    public final String getBindTitle() throws C10174a {
    ...
    public final Integer getInterval() throws C10174a {
    ...
    public final Integer getLoginPlatform() throws C10174a {
    ...
    public final Boolean getOpenWindow() throws C10174a {
    ...
    public final Integer getTotalTimes() throws C10174a {
