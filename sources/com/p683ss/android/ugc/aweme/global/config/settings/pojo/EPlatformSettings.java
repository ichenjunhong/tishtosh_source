...
public final class EPlatformSettings extends Message<EPlatformSettings, Builder> {
    ...
    static final class ProtoAdapter_EPlatformSettings extends DefaultValueProtoAdapter<EPlatformSettings> {
        ...
        public final EPlatformSettings decode(ProtoReader protoReader, EPlatformSettings ePlatformSettings) throws IOException {
            Builder builder;
            EPlatformSettings ePlatformSettings2 = (EPlatformSettings) C10617a.m21405a().mo18840a(EPlatformSettings.class, ePlatformSettings);
    ...
    public final String getBlockHint() throws C10174a {
    ...
    public final Integer getBlockMode() throws C10174a {
    ...
    public final String getJumpRedirectUrl() throws C10174a {
    ...
    public final String getLiteLink() throws C10174a {
    ...
    public final String getProfileAddContactInfoText() throws C10174a {
