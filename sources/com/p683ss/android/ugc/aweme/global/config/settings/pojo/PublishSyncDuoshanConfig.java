...
public final class PublishSyncDuoshanConfig extends Message<PublishSyncDuoshanConfig, Builder> {
    ...
    static final class ProtoAdapter_PublishSyncDuoshanConfig extends DefaultValueProtoAdapter<PublishSyncDuoshanConfig> {
        ...
        public final PublishSyncDuoshanConfig decode(ProtoReader protoReader, PublishSyncDuoshanConfig publishSyncDuoshanConfig) throws IOException {
            Builder builder;
            PublishSyncDuoshanConfig publishSyncDuoshanConfig2 = (PublishSyncDuoshanConfig) C10617a.m21405a().mo18840a(PublishSyncDuoshanConfig.class, publishSyncDuoshanConfig);
    ...
    public final String getH5Str() throws C10174a {
        if (this.h5_str != null) {
            return this.h5_str;
        }
        throw new C10174a();
    ...
    public final String getH5Url() throws C10174a {
        if (this.h5_url != null) {
            return this.h5_url;
        }
        throw new C10174a();
