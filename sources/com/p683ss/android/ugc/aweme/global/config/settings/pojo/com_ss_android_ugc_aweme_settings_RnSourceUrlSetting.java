...
public final class com_ss_android_ugc_aweme_settings_RnSourceUrlSetting extends Message<com_ss_android_ugc_aweme_settings_RnSourceUrlSetting, Builder> {
    public static final DefaultValueProtoAdapter<com_ss_android_ugc_aweme_settings_RnSourceUrlSetting> ADAPTER = new C32855x2534eab5();
    ...
    static final class C32855x2534eab5 extends DefaultValueProtoAdapter<com_ss_android_ugc_aweme_settings_RnSourceUrlSetting> {
        ...
        public final com_ss_android_ugc_aweme_settings_RnSourceUrlSetting decode(ProtoReader protoReader, com_ss_android_ugc_aweme_settings_RnSourceUrlSetting com_ss_android_ugc_aweme_settings_rnsourceurlsetting) throws IOException {
            Builder builder;
            com_ss_android_ugc_aweme_settings_RnSourceUrlSetting com_ss_android_ugc_aweme_settings_rnsourceurlsetting2 = (com_ss_android_ugc_aweme_settings_RnSourceUrlSetting) C10617a.m21405a().mo18840a(com_ss_android_ugc_aweme_settings_RnSourceUrlSetting.class, com_ss_android_ugc_aweme_settings_rnsourceurlsetting);
    ...
    public final String getChannel() throws C10174a {
    ...
    public final String getSourceUrl() throws C10174a {
