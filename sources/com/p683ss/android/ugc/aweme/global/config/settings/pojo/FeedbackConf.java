...
public final class FeedbackConf extends Message<FeedbackConf, Builder> {
    ...
    static final class ProtoAdapter_FeedbackConf extends DefaultValueProtoAdapter<FeedbackConf> {
        ...
        public final FeedbackConf decode(ProtoReader protoReader, FeedbackConf feedbackConf) throws IOException {
            Builder builder;
            FeedbackConf feedbackConf2 = (FeedbackConf) C10617a.m21405a().mo18840a(FeedbackConf.class, feedbackConf);
    ...
    public final String getFeHelp() throws C10174a {
    ...
    public final String getHelp() throws C10174a {
        if (this.help != null) {
            return this.help;
        }
        throw new C10174a();
    ...
    public final String getNormalEntry() throws C10174a {
    ...
    public final String getNotLoggedIn() throws C10174a {
