...
public final class UserCacheSetting extends Message<UserCacheSetting, Builder> {
    ...
    static final class ProtoAdapter_UserCacheSetting extends DefaultValueProtoAdapter<UserCacheSetting> {
        ...
        public final UserCacheSetting decode(ProtoReader protoReader, UserCacheSetting userCacheSetting) throws IOException {
            Builder builder;
            UserCacheSetting userCacheSetting2 = (UserCacheSetting) C10617a.m21405a().mo18840a(UserCacheSetting.class, userCacheSetting);
    ...
    public final Integer getEnableRuCache() throws C10174a {
    ...
    public final Integer getEnableRuInsert() throws C10174a {
    ...
    public final Long getRuCacheIntervals() throws C10174a {
