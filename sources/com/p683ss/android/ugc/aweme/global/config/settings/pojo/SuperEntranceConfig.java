...
public final class SuperEntranceConfig extends Message<SuperEntranceConfig, Builder> {
    ...
    static final class ProtoAdapter_SuperEntranceConfig extends DefaultValueProtoAdapter<SuperEntranceConfig> {
        ...
        public final SuperEntranceConfig decode(ProtoReader protoReader, SuperEntranceConfig superEntranceConfig) throws IOException {
            Builder builder;
            SuperEntranceConfig superEntranceConfig2 = (SuperEntranceConfig) C10617a.m21405a().mo18840a(SuperEntranceConfig.class, superEntranceConfig);
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            newMutableList.add(ValidTimesConfig.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(ValidTimesConfig.class)));
                            break;
                        case 2:
