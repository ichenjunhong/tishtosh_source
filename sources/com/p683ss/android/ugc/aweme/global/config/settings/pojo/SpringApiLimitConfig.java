...
public final class SpringApiLimitConfig extends Message<SpringApiLimitConfig, Builder> {
    ...
    static final class ProtoAdapter_SpringApiLimitConfig extends DefaultValueProtoAdapter<SpringApiLimitConfig> {
        ...
        public final SpringApiLimitConfig decode(ProtoReader protoReader, SpringApiLimitConfig springApiLimitConfig) throws IOException {
            Builder builder;
            SpringApiLimitConfig springApiLimitConfig2 = (SpringApiLimitConfig) C10617a.m21405a().mo18840a(SpringApiLimitConfig.class, springApiLimitConfig);
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            newMutableList.add(ApiConfigEntity.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(ApiConfigEntity.class)));
                            break;
                        default:
                            try {
    ...
    public final Long getBatchEventInterval() throws C10174a {
    ...
    public final Boolean getDisableFetchSetting() throws C10174a {
    ...
    public final Boolean getEnableDelayApplog() throws C10174a {
    ...
    public final Long getEndTime() throws C10174a {
    ...
    public final Long getLimitEndTime() throws C10174a {
    ...
    public final Long getLimitStartTime() throws C10174a {
    ...
    public final Integer getSendLaunchTimely() throws C10174a {
    ...
    public final Long getStartTime() throws C10174a {
