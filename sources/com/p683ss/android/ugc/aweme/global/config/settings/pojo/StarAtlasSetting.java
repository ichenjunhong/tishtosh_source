...
public final class StarAtlasSetting extends Message<StarAtlasSetting, Builder> {
    ...
    static final class ProtoAdapter_StarAtlasSetting extends DefaultValueProtoAdapter<StarAtlasSetting> {
        ...
        public final StarAtlasSetting decode(ProtoReader protoReader, StarAtlasSetting starAtlasSetting) throws IOException {
            Builder builder;
            StarAtlasSetting starAtlasSetting2 = (StarAtlasSetting) C10617a.m21405a().mo18840a(StarAtlasSetting.class, starAtlasSetting);
    ...
    public final Boolean getStarAtlasEnable() throws C10174a {
    ...
    public final String getStarAtlasRedirectUrl() throws C10174a {
    ...
    public final String getStarAtlasUrl() throws C10174a {
