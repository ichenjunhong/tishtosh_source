...
public final class ThirdPlatformLoginSettings extends Message<ThirdPlatformLoginSettings, Builder> {
    ...
    static final class ProtoAdapter_ThirdPlatformLoginSettings extends DefaultValueProtoAdapter<ThirdPlatformLoginSettings> {
        ...
        public final ThirdPlatformLoginSettings decode(ProtoReader protoReader, ThirdPlatformLoginSettings thirdPlatformLoginSettings) throws IOException {
            Builder builder;
            ThirdPlatformLoginSettings thirdPlatformLoginSettings2 = (ThirdPlatformLoginSettings) C10617a.m21405a().mo18840a(ThirdPlatformLoginSettings.class, thirdPlatformLoginSettings);
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            newMutableList.add(LoginJumpStruct.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(LoginJumpStruct.class)));
                            break;
                        case 2:
                            newMutableList2.add(BindWindowsStruct.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(BindWindowsStruct.class)));
                            break;
                        case 3:
                            newMutableList3.add(BindWindowsStruct.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(BindWindowsStruct.class)));
                            break;
                        default:
                            try {
