...
public final class MtcertSettings extends Message<MtcertSettings, Builder> {
    ...
    static final class ProtoAdapter_MtcertSettings extends DefaultValueProtoAdapter<MtcertSettings> {
        ...
        public final MtcertSettings decode(ProtoReader protoReader, MtcertSettings mtcertSettings) throws IOException {
            Builder builder;
            MtcertSettings mtcertSettings2 = (MtcertSettings) C10617a.m21405a().mo18840a(MtcertSettings.class, mtcertSettings);
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            newMutableList.add(VerificationBadgeType.ADAPTER.decode(protoReader, C10617a.m21405a().mo18839a(VerificationBadgeType.class)));
                            break;
                        case 7:
