...
public final class UgChannelPopup extends Message<UgChannelPopup, Builder> {
    ...
    static final class ProtoAdapter_UgChannelPopup extends DefaultValueProtoAdapter<UgChannelPopup> {
        ...
        public final UgChannelPopup decode(ProtoReader protoReader, UgChannelPopup ugChannelPopup) throws IOException {
            Builder builder;
            UgChannelPopup ugChannelPopup2 = (UgChannelPopup) C10617a.m21405a().mo18840a(UgChannelPopup.class, ugChannelPopup);
    ...
    public final String getButtonText() throws C10174a {
    ...
    public final String getCampaignName() throws C10174a {
    ...
    public final String getContent() throws C10174a {
    ...
    public final Integer getImageStyle() throws C10174a {
    ...
    public final String getLinkSchema() throws C10174a {
    ...
    public final UrlModel getResourceUrl() throws C10174a {
    ...
    public final Boolean getShowForAll() throws C10174a {
