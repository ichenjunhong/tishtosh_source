...
public final class IMXPlanUrlModel extends Message<IMXPlanUrlModel, Builder> {
    ...
    static final class ProtoAdapter_IMXPlanUrlModel extends DefaultValueProtoAdapter<IMXPlanUrlModel> {
        ...
        public final IMXPlanUrlModel decode(ProtoReader protoReader, IMXPlanUrlModel iMXPlanUrlModel) throws IOException {
            Builder builder;
            IMXPlanUrlModel iMXPlanUrlModel2 = (IMXPlanUrlModel) C10617a.m21405a().mo18840a(IMXPlanUrlModel.class, iMXPlanUrlModel);
    ...
    public final UrlModel getHigh() throws C10174a {
        if (this.high != null) {
            return this.high;
        }
        throw new C10174a();
    ...
    public final UrlModel getNormal() throws C10174a {
        if (this.normal != null) {
            return this.normal;
        }
        throw new C10174a();
