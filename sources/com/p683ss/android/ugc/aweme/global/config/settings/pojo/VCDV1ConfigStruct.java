...
public final class VCDV1ConfigStruct extends Message<VCDV1ConfigStruct, Builder> {
    ...
    static final class ProtoAdapter_VCDV1ConfigStruct extends DefaultValueProtoAdapter<VCDV1ConfigStruct> {
        ...
        public final VCDV1ConfigStruct decode(ProtoReader protoReader, VCDV1ConfigStruct vCDV1ConfigStruct) throws IOException {
            Builder builder;
            VCDV1ConfigStruct vCDV1ConfigStruct2 = (VCDV1ConfigStruct) C10617a.m21405a().mo18840a(VCDV1ConfigStruct.class, vCDV1ConfigStruct);
    ...
    public final UrlModel getAppIcon() throws C10174a {
    ...
    public final UrlModel getAppIconBig() throws C10174a {
    ...
    public final String getAppName() throws C10174a {
    ...
    public final Integer getAppVersion() throws C10174a {
    ...
    public final String getTextAuthAlert() throws C10174a {
    ...
    public final String getTextFirstAuth() throws C10174a {
    ...
    public final String getTextLowVersion() throws C10174a {
    ...
    public final String getTextNotInstall() throws C10174a {
    ...
    public final String getTextOpenAuth() throws C10174a {
    ...
    public final String getTextOpenPrivacy() throws C10174a {
    ...
    public final String getTitleAuthAlert() throws C10174a {
    ...
    public final String getTitleFirstAuth() throws C10174a {
    ...
    public final String getTitleLowVersion() throws C10174a {
    ...
    public final String getTitleNotInstall() throws C10174a {
    ...
    public final String getTitleOpenAuth() throws C10174a {
    ...
    public final String getTitleOpenPrivacy() throws C10174a {
