...
public final class WatermarkStruct extends Message<WatermarkStruct, Builder> {
    ...
    static final class ProtoAdapter_WatermarkStruct extends DefaultValueProtoAdapter<WatermarkStruct> {
        ...
        public final WatermarkStruct decode(ProtoReader protoReader, WatermarkStruct watermarkStruct) throws IOException {
            Builder builder;
            WatermarkStruct watermarkStruct2 = (WatermarkStruct) C10617a.m21405a().mo18840a(WatermarkStruct.class, watermarkStruct);
    ...
    public final String getEndWatermarkString() throws C10174a {
    ...
    public final String getEndWatermarkSubstring() throws C10174a {
    ...
    public final String getFps() throws C10174a {
        if (this.fps != null) {
            return this.fps;
        }
        throw new C10174a();
    ...
    public final String getMd5() throws C10174a {
        if (this.md5 != null) {
            return this.md5;
        }
        throw new C10174a();
