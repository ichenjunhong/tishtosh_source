...
public final class GeckoConfig extends Message<GeckoConfig, Builder> {
    ...
    static final class ProtoAdapter_GeckoConfig extends DefaultValueProtoAdapter<GeckoConfig> {
        ...
        public final GeckoConfig decode(ProtoReader protoReader, GeckoConfig geckoConfig) throws IOException {
            Builder builder;
            GeckoConfig geckoConfig2 = (GeckoConfig) C10617a.m21405a().mo18840a(GeckoConfig.class, geckoConfig);
    ...
    public final Integer getRnContextCreateTimeout() throws C10174a {
    ...
    public final Boolean getRnPreloadContext() throws C10174a {
    ...
    public final Boolean getRnUseSnapshot() throws C10174a {
    ...
    public final Boolean getUseNewPackageNow() throws C10174a {
