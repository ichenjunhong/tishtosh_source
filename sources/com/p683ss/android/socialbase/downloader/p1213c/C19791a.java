...
public class C19791a extends SQLiteOpenHelper {

    /* renamed from: a */
    private static volatile C19791a f54491a;

    /* renamed from: b */
    private boolean f54492b = false;

    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
    }

    private C19791a() {
        super(C19884b.m48627x(), "downloader.db", null, 12);
    }

    /* renamed from: a */
    public static C19791a m48316a() {
        if (f54491a == null) {
            synchronized (C19791a.class) {
                if (f54491a == null) {
                    f54491a = new C19791a();
                }
            }
    ...
    public void onUpgrade(android.database.sqlite.SQLiteDatabase r1, int r2, int r3) {
        ...
        L_0x0082:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.socialbase.downloader.p1213c.C19791a.onUpgrade(android.database.sqlite.SQLiteDatabase, int, int):void");
    }
}
