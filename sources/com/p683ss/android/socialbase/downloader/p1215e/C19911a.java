package com.p683ss.android.socialbase.downloader.p1215e;
...
public final class C19911a {
    /* renamed from: a */
    public static void m48889a(C19865t tVar, DownloadInfo downloadInfo, BaseException baseException, int i) {
        if (tVar != null) {
            try {
                JSONObject a = m48888a(tVar.mo41379b(), downloadInfo, baseException, i);
                if (a == null) {
                    a = new JSONObject();
                }
                tVar.mo41378a(a);
    ...
    private static org.json.JSONObject m48888a(java.lang.String r8, com.p683ss.android.socialbase.downloader.model.DownloadInfo r9, com.p683ss.android.socialbase.downloader.exception.BaseException r10, int r11) {
        /*
            org.json.JSONObject r0 = new org.json.JSONObject     // Catch:{ JSONException -> 0x01a0 }
            r0.<init>()     // Catch:{ JSONException -> 0x01a0 }
            com.ss.android.socialbase.downloader.downloader.q r1 = com.p683ss.android.socialbase.downloader.downloader.C19884b.m48609f()     // Catch:{ JSONException -> 0x01a2 }
            java.lang.String r2 = ""
            java.lang.String r3 = ""
            java.lang.String r4 = ""
            r5 = 0
            if (r1 == 0) goto L_0x0034
            java.lang.String r2 = r1.mo41625b()     // Catch:{ JSONException -> 0x01a2 }
            ...
            r3 = r4
        L_0x002c:
            java.lang.String r4 = r1.mo41624a()     // Catch:{ JSONException -> 0x01a2 }
            int r5 = r1.mo41626c()     // Catch:{ JSONException -> 0x01a2 }
        L_0x0034:
            ...
            com.ss.android.socialbase.downloader.b.j r11 = r9.getRetryDelayStatus()     // Catch:{ JSONException -> 0x01a2 }
            ...
            com.ss.android.socialbase.downloader.b.b r11 = r9.getByteInvalidRetryStatus()     // Catch:{ JSONException -> 0x01a2 }
            int r11 = r11.ordinal()     // Catch:{ JSONException -> 0x01a2 }
            r0.put(r8, r11)     // Catch:{ JSONException -> 0x01a2 }
            java.lang.String r8 = "forbidden_handler_status"
            com.ss.android.socialbase.downloader.b.a r11 = r9.getAsyncHandleStatus()     // Catch:{ JSONException -> 0x01a2 }
            int r11 = r11.ordinal()     // Catch:{ JSONException -> 0x01a2 }
            r0.put(r8, r11)     // Catch:{ JSONException -> 0x01a2 }
        ...
        L_0x01a2:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.socialbase.downloader.p1215e.C19911a.m48888a(java.lang.String, com.ss.android.socialbase.downloader.model.DownloadInfo, com.ss.android.socialbase.downloader.exception.BaseException, int):org.json.JSONObject");
    }
}
