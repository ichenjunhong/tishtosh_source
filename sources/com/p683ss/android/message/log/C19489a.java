...
public final class C19489a {

    /* renamed from: a */
    static final String[] f53821a = {"_id", "category", "tag", "label", "value", "ext_value", "ext_json"};

    /* renamed from: b */
    private static final Object f53822b = new Object();

    /* renamed from: c */
    private static C19489a f53823c;

    /* renamed from: d */
    private SQLiteDatabase f53824d;

    /* renamed from: com.ss.android.message.log.a$a */
    static class C19490a extends SQLiteOpenHelper {
        public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        }

        public C19490a(Context context) {
    ...
    /* renamed from: b */
    private synchronized void m47719b() {
        try {
            if (this.f53824d != null && this.f53824d.isOpen()) {
                this.f53824d.close();
                this.f53824d = null;
            }
    ...
    /* renamed from: a */
    public static void m47717a() {
        synchronized (f53822b) {
            if (f53823c != null) {
                f53823c.m47719b();
            }
            f53823c = null;
    ...
    private C19489a(Context context) {
        this.f53824d = new C19490a(context).getWritableDatabase();
    }

    /* renamed from: a */
    private static void m47718a(Cursor cursor) {
        if (cursor != null) {
            try {
                if (!cursor.isClosed()) {
                    cursor.close();
    ...
    /* renamed from: a */
    public static C19489a m47716a(Context context) {
        synchronized (f53822b) {
            if (f53823c == null) {
                f53823c = new C19489a(context.getApplicationContext());
            }
        }
        return f53823c;
    }
    ...
    /* renamed from: a */
    public final synchronized long mo40635a(C19491b bVar) {
        if (this.f53824d != null) {
            if (this.f53824d.isOpen()) {
                ContentValues contentValues = new ContentValues();
                contentValues.put("category", bVar.f53825a);
                contentValues.put("tag", bVar.f53826b);
                if (!C9431p.m18664a(bVar.f53827c)) {
                    contentValues.put("label", bVar.f53827c);
                }
                contentValues.put("value", Long.valueOf(bVar.f53828d));
                contentValues.put("ext_value", Long.valueOf(bVar.f53829e));
                if (!C9431p.m18664a(bVar.f53830f)) {
                    contentValues.put("ext_json", bVar.f53830f);
                }
                return this.f53824d.insert("event", null, contentValues);
            }
        }
        return -1;
    }
    ...
    public final synchronized boolean mo40637a(long r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            android.database.sqlite.SQLiteDatabase r0 = r4.f53824d     // Catch:{ all -> 0x002a }
            r1 = 0
        ...
        L_0x000f:
            ...
            android.database.sqlite.SQLiteDatabase r5 = r4.f53824d     // Catch:{ all -> 0x002a }
        ...
        L_0x002a:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.message.log.C19489a.mo40637a(long):boolean");
    }

    /* JADX WARNING: Missing exception handler attribute for start block: B:41:0x00c4 */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized org.json.JSONArray mo40636a(long r19, int r21) {
        /*
            r18 = this;
            r1 = r18
            monitor-enter(r18)
            ...
            android.database.sqlite.SQLiteDatabase r2 = r1.f53824d     // Catch:{ Throwable -> 0x00d0, all -> 0x00ca }
            java.lang.String r3 = "event"
            java.lang.String[] r4 = f53821a     // Catch:{ Throwable -> 0x00d0, all -> 0x00ca }
            r7 = 0
            r8 = 0
        ...
        L_0x007a:
            ...
            boolean r4 = com.bytedance.common.utility.C9431p.m18664a(r0)     // Catch:{ Throwable -> 0x00c4, all -> 0x00c8 }
        ...
        L_0x008f:
            ...
            boolean r0 = com.bytedance.common.utility.C9431p.m18664a(r8)     // Catch:{ Throwable -> 0x00c4, all -> 0x00c8 }
        ...
        L_0x00da:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.message.log.C19489a.mo40636a(long, int):org.json.JSONArray");
    }
}
