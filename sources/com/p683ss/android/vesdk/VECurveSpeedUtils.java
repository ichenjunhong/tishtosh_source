...
public class VECurveSpeedUtils {
    ...
    public void destroy() {
        if (this.mNative == 0) {
            C50792y.m109914d(TAG, "destroy, mNative == 0");
        } else {
    ...
    public double getAveCurveSpeed() {
        if (this.mNative == 0) {
            C50792y.m109914d(TAG, "getAveCurveSpeed, mNative == 0");
            return -112.0d;
        }
    ...
    public double getCurveSpeedWithSeqDelta(long j) {
        ...
        C50792y.m109914d(TAG, "getCurveSpeedWithSeqDelta, mNative == 0");
        return -112.0d;
    }
    ...
    public long mapSeqDeltaToTrimDelta(long j) {
        ...
        C50792y.m109914d(TAG, "mapSeqDeltaToTrimDelta, mNative == 0");
        return -112;
    }
    ...
    public long mapTrimDeltaToSeqDelta(long j) {
        ...
        C50792y.m109914d(TAG, "mapTrimDeltaToSeqDelta, mNative == 0");
        return -112;
    }

    public void setSeqDuration(long j) {
        if (this.mNative == 0) {
            C50792y.m109914d(TAG, "setSeqDuration, mNative == 0");
        } else {
    ...
    public int setCurveSpeed(float[] fArr, float[] fArr2) {
        if (fArr == null || fArr2 == null || fArr.length != fArr2.length || fArr.length < 2) {
            C50792y.m109914d(TAG, "setCurveSpeed,incorrect curve anchors, mNative == 0");
            return -100;
        } else if (this.mNative != 0) {
            return TEVideoUtils.nativeSetCurveSpeedData(this.mNative, fArr, fArr2);
        } else {
            C50792y.m109914d(TAG, "setCurveSpeed, mNative == 0");
            return -112;
        }
    }
    ...
    public VECurveSpeedUtils(float[] fArr, float[] fArr2) {
        if (fArr == null || fArr2 == null || fArr.length != fArr2.length || fArr.length < 2) {
            this.mNative = 0;
            C50792y.m109914d(TAG, "incorrect curve anchors, mNative == 0");
            return;
        }
    ...
    public static float[] transferTrimPointXtoSeqPointX(float[] fArr, float[] fArr2) {
        ...
        for (int i3 = 1; i3 < length; i3++) {
            ...
            sb.append("]= ");
            sb.append(fArr3[i3]);
            C50792y.m109911b("TAG", sb.toString());
        }
        return fArr3;
    }
}
