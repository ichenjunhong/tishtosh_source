...
public final class C20194i extends C20186c {

    /* renamed from: d */
    public static final Key<byte[]> f55504d = m49847c("com.vivo.chi.override.CameraType", byte[].class);

    /* renamed from: e */
    public static final CaptureRequest.Key<Float> f55505e = m49845a("vivo.control.zoom_ratio", Float.class);

    /* renamed from: f */
    public static final CaptureResult.Key<String> f55506f = m49846b("vivo.feedback.MasterCameraId", String.class);
    ...
    public final boolean mo42768a() {
        ...
        try {
            for (String cameraCharacteristics : cameraManager.getCameraIdList()) {
                if (new String((byte[]) cameraManager.getCameraCharacteristics(cameraCharacteristics).get(f55504d)).trim().equals("Wide")) {
                    return true;
                }
            }
            return false;
    ...
    public C20194i(Context context) {
        super(context);
    }

    /* renamed from: a */
    private static CaptureRequest.Key m49845a(String str, Class cls) {
        try {
    ...
    /* renamed from: b */
    private static CaptureResult.Key m49846b(String str, Class cls) {
        try {
    ...
    /* renamed from: c */
    private static Key m49847c(String str, Class cls) {
        try {
    ...
    /* renamed from: a */
    public static int m49843a(TotalCaptureResult totalCaptureResult, int i) {
        String str = (String) totalCaptureResult.get(f55506f);
        if (str == null) {
            str = "Master";
        }
        char c = 65535;
    ...
    public static int m49844a(java.lang.String r7, int r8) {
        /*
        ...
        L_0x006a:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttvecamera.p1229d.C20194i.m49844a(java.lang.String, int):int");
    }
}
