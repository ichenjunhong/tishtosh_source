...
public final class C20192h extends C20186c {

    /* renamed from: d */
    public static final Map<String, String> f55503d = new HashMap<String, String>() {
        {
    ...
    /* renamed from: a */
    public final int mo42770a(CameraCharacteristics cameraCharacteristics, Builder builder, boolean z) {
        return 0;
    }

    public C20192h(Context context) {
        super(context);
    }

    /* renamed from: a */
    public final boolean mo42771a(int i) {
        try {
            C13486b a = C13486b.m27243a();
            String str = ((CameraManager) this.f55498b.getSystemService("camera")).getCameraIdList()[i];
            String b = a.mo25276b((String) f55503d.get(this.f55498b.getPackageName()));
            if (b != null && !b.isEmpty()) {
            ...
            C20296p.m50062c("TEOppoCameraProxy", "AntiShake verify cause this exception");
        }
        return false;
    }
}
