...
public class CameraInstance {
    ...
    public synchronized void stopCamera() {
        /*
            ...
            com.p683ss.android.vesdk.C50792y.m109909a(r0, r1)     // Catch:{ all -> 0x0023 }
        ...
        L_0x0023:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.utils.CameraInstance.stopCamera():void");
    }

    public synchronized void stopPreview() {
        C50792y.m109911b(TAG, "Camera stopPreview...");
        if (this.mIsPreviewing && this.mCameraDevice != null) {
            this.mIsPreviewing = false;
            this.mCameraDevice.stopPreview();
            C50792y.m109909a(TAG, "Camera stopped!");
        }
    }

    public boolean tryOpenCamera(C20139a aVar) {
    ...
    public synchronized void setFocusMode(java.lang.String r2) {
        ...
        L_0x0022:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.utils.CameraInstance.setFocusMode(java.lang.String):void");
    }
    ...
    public synchronized void startPreview(SurfaceTexture surfaceTexture) {
        C50792y.m109909a(TAG, "Camera startPreview...");
        if (this.mIsPreviewing) {
            C50792y.m109913c(TAG, "Camera is previewing...");
    ...
    public void initCamera(int i) {
        if (this.mCameraDevice == null) {
            C50792y.m109914d(TAG, "initCamera: Camera is not opened!");
            return;
        }
        this.mParams = this.mCameraDevice.getParameters();
        for (Integer intValue : this.mParams.getSupportedPictureFormats()) {
            int intValue2 = intValue.intValue();
            C50792y.m109909a(TAG, C2240a.m6772a("Picture Format: %x", new Object[]{Integer.valueOf(intValue2)}));
        }
        this.mParams.setPictureFormat(UnReadVideoExperiment.BROWSE_RECORD_LIST);
        ...
        for (Size size4 : supportedPreviewSizes) {
            C50792y.m109911b(TAG, C2240a.m6772a("Supported preview size: %d x %d", new Object[]{Integer.valueOf(size4.width), Integer.valueOf(size4.height)}));
        ...
        for (Integer num : supportedPreviewFrameRates) {
            ...
            sb.append(num);
            C50792y.m109915e(str, sb.toString());
            if (i4 < num.intValue()) {
                i4 = num.intValue();
            }
            if (i5 > num.intValue()) {
        ...
        C50792y.m109909a(TAG, C2240a.m6772a("Camera Picture Size: %d x %d", new Object[]{Integer.valueOf(pictureSize.width), Integer.valueOf(pictureSize.height)}));
        C50792y.m109909a(TAG, C2240a.m6772a("Camera Preview Size: %d x %d", new Object[]{Integer.valueOf(previewSize.width), Integer.valueOf(previewSize.height)}));
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized boolean tryOpenCamera(com.p683ss.android.ttve.utils.CameraInstance.C20139a r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
            java.lang.String r0 = "CameraInstance"
            java.lang.String r1 = "try open camera..."
            com.p683ss.android.vesdk.C50792y.m109909a(r0, r1)     // Catch:{ all -> 0x0094 }
            r0 = 0
            r1 = 0
        ...
        L_0x004b:
            ...
            com.p683ss.android.vesdk.C50792y.m109911b(r8, r2)     // Catch:{ Exception -> 0x0089 }
            android.hardware.Camera r8 = r6.mCameraDevice     // Catch:{ all -> 0x0094 }
            if (r8 == 0) goto L_0x0087
            java.lang.String r8 = "CameraInstance"
            java.lang.String r2 = "Camera opened!"
            com.p683ss.android.vesdk.C50792y.m109909a(r8, r2)     // Catch:{ all -> 0x0094 }
            r8 = 30
            r6.initCamera(r8)     // Catch:{ Exception -> 0x007e }
            if (r7 == 0) goto L_0x007b
            r7.mo42292a()     // Catch:{ all -> 0x0094 }
        L_0x007b:
            monitor-exit(r6)
            r7 = 1
            return r7
        ...
        L_0x0089:
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r7, r8)     // Catch:{ all -> 0x0094 }
            r6.mCameraDevice = r0     // Catch:{ all -> 0x0094 }
            monitor-exit(r6)
            return r1
        L_0x0094:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.utils.CameraInstance.tryOpenCamera(com.ss.android.ttve.utils.CameraInstance$a, int):boolean");
    }
    ...
    public synchronized void focusAtPoint(float r4, float r5, float r6) {
        /*
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r4, r5)     // Catch:{ all -> 0x00c4 }
            monitor-exit(r3)
            return
        L_0x000e:
            android.hardware.Camera r0 = r3.mCameraDevice     // Catch:{ all -> 0x00c4 }
            ...
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x00c4 }
            r0[r1] = r2     // Catch:{ all -> 0x00c4 }
            java.lang.String r6 = com.C2240a.m6772a(r6, r0)     // Catch:{ all -> 0x00c4 }
            com.p683ss.android.vesdk.C50792y.m109911b(r5, r6)     // Catch:{ all -> 0x00c4 }
        ...
        L_0x00a1:
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r5, r4)     // Catch:{ all -> 0x00c4 }
            monitor-exit(r3)
            return
        L_0x00bb:
            java.lang.String r4 = "CameraInstance"
            java.lang.String r5 = "The device does not support metering areas..."
            com.p683ss.android.vesdk.C50792y.m109909a(r4, r5)     // Catch:{ all -> 0x00c4 }
        L_0x00c2:
            monitor-exit(r3)
            return
        L_0x00c4:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.utils.CameraInstance.focusAtPoint(float, float, float):void");
    }
