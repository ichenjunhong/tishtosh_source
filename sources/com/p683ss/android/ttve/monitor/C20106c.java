...
public final class C20106c {

    /* renamed from: a */
    private static String f55306a;

    /* renamed from: c */
    public static int m49623c() {
        try {
    ...
    public static java.lang.String m49622b() {
        /*
            java.lang.String r0 = ""
            r1 = 2
            r2 = 0
        ...
        L_0x0053:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.monitor.C20106c.m49622b():java.lang.String");
    }
    ...
    public static long m49625d() {
        ...
        L_0x0051:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.monitor.C20106c.m49625d():long");
    }
    ...
    public static String m49618a() {
        ...
        try {
            ...
            try {
                ...
                if (TextUtils.isEmpty(f55306a)) {
                    f55306a = m49619a("ro.board.platform");
                }
                String str = f55306a;
                m49620a((Reader) bufferedReader);
                m49620a(reader);
    ...
    /* renamed from: a */
    private static void m49620a(Reader reader) {
        if (reader != null) {
            try {
                reader.close();
            } catch (IOException unused) {
    ...
    /* renamed from: c */
    public static String m49624c(Context context) {
        try {
    ...
    /* renamed from: a */
    public static long m49617a(Context context) {
        String str;
        try {
    ...
    /* renamed from: b */
    public static int m49621b(Context context) {
        int i = 0;
        if (context == null) {
            return 0;
        }
    ...
    /* renamed from: a */
    private static String m49619a(String str) {
        String str2 = "unknown";
        try {
