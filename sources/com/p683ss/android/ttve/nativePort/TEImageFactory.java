...
public class TEImageFactory {
    ...
    public static int getRotation(android.content.ContentResolver r3, java.lang.String r4) {
        ...
        L_0x0073:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.nativePort.TEImageFactory.getRotation(android.content.ContentResolver, java.lang.String):int");
    }
    ...
    public static android.graphics.Bitmap decodeFileCompat(android.content.ContentResolver r3, java.lang.String r4, android.graphics.BitmapFactory.Options r5) {
        ...
        L_0x0053:
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r5, r3)
            goto L_0x0118
        L_0x0069:
            r4 = move-exception
            goto L_0x0072
        ...
        L_0x0072:
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r5, r4)     // Catch:{ all -> 0x00c8 }
        ...
        L_0x00bd:
            ...
            com.p683ss.android.vesdk.C50792y.m109914d(r4, r3)
            goto L_0x012a
        L_0x00c8:
            r4 = move-exception
        L_0x00c9:
        ...
        L_0x012a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.ttve.nativePort.TEImageFactory.decodeFileCompat(android.content.ContentResolver, java.lang.String, android.graphics.BitmapFactory$Options):android.graphics.Bitmap");
    }

    public static ImageInfo decodeFile(ContentResolver contentResolver, String str, Options options, int i, int i2) {
        if (options == null) {
            options = new Options();
        }
        if (i > 0 && i2 > 0) {
            options.inJustDecodeBounds = true;
            decodeFileCompat(contentResolver, str, options);
            int calBestSampleSize = TEImageUtils.calBestSampleSize(options.outWidth, options.outHeight, i, i2);
