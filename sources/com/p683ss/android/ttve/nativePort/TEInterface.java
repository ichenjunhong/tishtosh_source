...
import com.p683ss.android.vesdk.C50628ai;
...
import com.p683ss.android.vesdk.C50783t;
import com.p683ss.android.vesdk.C50792y;
import com.p683ss.android.vesdk.VEConfig;
import com.p683ss.android.vesdk.VEEffectParams;
import com.p683ss.android.vesdk.VEListener.VEEditorEffectListener;
import com.p683ss.android.vesdk.VEListener.VEInfoStickerBufferListener;
import com.p683ss.android.vesdk.VEMusicSRTEffectParam;
import com.p683ss.android.vesdk.VEStickerAnimator;
...
import com.p683ss.android.vesdk.filterparam.VEAmazingFilterParam;
import com.p683ss.android.vesdk.filterparam.VEAudioEffectFilterParam;
import com.p683ss.android.vesdk.filterparam.VEAudioFadeFilterParam;
import com.p683ss.android.vesdk.filterparam.VEAudioVolumeFilterParam;
import com.p683ss.android.vesdk.filterparam.VEBaseAudioFilterParam;
import com.p683ss.android.vesdk.filterparam.VEBaseFilterParam;
import com.p683ss.android.vesdk.filterparam.VEBeautyFilterParam;
import com.p683ss.android.vesdk.filterparam.VECanvasFilterParam;
import com.p683ss.android.vesdk.filterparam.VEColorFilterParam;
import com.p683ss.android.vesdk.filterparam.VEComposerFilterParam;
import com.p683ss.android.vesdk.filterparam.VEEffectFilterParam;
import com.p683ss.android.vesdk.filterparam.VEImageAddFilterParam;
import com.p683ss.android.vesdk.filterparam.VEImageTransformFilterParam;
import com.p683ss.android.vesdk.filterparam.VEReshapeFilterParam;
import com.p683ss.android.vesdk.filterparam.VETransitionFilterParam;
import com.p683ss.android.vesdk.filterparam.VEVideoAjustmentFilterParam;
import com.p683ss.android.vesdk.filterparam.VEVideoCropFilterParam;
import com.p683ss.android.vesdk.filterparam.VEVideoTransformFilterParam;
...
public final class TEInterface extends TENativeServiceBase {
    ...
    private native int nativeSetCompileAudioDriver(long j, String str, int i, int i2);
    ...
    public final int flushSeekCmd() {
        ...
        return nativeFlushSeekCmd(this.mNative);
    }
    ...
    public final Object getMVOriginalBackgroundAudio() {
        ...
        C50792y.m109914d(TAG, "getMVOriginalBackgroundAudio error, mNative == 0");
        return null;
    }
    ...
    public final long getPCMDeliverHandle() {
        ...
        return nativeGetPCMDeliverHandle(this.mNative);
    }
    ...
    public final Object getServerAlgorithmConfig() {
        ...
        C50792y.m109914d(TAG, "getServerAlgorithmConfig error, mNative == 0");
        return null;
    }
    ...
    public final int initBingoAlgorithm() {
        ...
        return nativeInitBingoAlgorithm(this.mNative);
    }
    ...
    public static TEInterface createEngine() {
        ...
        if (VERuntime.m109853a().f127478f) {
            i = 3;
        } else {
            i = 2;
        }
        TEGLGlobalContext.nativeSetGLVersion(i);
        TEGLGlobalContext.nativeSetMaxRenderSize(VERuntime.m109853a().f127479g.width, VERuntime.m109853a().f127479g.height);
        long nativeCreateEngine = tEInterface.nativeCreateEngine();
        if (nativeCreateEngine == 0) {
            return null;
        }
        tEInterface.mNative = nativeCreateEngine;
        C20102a.m49612a("vesdk_event_editor_init", null, "behavior");
        return tEInterface;
    }

    public final C50628ai getDisplayRect() {
        if (this.mNative == 0) {
            return new C50628ai(0, 0, 0, 0);
        }
        int[] nativeGetDisplayDumpSize = nativeGetDisplayDumpSize(this.mNative);
        return new C50628ai(nativeGetDisplayDumpSize[0], nativeGetDisplayDumpSize[1], nativeGetDisplayDumpSize[2], nativeGetDisplayDumpSize[3]);
    }
    ...
    private void configABforEditor() {
        C50716c a = C50712l.m109659a().mo99229a("vesdk_input_processor");
        if (!(a == null || a.f127275b == null || !(a.f127275b instanceof Boolean))) {
            boolean booleanValue = ((Boolean) a.f127275b).booleanValue();
            if (booleanValue) {
                enableInputDirectLinkProcessor(booleanValue);
            }
        }
        C50716c a2 = C50712l.m109659a().mo99229a("mv_use_amazing_engine");
        if (a2 != null && a2.f127275b != null && (a2.f127275b instanceof Boolean)) {
            boolean booleanValue2 = ((Boolean) a2.f127275b).booleanValue();
            if (booleanValue2) {
                enableEffectAmazingMV(booleanValue2);
            }
        }
    }
    ...
    public static int enableInputDirectLinkProcessor(boolean z) {
        return nativeInputLinkProcessor(z);
    }
    ...
    public final float[] getInfoStickerBoundingBox(int i) throws C50751p {
    ...
    public final void setEditorOpt(VEConfig vEConfig) {
        if (this.mNative != 0) {
            nativeSetEditorOpt(this.mNative, vEConfig);
        }
    }
    ...
    public final int getTransparentImage(Bitmap bitmap) {
        ...
        return nativeGetTransparentImage(this.mNative, bitmap);
    }
    ...
    public final int refreshCurrentFrame(int i) {
        ...
        return nativeRefreshCurrentFrame(this.mNative, i);
    }
    ...
    public final int setInfoStickerCallSync(boolean z) {
        ...
        return nativeSetInfoStickerCallSync(this.mNative, z);
    }
    ...
    public final int updateSceneFileOrder(C50633an anVar) {
        if (this.mNative == 0) {
            return -112;
        }
        return nativeUpdateSceneFileOrder(this.mNative, anVar.f126929b);
    }
    ...
    public final boolean isGestureRegistered(C50777s sVar) {
        int i;
        if (this.mNative == 0) {
            return false;
        }
    ...
    public final int updateSenceTime(C50633an anVar) {
        if (this.mNative == 0) {
            return -112;
        }
        return nativeUpdateSceneTime(this.mNative, anVar.f126937j, anVar.f126932e, anVar.f126933f, C50657c.toIntArray(anVar.f126938k), anVar.f126936i);
    }
    ...
    public final List<VEClipParam> getAllClips(int i, int i2) {
        ...
        return nativeGetAllClips(this.mNative, i, i2);
    }
    ...
    public final int updateCanvasResolution(int i, int i2) {
        ...
        return nativeUpdateCanvasResolution(this.mNative, i, i2);
    }
    ...
    public final C50628ai getDecodeRect(int i, int i2) {
        if (this.mNative == 0) {
            return new C50628ai(0, 0, 0, 0);
        }
        int[] nativeGetDecodeDumpSize = nativeGetDecodeDumpSize(this.mNative, i, i2);
        return new C50628ai(nativeGetDecodeDumpSize[0], nativeGetDecodeDumpSize[1], nativeGetDecodeDumpSize[2], nativeGetDecodeDumpSize[3]);
    }

    public final boolean processTouchEvent(C50634ao aoVar, int i) {
        if (this.mNative == 0) {
            return false;
        }
        return nativeProcessTouchEvent2(this.mNative, aoVar.f126940a, aoVar.f126942c, aoVar.f126943d, aoVar.f126944e, aoVar.f126945f, aoVar.f126941b.ordinal(), i);
    }
    ...
    public final boolean suspendGestureRecognizer(C50777s sVar, boolean z) {
        int i;
        if (this.mNative == 0) {
            return false;
        }
    ...
    public final float[] getInfoStickerBoundingBox(int i, boolean z) throws C50751p {
        float[] fArr;
        if (this.mNative == 0) {
            throw new C50751p(-112, "");
    ...
    public final int deleteClip(int i, int i2, int i3) {
        ...
        return nativeDeleteClip(this.mNative, i, i2, i3);
    }
    ...
    public final String getClipInfoString(int i, int i2, int i3) {
        ...
        return nativeGetClipInfoString(this.mNative, i, i2, i3);
    }
    ...
    public final int getDecodeImage(Bitmap bitmap, int i, int i2) {
        ...
        return nativeGetDecodeImage(this.mNative, bitmap, i, i2);
    }
    ...
    public final int processTouchDownEvent(float f, float f2, C50783t tVar) {
        if (this.mNative == 0) {
            return -112;
        }
        return nativeProcessTouchDownEvent(this.mNative, f, f2, tVar.ordinal());
    }

    public final int processTouchUpEvent(float f, float f2, C50783t tVar) {
        if (this.mNative == 0) {
            return -112;
        }
        return nativeProcessTouchUpEvent(this.mNative, f, f2, tVar.ordinal());
    }
    ...
    public final int setCompileAudioDriver(String str, int i, int i2) {
        if (this.mNative == 0) {
            return -112;
        }
        return nativeSetCompileAudioDriver(this.mNative, str, i, i2);
    }
    ...
    public final String getClipInfoStringWithPath(int i, int i2, int i3, String str) {
        ...
        return nativeGetClipInfoStringWithPath(this.mNative, i, i2, i3, str);
    }
    ...
    public final int setExternalAlgorithmResult(String str, String str2, String str3, int i) {
        if (this.mNative == 0) {
            C50792y.m109914d(TAG, "setExternalAlgorithmResult error, mNative == 0");
            return -112;
        }
        return nativeSetExternalAlgorithmResult(this.mNative, str, str2, str3, i);
    }
    ...
    public final int createSceneOnlyAudio(String str, String[] strArr, int[] iArr, int[] iArr2, float[] fArr) {
        ...
        int nativeCreateSceneOnlyAudio = nativeCreateSceneOnlyAudio(this.mNative, str, strArr, iArr, iArr2, fArr);
    ...
    public final int insertClip(int i, int i2, int i3, VEClipSourceParam vEClipSourceParam, VEClipTimelineParam vEClipTimelineParam) {
        ...
        return nativeInsertClip(this.mNative, i, i2, i3, vEClipSourceParam, vEClipTimelineParam);
    }
    ...
    public final int addExternalVideoTrack(String[] strArr, String[] strArr2, int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int i) {
        ...
        return nativeAddExternalVideoTrack(this.mNative, strArr, strArr2, iArr, iArr2, iArr3, iArr4, i);
    }

    public final void setDisplayState(float f, float f2, float f3, float f4, int i, int i2, int i3) {
        if (this.mNative != 0) {
            nativeSetDisplayState(this.mNative, f, f2, f3, f4, i, i2, i3);
        }
    }
    ...
    public final int updateAudioTrack(int i, int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        ...
        return nativeUpdateAudioTrack(this.mNative, i, i2, i3, i4, i5, z, z2);
    }
    ...
    public final void setWaterMark(ArrayList<String[]> arrayList, int i, int i2, int i3, int i4, int i5, long j, C50637aq aqVar, VEWatermarkMask vEWatermarkMask) {
        if (this.mNative != 0) {
            nativeSetWaterMark(this.mNative, arrayList, i, i2, i3, i4, i5, j, aqVar.ordinal(), vEWatermarkMask);
        }
    }
    ...
    public final int createScene2(String[] strArr, int[] iArr, int[] iArr2, String[] strArr2, int[] iArr3, int[] iArr4, String[] strArr3, String[][] strArr4, float[] fArr, int i) {
        return createScene2(strArr, iArr, iArr2, strArr2, iArr3, iArr4, strArr3, strArr4, fArr, fArr, null, i, false);
    }
    ...
    public final int createScene2(String[] strArr, int[] iArr, int[] iArr2, String[] strArr2, int[] iArr3, int[] iArr4, String[] strArr3, String[][] strArr4, float[] fArr, float[] fArr2, int[] iArr5, int i, boolean z) {
        float[] fArr3;
        float[] fArr4;
    ...
    public final int createCanvasScene(String[] strArr, String[] strArr2, int[] iArr, int[] iArr2, String[] strArr3, String[] strArr4, int[] iArr3, int[] iArr4, String[] strArr5, int[] iArr5, int[] iArr6, String[][] strArr6, float[] fArr, int i) {
        float[] fArr2;
        if (this.mNative == 0) {
            return -112;
        }
