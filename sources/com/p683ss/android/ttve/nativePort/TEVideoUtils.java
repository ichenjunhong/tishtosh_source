...
public final class TEVideoUtils {
    ...
    public static String findBestRemuxSuffix(String str) throws C50751p {
        if (str.length() > 0) {
            ...
            throw new C50751p(-205, "该文件暂不支持转封装!");
        }
        throw new C50751p(-100, "请检查输入参数!");
    }
    ...
    public static int concatRecordFrag(String[] strArr, long[] jArr, String[] strArr2, long[] jArr2, boolean z, int i, String str, String str2, String str3, String str4) {
        if (TextUtils.isEmpty(str3) || TextUtils.isEmpty(str4) || strArr.length == 0 || jArr.length != strArr.length || strArr.length != strArr2.length || strArr.length != jArr2.length) {
            C50792y.m109914d("TEVideoUtils", "concatRecordFrag 参数错误");
            return -100;
        }
        ...
        if (file.exists() || file.mkdirs()) {
            ...
            StringBuilder sb = new StringBuilder("create audio output dir failed. Output audio Directory: ");
            sb.append(str4);
            C50792y.m109914d("TEVideoUtils", sb.toString());
            return -114;
        }
        StringBuilder sb2 = new StringBuilder("create video output dir failed. Output Video Directory: ");
        sb2.append(str3);
        C50792y.m109914d("TEVideoUtils", sb2.toString());
        return -114;
    }
    ...
    public static int initAlgorithm(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, long j, long j2, int i, int i2, int i3) {
        ...
        return nativeInitAlgorithm(mHandler, z, z2, z3, z4, z5, z6, j, j2, i, i3, i2);
    }
}
