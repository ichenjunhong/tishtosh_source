...
import com.p683ss.android.medialib.model.C19351b;
...
import com.p683ss.android.medialib.model.SceneDetectInfo;
import com.p683ss.android.medialib.model.SkeletonInfo;
...
import com.p683ss.android.medialib.p1181c.C19232a;
...
import com.p683ss.android.vesdk.C50777s;
import com.p683ss.android.vesdk.C50790w;
import com.p683ss.android.vesdk.C50792y;
import com.p683ss.android.vesdk.LandMarkFrame;
...
public class FaceBeautyInvoker implements C2593a {
    ...
    private static C19214a mRecordStopCallback;
    private static Runnable sDuetCompleteRunable = null;
    private static C19232a sFaceDetectListener;
    private static C2593a sMessageListener;
    private static C19233b sNativeInitListener;
    private static List<C19234c> sSlamDetectListeners = new ArrayList();
    public C19216a mAVCEncoder;
    private C19221b mAVCEncoderInterface = new C19221b() {
        public final int getProfile() {
            return FaceBeautyInvoker.this.mAVCEncoder.f52987g;
        }
        ...
        public final void onUninitHardEncoder() {
            C50792y.m109909a(FaceBeautyInvoker.TAG, "FaceBeautyManager onUninitHardEncoder == enter");
            if (FaceBeautyInvoker.this.mAVCEncoder != null) {
                FaceBeautyInvoker.this.mAVCEncoder.mo39596b();
                FaceBeautyInvoker.this.mAVCEncoder = null;
                C50792y.m109909a(FaceBeautyInvoker.TAG, "====== uninitAVCEncoder ======");
            }
            C50792y.m109909a(FaceBeautyInvoker.TAG, "FaceBeautyManager onUninitHardEncoder == exit");
        }
        ...
        public final void onEncoderData(byte[] bArr, int i, boolean z) {
            C50792y.m109911b(FaceBeautyInvoker.TAG, "FaceBeautyManager onEncoderData == enter");
            if (FaceBeautyInvoker.this.mAVCEncoder != null) {
                FaceBeautyInvoker.this.mAVCEncoder.mo39593a(bArr, i, z);
            }
            C50792y.m109911b(FaceBeautyInvoker.TAG, "FaceBeautyManager onEncoderData == exit");
        }

        public final int onEncoderData(int i, int i2, int i3, boolean z) {
            C50792y.m109911b(FaceBeautyInvoker.TAG, "onEncoderData: ...");
            if (FaceBeautyInvoker.this.mAVCEncoder != null) {
                return FaceBeautyInvoker.this.mAVCEncoder.mo39592a(i, i2, i3, z);
            }
            return 0;
        }
        ...
        public final Surface onInitHardEncoder(int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
            C50792y.m109909a(FaceBeautyInvoker.TAG, "FaceBeautyManager onInitHardEncoder == enter");
            String str = FaceBeautyInvoker.TAG;
            ...
            if (FaceBeautyInvoker.this.mAVCEncoder == null) {
                FaceBeautyInvoker.this.mAVCEncoder = new C19216a();
            }
            C19216a.m46839a((C19221b) this);
            Surface a = FaceBeautyInvoker.this.mAVCEncoder.mo39594a(i, i2, i3, i4, i5, i6, z);
            if (a == null) {
                FaceBeautyInvoker.this.mAVCEncoder.mo39596b();
                FaceBeautyInvoker.this.mAVCEncoder = null;
            ...
            C50792y.m109914d(FaceBeautyInvoker.TAG, "====== initAVCEncoder succeed ======");
            FaceBeautyInvoker.this.setHardEncoderStatus(true);
            C50792y.m109909a(FaceBeautyInvoker.TAG, "FaceBeautyManager onInitHardEncoder == exit");
            return a;
        }
    };
    private Runnable mDuetCompleteRunable;
    private C19221b mEncoderCaller = this.mAVCEncoderInterface;
    private C19232a mFaceDetectListener;
    public long mHandler = 0;
    private boolean mIsDuringScreenshot;
    private boolean mIsRenderReady = false;
    private List<C50790w> mLandmarkDetectListeners = new ArrayList();
    private C2593a mMessageListener;
    private C19233b mNativeInitListener;
    private C19223a mOpenGLCallback;
    private C19224b mShotScreenCallback;
    private List<C19234c> mSlamDetectListeners = new ArrayList();
    private C19235d mTextureTimeListener;
    private Handler mainHandler = new Handler(Looper.getMainLooper());
    C19379a onVideoEOFListener;
    ...
    public static C19233b getNativeInitListener() {
    ...
    private native int nativeSetVideoBgStatus(long j, int i);
    ...
    public void onNativeRecordStop() {
        if (mRecordStopCallback != null) {
            mRecordStopCallback.mo39566a();
        }
    }

    public void onNativeVideoBgEOF() {
        if (this.onVideoEOFListener != null) {
            this.onVideoEOFListener.mo40428a();
        }
    }
    ...
    private int onNativeCallback_GetHardEncoderProfile() {
        ...
        C50792y.m109909a(TAG, "GetHardEncoderProfile");
    ...
    public String getComposerNodePaths() {
        ...
        C50792y.m109914d(TAG, "Native instance handle == 0 invalid.");
        return "";
    }
    ...
    public EnigmaResult getEnigmaResult() {
        ...
        C50792y.m109914d(TAG, "invalid handle");
        return null;
    }
    ...
    public void onNativeCallback_UninitHardEncoder() {
        C50792y.m109909a(TAG, " onUninitHardEncoder == enter");
        if (this.mEncoderCaller != null) {
            this.mEncoderCaller.onUninitHardEncoder();
        }
        C50792y.m109909a(TAG, " onUninitHardEncoder == exit");
    }

    public void onNativeCallback_onOpenGLCreate() {
        C50792y.m109909a(TAG, "onNativeCallback_onOpenGLCreate");
        if (this.mOpenGLCallback != null) {
            this.mOpenGLCallback.mo39607a();
        }
    }

    public void onNativeCallback_onOpenGLDestroy() {
        C50792y.m109909a(TAG, "onNativeCallback_onOpenGLDestroy");
        if (this.mOpenGLCallback != null) {
            this.mOpenGLCallback.mo39608b();
        }
    }

    public int onNativeCallback_onOpenGLRunning() {
        C50792y.m109911b(TAG, "onNativeCallback_onOpenGLRunning");
        if (this.mOpenGLCallback != null) {
            return this.mOpenGLCallback.mo39609c();
        }
        return 0;
    }
    ...
    public static void setFaceDetectListener(C19232a aVar) {
        sFaceDetectListener = aVar;
    }

    public static void setNativeInitListener(C19233b bVar) {
        sNativeInitListener = bVar;
    }

    public static void setRecordStopCallback(C19214a aVar) {
    ...
    public void setFaceDetectListener2(C19232a aVar) {
        this.mFaceDetectListener = aVar;
    }

    public void setMessageListenerV2(C2593a aVar) {
        this.mMessageListener = aVar;
    }

    public void setNativeInitListener2(C19233b bVar) {
        this.mNativeInitListener = bVar;
    }

    public void setOnOpenGLCallback(C19223a aVar) {
        this.mOpenGLCallback = aVar;
    }

    public void setTextureTimeListener(C19235d dVar) {
        this.mTextureTimeListener = dVar;
    }

    public void setVEOnVideoEOFListener(C19379a aVar) {
        this.onVideoEOFListener = aVar;
    }
    ...
    public int setVideoBgStatus(int i) {
        return nativeSetVideoBgStatus(this.mHandler, i);
    }

    public static synchronized void addSlamDetectListener(C19234c cVar) {
        synchronized (FaceBeautyInvoker.class) {
            if (cVar != null) {
    ...
    public static synchronized void removeSlamDetectListener(C19234c cVar) {
        synchronized (FaceBeautyInvoker.class) {
            sSlamDetectListeners.remove(cVar);
        }
    }

    public static synchronized void setMessageListener(C2593a aVar) {
        synchronized (FaceBeautyInvoker.class) {
            sMessageListener = aVar;
        }
    }

    public static synchronized void setSlamDetectListener(C19234c cVar) {
        synchronized (FaceBeautyInvoker.class) {
            addSlamDetectListener(cVar);
        }
    }

    public synchronized void addLandMarkDetectListener(C50790w wVar) {
        this.mLandmarkDetectListeners.add(wVar);
    }

    public synchronized void addSlamDetectListener2(C19234c cVar) {
        if (cVar != null) {
    ...
    public long getTextureDeltaTime(boolean z) {
        if (this.mTextureTimeListener != null) {
            return this.mTextureTimeListener.mo39627a(z);
        }
        return 0;
    }

    public synchronized void removeLandMarkDetectListener(C50790w wVar) {
        this.mLandmarkDetectListeners.remove(wVar);
    }

    public synchronized void removeSlamDetectListener2(C19234c cVar) {
    ...
    public void enableAbandonFirstFrame(boolean z) {
        if (this.mHandler == 0) {
            C19226c.m46861c(TAG, "invalid handle");
        } else {
    ...
    public boolean isGestureRegistered(C50777s sVar) {
        int i;
        if (this.mHandler == 0) {
            C50792y.m109914d(TAG, "Native instance handle == 0 invalid.");
            return false;
        }
        if (sVar.ordinal() == C50777s.ANY_SUPPORTED.ordinal()) {
            i = -1;
        } else {
            i = sVar.ordinal();
        }
    ...
    public synchronized void onNativeCallback_onShotScreen(int i) {
        ...
        if (this.mShotScreenCallback != null) {
            this.mShotScreenCallback.mo39610a(i);
        }
    }
    ...
    private void onNativeCallback_Init(int i) {
        ...
        if (this.mNativeInitListener != null) {
            this.mNativeInitListener.mo39624a(i);
        }
        if (sNativeInitListener != null) {
            sNativeInitListener.mo39624a(i);
        }
        this.mIsRenderReady = true;
    }

    public void onNativeCallback_onSlamDetect(boolean z) {
        ArrayList<C19234c> arrayList = new ArrayList<>();
        synchronized (FaceBeautyInvoker.class) {
            for (C19234c add : sSlamDetectListeners) {
                arrayList.add(add);
            }
            for (C19234c add2 : this.mSlamDetectListeners) {
                arrayList.add(add2);
            }
        }
        for (C19234c cVar : arrayList) {
            if (cVar != null) {
                cVar.mo39626a(z);
            }
        }
    ...
    public int onDrawFrame(ImageFrame imageFrame) {
        ...
        if (imageFrame.getBuf() != null) {
            ...
            if (new C19321i(imageFrame).mo39814a(iArr, byteBufferArr)) {
    ...
    public void changeDuetVideo(String str, String str2) {
        if (this.mHandler != 0) {
            nativeChangeDuetVideo(this.mHandler, str, str2);
        }
    }
    ...
    public int animateImageToPreview(String str, String str2) {
        ...
        return nativeAnimateImageToPreview(this.mHandler, str, str2, C19225b.m46857a(str2));
    }
    ...
    public void onNativeCallback_InitHardEncoderRet(int i, int i2) {
        C50792y.m109909a(TAG, "onInitHardEncoderRet");
        String str = TAG;
        StringBuilder sb = new StringBuilder("isCPUEncode = ");
        sb.append(i);
        C50792y.m109909a(str, sb.toString());
        if (this.mNativeInitListener != null) {
            this.mNativeInitListener.mo39625a(i, i2);
        }
        if (sNativeInitListener != null) {
            sNativeInitListener.mo39625a(i, i2);
        }
    }

    public void onNativeCallback_onLandMarkDetect(boolean z, boolean z2) {
        ArrayList<C50790w> arrayList = new ArrayList<>();
        synchronized (FaceBeautyInvoker.class) {
            for (C50790w add : this.mLandmarkDetectListeners) {
                arrayList.add(add);
            }
        }
        for (C50790w wVar : arrayList) {
            if (wVar != null) {
                wVar.mo43759a(z, z2);
            }
        }
    ...
    public boolean suspendGestureRecognizer(C50777s sVar, boolean z) {
        int i;
        if (this.mHandler == 0) {
            C50792y.m109914d(TAG, "Native instance handle == 0 invalid.");
            return false;
    ...
    public void onFirstFrameRenderInfo(int i, double d) {
        if (i == 0) {
            double d2 = (double) C19349b.f53485a;
            Double.isNaN(d2);
            C20114g.m49644a(0, "te_preview_first_frame_screen_time", d - d2);
            String str = TAG;
            StringBuilder sb = new StringBuilder("Camera Preview First Frame Cost: ");
            double d3 = (double) C19349b.f53485a;
            Double.isNaN(d3);
            sb.append(d - d3);
            C50792y.m109909a(str, sb.toString());
            return;
        ...
        if (i == 1) {
            double d4 = (double) C19349b.f53486b;
            Double.isNaN(d4);
            C20114g.m49644a(0, "te_preview_switch_camera_screen_time", d - d4);
            String str2 = TAG;
            StringBuilder sb2 = new StringBuilder("Camera Change Cost: ");
            double d5 = (double) C19349b.f53486b;
            Double.isNaN(d5);
            sb2.append(d - d5);
            C50792y.m109909a(str2, sb2.toString());
        }
    ...
    public boolean processTouchEvent(C50634ao aoVar, int i) {
        if (this.mHandler == 0) {
            C50792y.m109914d(TAG, "Native instance handle == 0 invalid.");
            return false;
        }
        return nativeProcessTouchEvent2(this.mHandler, aoVar.f126940a, aoVar.f126942c, aoVar.f126943d, aoVar.f126944e, aoVar.f126945f, aoVar.f126941b.ordinal(), i);
    }
    ...
    public static void onNativeCallback_onMonitorLogInt(String str, String str2, int i) {
        C20114g.m49652a(str, str2, (long) i);
    }
    ...
    public int concat(String str, String str2, String str3, String str4) {
        ...
        return nativeConcat(this.mHandler, str, str2, 0, str3, str4, false, -1);
    }
    ...
    public void onMessageReceived(int i, int i2, int i3, String str) {
        synchronized (FaceBeautyInvoker.class) {
            C2593a aVar = this.mMessageListener;
            if (aVar != null) {
    ...
    public void setBeautyFace(int i, String str, float f, float f2) {
        ...
        if (this.mHandler == 0) {
            C50792y.m109914d(TAG, "invalid handle");
        } else if (i != 3 || C19319g.m47185a(str)) {
    ...
    public synchronized int shotScreen(String str, int[] iArr, boolean z, int i, OnPictureCallback onPictureCallback, C19224b bVar) {
        ...
        C50792y.m109913c(TAG, "Last screenshot not complete");
        bVar.mo39610a(-1);
        return -1;
    }
    ...
    public Surface onNativeCallback_InitHardEncoder(int i, int i2, int i3, int i4, int i5, int i6, boolean z) {
        ...
        C50792y.m109909a(TAG, "InitHardEncoder");
    ...
    public int concat(String str, String str2, int i, String str3, String str4, boolean z, int i2) {
        synchronized (this) {
            ...
            return nativeConcat(this.mHandler, str, str2, i, str3, str4, z, i2);
        }
    }
    ...
    public synchronized int shotHDScreen(String str, int[] iArr, boolean z, int i, OnPictureCallback onPictureCallback, C19224b bVar, boolean z2, OnPictureCallback onPictureCallback2) {
        C19224b bVar2 = bVar;
        synchronized (this) {
            if (!this.mIsDuringScreenshot) {
                this.mIsDuringScreenshot = true;
    ...
    public int initFaceBeautyPlay(int r15, int r16, java.lang.String r17, int r18, int r19, java.lang.String r20, int r21, boolean r22) {
        /*
            ...
            com.p683ss.android.medialib.C19216a.m46837a(r0)
            monitor-enter(r14)
        ...
        L_0x0045:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.medialib.FaceBeautyInvoker.initFaceBeautyPlay(int, int, java.lang.String, int, int, java.lang.String, int, boolean):int");
    }
