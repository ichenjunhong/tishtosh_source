...
import com.p683ss.android.medialib.FFMpegManager.EncoderListener;
import com.p683ss.android.medialib.model.CoverInfo;
import com.p683ss.android.medialib.model.Segment;
...
public class FFMpegInvoker {
    C19313e mFFMpagCaller;
    C19320h metaInterface;
    ...
    public String onNativeCallback_getMetaKey() {
        if (this.metaInterface != null) {
            return this.metaInterface.mo39813a();
        }
        return null;
    }

    public void setMetaInterface(C19320h hVar) {
        this.metaInterface = hVar;
    }

    public void setmFFMpagCaller(C19313e eVar) {
