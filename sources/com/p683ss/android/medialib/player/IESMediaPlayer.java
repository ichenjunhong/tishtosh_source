package com.p683ss.android.medialib.player;

import android.content.Context;
import android.util.Pair;
import android.view.Surface;
import com.p683ss.android.medialib.model.Point;
import com.p683ss.android.medialib.p1184e.C19317c;
import com.p683ss.android.medialib.player.C19356a.C19357a;
...
public class IESMediaPlayer {
    ...
    public void setMessageListener(C19357a aVar) {
    ...
    public int prepare(List<String> list) {
        ...
        if (this.context != null) {
            Pair a = C19317c.m47182a(this.context);
