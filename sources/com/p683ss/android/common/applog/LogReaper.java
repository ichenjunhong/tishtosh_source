...
class LogReaper extends Thread {
    ...
    public static final UncaughtExceptionHandler sCrashHandler = new UncaughtExceptionHandler() {
        public final void uncaughtException(Thread thread, Throwable th) {
            if (!(th == null || LogReaper.sContext == null)) {
                ...
                try {
                    ...
                    try {
                        ...
                        th = th2;
                        fileOutputStream = fileOutputStream2;
                        C9398b.m18586a((Closeable) fileOutputStream);
                        throw th;
                    }
            ...
            if (!C18920g.m46048a(LogReaper.sContext)) {
                try {
    ...
    class _lancet {
        ...
        static int com_ss_android_ugc_aweme_lancet_I18nLancet_sendLog(LogReaper logReaper, String str, String str2, boolean z) throws Throwable {
            ...
            try {
                String language = C33106b.m76103a().getLanguage();
                if ("zh".equals(language)) {
                    language = "zh-Hant";
                }
                I18nLancet.m46138a(jSONObject2, "app_language", language);
                I18nLancet.m46138a(jSONObject2, "region", I18nManagerServiceImpl.createI18nManagerServicebyMonsterPlugin().getAppLogRegion());
                I18nLancet.m46138a(jSONObject2, "sys_region", I18nManagerServiceImpl.createI18nManagerServicebyMonsterPlugin().getSysRegion());
                I18nLancet.m46138a(jSONObject2, "carrier_region", C35837h.m80981f());
                I18nLancet.m46138a(jSONObject2, "timezone_name", TimeZone.getDefault().getDisplayName());
                I18nLancet.m46138a(jSONObject2, "timezone_offset", String.valueOf(TimeZone.getDefault().getRawOffset() / 1000));
            } catch (Exception unused) {
            }
    ...
    public synchronized void filterHeader() {
        C19005d.m46182a(this.mHeader);
    }

    private boolean existDid() {
        boolean z = false;
        try {
            if (!C9431p.m18664a(this.mHeader.optString("device_id", ""))) {
                z = true;
            }
            return z;
    ...
    private void collectCrashLog() {
        /*
            ...
            java.lang.String r2 = com.p683ss.android.common.util.C18920g.m46059e(r2)     // Catch:{ Exception -> 0x0089, all -> 0x0084 }
        ...
        L_0x007a:
            ...
            goto L_0x0089
        L_0x007c:
            com.bytedance.common.utility.p524d.C9398b.m18586a(r5)
            return
        L_0x0080:
        ...
        L_0x0089:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.collectCrashLog():void");
    }
    ...
    private boolean scanLog() {
        /*
            ...
            boolean r0 = com.p683ss.android.common.applog.LogReaper._lancet.com_ss_android_ugc_aweme_lancet_I18nLancet_isNetworkAvailable(r0)
            r1 = 0
        ...
        L_0x0037:
            android.content.Context r0 = r9.mContext
            com.ss.android.common.applog.DBHelper r0 = com.p683ss.android.common.applog.DBHelper.getInstance(r0)
            long r2 = r9.mMinLog
        ...
        L_0x006d:
            ...
            java.lang.String r3 = com.p683ss.android.common.applog.AppLog.APPLOG_URL()     // Catch:{ Throwable -> 0x00a6 }
        ...
        L_0x007e:
            ...
            java.lang.String r3 = com.p683ss.android.common.applog.AppLog.CRASH_URL()     // Catch:{ Throwable -> 0x00a6 }
            java.lang.String r6 = r2.value     // Catch:{ Throwable -> 0x00a6 }
        ...
        L_0x008d:
            ...
            java.lang.String r3 = com.p683ss.android.common.applog.AppLog.MON_URL()     // Catch:{ Throwable -> 0x00a6 }
            java.lang.String r6 = r2.value     // Catch:{ Throwable -> 0x00a6 }
            int r3 = r9.sendLog(r3, r6, r1)     // Catch:{ Throwable -> 0x00a6 }
            goto L_0x009f
        L_0x009d:
        ...
        L_0x00ab:
            ...
            r5.<init>(r1)
            com.p683ss.android.common.applog.AppLog.tryReportLogRequest(r3, r5)
        L_0x00be:
            ...
            r0.<init>(r1)
            com.p683ss.android.common.applog.AppLog.tryReportLogExpired(r0)
        L_0x00d8:
            java.util.List r0 = getTerminateSessionIdFromData(r5)
            com.p683ss.android.common.applog.AppLog.tryReportTerminateLost(r0)
        L_0x00df:
            return r4
        L_0x00e0:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.scanLog():boolean");
    }
    ...
    public void run() {
        ...
        L_0x0024:
            ...
            com.ss.android.common.applog.LogQueueItem r1 = (com.p683ss.android.common.applog.LogQueueItem) r1     // Catch:{ all -> 0x0036 }
        L_0x0034:
            monitor-exit(r2)     // Catch:{ all -> 0x0036 }
            goto L_0x0039
        L_0x0036:
        ...
        L_0x0071:
            ...
            boolean r1 = com.p683ss.android.common.applog.LogReaper._lancet.com_ss_android_ugc_aweme_lancet_I18nLancet_isNetworkAvailable(r1)
            if (r1 == 0) goto L_0x008e
        ...
        L_0x008f:
            ...
            boolean r1 = com.p683ss.android.common.applog.AppLog.getLogRecoverySwitch()
        ...
        L_0x00f0:
            ...
            com.ss.android.common.applog.LogQueueItem r2 = (com.p683ss.android.common.applog.LogQueueItem) r2     // Catch:{ all -> 0x00fc }
        L_0x00f8:
            monitor-exit(r1)     // Catch:{ all -> 0x00fc }
            r1 = r2
            goto L_0x0014
        L_0x00fc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.run():void");
    }
    ...
    private void collectNativeCrashLog() {
        /*
            ...
            java.lang.String r3 = com.p683ss.android.common.util.C18920g.m46059e(r3)     // Catch:{ Throwable -> 0x00de, all -> 0x0107 }
        ...
        L_0x00f8:
            ...
            goto L_0x0109
        L_0x00fa:
            com.bytedance.common.utility.p524d.C9398b.m18586a(r7)
            return
        L_0x00fe:
            r0 = move-exception
            r17 = 0
        ...
        L_0x0109:
            r17 = r7
        L_0x010b:
            com.bytedance.common.utility.p524d.C9398b.m18586a(r17)
            throw r0
        L_0x010f:
            com.bytedance.common.utility.p524d.C9398b.m18586a(r7)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.collectNativeCrashLog():void");
    }
    ...
    private void batchSession(long j) {
        if (j > 0) {
            ...
            if (session != null) {
                ...
                logQueueCleanSession.max_session = session.f52048id;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized void processItem(com.p683ss.android.common.applog.LogQueueItem r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            ...
            return
        L_0x0005:
            boolean r0 = r7 instanceof com.p683ss.android.common.applog.LogQueueSwitchSession     // Catch:{ all -> 0x005f }
            if (r0 == 0) goto L_0x0023
            com.ss.android.common.applog.LogQueueSwitchSession r7 = (com.p683ss.android.common.applog.LogQueueSwitchSession) r7     // Catch:{ all -> 0x005f }
            ...
            return
        L_0x0023:
            boolean r0 = r7 instanceof com.p683ss.android.common.applog.LogQueueCleanSession     // Catch:{ all -> 0x005f }
            if (r0 == 0) goto L_0x0030
            com.ss.android.common.applog.LogQueueCleanSession r7 = (com.p683ss.android.common.applog.LogQueueCleanSession) r7     // Catch:{ all -> 0x005f }
            long r0 = r7.max_session     // Catch:{ all -> 0x005f }
            r6.batchSession(r0)     // Catch:{ all -> 0x005f }
            monitor-exit(r6)
            return
        L_0x0030:
            boolean r0 = r7 instanceof com.p683ss.android.common.applog.LogQueueSaveAndSendTaskSession     // Catch:{ all -> 0x005f }
            if (r0 == 0) goto L_0x005d
            com.ss.android.common.applog.LogQueueSaveAndSendTaskSession r7 = (com.p683ss.android.common.applog.LogQueueSaveAndSendTaskSession) r7     // Catch:{ all -> 0x005f }
            ...
            com.ss.android.common.applog.TaskSessionDao r0 = com.p683ss.android.common.applog.TaskSessionDao.inst(r0)     // Catch:{ all -> 0x005f }
        ...
        L_0x005f:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.processItem(com.ss.android.common.applog.LogQueueItem):void");
    }
    ...
    public synchronized void insertCrashLog(org.json.JSONObject r4) {
        ...
        L_0x000a:
            ...
            com.ss.android.common.applog.DBHelper r0 = com.p683ss.android.common.applog.DBHelper.getInstance(r0)     // Catch:{ Exception -> 0x003e }
        ...
        L_0x0043:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.insertCrashLog(org.json.JSONObject):void");
    }
    ...
    public int sendLog$___twin___(java.lang.String r9, java.lang.String r10, boolean r11) throws java.lang.Throwable {
        /*
            ...
            boolean r0 = com.p683ss.android.common.applog.AppLog.getLogRecoverySwitch()     // Catch:{ Throwable -> 0x0149 }
            if (r0 == 0) goto L_0x0023
            ...
            if (r0 != 0) goto L_0x0023
            com.ss.android.common.applog.AppLog$ICustomInfo r10 = com.p683ss.android.common.applog.AppLog.sCustomInfo     // Catch:{ Throwable -> 0x0149 }
            if (r10 == 0) goto L_0x0021
            java.lang.String r10 = com.p683ss.android.common.applog.AppLog.CRASH_URL()     // Catch:{ Throwable -> 0x0149 }
        ...
        L_0x0023:
            r0 = 1
            java.lang.String r2 = com.p683ss.android.common.applog.NetUtil.addCommonParams(r9, r0)     // Catch:{ Throwable -> 0x0149 }
            ...
            boolean r1 = com.bytedance.common.utility.C9431p.m18664a(r2)     // Catch:{ Throwable -> 0x0149 }
            r7 = 0
            if (r1 != 0) goto L_0x004e
            if (r11 == 0) goto L_0x004e
            android.content.Context r11 = r8.mContext     // Catch:{ Throwable -> 0x0149 }
            if (r11 == 0) goto L_0x004e
            boolean r11 = com.p683ss.android.common.applog.AppLog.getLogEncryptSwitch()     // Catch:{ Throwable -> 0x0149 }
            if (r11 == 0) goto L_0x004e
            android.content.Context r11 = r8.mContext     // Catch:{ RuntimeException -> 0x004e }
            java.lang.String r10 = com.p683ss.android.common.applog.NetUtil.sendEncryptLog(r2, r10, r11, r7)     // Catch:{ RuntimeException -> 0x004e }
            goto L_0x005a
        L_0x004e:
            com.bytedance.common.utility.k r1 = com.bytedance.common.utility.C9423k.m18637a()     // Catch:{ Throwable -> 0x0149 }
            r4 = 1
            java.lang.String r5 = "application/json; charset=utf-8"
            r6 = 0
            java.lang.String r10 = r1.mo17062a(r2, r3, r4, r5, r6)     // Catch:{ Throwable -> 0x0149 }
        L_0x005a:
        ...
        L_0x00ad:
            boolean r10 = com.p683ss.android.common.applog.AppLog.getLogRecoverySwitch()     // Catch:{ Throwable -> 0x0133 }
        ...
        L_0x00d4:
            ...
            boolean r4 = com.bytedance.common.utility.C9431p.m18664a(r3)     // Catch:{ Throwable -> 0x0133 }
        ...
        L_0x0103:
            ...
            boolean r3 = com.bytedance.common.utility.C9431p.m18664a(r2)     // Catch:{ Throwable -> 0x0133 }
        ...
        L_0x0126:
            ...
            r10.clear()     // Catch:{ Throwable -> 0x0133 }
        L_0x0133:
            boolean r10 = com.p683ss.android.common.applog.AppLog.getLogRecoverySwitch()     // Catch:{ Throwable -> 0x0149 }
        ...
        L_0x0149:
            r10 = move-exception
            boolean r11 = com.p683ss.android.common.applog.AppLog.getLogRecoverySwitch()
        ...
        L_0x0159:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogReaper.sendLog$___twin___(java.lang.String, java.lang.String, boolean):int");
    }
                        ...
                        try {
                            ...
                            if (sendLog != -1) {
                                ...
                                if (z3 && logSession4 != null && existDid()) {
                                    ...
                                    dBHelper = dBHelper2;
                                    try {
                                        dBHelper.setSessionLaunchSent(logSession4.f52048id);
