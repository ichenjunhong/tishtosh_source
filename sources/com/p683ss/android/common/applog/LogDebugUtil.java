...
public class LogDebugUtil {
    ...
    private static synchronized void tryShrink(android.content.Context r3) {
        /*
            java.lang.Class<com.ss.android.common.applog.LogDebugUtil> r0 = com.p683ss.android.common.applog.LogDebugUtil.class
            monitor-enter(r0)
        ...
        L_0x0054:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.android.common.applog.LogDebugUtil.tryShrink(android.content.Context):void");
    }

    public static void trackLogDiscard(Context context, long j) {
        FileOutputStream fileOutputStream;
        if (sEnabled && C9415i.m18635b() && context != null && j > 0) {
            try {
    ...
    public static void trackLogInsert(Context context, long j, String str) {
        if (sEnabled && C9415i.m18635b() && context != null && j > 0 && str != null && str.length() > 0 && str.indexOf("item_impression") > 0) {
