...
public class TrafficGuard implements C9382a {
            ...
            if (j >= 0) {
                if (this.mLastTraffic[i] >= 0) {
                    ...
                    if (j2 > 5242880) {
                        ...
                        trafficWarningInfo.f52049tx = z2;
                ...
                if (this.mInitTraffic[i] >= 0) {
                    ...
                    if (j3 > 20971520) {
                        ...
                        trafficWarningInfo2.f52049tx = z;
    ...
    public TrafficGuard(Context context, ITrafficWarningCallback iTrafficWarningCallback) {
        ...
        this.mHandler = new C9381g(Looper.getMainLooper(), this);
