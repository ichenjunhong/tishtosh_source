...
import com.p683ss.android.http.p1169a.p1174d.C19189c;
...
public class AppConfigParser {
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(string)) {
                            ...
                            for (int i2 = 0; i2 < min; i2++) {
                                ...
                                if (C19189c.f52890a.matcher(string2).matches()) {
    ...
    public static boolean parsePathHostMap(HashMap<Pattern, String> hashMap, JSONArray jSONArray, HashMap<Pattern, String> hashMap2) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            JSONObject jSONObject = jSONArray.getJSONObject(i);
            String string = jSONObject.getString(LeakCanaryFileProvider.f132050j);
    ...
    public static boolean parseHostMap(HashMap<String, List<ConnectHost>> hashMap, JSONArray jSONArray, HashMap<String, List<C19202b>> hashMap2) throws JSONException {
        int i;
        int length = jSONArray.length();
        int i2 = 0;
        while (i2 < length) {
            JSONObject jSONObject = jSONArray.getJSONObject(i2);
            String string = jSONObject.getString(LeakCanaryFileProvider.f132049i);
            ...
            while (i3 < length2) {
                ...
                if (TextUtils.isEmpty(optString) || TextUtils.isEmpty(optString2)) {
                    ...
                    i = i2;
                    C19202b bVar = new C19202b(optString, optString2, (long) optInt);
