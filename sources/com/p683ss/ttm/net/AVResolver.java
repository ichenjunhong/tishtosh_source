    ...
    static class ParserHost implements Runnable {
        ...
        public void run() {
            ...
            L_0x0023:
                ...
                com.p683ss.ttm.net.AVResolver.putHostInfo(r0, r1)
                long r2 = java.lang.System.currentTimeMillis()
                r1.time = r2
                return
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.net.AVResolver.ParserHost.run():void");
        }
    ...
    public void getAddressInfo(String str) {
        ...
        if (str == null || str.length() <= 0 || "".equals(str)) {
            ...
            if (this.mHostInfo != null) {
                if (this.mHostInfo.f128642ip == null || System.currentTimeMillis() - this.mHostInfo.time >= ((long) HOST_MAX_CACHE_TIME)) {
                    mCacheHosts.remove(str);
                    this.mHostInfo = null;
                } else {
                    this.mIPStr = new String[1];
                    this.mIPStr[0] = this.mHostInfo.f128642ip;
                    this.mRet = true;
                    return;
                }
            }
