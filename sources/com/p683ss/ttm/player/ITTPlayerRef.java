...
public abstract class ITTPlayerRef {
    ...
    public static synchronized com.p683ss.ttm.player.ITTPlayerRef create(android.content.Context r11, com.p683ss.ttm.player.TTPlayerClient r12, java.util.HashMap<java.lang.Integer, java.lang.Integer> r13) {
        /*
            java.lang.Class<com.ss.ttm.player.ITTPlayerRef> r0 = com.p683ss.ttm.player.ITTPlayerRef.class
            monitor-enter(r0)
            int r1 = com.p683ss.ttm.utils.HardWareInfo.getCpuFamily()     // Catch:{ all -> 0x00f8 }
            r2 = 100
            r3 = 0
            r4 = 3
            r5 = 0
            ...
            java.lang.Class<com.ss.ttm.player.TTPlayerClient> r10 = com.p683ss.ttm.player.TTPlayerClient.class
            ...
            com.ss.ttm.player.ITTPlayerRef r1 = (com.p683ss.ttm.player.ITTPlayerRef) r1     // Catch:{ Exception -> 0x005b }
            goto L_0x005c
        L_0x005b:
            r1 = r3
        L_0x005c:
            if (r1 == 0) goto L_0x0098
            boolean r3 = com.p683ss.ttm.player.TTPlayerConfiger.isPrintInfo()     // Catch:{ all -> 0x00f8 }
            goto L_0x0098
        L_0x0063:
            boolean r7 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r1, r5)     // Catch:{ all -> 0x00f8 }
            ...
            com.ss.ttm.player.ITTPlayerRef r1 = (com.p683ss.ttm.player.ITTPlayerRef) r1     // Catch:{ Exception -> 0x0092 }
            goto L_0x0093
        L_0x0092:
            r1 = r3
        L_0x0093:
            if (r1 == 0) goto L_0x0098
            com.p683ss.ttm.player.TTPlayerConfiger.isPrintInfo()     // Catch:{ all -> 0x00f8 }
        L_0x0098:
            r3 = r1
        L_0x0099:
            if (r3 != 0) goto L_0x00a4
            com.ss.ttm.player.TTPlayerRef r3 = com.p683ss.ttm.player.TTPlayerRef.create(r12, r11)     // Catch:{ all -> 0x00f8 }
            if (r3 == 0) goto L_0x00a4
            com.p683ss.ttm.player.TTPlayerConfiger.isPrintInfo()     // Catch:{ all -> 0x00f8 }
        L_0x00a4:
            ...
            goto L_0x00f6
        L_0x00e7:
            boolean r13 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r12, r5)     // Catch:{ all -> 0x00f8 }
            if (r13 != 0) goto L_0x00f6
            int r11 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r11, r5)     // Catch:{ all -> 0x00f8 }
            if (r11 >= r4) goto L_0x00f6
            com.p683ss.ttm.player.TTPlayerConfiger.setValue(r12, r6)     // Catch:{ all -> 0x00f8 }
        L_0x00f6:
            monitor-exit(r0)
            return r3
        L_0x00f8:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.ITTPlayerRef.create(android.content.Context, com.ss.ttm.player.TTPlayerClient, java.util.HashMap):com.ss.ttm.player.ITTPlayerRef");
    }
}
