...
import com.p683ss.ttm.utils.Util;
...
class AJMediaCodec {
    ...
    private static boolean codecNeedsSetOutputSurfaceWorkaround() {
        /*
            java.lang.Class<com.ss.ttm.player.AJMediaCodec> r0 = com.p683ss.ttm.player.AJMediaCodec.class
            monitor-enter(r0)
            boolean r1 = mEvaluatedDeviceNeedsSetOutputSurfaceWorkaround     // Catch:{ all -> 0x008a }
            if (r1 != 0) goto L_0x0086
            int r1 = com.p683ss.ttm.utils.Util.SDK_INT     // Catch:{ all -> 0x008a }
            r2 = 27
            r3 = 1
            if (r1 > r2) goto L_0x0018
            java.lang.String r1 = "dangal"
            java.lang.String r4 = com.p683ss.ttm.utils.Util.DEVICE     // Catch:{ all -> 0x008a }
            boolean r1 = r1.equals(r4)     // Catch:{ all -> 0x008a }
            if (r1 != 0) goto L_0x0082
        L_0x0018:
            int r1 = com.p683ss.ttm.utils.Util.SDK_INT     // Catch:{ all -> 0x008a }
            if (r1 >= r2) goto L_0x0084
            java.lang.String r1 = com.p683ss.ttm.utils.Util.DEVICE     // Catch:{ all -> 0x008a }
        ...
        L_0x0059:
            java.lang.String r1 = com.p683ss.ttm.utils.Util.MODEL     // Catch:{ all -> 0x008a }
            int r2 = r1.hashCode()     // Catch:{ all -> 0x008a }
        ...
        L_0x008a:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.AJMediaCodec.codecNeedsSetOutputSurfaceWorkaround():boolean");
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    this.mInputBuffers = this.mMediaCodec.getInputBuffers();
                    this.mInputBuffersValid = true;
                    C2240a.m6772a("open() input params. width:%d,height:%d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)});
                    return 0;
                } catch (Exception unused) {
                    return -1;
                }
    ...
    public int configure(int i, int i2, int i3, int i4, int i5, String str, ByteBuffer byteBuffer, ByteBuffer byteBuffer2, ByteBuffer byteBuffer3, Surface surface, boolean z, boolean z2, int i6, int i7, boolean z3, int i8, boolean z4, boolean z5) {
        Surface surface2;
        int i9 = i;
        int i10 = i2;
        String str2 = str;
        ...
        maybeSetInteger(mediaFormat, "width", i);
        maybeSetInteger(mediaFormat, "height", i2);
        String str3 = "max-width";
        int i11 = i6;
        if (i11 <= i9) {
            i11 = i9;
        }
        maybeSetInteger(mediaFormat, str3, i11);
        String str4 = "max-height";
        int i12 = i7;
        if (i12 <= i10) {
            i12 = i10;
        }
        maybeSetInteger(mediaFormat, str4, i12);
        int i13 = i4;
