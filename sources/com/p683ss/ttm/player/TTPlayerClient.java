...
import com.p683ss.ttm.net.AVResolver;
...
import com.p683ss.ttm.utils.AVErrorInfo;
import com.p683ss.ttm.utils.AVLogger;
import com.p683ss.ttm.utils.AVTime;
...
public class TTPlayerClient extends MediaPlayerClient implements Callback, ISurfaceListener {
    ...
    public void onSurfaceChanged(SurfaceHolder surfaceHolder) {
        AVLogger.m110628k(TAG, "surface is change");
    }
    ...
    public void setDataSource(android.content.Context r3, android.net.Uri r4) throws java.lang.IllegalArgumentException, java.lang.SecurityException, java.lang.IllegalStateException, java.io.IOException {
        ...
        L_0x0062:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.TTPlayerClient.setDataSource(android.content.Context, android.net.Uri):void");
    }
    ...
    public void onPlayLogInfo(int i, int i2, String str) {
        if (i != 2) {
            ...
            if (str != null) {
                ...
                this.mLogInfo.addLast(C2240a.m6772a("%s&&time:%d", new Object[]{str, Long.valueOf(System.currentTimeMillis())}));
            }
        } else if (i2 == 1) {
            this.mVoiceInfo = str;
        } else {
    ...
    public void handleNotify(int r5, int r6, int r7, java.lang.String r8) {
        ...
        L_0x0078:
            ...
            goto L_0x00b6
        L_0x00b3:
            com.p683ss.ttm.player.TTPlayerConfiger.setValue(r8, r2)
        L_0x00b6:
            r4.stayAwake(r1)
            r4.sendSeekCompleted(r5)
        ...
        L_0x0101:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.TTPlayerClient.handleNotify(int, int, int, java.lang.String):void");
    }
}
