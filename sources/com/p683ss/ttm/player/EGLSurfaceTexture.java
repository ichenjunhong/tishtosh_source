...
public final class EGLSurfaceTexture implements OnFrameAvailableListener, Runnable {
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay eGLDisplay) {
        ...
        throw new GlException(C2240a.m6773a(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]}));
    }
