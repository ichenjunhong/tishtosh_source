...
public class AJVoice implements OnPlaybackPositionUpdateListener {
    ...
    public float getVolume() {
        /*
            ...
            if (r0 == 0) goto L_0x0025
            android.media.AudioManager r0 = r4.mAudioManager     // Catch:{ Exception -> 0x0025 }
            int r2 = r4.mStreamType     // Catch:{ Exception -> 0x0025 }
            int r0 = r0.getStreamMaxVolume(r2)     // Catch:{ Exception -> 0x0025 }
            android.media.AudioManager r2 = r4.mAudioManager     // Catch:{ Exception -> 0x0023 }
            int r3 = r4.mStreamType     // Catch:{ Exception -> 0x0023 }
            int r2 = r2.getStreamVolume(r3)     // Catch:{ Exception -> 0x0023 }
            r1 = r2
            goto L_0x0026
        L_0x0023:
            goto L_0x0026
        ...
        L_0x0030:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.AJVoice.getVolume():float");
    }
    ...
    private int reconfigure() {
        ...
        if (this.mChannelsLayout == 0) {
            AVLogger.m110628k(TAG, C2240a.m6772a("not supoort channel:%d", new Object[]{Integer.valueOf(this.mChannels)}));
            return -1;
        }
    ...
    public void releaseTrack(android.media.AudioTrack r6) {
        ...
        L_0x001d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.AJVoice.releaseTrack(android.media.AudioTrack):void");
    }
    ...
    public int write(ByteBuffer byteBuffer, int i) {
        if (byteBuffer == null) {
            AVLogger.m110626e(TAG, "buffer is nullpoint");
            return -1;
