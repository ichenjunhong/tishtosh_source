...
public class TTMediaPlayer implements MediaPlayer {
    ...
    public static final synchronized com.p683ss.ttm.player.TTMediaPlayer create(android.content.Context r7) {
        /*
            java.lang.Class<com.ss.ttm.player.TTMediaPlayer> r0 = com.p683ss.ttm.player.TTMediaPlayer.class
            monitor-enter(r0)
            com.ss.ttm.player.TTMediaPlayer r1 = new com.ss.ttm.player.TTMediaPlayer     // Catch:{ all -> 0x0047 }
            r1.<init>()     // Catch:{ all -> 0x0047 }
            com.p683ss.ttm.player.TTPlayerConfiger.isPrintInfo()     // Catch:{ all -> 0x0047 }
            r2 = 11
            r3 = 0
            r4 = 0
            boolean r5 = com.p683ss.ttm.player.TTPlayerConfiger.isOnTTPlayer()     // Catch:{ Throwable -> 0x0020 }
            if (r5 != 0) goto L_0x001b
            boolean r5 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r2, r3)     // Catch:{ Throwable -> 0x0020 }
            if (r5 == 0) goto L_0x002b
        L_0x001b:
            com.ss.ttm.player.TTPlayerClient r5 = com.p683ss.ttm.player.TTPlayerClient.create(r1, r7, r4)     // Catch:{ Throwable -> 0x0020 }
            goto L_0x002c
        L_0x0020:
            r5 = 7
            boolean r6 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r5, r3)     // Catch:{ all -> 0x0047 }
            if (r6 != 0) goto L_0x002b
            r6 = 1
            com.p683ss.ttm.player.TTPlayerConfiger.setValue(r5, r6)     // Catch:{ all -> 0x0047 }
        L_0x002b:
            r5 = r4
        L_0x002c:
            if (r5 != 0) goto L_0x003f
            com.p683ss.ttm.player.TTPlayerConfiger.isPrintInfo()     // Catch:{ all -> 0x0047 }
            boolean r2 = com.p683ss.ttm.player.TTPlayerConfiger.getValue(r2, r3)     // Catch:{ all -> 0x0047 }
            if (r2 == 0) goto L_0x0039
            monitor-exit(r0)
            return r4
        L_0x0039:
            com.ss.ttm.player.OSPlayerClient r5 = com.p683ss.ttm.player.OSPlayerClient.create(r1, r7)     // Catch:{ all -> 0x0047 }
        ...
        L_0x0047:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p683ss.ttm.player.TTMediaPlayer.create(android.content.Context):com.ss.ttm.player.TTMediaPlayer");
    }
