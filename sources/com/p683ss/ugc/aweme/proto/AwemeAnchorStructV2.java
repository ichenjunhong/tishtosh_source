...
public final class AwemeAnchorStructV2 extends Message<AwemeAnchorStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<AwemeAnchorStructV2, Builder> {
        ...
        public final AwemeAnchorStructV2 build() {
            AwemeAnchorStructV2 awemeAnchorStructV2 = new AwemeAnchorStructV2(this.type, this.f128791id, this.icon, this.title, this.open_url, this.web_url, this.mp_url, this.extra, this.log_extra, super.buildUnknownFields());
        ...
        /* renamed from: id */
        public final Builder mo103843id(String str) {
            this.f128791id = str;
            return this;
        }
    ...
    static final class ProtoAdapter_AwemeAnchorStructV2 extends ProtoAdapter<AwemeAnchorStructV2> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            ...
                            break;
                        case 2:
                            builder.mo103843id((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case 3:
        ...
        public final void encode(ProtoWriter protoWriter, AwemeAnchorStructV2 awemeAnchorStructV2) throws IOException {
            ...
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 2, awemeAnchorStructV2.f128790id);
    ...
    public final Builder newBuilder() {
        ...
        builder.f128791id = this.f128790id;
    ...
    public final int hashCode() {
        ...
        if (this.f128790id != null) {
            i2 = this.f128790id.hashCode();
        } else {
            i2 = 0;
        }
        int i12 = (i11 + i2) * 37;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(awemeAnchorStructV2.unknownFields()) || !Internal.equals(this.type, awemeAnchorStructV2.type) || !Internal.equals(this.f128790id, awemeAnchorStructV2.f128790id) || !Internal.equals(this.icon, awemeAnchorStructV2.icon) || !Internal.equals(this.title, awemeAnchorStructV2.title) || !Internal.equals(this.open_url, awemeAnchorStructV2.open_url) || !Internal.equals(this.web_url, awemeAnchorStructV2.web_url) || !Internal.equals(this.mp_url, awemeAnchorStructV2.mp_url) || !Internal.equals(this.extra, awemeAnchorStructV2.extra) || !Internal.equals(this.log_extra, awemeAnchorStructV2.log_extra)) {
            return false;
        }
        return true;
    }

    public AwemeAnchorStructV2(Integer num, String str, UrlStructV2 urlStructV2, String str2, String str3, String str4, String str5, String str6, String str7) {
        this(num, str, urlStructV2, str2, str3, str4, str5, str6, str7, ByteString.EMPTY);
    }

    public AwemeAnchorStructV2(Integer num, String str, UrlStructV2 urlStructV2, String str2, String str3, String str4, String str5, String str6, String str7, ByteString byteString) {
