...
public final class aweme_v2_feed_response extends Message<aweme_v2_feed_response, Builder> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 16:
                            ...
                            break;
                        case 17:
                            builder.enable_re_rank((Boolean) ProtoAdapter.BOOL.decode(protoReader));
                            break;
                        default:
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i18 + i4) * 37) + this.aweme_list.hashCode()) * 37;
        if (this.rid != null) {
            i5 = this.rid.hashCode();
        } else {
            i5 = 0;
        }
        int i19 = (hashCode2 + i5) * 37;
        ...
        int hashCode3 = (((i24 + i11) * 37) + this.preload_ads.hashCode()) * 37;
        if (this.status_msg != null) {
            i12 = this.status_msg.hashCode();
        } else {
            i12 = 0;
        }
        int i25 = (hashCode3 + i12) * 37;
        if (this.block_code != null) {
            i13 = this.block_code.hashCode();
        } else {
            i13 = 0;
        }
        int hashCode4 = (((i25 + i13) * 37) + this.preload_awemes.hashCode()) * 37;
        if (this.enable_re_rank != null) {
            i15 = this.enable_re_rank.hashCode();
        }
