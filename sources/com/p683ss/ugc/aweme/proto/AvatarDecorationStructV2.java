...
public final class AvatarDecorationStructV2 extends Message<AvatarDecorationStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<AvatarDecorationStructV2, Builder> {
        ...
        /* renamed from: id */
        public Long f128789id;
        public String name;
        public UrlStructV2 source_url;

        public final AvatarDecorationStructV2 build() {
            return new AvatarDecorationStructV2(this.f128789id, this.name, this.source_url, super.buildUnknownFields());
        }

        /* renamed from: id */
        public final Builder mo103827id(Long l) {
            this.f128789id = l;
            return this;
        }
    ...
    static final class ProtoAdapter_AvatarDecorationStructV2 extends ProtoAdapter<AvatarDecorationStructV2> {
        ...
        public final int encodedSize(AvatarDecorationStructV2 avatarDecorationStructV2) {
            return ProtoAdapter.INT64.encodedSizeWithTag(1, avatarDecorationStructV2.f128788id) + ProtoAdapter.STRING.encodedSizeWithTag(2, avatarDecorationStructV2.name) + UrlStructV2.ADAPTER.encodedSizeWithTag(3, avatarDecorationStructV2.source_url) + avatarDecorationStructV2.unknownFields().size();
        }
        ...
        public final AvatarDecorationStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo103827id((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 2:
        ...
        public final void encode(ProtoWriter protoWriter, AvatarDecorationStructV2 avatarDecorationStructV2) throws IOException {
            ProtoAdapter.INT64.encodeWithTag(protoWriter, 1, avatarDecorationStructV2.f128788id);
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128789id = this.f128788id;
    ...
    public final int hashCode() {
        ...
        int i4 = 0;
        if (this.f128788id != null) {
            i = this.f128788id.hashCode();
        } else {
            i = 0;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(avatarDecorationStructV2.unknownFields()) || !Internal.equals(this.f128788id, avatarDecorationStructV2.f128788id) || !Internal.equals(this.name, avatarDecorationStructV2.name) || !Internal.equals(this.source_url, avatarDecorationStructV2.source_url)) {
            return false;
        }
        return true;
    }
