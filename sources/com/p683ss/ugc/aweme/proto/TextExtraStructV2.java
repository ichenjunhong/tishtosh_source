...
public final class TextExtraStructV2 extends Message<TextExtraStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<TextExtraStructV2, Builder> {
        ...
        public final TextExtraStructV2 build() {
            TextExtraStructV2 textExtraStructV2 = new TextExtraStructV2(this.start, this.end, this.user_id, this.type, this.hashtag_name, this.hashtag_id, this.is_commerce, this.hashTagName, this.sec_uid, this.aweme_id, this.sub_type, super.buildUnknownFields());
    ...
    public final int hashCode() {
        ...
        if (this.aweme_id != null) {
            i10 = this.aweme_id.hashCode();
        } else {
            i10 = 0;
        }
        int i22 = (i21 + i10) * 37;
        if (this.sub_type != null) {
            i12 = this.sub_type.hashCode();
        }
        int i23 = i22 + i12;
        this.hashCode = i23;
        return i23;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(textExtraStructV2.unknownFields()) || !Internal.equals(this.start, textExtraStructV2.start) || !Internal.equals(this.end, textExtraStructV2.end) || !Internal.equals(this.user_id, textExtraStructV2.user_id) || !Internal.equals(this.type, textExtraStructV2.type) || !Internal.equals(this.hashtag_name, textExtraStructV2.hashtag_name) || !Internal.equals(this.hashtag_id, textExtraStructV2.hashtag_id) || !Internal.equals(this.is_commerce, textExtraStructV2.is_commerce) || !Internal.equals(this.hashTagName, textExtraStructV2.hashTagName) || !Internal.equals(this.sec_uid, textExtraStructV2.sec_uid) || !Internal.equals(this.aweme_id, textExtraStructV2.aweme_id) || !Internal.equals(this.sub_type, textExtraStructV2.sub_type)) {
            return false;
        }
        return true;
    }
    ...
    public TextExtraStructV2(Integer num, Integer num2, String str, Integer num3, String str2, String str3, Boolean bool, String str4, String str5, String str6, Integer num4) {
        this(num, num2, str, num3, str2, str3, bool, str4, str5, str6, num4, ByteString.EMPTY);
    }

    public TextExtraStructV2(Integer num, Integer num2, String str, Integer num3, String str2, String str3, Boolean bool, String str4, String str5, String str6, Integer num4, ByteString byteString) {
