...
public final class NationalTaskLinkStructV2 extends Message<NationalTaskLinkStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<NationalTaskLinkStructV2, Builder> {
        ...
        public final NationalTaskLinkStructV2 build() {
            if (this.f128799id == null || this.title == null || this.sub_title == null || this.avatar_icon == null) {
                throw Internal.missingRequiredFields(this.f128799id, "id", this.title, "title", this.sub_title, "sub_title", this.avatar_icon, "avatar_icon");
            }
            NationalTaskLinkStructV2 nationalTaskLinkStructV2 = new NationalTaskLinkStructV2(this.f128799id, this.title, this.sub_title, this.avatar_icon, this.web_url, this.open_url, super.buildUnknownFields());
        ...
        /* renamed from: id */
        public final Builder mo104675id(String str) {
            this.f128799id = str;
            return this;
        }
    ...
    static final class ProtoAdapter_NationalTaskLinkStructV2 extends ProtoAdapter<NationalTaskLinkStructV2> {
        ...
        public final int encodedSize(NationalTaskLinkStructV2 nationalTaskLinkStructV2) {
            return ProtoAdapter.STRING.encodedSizeWithTag(1, nationalTaskLinkStructV2.f128798id) + ProtoAdapter.STRING.encodedSizeWithTag(2, nationalTaskLinkStructV2.title) + ProtoAdapter.STRING.encodedSizeWithTag(3, nationalTaskLinkStructV2.sub_title) + UrlStructV2.ADAPTER.encodedSizeWithTag(4, nationalTaskLinkStructV2.avatar_icon) + ProtoAdapter.STRING.encodedSizeWithTag(5, nationalTaskLinkStructV2.web_url) + ProtoAdapter.STRING.encodedSizeWithTag(6, nationalTaskLinkStructV2.open_url) + nationalTaskLinkStructV2.unknownFields().size();
        }
        ...
        public final NationalTaskLinkStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo104675id((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case 2:
        ...
        public final void encode(ProtoWriter protoWriter, NationalTaskLinkStructV2 nationalTaskLinkStructV2) throws IOException {
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 1, nationalTaskLinkStructV2.f128798id);
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128799id = this.f128798id;
    ...
    public final int hashCode() {
        ...
        int hashCode = ((((((((unknownFields().hashCode() * 37) + this.f128798id.hashCode()) * 37) + this.title.hashCode()) * 37) + this.sub_title.hashCode()) * 37) + this.avatar_icon.hashCode()) * 37;
        int i3 = 0;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(nationalTaskLinkStructV2.unknownFields()) || !this.f128798id.equals(nationalTaskLinkStructV2.f128798id) || !this.title.equals(nationalTaskLinkStructV2.title) || !this.sub_title.equals(nationalTaskLinkStructV2.sub_title) || !this.avatar_icon.equals(nationalTaskLinkStructV2.avatar_icon) || !Internal.equals(this.web_url, nationalTaskLinkStructV2.web_url) || !Internal.equals(this.open_url, nationalTaskLinkStructV2.open_url)) {
            return false;
        }
        return true;
    }
