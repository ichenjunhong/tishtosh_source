...
public final class WebcastRoomFeedCellStructV2 extends Message<WebcastRoomFeedCellStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<WebcastRoomFeedCellStructV2, Builder> {
        ...
        public final WebcastRoomFeedCellStructV2 build() {
            WebcastRoomFeedCellStructV2 webcastRoomFeedCellStructV2 = new WebcastRoomFeedCellStructV2(this.room, this.type, this.fans_struct, this.tag, this.tag_id, this.icon, this.distance, this.rawdata, super.buildUnknownFields());
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            builder.rawdata((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        default:
    ...
    public WebcastRoomFeedCellStructV2(WebcastRoomStructV2 webcastRoomStructV2, Integer num, FansStructV2 fansStructV2, String str, Long l, UrlStructV2 urlStructV2, String str2, String str3) {
        this(webcastRoomStructV2, num, fansStructV2, str, l, urlStructV2, str2, str3, ByteString.EMPTY);
    }

    public WebcastRoomFeedCellStructV2(WebcastRoomStructV2 webcastRoomStructV2, Integer num, FansStructV2 fansStructV2, String str, Long l, UrlStructV2 urlStructV2, String str2, String str3, ByteString byteString) {
