...
public final class VideoStructV2 extends Message<VideoStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<VideoStructV2, Builder> {
        ...
        public final VideoStructV2 build() {
            VideoStructV2 videoStructV2 = new VideoStructV2(this.play_addr, this.cover, this.height, this.width, this.dynamic_cover, this.origin_cover, this.ratio, this.download_addr, this.has_watermark, this.play_addr_lowbr, this.bit_rate, this.new_download_addr, this.duration, this.download_suffix_logo_addr, this.has_download_suffix_logo_addr, this.play_addr_265, this.is_h265, this.play_addr_h264, this.ui_alike_download_addr, this.caption_download_addr, this.cdn_url_expired, this.is_long_video, this.video_model, this.need_set_token, this.misc_download_addrs, this.token_auth, super.buildUnknownFields());
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 23:
                            ...
                            break;
                        case 24:
                            builder.need_set_token((Boolean) ProtoAdapter.BOOL.decode(protoReader));
                            break;
                        case 25:
                            builder.misc_download_addrs((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case BaseNotice.STORY_NOTICE_COMMENT /*26*/:
                            builder.token_auth((PlayTokenAuthStructV2) PlayTokenAuthStructV2.ADAPTER.decode(protoReader));
                            break;
                        default:
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i35 + i10) * 37) + this.bit_rate.hashCode()) * 37;
        if (this.new_download_addr != null) {
            i11 = this.new_download_addr.hashCode();
        } else {
            i11 = 0;
        }
        int i36 = (hashCode2 + i11) * 37;
        ...
        if (this.need_set_token != null) {
            i23 = this.need_set_token.hashCode();
        } else {
            i23 = 0;
        }
        int i48 = (i47 + i23) * 37;
        if (this.misc_download_addrs != null) {
            i24 = this.misc_download_addrs.hashCode();
        } else {
            i24 = 0;
        }
        int i49 = (i48 + i24) * 37;
        if (this.token_auth != null) {
            i26 = this.token_auth.hashCode();
        }
        int i50 = i49 + i26;
        this.hashCode = i50;
        return i50;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(videoStructV2.unknownFields()) || !Internal.equals(this.play_addr, videoStructV2.play_addr) || !Internal.equals(this.cover, videoStructV2.cover) || !Internal.equals(this.height, videoStructV2.height) || !Internal.equals(this.width, videoStructV2.width) || !Internal.equals(this.dynamic_cover, videoStructV2.dynamic_cover) || !Internal.equals(this.origin_cover, videoStructV2.origin_cover) || !Internal.equals(this.ratio, videoStructV2.ratio) || !Internal.equals(this.download_addr, videoStructV2.download_addr) || !Internal.equals(this.has_watermark, videoStructV2.has_watermark) || !Internal.equals(this.play_addr_lowbr, videoStructV2.play_addr_lowbr) || !this.bit_rate.equals(videoStructV2.bit_rate) || !Internal.equals(this.new_download_addr, videoStructV2.new_download_addr) || !Internal.equals(this.duration, videoStructV2.duration) || !Internal.equals(this.download_suffix_logo_addr, videoStructV2.download_suffix_logo_addr) || !Internal.equals(this.has_download_suffix_logo_addr, videoStructV2.has_download_suffix_logo_addr) || !Internal.equals(this.play_addr_265, videoStructV2.play_addr_265) || !Internal.equals(this.is_h265, videoStructV2.is_h265) || !Internal.equals(this.play_addr_h264, videoStructV2.play_addr_h264) || !Internal.equals(this.ui_alike_download_addr, videoStructV2.ui_alike_download_addr) || !Internal.equals(this.caption_download_addr, videoStructV2.caption_download_addr) || !Internal.equals(this.cdn_url_expired, videoStructV2.cdn_url_expired) || !Internal.equals(this.is_long_video, videoStructV2.is_long_video) || !Internal.equals(this.video_model, videoStructV2.video_model) || !Internal.equals(this.need_set_token, videoStructV2.need_set_token) || !Internal.equals(this.misc_download_addrs, videoStructV2.misc_download_addrs) || !Internal.equals(this.token_auth, videoStructV2.token_auth)) {
            return false;
        }
        return true;
    }

    public VideoStructV2(UrlStructV2 urlStructV2, UrlStructV2 urlStructV22, Integer num, Integer num2, UrlStructV2 urlStructV23, UrlStructV2 urlStructV24, String str, UrlStructV2 urlStructV25, Boolean bool, UrlStructV2 urlStructV26, List<BitRateStructV2> list, UrlStructV2 urlStructV27, Integer num3, UrlStructV2 urlStructV28, Boolean bool2, UrlStructV2 urlStructV29, Integer num4, UrlStructV2 urlStructV210, UrlStructV2 urlStructV211, UrlStructV2 urlStructV212, Long l, Integer num5, String str2, Boolean bool3, String str3, PlayTokenAuthStructV2 playTokenAuthStructV2) {
        this(urlStructV2, urlStructV22, num, num2, urlStructV23, urlStructV24, str, urlStructV25, bool, urlStructV26, list, urlStructV27, num3, urlStructV28, bool2, urlStructV29, num4, urlStructV210, urlStructV211, urlStructV212, l, num5, str2, bool3, str3, playTokenAuthStructV2, ByteString.EMPTY);
    }

    public VideoStructV2(UrlStructV2 urlStructV2, UrlStructV2 urlStructV22, Integer num, Integer num2, UrlStructV2 urlStructV23, UrlStructV2 urlStructV24, String str, UrlStructV2 urlStructV25, Boolean bool, UrlStructV2 urlStructV26, List<BitRateStructV2> list, UrlStructV2 urlStructV27, Integer num3, UrlStructV2 urlStructV28, Boolean bool2, UrlStructV2 urlStructV29, Integer num4, UrlStructV2 urlStructV210, UrlStructV2 urlStructV211, UrlStructV2 urlStructV212, Long l, Integer num5, String str2, Boolean bool3, String str3, PlayTokenAuthStructV2 playTokenAuthStructV2, ByteString byteString) {
