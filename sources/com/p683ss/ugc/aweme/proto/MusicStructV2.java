...
public final class MusicStructV2 extends Message<MusicStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<MusicStructV2, Builder> {
        ...
        /* renamed from: id */
        public final Builder mo104632id(Long l) {
            this.f128797id = l;
            return this;
        }
        ...
        public final MusicStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo104632id((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 2:
                        ...
                        case BaseNotice.CREATOR /*62*/:
                            ...
                            break;
                        case 63:
                            builder.is_author_artist((Boolean) ProtoAdapter.BOOL.decode(protoReader));
                            break;
                        case UnReadVideoExperiment.RELATION_LIST /*64*/:
                            builder.is_pgc((Boolean) ProtoAdapter.BOOL.decode(protoReader));
                            break;
                        default:
    ...
    public MusicStructV2(Long l, String str, String str2, String str3, String str4, UrlStructV2 urlStructV2, UrlStructV2 urlStructV22, UrlStructV2 urlStructV23, UrlStructV2 urlStructV24, UrlStructV2 urlStructV25, String str5, Integer num, Integer num2, Integer num3, Integer num4, String str6, Integer num5, List<PositionStructV2> list, ShareStructV2 shareStructV2, Integer num6, Integer num7, String str7, UrlStructV2 urlStructV26, String str8, String str9, String str10, UrlStructV2 urlStructV27, UrlStructV2 urlStructV28, ChallengeStructV2 challengeStructV2, Boolean bool, ChallengeStructV2 challengeStructV22, Integer num8, String str11, UrlStructV2 urlStructV29, Long l2, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, Boolean bool6, String str12, List<PositionStructV2> list2, Boolean bool7, Integer num9, BranchBillboardWeeklyStructV2 branchBillboardWeeklyStructV2, CategoryCoverStructV2 categoryCoverStructV2, Boolean bool8, Boolean bool9, UrlStructV2 urlStructV210, List<String> list3, Integer num10, List<ExternalSongStructV2> list4, String str13, Integer num11, String str14, UrlStructV2 urlStructV211, UrlStructV2 urlStructV212, UrlStructV2 urlStructV213, Double d, Double d2, Long l3, Boolean bool10, Boolean bool11, Boolean bool12) {
        this(l, str, str2, str3, str4, urlStructV2, urlStructV22, urlStructV23, urlStructV24, urlStructV25, str5, num, num2, num3, num4, str6, num5, list, shareStructV2, num6, num7, str7, urlStructV26, str8, str9, str10, urlStructV27, urlStructV28, challengeStructV2, bool, challengeStructV22, num8, str11, urlStructV29, l2, bool2, bool3, bool4, bool5, bool6, str12, list2, bool7, num9, branchBillboardWeeklyStructV2, categoryCoverStructV2, bool8, bool9, urlStructV210, list3, num10, list4, str13, num11, str14, urlStructV211, urlStructV212, urlStructV213, d, d2, l3, bool10, bool11, bool12, ByteString.EMPTY);
    }

    public MusicStructV2(Long l, String str, String str2, String str3, String str4, UrlStructV2 urlStructV2, UrlStructV2 urlStructV22, UrlStructV2 urlStructV23, UrlStructV2 urlStructV24, UrlStructV2 urlStructV25, String str5, Integer num, Integer num2, Integer num3, Integer num4, String str6, Integer num5, List<PositionStructV2> list, ShareStructV2 shareStructV2, Integer num6, Integer num7, String str7, UrlStructV2 urlStructV26, String str8, String str9, String str10, UrlStructV2 urlStructV27, UrlStructV2 urlStructV28, ChallengeStructV2 challengeStructV2, Boolean bool, ChallengeStructV2 challengeStructV22, Integer num8, String str11, UrlStructV2 urlStructV29, Long l2, Boolean bool2, Boolean bool3, Boolean bool4, Boolean bool5, Boolean bool6, String str12, List<PositionStructV2> list2, Boolean bool7, Integer num9, BranchBillboardWeeklyStructV2 branchBillboardWeeklyStructV2, CategoryCoverStructV2 categoryCoverStructV2, Boolean bool8, Boolean bool9, UrlStructV2 urlStructV210, List<String> list3, Integer num10, List<ExternalSongStructV2> list4, String str13, Integer num11, String str14, UrlStructV2 urlStructV211, UrlStructV2 urlStructV212, UrlStructV2 urlStructV213, Double d, Double d2, Long l3, Boolean bool10, Boolean bool11, Boolean bool12, ByteString byteString) {
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128797id = this.f128796id;
    ...
    public final int hashCode() {
        ...
        int i61 = 0;
        if (this.f128796id != null) {
            i = this.f128796id.hashCode();
        } else {
            i = 0;
        }
        int i62 = (hashCode + i) * 37;
        if (this.id_str != null) {
        ...
        int hashCode2 = (((i77 + i17) * 37) + this.position.hashCode()) * 37;
        if (this.share_info != null) {
            i18 = this.share_info.hashCode();
        } else {
            i18 = 0;
        }
        int i78 = (hashCode2 + i18) * 37;
