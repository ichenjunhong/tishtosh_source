...
public final class AwemeStatisticsStructV2 extends Message<AwemeStatisticsStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<AwemeStatisticsStructV2, Builder> {
        ...
        public final AwemeStatisticsStructV2 build() {
            AwemeStatisticsStructV2 awemeStatisticsStructV2 = new AwemeStatisticsStructV2(this.aweme_id, this.comment_count, this.digg_count, this.download_count, this.play_count, this.share_count, this.forward_count, this.lose_count, this.lose_comment_count, this.whatsapp_share_count, super.buildUnknownFields());
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            ...
                            break;
                        case 2:
                            builder.comment_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 3:
                            builder.digg_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 4:
                            builder.download_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 5:
                            builder.play_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 6:
                            builder.share_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 7:
                            builder.forward_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 8:
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            builder.whatsapp_share_count((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        default:
    ...
    public final int hashCode() {
        ...
        if (this.lose_comment_count != null) {
            i9 = this.lose_comment_count.hashCode();
        } else {
            i9 = 0;
        }
        int i20 = (i19 + i9) * 37;
        if (this.whatsapp_share_count != null) {
            i11 = this.whatsapp_share_count.hashCode();
        }
        int i21 = i20 + i11;
        this.hashCode = i21;
        return i21;
    ...
    public final String toString() {
        ...
        if (this.whatsapp_share_count != null) {
            sb.append(", whatsapp_share_count=");
            sb.append(this.whatsapp_share_count);
        }
    ...
    public AwemeStatisticsStructV2(String str, Long l, Long l2, Long l3, Long l4, Long l5, Long l6, Integer num, Integer num2, Long l7) {
        this(str, l, l2, l3, l4, l5, l6, num, num2, l7, ByteString.EMPTY);
    }

    public AwemeStatisticsStructV2(String str, Long l, Long l2, Long l3, Long l4, Long l5, Long l6, Integer num, Integer num2, Long l7, ByteString byteString) {
