...
final class DouplusToastStructV2 extends Message<DouplusToastStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<DouplusToastStructV2, Builder> {
        ...
        /* renamed from: id */
        public Integer f128795id;
        public String toast;

        public final DouplusToastStructV2 build() {
            return new DouplusToastStructV2(this.f128795id, this.toast, super.buildUnknownFields());
        }

        /* renamed from: id */
        public final Builder mo104350id(Integer num) {
            this.f128795id = num;
            return this;
        }
    ...
    static final class ProtoAdapter_DouplusToastStructV2 extends ProtoAdapter<DouplusToastStructV2> {
        ...
        public final int encodedSize(DouplusToastStructV2 douplusToastStructV2) {
            return ProtoAdapter.INT32.encodedSizeWithTag(1, douplusToastStructV2.f128794id) + ProtoAdapter.STRING.encodedSizeWithTag(2, douplusToastStructV2.toast) + douplusToastStructV2.unknownFields().size();
        }
        ...
        public final DouplusToastStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo104350id((Integer) ProtoAdapter.INT32.decode(protoReader));
                            break;
                        case 2:
        ...
        public final void encode(ProtoWriter protoWriter, DouplusToastStructV2 douplusToastStructV2) throws IOException {
            ProtoAdapter.INT32.encodeWithTag(protoWriter, 1, douplusToastStructV2.f128794id);
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128795id = this.f128794id;
    ...
    public final int hashCode() {
        ...
        int i3 = 0;
        if (this.f128794id != null) {
            i = this.f128794id.hashCode();
        } else {
            i = 0;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(douplusToastStructV2.unknownFields()) || !Internal.equals(this.f128794id, douplusToastStructV2.f128794id) || !Internal.equals(this.toast, douplusToastStructV2.toast)) {
            return false;
        }
        return true;
    }
