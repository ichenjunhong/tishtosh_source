...
public final class StarAtlasLinkStructV2 extends Message<StarAtlasLinkStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<StarAtlasLinkStructV2, Builder> {
        ...
        public final StarAtlasLinkStructV2 build() {
            if (this.f128803id == null || this.title == null || this.sub_title == null || this.avatar_icon == null) {
                throw Internal.missingRequiredFields(this.f128803id, "id", this.title, "title", this.sub_title, "sub_title", this.avatar_icon, "avatar_icon");
            }
            StarAtlasLinkStructV2 starAtlasLinkStructV2 = new StarAtlasLinkStructV2(this.f128803id, this.title, this.sub_title, this.avatar_icon, this.web_url, this.open_url, super.buildUnknownFields());
        ...
        /* renamed from: id */
        public final Builder mo105017id(String str) {
            this.f128803id = str;
            return this;
        }
    ...
    static final class ProtoAdapter_StarAtlasLinkStructV2 extends ProtoAdapter<StarAtlasLinkStructV2> {
        ...
        public final int encodedSize(StarAtlasLinkStructV2 starAtlasLinkStructV2) {
            return ProtoAdapter.STRING.encodedSizeWithTag(1, starAtlasLinkStructV2.f128802id) + ProtoAdapter.STRING.encodedSizeWithTag(2, starAtlasLinkStructV2.title) + ProtoAdapter.STRING.encodedSizeWithTag(3, starAtlasLinkStructV2.sub_title) + UrlStructV2.ADAPTER.encodedSizeWithTag(4, starAtlasLinkStructV2.avatar_icon) + ProtoAdapter.STRING.encodedSizeWithTag(5, starAtlasLinkStructV2.web_url) + ProtoAdapter.STRING.encodedSizeWithTag(6, starAtlasLinkStructV2.open_url) + starAtlasLinkStructV2.unknownFields().size();
        }
        ...
        public final StarAtlasLinkStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo105017id((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case 2:
        ...
        public final void encode(ProtoWriter protoWriter, StarAtlasLinkStructV2 starAtlasLinkStructV2) throws IOException {
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 1, starAtlasLinkStructV2.f128802id);
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128803id = this.f128802id;
    ...
    public final int hashCode() {
        ...
        int hashCode = ((((((((unknownFields().hashCode() * 37) + this.f128802id.hashCode()) * 37) + this.title.hashCode()) * 37) + this.sub_title.hashCode()) * 37) + this.avatar_icon.hashCode()) * 37;
        int i3 = 0;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(starAtlasLinkStructV2.unknownFields()) || !this.f128802id.equals(starAtlasLinkStructV2.f128802id) || !this.title.equals(starAtlasLinkStructV2.title) || !this.sub_title.equals(starAtlasLinkStructV2.sub_title) || !this.avatar_icon.equals(starAtlasLinkStructV2.avatar_icon) || !Internal.equals(this.web_url, starAtlasLinkStructV2.web_url) || !Internal.equals(this.open_url, starAtlasLinkStructV2.open_url)) {
            return false;
        }
        return true;
    }
