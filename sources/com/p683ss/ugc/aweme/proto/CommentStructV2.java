...
final class CommentStructV2 extends Message<CommentStructV2, Builder> {
    ...
    static final class ProtoAdapter_CommentStructV2 extends ProtoAdapter<CommentStructV2> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 15:
                            ...
                            break;
                        case 16:
                            builder.reply_comment_total((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 17:
        ...
        public final void encode(ProtoWriter protoWriter, CommentStructV2 commentStructV2) throws IOException {
            ...
            ProtoAdapter.INT64.encodeWithTag(protoWriter, 16, commentStructV2.reply_comment_total);
    ...
    public CommentStructV2(String str, String str2, String str3, Long l, Integer num, Integer num2, UserStructV2 userStructV2, String str4, Integer num3, List<CommentStructV2> list, List<TextExtraStructV2> list2, String str5, Integer num4, RelationDynamicLableStructV2 relationDynamicLableStructV2, String str6, Long l2, String str7, String str8, String str9, Boolean bool) {
        this(str, str2, str3, l, num, num2, userStructV2, str4, num3, list, list2, str5, num4, relationDynamicLableStructV2, str6, l2, str7, str8, str9, bool, ByteString.EMPTY);
    }

    public CommentStructV2(String str, String str2, String str3, Long l, Integer num, Integer num2, UserStructV2 userStructV2, String str4, Integer num3, List<CommentStructV2> list, List<TextExtraStructV2> list2, String str5, Integer num4, RelationDynamicLableStructV2 relationDynamicLableStructV2, String str6, Long l2, String str7, String str8, String str9, Boolean bool, ByteString byteString) {
