...
final class UserShopCategoryV2 extends Message<UserShopCategoryV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<UserShopCategoryV2, Builder> {
        ...
        /* renamed from: id */
        public Long f128807id;
        public String name;

        public final UserShopCategoryV2 build() {
            return new UserShopCategoryV2(this.f128807id, this.name, this.count, super.buildUnknownFields());
        }
        ...
        /* renamed from: id */
        public final Builder mo105079id(Long l) {
            this.f128807id = l;
            return this;
        }
    ...
    static final class ProtoAdapter_UserShopCategoryV2 extends ProtoAdapter<UserShopCategoryV2> {
        ...
        public final int encodedSize(UserShopCategoryV2 userShopCategoryV2) {
            return ProtoAdapter.INT64.encodedSizeWithTag(1, userShopCategoryV2.f128806id) + ProtoAdapter.STRING.encodedSizeWithTag(2, userShopCategoryV2.name) + ProtoAdapter.INT64.encodedSizeWithTag(3, userShopCategoryV2.count) + userShopCategoryV2.unknownFields().size();
        }
        ...
        public final UserShopCategoryV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.mo105079id((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 2:
        ...
        public final void encode(ProtoWriter protoWriter, UserShopCategoryV2 userShopCategoryV2) throws IOException {
            ProtoAdapter.INT64.encodeWithTag(protoWriter, 1, userShopCategoryV2.f128806id);
    ...
    public final Builder newBuilder() {
        Builder builder = new Builder();
        builder.f128807id = this.f128806id;
    ...
    public final int hashCode() {
        ...
        int i4 = 0;
        if (this.f128806id != null) {
            i = this.f128806id.hashCode();
        } else {
            i = 0;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(userShopCategoryV2.unknownFields()) || !Internal.equals(this.f128806id, userShopCategoryV2.f128806id) || !Internal.equals(this.name, userShopCategoryV2.name) || !Internal.equals(this.count, userShopCategoryV2.count)) {
            return false;
        }
        return true;
    }
