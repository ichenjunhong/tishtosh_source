...
public final class InteractionStickerStructV2 extends Message<InteractionStickerStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<InteractionStickerStructV2, Builder> {
        ...
        public final InteractionStickerStructV2 build() {
            InteractionStickerStructV2 interactionStickerStructV2 = new InteractionStickerStructV2(this.type, this.index, this.poi_info, this.track_info, this.attr, this.vote_info, this.text_info, super.buildUnknownFields());
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            builder.text_info((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        default:
    ...
    public final int hashCode() {
        ...
        if (this.vote_info != null) {
            i6 = this.vote_info.hashCode();
        } else {
            i6 = 0;
        }
        int i14 = (i13 + i6) * 37;
        if (this.text_info != null) {
            i8 = this.text_info.hashCode();
        }
        int i15 = i14 + i8;
        this.hashCode = i15;
        return i15;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(interactionStickerStructV2.unknownFields()) || !Internal.equals(this.type, interactionStickerStructV2.type) || !Internal.equals(this.index, interactionStickerStructV2.index) || !Internal.equals(this.poi_info, interactionStickerStructV2.poi_info) || !Internal.equals(this.track_info, interactionStickerStructV2.track_info) || !Internal.equals(this.attr, interactionStickerStructV2.attr) || !Internal.equals(this.vote_info, interactionStickerStructV2.vote_info) || !Internal.equals(this.text_info, interactionStickerStructV2.text_info)) {
            return false;
        }
        return true;
    }

    public InteractionStickerStructV2(Integer num, Integer num2, PoiStructV2 poiStructV2, String str, String str2, VoteStructV2 voteStructV2, String str3) {
        this(num, num2, poiStructV2, str, str2, voteStructV2, str3, ByteString.EMPTY);
    }

    public InteractionStickerStructV2(Integer num, Integer num2, PoiStructV2 poiStructV2, String str, String str2, VoteStructV2 voteStructV2, String str3, ByteString byteString) {
