...
public final class StreamUrlStructV2 extends Message<StreamUrlStructV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<StreamUrlStructV2, Builder> {
        ...
        public final StreamUrlStructV2 build() {
            StreamUrlStructV2 streamUrlStructV2 = new StreamUrlStructV2(this.sid, this.rtmp_pull_url, this.rtmp_push_url, this.provider, this.extra, this.f128805id, super.buildUnknownFields());
        ...
        /* renamed from: id */
        public final Builder mo105037id(String str) {
            this.f128805id = str;
            return this;
        }
    ...
    static final class ProtoAdapter_StreamUrlStructV2 extends ProtoAdapter<StreamUrlStructV2> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            builder.mo105037id((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        default:
        ...
        public final void encode(ProtoWriter protoWriter, StreamUrlStructV2 streamUrlStructV2) throws IOException {
            ...
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 6, streamUrlStructV2.f128804id);
    ...
    public final Builder newBuilder() {
        ...
        builder.f128805id = this.f128804id;
    ...
    public final int hashCode() {
        ...
        int i12 = (i11 + i5) * 37;
        if (this.f128804id != null) {
            i7 = this.f128804id.hashCode();
        }
        int i13 = i12 + i7;
        this.hashCode = i13;
        return i13;
