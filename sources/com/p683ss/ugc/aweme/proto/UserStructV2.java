...
public final class UserStructV2 extends Message<UserStructV2, Builder> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 209:
                            ...
                            break;
                        case 210:
                            builder.video_unread_info((VideoUnreadStructV2) VideoUnreadStructV2.ADAPTER.decode(protoReader));
                            break;
                        default:
    ...
    public final String toString() {
        ...
        if (this.video_unread_info != null) {
            sb.append(", video_unread_info=");
            sb.append(this.video_unread_info);
        }
