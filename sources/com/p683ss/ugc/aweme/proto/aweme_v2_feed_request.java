...
final class aweme_v2_feed_request extends Message<aweme_v2_feed_request, Builder> {
    ...
    static final class ProtoAdapter_aweme_v2_feed_request extends ProtoAdapter<aweme_v2_feed_request> {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 19:
                            ...
                            break;
                        case 20:
                            builder.interest_list((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case 21:
                            builder.preload_live_item_id((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        case 22:
                            builder.action_mask((Integer) ProtoAdapter.INT32.decode(protoReader));
                            break;
                        case 23:
                            builder.af_params((String) ProtoAdapter.STRING.decode(protoReader));
                            break;
                        default:
        ...
        public final void encode(ProtoWriter protoWriter, aweme_v2_feed_request aweme_v2_feed_request) throws IOException {
            ...
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 20, aweme_v2_feed_request.interest_list);
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 21, aweme_v2_feed_request.preload_live_item_id);
            ProtoAdapter.INT32.encodeWithTag(protoWriter, 22, aweme_v2_feed_request.action_mask);
            ProtoAdapter.STRING.encodeWithTag(protoWriter, 23, aweme_v2_feed_request.af_params);
    ...
    public final int hashCode() {
        ...
        if (this.last_ad_show_interval != null) {
            i19 = this.last_ad_show_interval.hashCode();
        } else {
            i19 = 0;
        }
        int i43 = (i42 + i19) * 37;
        if (this.interest_list != null) {
            i20 = this.interest_list.hashCode();
        } else {
            i20 = 0;
        }
        int i44 = (i43 + i20) * 37;
        if (this.preload_live_item_id != null) {
            i21 = this.preload_live_item_id.hashCode();
        } else {
            i21 = 0;
        }
        int i45 = (i44 + i21) * 37;
        if (this.action_mask != null) {
            i22 = this.action_mask.hashCode();
        } else {
            i22 = 0;
        }
        int i46 = (i45 + i22) * 37;
        if (this.af_params != null) {
            i24 = this.af_params.hashCode();
        }
        int i47 = i46 + i24;
        this.hashCode = i47;
        return i47;
