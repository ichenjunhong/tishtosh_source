...
public class TextLayoutUtils {
    ...
    static /* synthetic */ class C25971 {
        ...
        /* renamed from: b */
        static final /* synthetic */ int[] f8008b = new int[C2598a.values().length];
        ...
        static {
            /*
                com.bef.effectsdk.text.TextLayoutUtils$a[] r0 = com.bef.effectsdk.text.TextLayoutUtils.C2598a.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f8008b = r0
                r0 = 1
                int[] r1 = f8008b     // Catch:{ NoSuchFieldError -> 0x0014 }
                com.bef.effectsdk.text.TextLayoutUtils$a r2 = com.bef.effectsdk.text.TextLayoutUtils.C2598a.COLOR_TYPE_ALPHA     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r1[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                r1 = 2
                int[] r2 = f8008b     // Catch:{ NoSuchFieldError -> 0x001f }
                com.bef.effectsdk.text.TextLayoutUtils$a r3 = com.bef.effectsdk.text.TextLayoutUtils.C2598a.COLOR_TYPE_RGBA     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                ...
                int[] r2 = new int[r2]
                f8007a = r2
                int[] r2 = f8007a     // Catch:{ NoSuchFieldError -> 0x0032 }
            ...
            L_0x0032:
                int[] r0 = f8007a     // Catch:{ NoSuchFieldError -> 0x003c }
            ...
            L_0x003c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bef.effectsdk.text.TextLayoutUtils.C25971.<clinit>():void");
        }
    }
    ...
    public static TextBitmapResult generateBitmapAtlasAlphaUTF32(int[] iArr, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapAtlasUTF8(new String(iArr, 0, iArr.length), textLayoutParam, C2598a.COLOR_TYPE_ALPHA);
    }
    ...
    public static TextBitmapResult generateBitmapAtlasAlphaUTF8(String str, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapAtlasUTF8(str, textLayoutParam, C2598a.COLOR_TYPE_ALPHA);
    }
    ...
    public static TextBitmapResult generateBitmapAtlasRGBAUTF32(int[] iArr, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapAtlasUTF8(new String(iArr, 0, iArr.length), textLayoutParam, C2598a.COLOR_TYPE_RGBA);
    }
    ...
    public static TextBitmapResult generateBitmapAtlasRGBAUTF8(String str, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapAtlasUTF8(str, textLayoutParam, C2598a.COLOR_TYPE_RGBA);
    }
    ...
    public static TextBitmapResult generateBitmapNormalAlphaUTF32(int[] iArr, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapNormalUTF8(new String(iArr, 0, iArr.length), textLayoutParam, C2598a.COLOR_TYPE_ALPHA);
    }
    ...
    public static TextBitmapResult generateBitmapNormalAlphaUTF8(String str, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapNormalUTF8(str, textLayoutParam, C2598a.COLOR_TYPE_ALPHA);
    }
    ...
    public static TextBitmapResult generateBitmapNormalRGBAUTF32(int[] iArr, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapNormalUTF8(new String(iArr, 0, iArr.length), textLayoutParam, C2598a.COLOR_TYPE_RGBA);
    }
    ...
    public static TextBitmapResult generateBitmapNormalRGBAUTF8(String str, TextLayoutParam textLayoutParam) {
        ...
        return generateBitmapNormalUTF8(str, textLayoutParam, C2598a.COLOR_TYPE_RGBA);
    }
    ...
    public static TextBitmapResult generateTextAutoSizedNeonBitmap(String str, TextLayoutParam textLayoutParam) {
        ...
        if (!TextUtils.isEmpty(textLayoutParam2.familyName) && !TextUtils.isEmpty(textLayoutParam2.fontPath)) {
            textPaint.setTypeface(C2599a.m7543a(textLayoutParam2.fontPath, textLayoutParam2.familyName));
        }
        boolean z2 = false;
    ...
    public static TextBitmapResult generateTextAutoSizedShakeBitmap(String str, TextLayoutParam textLayoutParam) {
        ...
        if (!TextUtils.isEmpty(textLayoutParam2.familyName) && !TextUtils.isEmpty(textLayoutParam2.fontPath)) {
            textPaint2.setTypeface(C2599a.m7543a(textLayoutParam2.fontPath, textLayoutParam2.familyName));
        }
    ...
    private static TextBitmapResult generateBitmapAtlasUTF8(String str, TextLayoutParam textLayoutParam, C2598a aVar) {
        int i;
        int i2;
        int i3;
        float f;
        ...
        if (textLayoutParam2.familyName != null && !textLayoutParam2.familyName.isEmpty()) {
            typeface = (textLayoutParam2.fontPath == null || textLayoutParam2.fontPath.isEmpty()) ? C2599a.m7542a(textLayoutParam2.familyName, textLayoutParam2.fontStyle) : C2599a.m7543a(textLayoutParam2.fontPath, textLayoutParam2.familyName);
        }
        int i11 = textLayoutParam2.textColor;
        int i12 = textLayoutParam2.backColor;
        int i13 = textLayoutParam2.shadowColor;
        if (C25971.f8008b[aVar.ordinal()] != 1) {
    ...
    /* JADX WARNING: type inference failed for: r0v10, types: [android.text.StaticLayout] */
    /* JADX WARNING: type inference failed for: r20v2, types: [android.text.StaticLayout] */
    /* JADX WARNING: type inference failed for: r0v18 */
    /* JADX WARNING: type inference failed for: r0v20, types: [android.text.BoringLayout] */
    ...
    private static com.bef.effectsdk.text.data.TextBitmapResult generateBitmapNormalUTF8(java.lang.String r26, com.bef.effectsdk.text.data.TextLayoutParam r27, com.bef.effectsdk.text.TextLayoutUtils.C2598a r28) {
        /*
            r1 = r26
            r12 = r27
        ...
        L_0x000c:
            ...
            java.lang.String r0 = r12.fontPath
            java.lang.String r2 = r12.familyName
            android.graphics.Typeface r0 = com.bef.effectsdk.text.C2599a.m7543a(r0, r2)
            goto L_0x0037
        L_0x002f:
            java.lang.String r0 = r12.familyName
            int r2 = r12.fontStyle
            android.graphics.Typeface r0 = com.bef.effectsdk.text.C2599a.m7542a(r0, r2)
        L_0x0037:
            int r2 = r12.textColor
            int r3 = r12.backColor
            int r4 = r12.shadowColor
            int[] r5 = com.bef.effectsdk.text.TextLayoutUtils.C25971.f8008b
            int r6 = r28.ordinal()
            r5 = r5[r6]
            r14 = 1
        ...
        L_0x02ae:
            ...
            goto L_0x0236
        L_0x02b9:
            int[] r4 = com.bef.effectsdk.text.TextLayoutUtils.C25971.f8008b
            int r5 = r28.ordinal()
            r4 = r4[r5]
            r5 = 1
