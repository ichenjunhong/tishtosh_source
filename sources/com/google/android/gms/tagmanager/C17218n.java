...
final class C17218n extends SQLiteOpenHelper {

    /* renamed from: a */
    private final /* synthetic */ C17215k f48677a;

    C17218n(C17215k kVar, Context context, String str) {
        this.f48677a = kVar;
    ...
    private static boolean m42180a(java.lang.String r10, android.database.sqlite.SQLiteDatabase r11) {
        /*
            r0 = 0
            r1 = 0
        ...
        L_0x004a:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.C17218n.m42180a(java.lang.String, android.database.sqlite.SQLiteDatabase):boolean");
    }
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            this.f48677a.f48667b.getDatabasePath("google_tagmanager.db").delete();
            sQLiteDatabase = null;
        }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        if (!m42180a("datalayer", sQLiteDatabase)) {
            sQLiteDatabase.execSQL(C17215k.f48666a);
            return;
        }
