...
public final class C17129n extends C17076do {

    /* renamed from: a */
    private final C17130o f48438a = new C17130o(this, mo32850m(), "google_app_measurement_local.db");

    /* renamed from: b */
    private boolean f48439b;

    C17129n(C17005ay ayVar) {
        super(ayVar);
    }
    ...
    public final boolean mo33359a(int r18, byte[] r19) {
        /*
            r17 = this;
            r1 = r17
            r17.mo32840c()
            boolean r0 = r1.f48439b
            r2 = 0
        ...
        L_0x0023:
            ...
            r7 = 0
            r8 = 1
            android.database.sqlite.SQLiteDatabase r9 = r17.mo33360v()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c0, all -> 0x00bc }
            if (r9 != 0) goto L_0x003d
            r1.f48439b = r8     // Catch:{ SQLiteFullException -> 0x003a, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x0035 }
        ...
        L_0x005e:
            ...
            com.google.android.gms.measurement.internal.r r0 = r17.mo32854q()     // Catch:{ SQLiteFullException -> 0x005a, SQLiteDatabaseLockedException -> 0x00ba, SQLiteException -> 0x0058, all -> 0x0055 }
            com.google.android.gms.measurement.internal.t r0 = r0.f48445b     // Catch:{ SQLiteFullException -> 0x005a, SQLiteDatabaseLockedException -> 0x00ba, SQLiteException -> 0x0058, all -> 0x0055 }
            java.lang.String r15 = "Data loss, local db full"
            r0.mo33376a(r15)     // Catch:{ SQLiteFullException -> 0x005a, SQLiteDatabaseLockedException -> 0x00ba, SQLiteException -> 0x0058, all -> 0x0055 }
            r0 = 0
            long r13 = r13 - r10
            r10 = 1
            long r13 = r13 + r10
            ...
            r0.mo33379a(r15, r4, r2, r10)     // Catch:{ SQLiteFullException -> 0x005a, SQLiteDatabaseLockedException -> 0x00ba, SQLiteException -> 0x0058, all -> 0x0055 }
        L_0x00a4:
            java.lang.String r0 = "messages"
        ...
        L_0x00ce:
            ...
            goto L_0x011c
        L_0x00d1:
            com.google.android.gms.measurement.internal.r r2 = r17.mo32854q()     // Catch:{ all -> 0x00ce }
            com.google.android.gms.measurement.internal.t r2 = r2.f48445b     // Catch:{ all -> 0x00ce }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo33377a(r4, r0)     // Catch:{ all -> 0x00ce }
            r1.f48439b = r8     // Catch:{ all -> 0x00ce }
        ...
        L_0x00fb:
            ...
            r9 = r7
        L_0x00fd:
            com.google.android.gms.measurement.internal.r r2 = r17.mo32854q()     // Catch:{ all -> 0x011a }
            com.google.android.gms.measurement.internal.t r2 = r2.f48445b     // Catch:{ all -> 0x011a }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo33377a(r4, r0)     // Catch:{ all -> 0x011a }
            r1.f48439b = r8     // Catch:{ all -> 0x011a }
        ...
        L_0x0126:
            throw r0
        L_0x0127:
            com.google.android.gms.measurement.internal.r r0 = r17.mo32854q()
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C17129n.mo33359a(int, byte[]):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:?, code lost:
        mo32854q().f48445b.mo33376a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:44:?, code lost:
        r13.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:55:?, code lost:
        mo32854q().f48445b.mo33376a("Failed to load user property from local database");
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable> mo33358a(int r20) {
        /*
            r19 = this;
            r1 = r19
            r19.mo32840c()
        ...
        L_0x000b:
            ...
            r3.<init>()
            android.content.Context r0 = r19.mo32850m()
        ...
        L_0x0025:
            ...
            r8 = 1
            android.database.sqlite.SQLiteDatabase r15 = r19.mo33360v()     // Catch:{ SQLiteFullException -> 0x01c3, SQLiteDatabaseLockedException -> 0x01ac, SQLiteException -> 0x0183, all -> 0x017e }
            if (r15 != 0) goto L_0x0041
            r1.f48439b = r8     // Catch:{ SQLiteFullException -> 0x003e, SQLiteDatabaseLockedException -> 0x003b, SQLiteException -> 0x0036 }
        ...
        L_0x0073:
            ...
            int r0 = r12.length     // Catch:{ a -> 0x00a5 }
            r13.unmarshall(r12, r5, r0)     // Catch:{ a -> 0x00a5 }
            r13.setDataPosition(r5)     // Catch:{ a -> 0x00a5 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzag> r0 = com.google.android.gms.measurement.internal.zzag.CREATOR     // Catch:{ a -> 0x00a5 }
            java.lang.Object r0 = r0.createFromParcel(r13)     // Catch:{ a -> 0x00a5 }
            com.google.android.gms.measurement.internal.zzag r0 = (com.google.android.gms.measurement.internal.zzag) r0     // Catch:{ a -> 0x00a5 }
        ...
        L_0x00a3:
            ...
            goto L_0x00b4
        L_0x00a5:
            com.google.android.gms.measurement.internal.r r0 = r19.mo32854q()     // Catch:{ all -> 0x00a3 }
            com.google.android.gms.measurement.internal.t r0 = r0.f48445b     // Catch:{ all -> 0x00a3 }
            java.lang.String r12 = "Failed to load event from local database"
            r0.mo33376a(r12)     // Catch:{ all -> 0x00a3 }
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            goto L_0x0073
        L_0x00b4:
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
        ...
        L_0x00b8:
            ...
            android.os.Parcel r13 = android.os.Parcel.obtain()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            int r0 = r12.length     // Catch:{ a -> 0x00d3 }
            r13.unmarshall(r12, r5, r0)     // Catch:{ a -> 0x00d3 }
            r13.setDataPosition(r5)     // Catch:{ a -> 0x00d3 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzfv> r0 = com.google.android.gms.measurement.internal.zzfv.CREATOR     // Catch:{ a -> 0x00d3 }
            java.lang.Object r0 = r0.createFromParcel(r13)     // Catch:{ a -> 0x00d3 }
            com.google.android.gms.measurement.internal.zzfv r0 = (com.google.android.gms.measurement.internal.zzfv) r0     // Catch:{ a -> 0x00d3 }
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            goto L_0x00e2
        L_0x00d1:
            r0 = move-exception
            goto L_0x00e8
        L_0x00d3:
            com.google.android.gms.measurement.internal.r r0 = r19.mo32854q()     // Catch:{ all -> 0x00d1 }
            com.google.android.gms.measurement.internal.t r0 = r0.f48445b     // Catch:{ all -> 0x00d1 }
            java.lang.String r12 = "Failed to load user property from local database"
            r0.mo33376a(r12)     // Catch:{ all -> 0x00d1 }
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            r0 = 0
        L_0x00e2:
            if (r0 == 0) goto L_0x0073
        ...
        L_0x00ec:
            ...
            r13.unmarshall(r12, r5, r0)     // Catch:{ a -> 0x0107 }
            r13.setDataPosition(r5)     // Catch:{ a -> 0x0107 }
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzo> r0 = com.google.android.gms.measurement.internal.zzo.CREATOR     // Catch:{ a -> 0x0107 }
            java.lang.Object r0 = r0.createFromParcel(r13)     // Catch:{ a -> 0x0107 }
            com.google.android.gms.measurement.internal.zzo r0 = (com.google.android.gms.measurement.internal.zzo) r0     // Catch:{ a -> 0x0107 }
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            goto L_0x0116
        L_0x0105:
            r0 = move-exception
            goto L_0x011d
        L_0x0107:
            com.google.android.gms.measurement.internal.r r0 = r19.mo32854q()     // Catch:{ all -> 0x0105 }
            com.google.android.gms.measurement.internal.t r0 = r0.f48445b     // Catch:{ all -> 0x0105 }
            java.lang.String r12 = "Failed to load user property from local database"
            r0.mo33376a(r12)     // Catch:{ all -> 0x0105 }
            r13.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            r0 = 0
        L_0x0116:
            if (r0 == 0) goto L_0x0073
        ...
        L_0x011d:
            ...
            throw r0     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
        L_0x0121:
            com.google.android.gms.measurement.internal.r r0 = r19.mo32854q()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            com.google.android.gms.measurement.internal.t r0 = r0.f48445b     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            java.lang.String r12 = "Unknown record type in local database"
            r0.mo33376a(r12)     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            goto L_0x0073
        L_0x012e:
            java.lang.String r0 = "messages"
            ...
            r0.mo33376a(r4)     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
        L_0x014f:
        ...
        L_0x0192:
            ...
            goto L_0x01e6
        L_0x0194:
            com.google.android.gms.measurement.internal.r r4 = r19.mo32854q()     // Catch:{ all -> 0x0192 }
            com.google.android.gms.measurement.internal.t r4 = r4.f48445b     // Catch:{ all -> 0x0192 }
            java.lang.String r10 = "Error reading entries from local database"
            r4.mo33377a(r10, r0)     // Catch:{ all -> 0x0192 }
            r1.f48439b = r8     // Catch:{ all -> 0x0192 }
        ...
        L_0x01c3:
            ...
            r15 = 0
        L_0x01c6:
            com.google.android.gms.measurement.internal.r r4 = r19.mo32854q()     // Catch:{ all -> 0x01e3 }
            com.google.android.gms.measurement.internal.t r4 = r4.f48445b     // Catch:{ all -> 0x01e3 }
            java.lang.String r9 = "Error reading entries from local database"
            r4.mo33377a(r9, r0)     // Catch:{ all -> 0x01e3 }
            r1.f48439b = r8     // Catch:{ all -> 0x01e3 }
        ...
        L_0x01f0:
            throw r0
        L_0x01f1:
            com.google.android.gms.measurement.internal.r r0 = r19.mo32854q()
            com.google.android.gms.measurement.internal.t r0 = r0.f48448e
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C17129n.mo33358a(int):java.util.List");
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: v */
    public final SQLiteDatabase mo33360v() throws SQLiteException {
        if (this.f48439b) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f48438a.getWritableDatabase();
