...
public final class bbz {
    /* renamed from: a */
    public static <T extends bby> String m35345a(T t) {
        StringBuffer stringBuffer = new StringBuffer();
        try {
            m35347a(null, t, new StringBuffer(), stringBuffer);
    ...
    /* renamed from: a */
    private static void m35347a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        Field[] fields;
        int i;
        if (obj != null) {
            if (obj instanceof bby) {
                ...
                if (str != null) {
                    ...
                    stringBuffer2.append(m35346a(str));
                ...
                for (Field field : cls.getFields()) {
                    ...
                    if (!"cachedSize".equals(name) && (modifiers & 1) == 1 && (modifiers & 8) != 8 && !name.startsWith("_") && !name.endsWith("_")) {
                        ...
                        if (!type.isArray() || type.getComponentType() == Byte.TYPE) {
                            m35347a(name, obj2, stringBuffer, stringBuffer2);
                        } else {
                            if (obj2 == null) {
                                i = 0;
                            } else {
                            ...
                            for (int i2 = 0; i2 < i; i2++) {
                                m35347a(name, Array.get(obj2, i2), stringBuffer, stringBuffer2);
                            }
                        }
                    }
                }
                    ...
                    if (name3.startsWith("set")) {
                        ...
                        try {
                            ...
                            if (((Boolean) cls.getMethod(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                                ...
                                m35347a(substring, cls.getMethod(valueOf2.length() != 0 ? str3.concat(valueOf2) : new String(str3), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                            }
    ...
    /* renamed from: a */
    private static String m35346a(String str) {
        StringBuffer stringBuffer = new StringBuffer();
