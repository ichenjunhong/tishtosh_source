...
final class bkq {
    /* renamed from: a */
    static InputStream m35970a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m35971a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C18982g.m46160a(uRLConnection)) {
