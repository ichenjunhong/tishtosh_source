...
public final class C15884fg extends C14923f {

    /* renamed from: a */
    private final C15881fd f44980a;

    /* renamed from: b */
    private final List<C14918b> f44981b = new ArrayList();

    /* renamed from: c */
    private final C15869es f44982c;

    /* renamed from: d */
    private final C14937i f44983d = new C14937i();

    /* renamed from: e */
    private final C14917a f44984e;
    ...
    public C15884fg(com.google.android.gms.internal.ads.C15881fd r5) {
        /*
            r4 = this;
            r4.<init>()
            ...
            r4.f44980a = r5
            r5 = 0
            com.google.android.gms.internal.ads.fd r0 = r4.f44980a     // Catch:{ RemoteException -> 0x0055 }
        ...
        L_0x0048:
            ...
            java.util.List<com.google.android.gms.ads.formats.b$b> r2 = r4.f44981b     // Catch:{ RemoteException -> 0x0055 }
        ...
        L_0x005b:
            com.google.android.gms.internal.ads.fd r0 = r4.f44980a     // Catch:{ RemoteException -> 0x0069 }
            com.google.android.gms.internal.ads.eo r0 = r0.mo30940h()     // Catch:{ RemoteException -> 0x0069 }
        ...
        L_0x0070:
            r4.f44982c = r1
            com.google.android.gms.internal.ads.fd r0 = r4.f44980a     // Catch:{ RemoteException -> 0x0087 }
            com.google.android.gms.internal.ads.ek r0 = r0.mo30950r()     // Catch:{ RemoteException -> 0x0087 }
            if (r0 == 0) goto L_0x008d
            com.google.android.gms.internal.ads.en r0 = new com.google.android.gms.internal.ads.en     // Catch:{ RemoteException -> 0x0087 }
            com.google.android.gms.internal.ads.fd r1 = r4.f44980a     // Catch:{ RemoteException -> 0x0087 }
            com.google.android.gms.internal.ads.ek r1 = r1.mo30950r()     // Catch:{ RemoteException -> 0x0087 }
        ...
        L_0x008d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C15884fg.<init>(com.google.android.gms.internal.ads.fd):void");
    }
    ...
    /* renamed from: b */
    public final CharSequence mo27366b() {
        try {
            return this.f44980a.mo30934a();
        } catch (RemoteException e) {
            afc.m32793b("", e);
            return null;
        }
    ...
    /* renamed from: c */
    public final List<C14918b> mo27367c() {
        return this.f44981b;
    }

    /* renamed from: d */
    public final CharSequence mo27368d() {
        try {
            return this.f44980a.mo30939g();
        } catch (RemoteException e) {
            afc.m32793b("", e);
            return null;
        }
    ...
    /* renamed from: e */
    public final C14918b mo27369e() {
        return this.f44982c;
    }

    /* renamed from: f */
    public final CharSequence mo27370f() {
        try {
            return this.f44980a.mo30941i();
        } catch (RemoteException e) {
            afc.m32793b("", e);
            return null;
        }
    ...
    /* renamed from: g */
    public final Double mo27371g() {
        try {
            double j = this.f44980a.mo30942j();
            if (j == -1.0d) {
                return null;
            }
    ...
    /* renamed from: h */
    public final CharSequence mo27372h() {
        try {
            return this.f44980a.mo30943k();
        } catch (RemoteException e) {
            afc.m32793b("", e);
            return null;
        }
    ...
    /* renamed from: i */
    public final CharSequence mo27373i() {
        try {
            return this.f44980a.mo30944l();
        } catch (RemoteException e) {
            afc.m32793b("", e);
            return null;
        }
    ...
    /* renamed from: j */
    public final C14937i mo27374j() {
        try {
            if (this.f44980a.mo30945m() != null) {
                this.f44983d.mo27431a(this.f44980a.mo30945m());
            }
        } catch (RemoteException e) {
