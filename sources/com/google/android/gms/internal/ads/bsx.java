...
final class bsx {
    /* renamed from: a */
    static InputStream m36675a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m36676a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C18982g.m46160a(uRLConnection)) {
