...
abstract class bbe {
    ...
    /* renamed from: a */
    public abstract int mo30011a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract int mo30012a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract void mo30013a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: 0000 */
    /* renamed from: b */
    public abstract String mo30015b(byte[] bArr, int i, int i2) throws ayi;

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final boolean mo30014a(byte[] bArr, int i, int i2) {
        return mo30011a(0, bArr, i, i2) == 0;
    }

    /* renamed from: b */
    static void m35247b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
