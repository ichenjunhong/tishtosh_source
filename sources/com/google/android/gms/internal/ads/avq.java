...
final class avq {
    /* renamed from: a */
    private static long m34230a(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & 255) << 24) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16))) & 4294967295L;
    }

    /* renamed from: a */
    private static long m34231a(byte[] bArr, int i, int i2) {
        return (m34230a(bArr, i) >> i2) & 67108863;
    }

    /* renamed from: a */
    private static void m34232a(byte[] bArr, long j, int i) {
        int i2 = 0;
        while (i2 < 4) {
    ...
    /* renamed from: a */
    static byte[] m34233a(byte[] bArr, byte[] bArr2) {
        byte[] bArr3 = bArr;
        byte[] bArr4 = bArr2;
        long a = m34231a(bArr3, 0, 0) & 67108863;
        int i = 2;
        long a2 = m34231a(bArr3, 3, 2) & 67108611;
        int i2 = 6;
        long a3 = m34231a(bArr3, 6, 4) & 67092735;
        long a4 = m34231a(bArr3, 9, 6) & 66076671;
        long a5 = m34231a(bArr3, 12, 8) & 1048575;
        long j = a2 * 5;
        long j2 = a3 * 5;
        long j3 = a4 * 5;
        long j4 = a5 * 5;
        ...
        while (i3 < bArr4.length) {
            ...
            long a6 = j9 + m34231a(bArr5, 0, 0);
            long a7 = j5 + m34231a(bArr5, 3, i);
            long a8 = j6 + m34231a(bArr5, i2, 4);
            long a9 = j7 + m34231a(bArr5, 9, i2);
            long a10 = j8 + (m34231a(bArr5, 12, 8) | ((long) (bArr5[16] << 24)));
        ...
        long a11 = ((j44 | j34 | (j27 & j39)) & 4294967295L) + m34230a(bArr3, 16);
        long j48 = a11 & 4294967295L;
        long a12 = j45 + m34230a(bArr3, 20) + (a11 >> 32);
        long j49 = a12 & 4294967295L;
        long a13 = j46 + m34230a(bArr3, 24) + (a12 >> 32);
        long j50 = a13 & 4294967295L;
        long a14 = (j47 + m34230a(bArr3, 28) + (a13 >> 32)) & 4294967295L;
        byte[] bArr6 = new byte[16];
        m34232a(bArr6, j48, 0);
        m34232a(bArr6, j49, 4);
        m34232a(bArr6, j50, 8);
        m34232a(bArr6, a14, 12);
        return bArr6;
    }
}
