...
final class bbf extends bbe {
    bbf() {
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final int mo30011a(int i, byte[] bArr, int i2, int i3) {
            ...
            while (r13 < i3) {
                ...
                if (bbd.m35243a(b2)) {
                    ...
                    while (i7 < i3) {
                        ...
                        i7++;
                        int i9 = i8 + 1;
                        bbd.m35242a(b3, cArr, i8);
                        i8 = i9;
                    }
                    r13 = i7;
                    i6 = i8;
                } else if (bbd.m35244b(b2)) {
                    if (i7 < i3) {
                        int i10 = i7 + 1;
                        int i11 = i6 + 1;
                        bbd.m35241a(b2, bArr[i7], cArr, i6);
                        r13 = i10;
                        i6 = i11;
                    } else {
                        throw ayi.m34785h();
                    }
                } else if (bbd.m35245c(b2)) {
                    if (i7 < i3 - 1) {
                        int i12 = i7 + 1;
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        bbd.m35240a(b2, bArr[i7], bArr[i12], cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw ayi.m34785h();
                    ...
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    bbd.m35239a(b2, b4, bArr[i15], bArr[i16], cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw ayi.m34785h();
    ...
    public final void mo30013a(CharSequence charSequence, ByteBuffer byteBuffer) {
        m35247b(charSequence, byteBuffer);
    }
}
