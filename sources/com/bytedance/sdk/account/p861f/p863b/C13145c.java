...
public final class C13145c extends C13090h<C12993e<C13103b>> {

    /* renamed from: e */
    private C13103b f34343e;
    ...
    public final /* synthetic */ C12990b mo24584a(boolean z, C13075b bVar) {
        return new C12993e(z, 1012, this.f34343e);
    }

    /* renamed from: b */
    public final void mo24587b(JSONObject jSONObject, JSONObject jSONObject2) throws Exception {
        this.f34343e.f34239f = C13079a.m26266a(jSONObject, jSONObject2);
        this.f34343e.f34279l = jSONObject;
    }

    /* renamed from: a */
    public final void mo24586a(JSONObject jSONObject, JSONObject jSONObject2) {
        C13078b.m26263a(this.f34343e, jSONObject);
        this.f34343e.f34279l = jSONObject2;
    }

    private C13145c(Context context, C13073a aVar, C13103b bVar, C13125b bVar2) {
        super(context, aVar, bVar2);
        this.f34343e = bVar;
    }

    /* renamed from: a */
    public static C13145c m26415a(Context context, String str, String str2, String str3, String str4, int i, C13125b bVar) {
        C13103b bVar2 = new C13103b(str, str2, null, str4, i);
        C13074a a = new C13074a().mo24752a(C12998a.m26126i());
        ...
        return new C13145c(context, a.mo24754a((Map<String, String>) hashMap).mo24757c(), bVar2, bVar);
    }
}
