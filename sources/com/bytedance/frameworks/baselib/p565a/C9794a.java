...
class C9794a {
    ...
    /* renamed from: a */
    static final String[] f26651a = {"_id", "value", "type", "timestamp", "retry_count", "retry_time"};

    /* renamed from: b */
    private static C9794a f26652b;

    /* renamed from: c */
    private SQLiteDatabase f26653c;

    /* renamed from: com.bytedance.frameworks.baselib.a.a$a */
    static class C9795a extends SQLiteOpenHelper {
        public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        }

        public C9795a(Context context) {
    ...
    /* renamed from: b */
    private synchronized boolean m19606b() {
        if (this.f26653c == null || !this.f26653c.isOpen()) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: a */
    public final synchronized void mo17641a() {
        if (m19606b()) {
            try {
                this.f26653c.execSQL("DROP TABLE IF EXISTS queue");
                this.f26653c.execSQL("CREATE TABLE queue ( _id INTEGER PRIMARY KEY AUTOINCREMENT, value BLOB, type TEXT, timestamp INTEGER, retry_count INTEGER, retry_time INTEGER )");
            } catch (Exception e) {
    ...
    /* renamed from: a */
    private static void m19605a(Cursor cursor) {
        if (cursor != null) {
            try {
                if (!cursor.isClosed()) {
                    cursor.close();
    ...
    private C9794a(Context context) {
        if (context != null) {
            try {
                this.f26653c = new C9795a(context.getApplicationContext()).getWritableDatabase();
    ...
    /* renamed from: a */
    static C9794a m19604a(Context context) {
        if (f26652b == null) {
            synchronized (C9794a.class) {
                if (f26652b == null) {
                    f26652b = new C9794a(context);
                }
            }
        }
        return f26652b;
    ...
    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized long mo17638a(String str) {
        long j = 0;
        if (!m19606b()) {
            return 0;
        }
        ...
        try {
            ...
            Cursor rawQuery = this.f26653c.rawQuery(str2, null);
            try {
    ...
    public final synchronized com.bytedance.frameworks.baselib.p565a.C9800c mo17640a(long r12) {
        /*
            r11 = this;
            monitor-enter(r11)
            boolean r0 = r11.m19606b()     // Catch:{ all -> 0x0080 }
            r1 = 0
        ...
        L_0x000a:
            ...
            android.database.sqlite.SQLiteDatabase r2 = r11.f26653c     // Catch:{ Exception -> 0x006a }
            java.lang.String r3 = "queue"
            java.lang.String[] r4 = f26651a     // Catch:{ Exception -> 0x006a }
            r7 = 0
            r8 = 0
            ...
            r2.f26661a = r3     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            byte[] r13 = r12.getBlob(r0)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f26662b = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 2
            java.lang.String r13 = r12.getString(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f26666f = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 3
            long r0 = r12.getLong(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f26663c = r0     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 4
            int r13 = r12.getInt(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f26664d = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 5
            long r0 = r12.getLong(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f26665e = r0     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r1 = r2
            goto L_0x005d
        L_0x005b:
            r13 = move-exception
        ...
        L_0x0080:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.frameworks.baselib.p565a.C9794a.mo17640a(long):com.bytedance.frameworks.baselib.a.c");
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized long mo17639a(String str, byte[] bArr) {
        if (m19606b() && bArr != null) {
            if (bArr.length > 0) {
                ...
                return this.f26653c.insert("queue", null, contentValues);
            }
        }
        return -1;
    }
    ...
    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized void mo17642a(String str, int i, long j) {
        String[] strArr;
        String str2;
        if (m19606b()) {
            ...
            try {
                this.f26653c.delete("queue", str2, strArr);
            } catch (Exception e) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean mo17643a(long r16, boolean r18, long r19, int r21) {
        /*
            r15 = this;
            r1 = r15
            r2 = r16
            monitor-enter(r15)
            boolean r0 = r15.m19606b()     // Catch:{ all -> 0x00bb }
            r4 = 0
        ...
        L_0x0013:
            ...
            android.database.sqlite.SQLiteDatabase r5 = r1.f26653c     // Catch:{ Exception -> 0x008c }
        ...
        L_0x0043:
            ...
            r6.put(r7, r8)     // Catch:{ Exception -> 0x0086, all -> 0x0084 }
            android.database.sqlite.SQLiteDatabase r7 = r1.f26653c     // Catch:{ Exception -> 0x0086, all -> 0x0084 }
        ...
        L_0x00a0:
            ...
            android.database.sqlite.SQLiteDatabase r0 = r1.f26653c     // Catch:{ Throwable -> 0x00ab }
        ...
        L_0x00bb:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.frameworks.baselib.p565a.C9794a.mo17643a(long, boolean, long, int):boolean");
    }
}
