...
/* renamed from: com.bytedance.geckox.e.a.b.b */
public class C10070b extends C12382d<Pair<C10053a, UpdatePackage>, Pair<C10053a, UpdatePackage>> {
    /* renamed from: a_ */
    public final /* synthetic */ Object mo18063a_(C12378b bVar, Object obj) throws Throwable {
        return m20306a(bVar, (Pair) obj);
    }

    /* renamed from: a */
    private static Object m20306a(C12378b<Pair<C10053a, UpdatePackage>> bVar, Pair<C10053a, UpdatePackage> pair) throws Throwable {
        C10117b.m20388a("gecko-debug-tag", "开始校验增量单文件 channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder("增量单文件校验失败 channel:");
