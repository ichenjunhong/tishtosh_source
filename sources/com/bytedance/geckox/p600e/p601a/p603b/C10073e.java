...
/* renamed from: com.bytedance.geckox.e.a.b.e */
public class C10073e extends C12382d<Pair<File, UpdatePackage>, Pair<String, Long>> {
    /* renamed from: a_ */
    public final /* synthetic */ Object mo18063a_(C12378b bVar, Object obj) throws Throwable {
        Pair pair = (Pair) obj;
        C10117b.m20388a("gecko-debug-tag", "开始激活合成后的单文件 channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        StringBuilder sb2 = new StringBuilder("激活合成后的单文件失败:");
