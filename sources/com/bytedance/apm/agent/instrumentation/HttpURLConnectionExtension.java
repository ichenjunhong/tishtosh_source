...
import com.bytedance.apm.agent.instrumentation.p469io.CountingInputStream;
import com.bytedance.apm.agent.instrumentation.p469io.CountingOutputStream;
import com.bytedance.apm.agent.instrumentation.p469io.StreamCompleteEvent;
import com.bytedance.apm.agent.instrumentation.p469io.StreamCompleteListener;
...
public class HttpURLConnectionExtension extends HttpURLConnection {
    ...
    class _lancet {
        ...
        static void m17646x5a2787bc(HttpURLConnection httpURLConnection, String str, String str2) {
        ...
        static InputStream m17647xff4d584d(HttpURLConnection httpURLConnection) throws IOException {
            URLConnection uRLConnection = httpURLConnection;
            if (C18982g.m46160a(uRLConnection)) {
        ...
        static void m17648x963129db(HttpURLConnection httpURLConnection, String str, String str2) {
            URLConnection uRLConnection = httpURLConnection;
            if (C18982g.m46160a(uRLConnection)) {
                C18976b.m46151a(uRLConnection.getURL(), str, str2, "");
            }
    ...
    public InputStream getInputStream() throws IOException {
        final TransactionState transactionState2 = getTransactionState();
        try {
            CountingInputStream countingInputStream = new CountingInputStream(_lancet.m17647xff4d584d(this.impl));
    ...
    public void addRequestProperty(String str, String str2) {
        _lancet.m17646x5a2787bc(this.impl, str, str2);
    }

    public void setRequestProperty(String str, String str2) {
        _lancet.m17648x963129db(this.impl, str, str2);
    }
