...
public class FragmentInstrumentation {
        ...
        if (fragment.getUserVisibleHint() && !fragment.isHidden()) {
            ...
            try {
                ...
                if (TextUtils.equals(canonicalName, sOnCreateFragmentName)) {
                    registerOnGlobalLayoutListener(canonicalName, fragment.getView(), C9172a.m18196a(canonicalName), sOnCreateTime, "fragmentOnCreateToViewShow");
                }
    ...
    public static void onHiddenChanged(Fragment fragment, boolean z) {
        ...
        if (!z) {
            try {
                String canonicalName = fragment.getClass().getCanonicalName();
                registerOnGlobalLayoutListener(canonicalName, fragment.getView(), C9172a.m18196a(canonicalName), System.currentTimeMillis(), "fragmentOnHiddenChangedToViewShow");
            } catch (Exception unused) {
            }
        }
    }
    ...
    public static void setUserVisibleHint(Fragment fragment, boolean z) {
        if (fragment.isResumed() && !fragment.isHidden()) {
            ...
            if (z) {
                try {
                    String canonicalName = fragment.getClass().getCanonicalName();
                    registerOnGlobalLayoutListener(canonicalName, fragment.getView(), C9172a.m18196a(canonicalName), System.currentTimeMillis(), "fragmentUserVisibleToViewShow");
                } catch (Exception unused) {
                }
            }
        }
                            ...
                            if (FragmentInstrumentation.sRootViewRef.get() != null) {
                                ...
                                if (findViewById != null && findViewById.getVisibility() == 0 && findViewById.getWidth() > 0) {
                                    ...
                                    if (FragmentInstrumentation.sWaitViewTimeoutRunnable != null) {
                                        C9148a.m18169a().removeCallbacks(FragmentInstrumentation.sWaitViewTimeoutRunnable);
                                    }
