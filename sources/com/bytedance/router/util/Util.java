...
public final class Util {
    ...
    class _lancet {
        ...
        static ApplicationInfo m25724x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    public static int getAppVersionCode(android.content.Context r4) {
        /*
            ...
            android.content.pm.ApplicationInfo r2 = com.bytedance.router.util.Util._lancet.m25724x89c42dc8(r0, r2, r3)     // Catch:{ NameNotFoundException -> 0x0021 }
    ...
    public static Map<String, String> sliceUrlParams(String str) {
        if (TextUtils.isEmpty(str)) {
            Logger.m25716e("Slice url params but the url is null!!!");
