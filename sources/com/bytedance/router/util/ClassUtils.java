...
public class ClassUtils {
    ...
    class _lancet {
        ...
        static ApplicationInfo m25713x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    private static SharedPreferences getMultiDexPreferences(Context context) {
        ...
        return C35807d.m80935a(context, str, i);
    }

    public static List<String> getSourcePaths(Context context) throws NameNotFoundException, IOException {
        ApplicationInfo com_ss_android_ugc_aweme_lancet_lanch_AwemeMetaDataLancet_getApplicationInfo = _lancet.m25713x89c42dc8(context.getPackageManager(), context.getPackageName(), 0);
