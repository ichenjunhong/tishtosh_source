...
public class RouterConfig {
    ...
    class _lancet {
        ...
        static ApplicationInfo m25708x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    public static boolean isExpired(Context context, RouterConfig routerConfig) {
        ...
        try {
            ...
            try {
                Bundle bundle = _lancet.m25708x89c42dc8(context.getPackageManager(), context.getPackageName(), 128).metaData;
                if (bundle != null) {
