...
public class SmartRouterApi {
    ...
    class _lancet {
        ...
        static ApplicationInfo m25711x89c42dc8(PackageManager packageManager, String str, int i) throws NameNotFoundException {
    ...
    private static Map<String, String> getCommonParams(Context context) {
        ...
        try {
            ...
            Bundle bundle = _lancet.m25711x89c42dc8(context.getPackageManager(), context.getPackageName(), 128).metaData;
            if (bundle != null) {
    ...
    public static ApiResult<RouterConfig> requestConfig(Context context, ServerParam serverParam) {
        ...
        if (commonParams == null) {
            Logger.m25716e("SmartRouterApi#requestConfig commonParams is null!!!");
            return apiResult;
        } else if (serverParam == null) {
            Logger.m25716e("SmartRouterApi#requestConfig serverParam is null!!!");
            return apiResult;
        } else {
    ...
    public static boolean reportRouterConfig(Context context, ServerParam serverParam, RouterConfig routerConfig) {
        ...
        Map commonParams = getCommonParams(context);
        if (commonParams == null) {
            Logger.m25716e("SmartRouterApi#reportRouterConfig commonParams is null!!!");
            return false;
        } else if (serverParam == null) {
            Logger.m25716e("SmartRouterApi#reportRouterConfig serverParam is null!!!");
            return false;
        } else if (routerConfig == null || (routerConfig.getIncMapping().isEmpty() && routerConfig.getRewriteMapping().isEmpty())) {
            Logger.m25714d("SmartRouterApi#reportRouterConfig there is no need to report.");
            return true;
        } else {
            commonParams.put("aid", String.valueOf(serverParam.getAid()));
            commonParams.put("device_id", String.valueOf(serverParam.getDeviceId()));
