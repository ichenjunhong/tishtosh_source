...
public class RouteFactory {
    ...
    public static BaseRoute createRoute(String str, String str2, RoutesConfig routesConfig) {
        ...
        if (TextUtils.isEmpty(str)) {
            Logger.m25716e("RouteFactory#createRoute url is null!!!");
            return null;
        }
        Uri parse = Uri.parse(str);
        if (!parse.isHierarchical()) {
            Logger.m25716e("RouteFactory#createRoute url is not illegal!!!");
            return null;
        }
        String scheme = parse.getScheme();
        if (TextUtils.isEmpty(scheme)) {
            Logger.m25716e("RouteFactory#createRoute scheme is null!!!");
            return null;
        }
        String host = parse.getHost();
        if (TextUtils.isEmpty(host)) {
            Logger.m25716e("RouteFactory#createRoute host is null!!!");
            return null;
        } else if (!isSchemeLegal(scheme, routesConfig)) {
            Logger.m25716e(C2240a.m6772a("RouteFactory#createRoute router cannot support this scheme protocol: %s\nRouteConfig:\n%s", new Object[]{str, routesConfig.toString()}));
            return null;
            ...
            try {
                ...
                Logger.m25716e("RouteFactory#createRoute routeClass new instance exception!!!");
                return null;
            }
        } else {
            try {
