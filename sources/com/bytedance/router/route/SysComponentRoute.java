...
public abstract class SysComponentRoute extends BaseRoute {
    ...
    public void open(Context context) {
        ...
        if (routeIntent == null) {
            ...
            Logger.m25716e("SysComponentRoute open routeIntent but the routeIntent is null!!!");
            return;
        }
        ...
        if (TextUtils.isEmpty(targetClass)) {
            ...
            Logger.m25716e("SysComponentRoute open routeIntent but the classPath is null!!!");
            return;
        }
        ...
        if (extra == null) {
            ...
            Logger.m25716e("SysComponentRoute open routeIntent but the intent is null!!!");
            return;
        }
        Class cls = null;
        try {
