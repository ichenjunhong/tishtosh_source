...
public class RouteMapper {
    ...
    public void requestRouteConfig() {
        if (this.mServerParam == null || !this.mServerParam.isAvailable()) {
            Logger.m25716e("RouteMapper#requestRouteConfig serverParam is null or unavailable,You must use SmartRouter#init(Context, ServerParam) before !!!");
        } else {
    ...
    public void loadLocalRouteConfig() {
        String string = C35807d.m80935a(this.mContext, "smartrouter_conf", 0).getString("smartrouter_config", "");
    ...
    public void updateNetRouteConfig() {
        ...
        if (requestConfig.errorCode != 0) {
            ...
            C35807d.m80935a(this.mContext, "smartrouter_conf", 0).edit().putString("smartrouter_config", ((RouterConfig) requestConfig.result).toString()).commit();
        }
    }
    ...
    private void initDynamicRoutes(ServerParam serverParam) {
        ...
        if (serverParam == null || !serverParam.isAvailable()) {
            Logger.m25716e("RouteMapper#initDynamicRoutes serverParam is null or unavailable!!!");
        } else {
            AsyncTask.execute(new Runnable() {
                public void run() {
    ...
    public boolean loadModuleMapping(String str) {
        ...
        try {
            Object newInstance = Class.forName(C2240a.m6772a("com.bytedance.router.generator.mapping.SmartrouterMapping$$%s", new Object[]{str})).newInstance();
    ...
    public void init(Context context, ServerParam serverParam, IConfigUpdateListener iConfigUpdateListener) {
        Logger.m25714d("RouteMapper#init RouteMapper");
        this.mContext = context;
        this.mConfigUpdateListener = iConfigUpdateListener;
        if (!this.mIsInited.get()) {
            initRouteMap();
        }
        Logger.m25714d(C2240a.m6772a("RouteMapper#loadMappingByRouter routes: %d .", new Object[]{Integer.valueOf(this.mRouteMap.size())}));
        if (serverParam != null) {
