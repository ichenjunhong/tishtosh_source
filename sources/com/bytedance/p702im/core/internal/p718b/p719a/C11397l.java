...
public final class C11397l extends C11406q<List<ParticipantMinIndex>> {
    public C11397l() {
        super(IMCMD.GET_CONVERSATION_PARTICIPANTS_MIN_INDEX_V3.getValue());
    }

    public C11397l(C11162b<List<ParticipantMinIndex>> bVar) {
    ...
    public final boolean mo20947a(C11447f fVar) {
        if (fVar == null || fVar.f30732g == null || fVar.f30732g.body == null || fVar.f30732g.body.participants_min_index_body == null) {
            return false;
        }
        return true;
    }
    ...
    public final void mo20946a(C11447f fVar, Runnable runnable) {
        ...
        if (z) {
            mo21055a(fVar.f30732g.body.participants_min_index_body.indexes);
            C11467e.m23462a(C2240a.m6772a("request minIndex result=%s", new Object[]{C11466d.f30773a.mo34889b(fVar.f30732g.body.participants_min_index_body.indexes)}));
        } else {
            mo21058b(fVar);
            C11467e.m23462a("request minIndex error");
        }
