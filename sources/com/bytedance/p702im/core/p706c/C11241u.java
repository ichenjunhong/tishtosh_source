...
/* renamed from: com.bytedance.im.core.c.u */
public final class C11241u implements Serializable, Cloneable, Comparable<C11241u> {
    ...
    public final C11241u clone() {
        try {
            return (C11241u) super.clone();
    ...
    public final int compareTo(C11241u uVar) {
        if (equals(uVar)) {
            return 0;
        }
        long orderIndex2 = uVar.getOrderIndex() - getOrderIndex();
        if (orderIndex2 > 0) {
            return 1;
        }
        if (orderIndex2 < 0) {
        ...
        long createdTime2 = uVar.getCreatedTime() - getCreatedTime();
        if (createdTime2 > 0) {
            return 1;
        }
        if (createdTime2 < 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!TextUtils.isEmpty(this.uuid)) {
            return this.uuid.equals(uVar.uuid);
        }
        return TextUtils.isEmpty(uVar.uuid);
    }
