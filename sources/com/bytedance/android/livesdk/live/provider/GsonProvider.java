...
public final class GsonProvider implements C4510b<C17971f> {

    static abstract class AbsJsonDeserializer<T> implements C18081k<T> {

        /* renamed from: a */
        protected C17971f f21346a;
    ...
    static class BaseListResponseDeserializer extends AbsJsonDeserializer<C4172a> {
        ...
        public final /* synthetic */ Object mo9501a(C18082l lVar, Type type, C18080j jVar) throws C18086p {
            ...
            if (m.mo35022b("status_code") != null) {
                i = m.mo35022b("status_code").mo34910g();
            } else {
                i = 0;
            }
            if (i == 0) {
                return (C4172a) this.f21346a.mo34882a(lVar, type);
            }
            C4172a aVar = new C4172a();
            aVar.f11364a = i;
            aVar.f11367d = (RequestError) this.f21346a.mo34881a(m.mo35022b("data"), RequestError.class);
            if (type instanceof ParameterizedType) {
                Type[] actualTypeArguments = ((ParameterizedType) type).getActualTypeArguments();
                if (actualTypeArguments.length <= 1) {
                    aVar.f11366c = (Extra) this.f21346a.mo34881a(m.mo35022b("extra"), Extra.class);
                } else {
                    aVar.f11366c = (Extra) this.f21346a.mo34882a(m.mo35022b("extra"), actualTypeArguments[1]);
                }
            } else {
                aVar.f11366c = (Extra) this.f21346a.mo34881a(m.mo35022b("extra"), Extra.class);
            }
    ...
    static class BaseResponseDeserializer extends AbsJsonDeserializer<C4175b> {
        ...
        /* renamed from: a */
        public final /* synthetic */ Object mo9501a(C18082l lVar, Type type, C18080j jVar) throws C18086p {
            C4175b bVar = (C4175b) this.f21346a.mo34882a(lVar, type);
            if (bVar.statusCode != 0) {
                bVar.error = (RequestError) this.f21346a.mo34881a(lVar.mo35009m().mo35022b("data"), RequestError.class);
            }
            return bVar;
        }
    }
    ...
    static class ListResponseDeserializer extends AbsJsonDeserializer<C4176c> {
        ...
        public final /* synthetic */ Object mo9501a(C18082l lVar, Type type, C18080j jVar) throws C18086p {
            ...
            if (g == 0) {
                return (C4176c) this.f21346a.mo34882a(lVar, type);
            }
            C4176c cVar = new C4176c();
            cVar.f11364a = g;
            cVar.f11366c = (Extra) this.f21346a.mo34881a(m.mo35022b("extra"), Extra.class);
            cVar.f11367d = (RequestError) this.f21346a.mo34881a(m.mo35022b("data"), RequestError.class);
            return cVar;
        }
    }
    ...
    static class ResponseDeserializer extends AbsJsonDeserializer<C4177d> {
        ...
        /* renamed from: a */
        public final /* synthetic */ Object mo9501a(C18082l lVar, Type type, C18080j jVar) throws C18086p {
            C4177d dVar = (C4177d) this.f21346a.mo34882a(lVar, type);
            if (dVar.statusCode != 0) {
                dVar.error = (RequestError) this.f21346a.mo34881a(lVar.mo35009m().mo35022b("data"), RequestError.class);
            }
            return dVar;
        }
    }
    ...
    static class RoomDeserializer implements C18081k<Room> {
        ...
        /* renamed from: a */
        private C17971f f21347a;

        private RoomDeserializer() {
            this.f21347a = C2942b.m8369a();
        }

        /* renamed from: a */
        public final /* synthetic */ Object mo9501a(C18082l lVar, Type type, C18080j jVar) throws C18086p {
            Room room = (Room) this.f21347a.mo34882a(lVar, type);
            room.init();
            return room;
        }
    }
    ...
    static class C7762a extends C18095w<Boolean> {
        private C7762a() {
        }
    ...
    /* renamed from: a */
    public final C4511a<C17971f> mo10307a(C4511a<C17971f> aVar) {
        C17978g a = new C17978g().mo34893a(C17963d.LOWER_CASE_WITH_UNDERSCORES);
        HashMap hashMap = new HashMap();
        hashMap.put(Room.class, new RoomDeserializer());
        hashMap.put(Boolean.class, new C7762a());
        hashMap.put(Boolean.TYPE, new C7762a());
        ...
        return aVar.mo10337a(a.mo34900d()).mo10336a();
    }
}
