...
public class DouyinGiftCombHelper {
    public static final int REPEAT_SEND_TIMEOUT = ((Integer) C6718b.f18310G.mo9431a()).intValue();
    ...
    public void handleComboClick(C7232c cVar) {
        cancelAnimator(this.showAnimator, this.processAnimator, this.dismissAnimator);
        if (!cVar.mo13462a().equals(this.mCombTarget)) {
            this.isFirstClicked = true;
        }
        if (this.isFirstClicked) {
            this.isFirstClicked = false;
            showCombView(cVar.mo13462a());
            return;
        }
        startCombViewClickAnimation(cVar.mo13462a());
    }
