...
public class NormalGiftView extends View implements C7327a {
    ...
    public void resetUI() {
        ...
        C7433a aVar = this.mBaseGiftView;
        aVar.f20376l.setText("");
        aVar.f20377m.setText("");
        aVar.f20378n.setVisibility(8);
        aVar.f20372h.setImageResource(R.drawable.c2g);
        aVar.f20374j.setImageResource(0);
        aVar.f20373i.setImageResource(0);
        aVar.f20375k.setImageResource(R.drawable.bt5);
    }

    private void init() {
        this.isRTL = false;
        this.mBaseGiftView = new C7433a(getContext());
        ...
        this.bgMarginStart = getResources().getDimension(R.dimen.p2);
        this.bgHeight = getResources().getDimension(R.dimen.p1);
        this.rectRadio = getResources().getDimension(R.dimen.p3);
        this.viewWidth = (float) this.mBaseGiftView.getWidth();
        this.viewHeight = (float) this.mBaseGiftView.getHeight();
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, this.viewWidth, this.viewHeight, getResources().getColor(R.color.ae9), getResources().getColor(R.color.ae9), TileMode.CLAMP);
    ...
    private void initLightCanvas() {
        ...
        if (this.isRTL) {
            color = getResources().getColor(R.color.aem);
        } else {
            color = getResources().getColor(R.color.aen);
        }
        int i = color;
        if (this.isRTL) {
            color2 = getResources().getColor(R.color.aen);
        } else {
            color2 = getResources().getColor(R.color.aem);
        }
        ...
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, f4, this.viewHeight, C0803a.m2298b(this.startColor, ALPHA_255), C0803a.m2298b(this.endColor, ALPHA_255), TileMode.CLAMP);
        this.lightShader = linearGradient2;
        float f5 = this.viewHeight / 2.0f;
        float f6 = this.viewWidth;
        LinearGradient linearGradient3 = new LinearGradient(0.0f, f5, f6, this.viewHeight / 2.0f, new int[]{getResources().getColor(R.color.aem), getResources().getColor(R.color.aen), getResources().getColor(R.color.aem)}, new float[]{0.0f, 0.9f, 1.0f}, TileMode.CLAMP);
    ...
    public void updateDrawingCache(View view) {
        this.mGiftBaseViewBitmap = C7429b.m15317a((View) this.mBaseGiftView);
    ...
    public void settingUi(C7421b bVar, boolean z) {
        this.isRTL = z;
        this.giftMsg = bVar;
        if (this.giftMsg.f20323o * this.giftMsg.f20324a > 60) {
            this.isPlayLight = true;
        }
        int[] b = C7456f.m15404a().mo13860b(this.giftMsg.f20323o * this.giftMsg.f20324a);
