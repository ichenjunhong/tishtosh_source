...
public final class C3973a {
    ...
    public static double m10055a() {
        ...
        L_0x001d:
            ...
            int r7 = m10057a(r6)     // Catch:{ Throwable -> 0x0087, all -> 0x0089 }
        ...
        L_0x0098:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.android.live.core.performance.C3973a.m10055a():double");
    }

    /* renamed from: a */
    private static void m10059a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
    ...
    /* renamed from: a */
    private static int m10057a(String str) {
        if (str.contains("CPU")) {
    ...
    /* renamed from: a */
    public static long m10058a(Context context) {
        Throwable th;
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    m10059a((Closeable) bufferedReader2);
                    return j;
                } catch (Throwable th2) {
                    th = th2;
                    m10059a((Closeable) bufferedReader);
                    throw th;
                }
            }
    ...
    /* renamed from: a */
    public static int m10056a(Context context, int i) {
        if (context == null) {
            return -1;
        }
        ActivityManager activityManager = (ActivityManager) context.getSystemService("activity");
