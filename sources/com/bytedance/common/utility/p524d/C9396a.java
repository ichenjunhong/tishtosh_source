...
public final class C9396a {
    ...
    /* renamed from: a */
    private static final byte[] f25643a = {71, 73, 70, 56, 55, 97};

    /* renamed from: b */
    private static final byte[] f25644b = {71, 73, 70, 56, 57, 97};

    /* renamed from: c */
    private static final byte[] f25645c = {-1, -40, -1};

    /* renamed from: d */
    private static final byte[] f25646d = {-119, 80, 78, 71, 13, 10, 26, 10};

    /* renamed from: com.bytedance.common.utility.d.a$a */
    public enum C9397a {
        UNKNOWN,
        JPG,
        PNG,
    ...
    /* renamed from: b */
    public static boolean m18582b(File file) {
        if (m18575a(file) == C9397a.GIF) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: a */
    public static InputStream m18576a(String str) {
    ...
    /* renamed from: b */
    public static boolean m18583b(String str) {
    ...
    /* renamed from: c */
    public static void m18584c(String str) throws Exception {
        File file = new File(str);
        if (file.exists()) {
            ...
            for (int i = 0; i < length; i++) {
                if (listFiles[i].isDirectory()) {
                    m18585d(listFiles[i].getAbsolutePath());
    ...
    /* renamed from: d */
    private static void m18585d(String str) throws Exception {
        File file = new File(str);
    ...
    public static com.bytedance.common.utility.p524d.C9396a.C9397a m18575a(java.io.File r3) {
        /*
            ...
            goto L_0x0061
        L_0x0009:
            com.bytedance.common.utility.d.a$a r0 = com.bytedance.common.utility.p524d.C9396a.C9397a.UNKNOWN
            r1 = 0
            ...
            byte[] r1 = f25644b     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            boolean r1 = m18581a(r3, r1)     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            if (r1 != 0) goto L_0x0049
            byte[] r1 = f25643a     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            boolean r1 = m18581a(r3, r1)     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            if (r1 == 0) goto L_0x0029
            goto L_0x0049
        L_0x0029:
            byte[] r1 = f25645c     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            boolean r1 = m18581a(r3, r1)     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            if (r1 == 0) goto L_0x0037
            com.bytedance.common.utility.d.a$a r3 = com.bytedance.common.utility.p524d.C9396a.C9397a.JPG     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            r2.close()     // Catch:{ Exception -> 0x0036 }
        L_0x0036:
            return r3
        L_0x0037:
            byte[] r1 = f25646d     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            boolean r3 = m18581a(r3, r1)     // Catch:{ Exception -> 0x0051, all -> 0x004f }
            if (r3 == 0) goto L_0x0045
            com.bytedance.common.utility.d.a$a r3 = com.bytedance.common.utility.p524d.C9396a.C9397a.PNG     // Catch:{ Exception -> 0x0051, all -> 0x004f }
        ...
        L_0x0045:
            ...
            goto L_0x0060
        L_0x0049:
            com.bytedance.common.utility.d.a$a r3 = com.bytedance.common.utility.p524d.C9396a.C9397a.GIF     // Catch:{ Exception -> 0x0051, all -> 0x004f }
        ...
        L_0x0060:
            return r0
        L_0x0061:
            com.bytedance.common.utility.d.a$a r3 = com.bytedance.common.utility.p524d.C9396a.C9397a.UNKNOWN
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.common.utility.p524d.C9396a.m18575a(java.io.File):com.bytedance.common.utility.d.a$a");
    }

    /* renamed from: a */
    public static String m18577a(Context context) throws NullPointerException {
        String str;
        if (context != null) {
            try {
    ...
    /* renamed from: a */
    public static void m18578a(String str, int i) {
        try {
    ...
    /* renamed from: a */
    private static boolean m18581a(byte[] bArr, byte[] bArr2) {
        boolean z = false;
        if (bArr2 == null) {
            return false;
        }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m18580a(java.lang.String r3, java.lang.String r4, java.lang.String r5) {
        /*
            boolean r0 = com.bytedance.common.utility.C9431p.m18664a(r3)
            r1 = 0
            if (r0 != 0) goto L_0x0034
            boolean r0 = com.bytedance.common.utility.C9431p.m18664a(r4)
            if (r0 != 0) goto L_0x0034
            boolean r0 = com.bytedance.common.utility.C9431p.m18664a(r5)
        ...
        L_0x0014:
            ...
            boolean r3 = m18579a(r2, r4, r5)     // Catch:{ Exception -> 0x0025, all -> 0x0022 }
        ...
        L_0x0034:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.common.utility.p524d.C9396a.m18580a(java.lang.String, java.lang.String, java.lang.String):boolean");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m18579a(java.io.InputStream r4, java.lang.String r5, java.lang.String r6) {
        /*
            r0 = 0
        ...
        L_0x0060:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.common.utility.p524d.C9396a.m18579a(java.io.InputStream, java.lang.String, java.lang.String):boolean");
    }
}
