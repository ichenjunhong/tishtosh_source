...
abstract class KevaImpl extends Keva {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x0226, code lost:
        return;
     */
    /* JADX WARNING: Removed duplicated region for block: B:69:0x01e8 A[Catch:{ Throwable -> 0x01eb }] */
    ...
    public void doPortingFromSp(android.content.Context r20) {
        /*
            ...
            r9 = r19
            monitor-enter(r19)
            long r0 = r9.mHandle     // Catch:{ all -> 0x0227 }
            r2 = 0
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 == 0) goto L_0x000d
            monitor-exit(r19)     // Catch:{ all -> 0x0227 }
            return
        L_0x000d:
            boolean r10 = r9 instanceof com.bytedance.keva.KevaMultiProcessImpl     // Catch:{ all -> 0x0227 }
            r0 = -1
            r11 = 1
            r12 = 0
            if (r10 == 0) goto L_0x0038
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            int r0 = r9.protectPortingInterProcess(r1, r11, r0)     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            boolean r1 = isRepoPorted(r1)     // Catch:{ all -> 0x0227 }
            if (r1 == 0) goto L_0x0036
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            int r2 = r9.mMode     // Catch:{ all -> 0x0227 }
            long r1 = r9.loadRepo(r1, r2, r12)     // Catch:{ all -> 0x0227 }
            r9.mHandle = r1     // Catch:{ all -> 0x0227 }
            r19.cleanUpAfterLoadRepo()     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            r9.protectPortingInterProcess(r1, r12, r0)     // Catch:{ all -> 0x0227 }
            monitor-exit(r19)     // Catch:{ all -> 0x0227 }
            return
        L_0x0036:
            r13 = r0
        ...
        L_0x0039:
            ...
            java.lang.String r0 = r9.mName     // Catch:{ all -> 0x0227 }
            boolean r0 = delete(r0)     // Catch:{ all -> 0x0227 }
        ...
        L_0x0045:
            r0 = 0
        L_0x0046:
            com.bytedance.keva.KevaMonitor r1 = sMonitor     // Catch:{ all -> 0x0227 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0227 }
            java.lang.String r5 = "poring load empty repo >> "
            r4.<init>(r5)     // Catch:{ all -> 0x0227 }
            java.lang.String r5 = r9.mName     // Catch:{ all -> 0x0227 }
            r4.append(r5)     // Catch:{ all -> 0x0227 }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x0227 }
            r1.logDebug(r4)     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            int r4 = r9.mMode     // Catch:{ all -> 0x0227 }
            long r4 = r9.loadRepo(r1, r4, r12)     // Catch:{ all -> 0x0227 }
            r9.mHandle = r4     // Catch:{ all -> 0x0227 }
            r19.cleanUpAfterLoadRepo()     // Catch:{ all -> 0x0227 }
            long r4 = r9.mHandle     // Catch:{ all -> 0x0227 }
        ...
        L_0x0070:
            ...
            r19.clear()     // Catch:{ all -> 0x0227 }
        L_0x0075:
            java.lang.String r0 = r9.mName     // Catch:{ all -> 0x0227 }
            r1 = r20
            android.content.SharedPreferences r0 = r1.getSharedPreferences(r0, r12)     // Catch:{ all -> 0x0227 }
            com.bytedance.keva.KevaMonitor r1 = sMonitor     // Catch:{ all -> 0x0227 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x0227 }
            java.lang.String r3 = "poring get sp >> "
            r2.<init>(r3)     // Catch:{ all -> 0x0227 }
            java.lang.String r3 = r9.mName     // Catch:{ all -> 0x0227 }
            r2.append(r3)     // Catch:{ all -> 0x0227 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0227 }
            r1.logDebug(r2)     // Catch:{ all -> 0x0227 }
            java.util.Map r0 = r0.getAll()     // Catch:{ all -> 0x0227 }
            com.bytedance.keva.KevaMonitor r1 = sMonitor     // Catch:{ all -> 0x0227 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x0227 }
            ...
            java.util.Iterator r14 = r0.iterator()     // Catch:{ all -> 0x0227 }
        L_0x00b3:
            boolean r0 = r14.hasNext()     // Catch:{ all -> 0x0227 }
            if (r0 == 0) goto L_0x01ff
            java.lang.Object r0 = r14.next()     // Catch:{ all -> 0x0227 }
            java.util.Map$Entry r0 = (java.util.Map.Entry) r0     // Catch:{ all -> 0x0227 }
            java.lang.Object r1 = r0.getKey()     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = (java.lang.String) r1     // Catch:{ all -> 0x0227 }
            java.lang.Object r15 = r0.getValue()     // Catch:{ all -> 0x0227 }
            if (r15 == 0) goto L_0x00b3
            java.lang.String r0 = ""
            boolean r0 = r0.equals(r1)     // Catch:{ all -> 0x0227 }
        ...
        L_0x00d6:
            r8 = r1
        L_0x00d7:
            com.bytedance.keva.KevaMonitor r0 = sMonitor     // Catch:{ all -> 0x0227 }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x0227 }
            java.lang.String r2 = "poring process key: "
            r1.<init>(r2)     // Catch:{ all -> 0x0227 }
            r1.append(r8)     // Catch:{ all -> 0x0227 }
            java.lang.String r2 = ", value: "
            r1.append(r2)     // Catch:{ all -> 0x0227 }
            r1.append(r15)     // Catch:{ all -> 0x0227 }
            java.lang.String r2 = " >> "
            r1.append(r2)     // Catch:{ all -> 0x0227 }
            java.lang.String r2 = r9.mName     // Catch:{ all -> 0x0227 }
            r1.append(r2)     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0227 }
            r0.logDebug(r1)     // Catch:{ all -> 0x0227 }
            com.bytedance.keva.KevaImpl$KevaValueWrapper r0 = new com.bytedance.keva.KevaImpl$KevaValueWrapper     // Catch:{ all -> 0x0227 }
            r0.<init>()     // Catch:{ all -> 0x0227 }
            java.util.HashMap<java.lang.String, com.bytedance.keva.KevaImpl$KevaValueWrapper> r1 = r9.mValueMap     // Catch:{ all -> 0x0227 }
            r1.put(r8, r0)     // Catch:{ all -> 0x0227 }
            boolean r1 = r15 instanceof java.lang.Boolean     // Catch:{ Throwable -> 0x01ed }
            if (r1 == 0) goto L_0x012a
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x0124 }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x0124 }
            r1 = r15
            java.lang.Boolean r1 = (java.lang.Boolean) r1     // Catch:{ Throwable -> 0x0124 }
            boolean r7 = r1.booleanValue()     // Catch:{ Throwable -> 0x0124 }
            r1 = r19
            r4 = r8
            long r1 = r1.storeBoolean(r2, r4, r5, r7)     // Catch:{ Throwable -> 0x0124 }
            r0.offset = r1     // Catch:{ Throwable -> 0x0124 }
            r0.value = r15     // Catch:{ Throwable -> 0x0124 }
        L_0x0120:
            r18 = r8
            goto L_0x01e4
        L_0x0124:
            ...
            goto L_0x01f1
        L_0x012a:
            boolean r1 = r15 instanceof java.lang.Integer     // Catch:{ Throwable -> 0x01ed }
            if (r1 == 0) goto L_0x0145
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x0124 }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x0124 }
            r1 = r15
            java.lang.Integer r1 = (java.lang.Integer) r1     // Catch:{ Throwable -> 0x0124 }
            int r7 = r1.intValue()     // Catch:{ Throwable -> 0x0124 }
            r1 = r19
            r4 = r8
            long r1 = r1.storeInt(r2, r4, r5, r7)     // Catch:{ Throwable -> 0x0124 }
            r0.offset = r1     // Catch:{ Throwable -> 0x0124 }
            r0.value = r15     // Catch:{ Throwable -> 0x0124 }
            goto L_0x0120
        L_0x0145:
            boolean r1 = r15 instanceof java.lang.Long     // Catch:{ Throwable -> 0x01ed }
            if (r1 == 0) goto L_0x0165
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x01ed }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x01ed }
            r1 = r15
            java.lang.Long r1 = (java.lang.Long) r1     // Catch:{ Throwable -> 0x01ed }
            long r16 = r1.longValue()     // Catch:{ Throwable -> 0x01ed }
            r1 = r19
            r4 = r8
            r18 = r8
            r7 = r16
            long r1 = r1.storeLong(r2, r4, r5, r7)     // Catch:{ Throwable -> 0x01eb }
            r0.offset = r1     // Catch:{ Throwable -> 0x01eb }
            r0.value = r15     // Catch:{ Throwable -> 0x01eb }
            goto L_0x01e4
        L_0x0165:
            r18 = r8
            boolean r1 = r15 instanceof java.lang.Float     // Catch:{ Throwable -> 0x01eb }
            if (r1 == 0) goto L_0x0183
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x01eb }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x01eb }
            r1 = r15
            java.lang.Float r1 = (java.lang.Float) r1     // Catch:{ Throwable -> 0x01eb }
            float r7 = r1.floatValue()     // Catch:{ Throwable -> 0x01eb }
            r1 = r19
            r4 = r18
            long r1 = r1.storeFloat(r2, r4, r5, r7)     // Catch:{ Throwable -> 0x01eb }
            r0.offset = r1     // Catch:{ Throwable -> 0x01eb }
            r0.value = r15     // Catch:{ Throwable -> 0x01eb }
            goto L_0x01e4
        L_0x0183:
            boolean r1 = r15 instanceof java.lang.String     // Catch:{ Throwable -> 0x01eb }
            if (r1 == 0) goto L_0x019b
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x01eb }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x01eb }
            r7 = r15
            java.lang.String r7 = (java.lang.String) r7     // Catch:{ Throwable -> 0x01eb }
            r1 = r19
            r4 = r18
            long r1 = r1.storeString(r2, r4, r5, r7)     // Catch:{ Throwable -> 0x01eb }
            r0.offset = r1     // Catch:{ Throwable -> 0x01eb }
            r0.value = r15     // Catch:{ Throwable -> 0x01eb }
            goto L_0x01e4
        L_0x019b:
            boolean r1 = r15 instanceof java.util.Set     // Catch:{ Throwable -> 0x01eb }
            if (r1 == 0) goto L_0x01c2
            r1 = r15
            java.util.Set r1 = (java.util.Set) r1     // Catch:{ Throwable -> 0x01eb }
            int r2 = r1.size()     // Catch:{ Throwable -> 0x01eb }
            java.lang.String[] r8 = new java.lang.String[r2]     // Catch:{ Throwable -> 0x01eb }
            r1.toArray(r8)     // Catch:{ Throwable -> 0x01eb }
            long r2 = r9.mHandle     // Catch:{ Throwable -> 0x01eb }
            long r5 = r0.offset     // Catch:{ Throwable -> 0x01eb }
            r16 = 3
            r1 = r19
            ...
            r12 = r8
            r8 = r16
            long r1 = r1.storeStringArray(r2, r4, r5, r7, r8)     // Catch:{ Throwable -> 0x01eb }
            r0.offset = r1     // Catch:{ Throwable -> 0x01eb }
            r0.value = r12     // Catch:{ Throwable -> 0x01eb }
            goto L_0x01e4
        L_0x01c2:
            com.bytedance.keva.KevaMonitor r2 = sMonitor     // Catch:{ Throwable -> 0x01eb }
            r3 = 1
            java.lang.String r4 = r9.mName     // Catch:{ Throwable -> 0x01eb }
            java.lang.IllegalStateException r7 = new java.lang.IllegalStateException     // Catch:{ Throwable -> 0x01eb }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x01eb }
            java.lang.String r5 = "do not support type: "
            r1.<init>(r5)     // Catch:{ Throwable -> 0x01eb }
            java.lang.Class r5 = r15.getClass()     // Catch:{ Throwable -> 0x01eb }
            r1.append(r5)     // Catch:{ Throwable -> 0x01eb }
            java.lang.String r1 = r1.toString()     // Catch:{ Throwable -> 0x01eb }
            r7.<init>(r1)     // Catch:{ Throwable -> 0x01eb }
            r5 = r18
            r6 = r15
            r2.reportThrowable(r3, r4, r5, r6, r7)     // Catch:{ Throwable -> 0x01eb }
        L_0x01e4:
            boolean r1 = r9.mIsMultiProcess     // Catch:{ Throwable -> 0x01eb }
            if (r1 != 0) goto L_0x01fc
            r0.loaded = r11     // Catch:{ Throwable -> 0x01eb }
            goto L_0x01fc
        L_0x01eb:
            r0 = move-exception
            goto L_0x01f0
        ...
        L_0x01f0:
            r7 = r0
        L_0x01f1:
            com.bytedance.keva.KevaMonitor r2 = sMonitor     // Catch:{ all -> 0x0227 }
            r3 = 3
            java.lang.String r4 = r9.mName     // Catch:{ all -> 0x0227 }
            r5 = r18
            r6 = r15
            r2.reportThrowable(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x0227 }
        L_0x01fc:
            r12 = 0
            goto L_0x00b3
        L_0x01ff:
            com.bytedance.keva.Keva r0 = getPortedSpRepo()     // Catch:{ all -> 0x0227 }
            java.lang.String r1 = r9.mName     // Catch:{ all -> 0x0227 }
            r0.storeBoolean(r1, r11)     // Catch:{ all -> 0x0227 }
            if (r10 == 0) goto L_0x0210
            java.lang.String r0 = r9.mName     // Catch:{ all -> 0x0227 }
            r1 = 0
            r9.protectPortingInterProcess(r0, r1, r13)     // Catch:{ all -> 0x0227 }
        L_0x0210:
            monitor-exit(r19)     // Catch:{ all -> 0x0227 }
