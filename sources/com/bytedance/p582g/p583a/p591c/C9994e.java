...
import com.bytedance.p582g.p583a.p585b.C9952a;

/* renamed from: com.bytedance.g.a.c.e */
class C9994e {

    /* renamed from: a */
    static final String[] f27129a = {"_id", "value", "type", "timestamp", "retry_count", "retry_time"};

    /* renamed from: b */
    private static C9994e f27130b;

    /* renamed from: c */
    private SQLiteDatabase f27131c;

    /* renamed from: b */
    private synchronized boolean m20095b() {
        if (this.f27131c == null || !this.f27131c.isOpen()) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: a */
    public final synchronized void mo17962a() {
        if (m20095b()) {
            try {
                this.f27131c.execSQL("DROP TABLE IF EXISTS queue");
                this.f27131c.execSQL("CREATE TABLE queue ( _id INTEGER PRIMARY KEY AUTOINCREMENT, value BLOB, type TEXT, timestamp INTEGER, retry_count INTEGER, retry_time INTEGER )");
            } catch (Exception e) {
    ...
    /* renamed from: a */
    private static void m20094a(Cursor cursor) {
        if (cursor != null) {
            try {
                if (!cursor.isClosed()) {
                    cursor.close();
    ...
    private C9994e(Context context) {
        if (context != null) {
            try {
                this.f27131c = C9952a.m20002a(context).getWritableDatabase();
    ...
    /* renamed from: a */
    static C9994e m20093a(Context context) {
        if (f27130b == null) {
            synchronized (C9994e.class) {
                if (f27130b == null) {
                    f27130b = new C9994e(context);
                }
            }
        }
        return f27130b;
    ...
    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized long mo17959a(String str) {
        long j = 0;
        if (!m20095b()) {
            return 0;
        }
        ...
        try {
            ...
            Cursor rawQuery = this.f27131c.rawQuery(str2, null);
            try {
    ...
    /* JADX WARNING: type inference failed for: r1v1, types: [com.bytedance.g.a.c.b] */
    ...
    /* JADX WARNING: type inference failed for: r2v6, types: [com.bytedance.g.a.c.b] */
    ...
    public final synchronized com.bytedance.p582g.p583a.p591c.C9989b mo17961a(long r12) {
        /*
            r11 = this;
            monitor-enter(r11)
            boolean r0 = r11.m20095b()     // Catch:{ all -> 0x0080 }
            r1 = 0
        ...
        L_0x000a:
            ...
            android.database.sqlite.SQLiteDatabase r2 = r11.f27131c     // Catch:{ Exception -> 0x006a }
            java.lang.String r3 = "queue"
            java.lang.String[] r4 = f27129a     // Catch:{ Exception -> 0x006a }
            r7 = 0
            r8 = 0
            ...
            com.bytedance.g.a.c.b r2 = new com.bytedance.g.a.c.b     // Catch:{ Exception -> 0x0063, all -> 0x0061 }
            r2.<init>()     // Catch:{ Exception -> 0x0063, all -> 0x0061 }
            long r3 = r12.getLong(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27115a = r3     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            byte[] r13 = r12.getBlob(r0)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27116b = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 2
            java.lang.String r13 = r12.getString(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27120f = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 3
            long r0 = r12.getLong(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27117c = r0     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 4
            int r13 = r12.getInt(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27118d = r13     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r13 = 5
            long r0 = r12.getLong(r13)     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r2.f27119e = r0     // Catch:{ Exception -> 0x005b, all -> 0x0061 }
            r1 = r2
            goto L_0x005d
        L_0x005b:
            r13 = move-exception
        ...
        L_0x0080:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.p582g.p583a.p591c.C9994e.mo17961a(long):com.bytedance.g.a.c.b");
    }

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized long mo17960a(String str, byte[] bArr) {
        if (m20095b() && bArr != null) {
            if (bArr.length > 0) {
                ...
                return this.f27131c.insert("queue", null, contentValues);
            }
        }
        return -1;
    }
    ...
    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final synchronized void mo17963a(String str, int i, long j) {
        String[] strArr;
        String str2;
        if (m20095b()) {
            ...
            try {
                this.f27131c.delete("queue", str2, strArr);
            } catch (Exception e) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean mo17964a(long r16, boolean r18, long r19, int r21) {
        /*
            r15 = this;
            r1 = r15
            r2 = r16
            monitor-enter(r15)
            boolean r0 = r15.m20095b()     // Catch:{ all -> 0x00bb }
            r4 = 0
        ...
        L_0x0013:
            ...
            android.database.sqlite.SQLiteDatabase r5 = r1.f27131c     // Catch:{ Exception -> 0x008c }
        ...
        L_0x0043:
            ...
            r6.put(r7, r8)     // Catch:{ Exception -> 0x0086, all -> 0x0084 }
            android.database.sqlite.SQLiteDatabase r7 = r1.f27131c     // Catch:{ Exception -> 0x0086, all -> 0x0084 }
        ...
        L_0x00a0:
            ...
            android.database.sqlite.SQLiteDatabase r0 = r1.f27131c     // Catch:{ Throwable -> 0x00ab }
        ...
        L_0x00bb:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.p582g.p583a.p591c.C9994e.mo17964a(long, boolean, long, int):boolean");
    }
}
