...
/* renamed from: com.bytedance.jirafast.d.i */
final class C12039i {
    /* renamed from: a */
    static InputStream m24492a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m24493a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C18982g.m46160a(uRLConnection)) {
