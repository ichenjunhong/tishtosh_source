...
public class DividerItemDecoration extends C1331h {
    ...
    public void drawHorizontal(Canvas canvas, RecyclerView recyclerView) {
        ...
        if (this.mDrawFirstChildTopLine) {
            ...
            if (recyclerView.mo4843e(childAt2) == 0) {
    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, C1349s sVar) {
        ...
        if (this.mOrientation == 1) {
            if (f == 0) {
                i += (int) C9432q.m18687b(recyclerView.getContext(), (float) this.mFirstOffset);
            }
