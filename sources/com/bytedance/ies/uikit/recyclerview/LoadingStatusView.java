...
public class LoadingStatusView extends FrameLayout {
    ...
    public static class Builder {
        ...
        private CircularProgressView createProgressView() {
            return (CircularProgressView) LayoutInflater.from(this.mContext).inflate(R.layout.a_f, null);
        }
        ...
        public static Builder createDefaultBuilder(Context context) {
            return new Builder(context).setEmptyText(R.string.c0d).setLoadingText(R.string.c0f).setErrorText(R.string.c0e, null);
        }

        private View createDefaultView(int i) {
            TextView textView = (TextView) LayoutInflater.from(this.mContext).inflate(R.layout.a_g, null);
            textView.setText(i);
            return textView;
        }

        public Builder setEmptyText(int i) {
            TextView textView = (TextView) LayoutInflater.from(this.mContext).inflate(R.layout.auk, null);
            textView.setText(i);
