...
public class C10938c extends SQLiteOpenHelper {

    /* renamed from: a */
    private static volatile C10938c f29353a;

    public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
    }

    /* renamed from: a */
    public final List<PackageStatisticModel> mo19723a() {
        Cursor cursor;
        String str;
    ...
    /* renamed from: a */
    public static C10938c m22193a(Context context) {
        if (f29353a == null) {
            synchronized (C10938c.class) {
                if (f29353a == null) {
                    f29353a = new C10938c(context.getApplicationContext(), "gecko_clean_statistic.db", null, 1);
                }
            }
        }
        return f29353a;
    ...
    private C10938c(Context context, String str, CursorFactory cursorFactory, int i) {
        super(context, str, null, 1);
    }

    /* renamed from: a */
    public final void mo19724a(String str, String str2, int i, int i2, int i3, int i4, String str3, long j, int i5) {
