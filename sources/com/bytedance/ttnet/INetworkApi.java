...
public interface INetworkApi {
    ...
    @C12718t
    C12690b<String> postBody(@C12713o int i, @C12699af String str, @C12694aa(mo23869a = true) Map<String, String> map, @C12700b TypedOutput typedOutput, @C12710l List<C12685b> list);

    @C12718t
    @C12715q
    C12690b<String> postMultiPart(@C12713o int i, @C12699af String str, @C12694aa(mo23869a = true) Map<String, String> map, @C12721w Map<String, TypedOutput> map2, @C12710l List<C12685b> list);
}
