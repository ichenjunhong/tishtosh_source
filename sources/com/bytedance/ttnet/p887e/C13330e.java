...
/* renamed from: com.bytedance.ttnet.e.e */
public final class C13330e {
    /* renamed from: a */
    public static void m26852a(Context context, Map<String, String> map) {
        if (context != null && map != null) {
            try {
                m26851a(context, 1, C9431p.m18662a(map));
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockSplitter
        ...
        */
    /* renamed from: a */
    public static java.lang.String m26850a(android.content.Context r2, int r3) {
        /*
            java.lang.String r0 = ""
            switch(r3) {
        ...
        L_0x0006:
            com.bytedance.ttnet.c r3 = com.bytedance.ttnet.C13303d.m26799b()     // Catch:{ Exception -> 0x003a }
            java.lang.String r0 = "tnc_config"     // Catch:{ Exception -> 0x003a }
            java.lang.String r1 = ""     // Catch:{ Exception -> 0x003a }
            java.lang.String r0 = r3.mo24899a(r2, r0, r1)     // Catch:{ Exception -> 0x003a }
            goto L_0x003c     // Catch:{ Exception -> 0x003a }
        L_0x0013:
            com.bytedance.ttnet.c r3 = com.bytedance.ttnet.C13303d.m26799b()     // Catch:{ Exception -> 0x003a }
        ...
        L_0x0047:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.ttnet.p887e.C13330e.m26850a(android.content.Context, int):java.lang.String");
    }

    /* renamed from: a */
    public static void m26851a(Context context, int i, String str) {
        try {
            ...
            C13303d.m26799b().mo24901a(context, (Map<String, ?>) linkedHashMap);
        } catch (Exception unused) {
        }
    }
}
