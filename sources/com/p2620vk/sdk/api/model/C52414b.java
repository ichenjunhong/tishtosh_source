...
final class C52414b {
    /* renamed from: a */
    public static boolean m111969a(JSONObject jSONObject, String str) {
    ...
    /* renamed from: b */
    public static int m111970b(JSONObject jSONObject, String str) {
        if (jSONObject == null) {
            return 0;
        }
    ...
    /* renamed from: a */
    private static Object m111968a(JSONArray jSONArray, Class cls) throws JSONException {
        ...
        while (i < jSONArray.length()) {
            try {
                ...
                if (VKApiModel.class.isAssignableFrom(componentType) && (opt instanceof JSONObject)) {
                    opt = ((VKApiModel) componentType.newInstance()).mo109175b((JSONObject) opt);
                }
    ...
    /* renamed from: a */
    public static <T> T m111967a(T t, JSONObject jSONObject) throws JSONException {
        Field[] fields;
        Object vKList;
                    ...
                    if (!type.isPrimitive() || !(opt instanceof Number)) {
                        ...
                        if (!opt.getClass().equals(type)) {
                            if (type.isArray() && (opt instanceof JSONArray)) {
                                opt = m111968a((JSONArray) opt, type);
                                ...
                                if (VKList.class.equals(type)) {
                                    ...
                                    if (VKApiModel.class.isAssignableFrom(cls) && Parcelable.class.isAssignableFrom(cls) && C52413a.class.isAssignableFrom(cls)) {
                                    ...
                                    opt = ((VKApiModel) type.newInstance()).mo109175b((JSONObject) opt);
                                }
                                opt = obj;
                            } else {
                                opt = type.getConstructor(new Class[]{JSONArray.class}).newInstance(new Object[]{(JSONArray) opt});
