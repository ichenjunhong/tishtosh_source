...
final class C52340c {
    /* renamed from: a */
    static void m111811a(HttpURLConnection httpURLConnection, String str, String str2) {
    ...
    /* renamed from: b */
    static void m111812b(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C18982g.m46160a(uRLConnection)) {
            C18976b.m46151a(uRLConnection.getURL(), str, str2, "");
        }
